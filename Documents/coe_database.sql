...
ALTER TABLE `coe_value_subjects`
  MODIFY `coe_val_sub_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
COMMIT;
...
ALTER TABLE `sub`
  ADD PRIMARY KEY (`coe_sub_mapping_id`);
  ...
  ALTER TABLE `coe_value_nominal`
  ADD PRIMARY KEY (`coe_nominal_val_id`);


  ALTER TABLE `coe_value_nominal`
  MODIFY `coe_nominal_val_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
COMMIT;
...
ALTER TABLE `coe_value_mark_entry`
  ADD PRIMARY KEY (`coe_value_mark_entry_id`);
