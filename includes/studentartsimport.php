...
{    
     $stu_columns=['A'=>'YEAR','B'=>'DEGREE','C'=>'MAJOR','D'=>'SECTION','E'=>'STUDENT_NAME','F'=>'DOB(mm-dd-yyyy)','G'=>'GENDER','H'=>'BLOOD_GROUP','I'=>'RELIGION','J'=>'COMMUNITY','K'=>'CASTE','L'=>'PARENT_NAME','M'=>'DOOR_NO/STREET','N'=>'TOWN/TALUK','O'=>'CITY/DISTRICT','P'=>'STATE','Q'=>'EMAIL_ID','R'=>'PIN_CODE','S'=>'PARENT_PHONE','T'=>'STUDENT_PHONE','U'=>'REGISTER_NUMBER','V'=>'PART_KEY'];

    $template_clumns=['A'=>$line['A'],'B'=>$line['B'],'C'=>$line['C'],'D'=>$line['D'],'E'=>$line['E'],'F'=>$line['F'],'G'=>$line['G'],'H'=>$line['H'],'I'=>$line['I'],'J'=>$line['J'],'K'=>$line['K'],'L'=>$line['L'],'M'=>$line['M'],'N'=>$line['N'],'O'=>$line['O'],'P'=>$line['P'],'Q'=>$line['Q'],'R'=>$line['R'],'S'=>$line['S'],'T'=>$line['T'],'U'=>$line['U'],'V'=>$line['V']];
