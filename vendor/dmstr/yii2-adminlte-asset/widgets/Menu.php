...
class Menu extends \yii\widgets\Menu
{
    ...
    public $activateParents = false; // Make it true if required then active dropdown always visible
    ...
    {
        if (isset($item['items'])) {
            $labelTemplate = '<a href="{url}" class="dropdown-toggle" tabindex="-1">{icon} {label} </a>';
            $linkTemplate = '<a href="{url}" class="dropdown-toggle" tabindex="-1">{icon} {label} </a>';
        } else {
