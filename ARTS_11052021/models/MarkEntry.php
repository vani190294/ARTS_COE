...
class MarkEntry extends \yii\db\ActiveRecord
{
    ...
    public $model_1,$model_2,$credit_type,$model_type,$semester,$section,$stu_batch_id,$stu_programme_id,$filter,$reg_range_from,$reg_range_to,$mark_from,$mark_to,$register_number,$mark_view_register_number;
