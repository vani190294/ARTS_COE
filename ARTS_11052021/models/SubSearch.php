...
class SubSearch extends Sub
{
    ...
    {
        return [
            [['coe_sub_mapping_id', 'batch_mapping_id', 'val_subject_id', 'semester', 'paper_type_id', 'subject_type_id', 'course_type_id', 'paper_no', 'created_by', 'updated_by'], 'integer'],
            [['migration_status', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        // add conditions that should always apply here
         $query->joinWith(['coeBatch','coeDegree','coeProgramme','paperTypes','subjectTypes','courseTypes']);
