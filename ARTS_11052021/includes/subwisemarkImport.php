...
{    
    ...
    { 
        ...
        else
        {
            ...
            if($sem_verify != $line['E'])
            {
                $cia_marks='';
                $marks_available=0;
            }
            else if(count($check_cia_marks)>0 && !empty($check_cia_marks))
            {
...
$_SESSION['importResults'] = ['dispResults'=>$dispResults,'totalSuccess'=>$totalSuccess,'result_for'=>'Subwise Marks'];
?>