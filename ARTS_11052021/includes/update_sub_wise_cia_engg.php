...
{    
    ...
    if(!empty($year) && !empty($month) && !empty($mark_type) && !empty($reg_num_stu) && !empty($subject_code) && !in_array(null, $line, true) && !empty($line['G']))
    {      
        $inserted_res = 0;
                    ...
                    if($command1->execute())
                     { 
                        ...
                        if(!empty($check_mark_entry_master))
                        {
                            ...
                            $ese_marks = !empty($check_ese_marks['category_type_id_marks']) && $check_ese_marks['category_type_id_marks']!=0?$check_ese_marks['category_type_id_marks']:0;
