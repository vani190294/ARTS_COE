            ...
            <div class="row">
                ...
                <section class="content">
                  ...
                  <div class="row">
                    ...
                    <div class="box">
                        ...
                        $head .='<table style="background: #FFF;" class="main_table"  width="100%" >
                                <tr class="table-danger">
                                    <th align="center" colspan="12" ><br /><br /><h3>
                    ...
                    {
                        $body .= "<tr>
                            <td valign='middle' width='70' height='30px'>".$sn."</td>
                            <td valign='middle' width='125' height='30px'>".$value['register_number']."</td>
                            <td valign='middle' width='125' height='30px'>".$value['name']."</td>
                            <td valign='middle' width='125' height='30px'>".$value['guardian_name']."</td>
                            <td valign='middle' width='125' height='30px'>".$value['nationality']." </td>
                            <td valign='middle' width='125' height='30px'>".$value['religion']."</td>
                            <td valign='middle' width='125' height='30px'>".$value['caste']."</td>
                            <td valign='middle' width='125' height='30px'>".$value['sub_caste']."</td>
                            <td valign='middle' width='170' height='30px'>".date('d-m-Y',strtotime($value['dob']))."</td>
                            <td valign='middle' width='170' height='30px'>".date('d-M-Y',strtotime($value['dob']))."</td> 
                            <td valign='middle' width='170' height='30px'>".date('d-m-Y',strtotime($value['admission_date']))."</td>
                            <td valign='middle' width='170' height='30px'>&nbsp;</td>
                            </tr>

                            <tr>
                            <td valign='middle' width='70' height='30px'>&nbsp;</td>
                            <td valign='middle' width='125' height='30px'>".$value['register_number']."</td>
