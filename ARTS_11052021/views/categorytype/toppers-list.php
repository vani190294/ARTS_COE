    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="btn-group col-lg-12 col-sm-12" role="group" aria-label="Actions to be Perform">
                <input type="button" id="toppersList" name="toppersList" class="btn btn-success" value="Submit">
                <?= Html::a("Reset", Url::toRoute(['categorytype/toppers-list']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
       	</div>
    </div>
