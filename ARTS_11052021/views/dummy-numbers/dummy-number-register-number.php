...
$this->title= ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_DUMMY)." REGISTER NUMBER REPORT";
?>
...
<div class="row">
   <div class="col-xs-12 col-sm-12 col-lg-12"> 
        ...
        <?= $form->field($model, 'month')->widget(
                Select2::classname(), [  
                    ...
                    'options' => [
                        ...
                        'id' => 'dum_exam_month', 
                        'onchange' => 'bringYearMonthSubs(this.value,$("#year").val());',                           
                    ],
                   'pluginOptions' => [
                       'allowClear' => true,
                    ],
        ...
        <div class="btn-group col-lg-6 col-sm-6" role="group" aria-label="Actions to be Perform">
                <?= Html::Button( 'Download' , ['onClick'=>'get_dummy_num_reg_info();','class' => 'btn btn-success' ]) ?>

                <?= Html::a("Reset", Url::toRoute(['dummy-numbers/dummy-number-register-number']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
