...
<div class="col-xs-12 col-sm-12 col-lg-12">
   <div class="col-xs-12 col-sm-12 col-lg-12"> 
        ...
        <div class="col-xs-12 col-sm-2 col-lg-2">
            <?= $form->field($model, 'start_number')->textInput(['onkeypress'=>'numbersOnly(event)','id'=>'start_number','min'=>4,'autocomplete'=>'off','onchange'=>'getAllnumbersLimit(this.value,$("#exam_year").val(), $("#exam_month").val());','max'=>10,'required'=>'required']); ?>
        ...
        <div class="col-xs-12 col-sm-2 col-lg-2">
            <?= $form->field($model, 'limit')->textInput(['onkeypress'=>'numbersOnly(event)','id'=>'limit','min'=>4,'max'=>10,'value'=>30,'required'=>'required','autocomplete'=>"off"]); ?>
                     
        </div>   
        <div class="col-xs-12 col-sm-2 col-lg-2">
            <?= $form->field($model, 'chief_examiner_name')->textInput(['required'=>'required','id'=>'chief_examiner_name','autocomplete'=>"off"])->label('Chief Examiner Name'); ?>
