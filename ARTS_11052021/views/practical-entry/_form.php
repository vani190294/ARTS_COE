...
<?php Yii::$app->ShowFlashMessages->showFlashes();?>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <br />
                <div class="btn-group pull-right col-lg-2 col-sm-2" role="group" aria-label="Actions to be Perform">
                    <?= Html::a("Reset", Url::toRoute(['practical-entry/create']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
                </div>
        </div>
