...
$this->title = $model->coe_practical_exam_timetable_id;
...
<div class="practical-exam-timetable-view">
    ...
    <p>
        <?= Html::a('Update', ['update', 'id' => $model->coe_practical_exam_timetable_id], ['class' => 'btn btn-primary']) ?>
        <?= Html::a('Delete', ['delete', 'id' => $model->coe_practical_exam_timetable_id], [
