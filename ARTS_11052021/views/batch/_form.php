...
<div class="box-body"> 
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">                
        <div class="col-xs-12 col-sm-3 col-lg-3">
            <?php if(!$model->isNewRecord){
                ?>
                <?= $form->field($model, 'batch_name')->textInput(['maxlength' => 4,'id' =>'batch_name','required'=>'required','placeholder'=>'YYYY','autocomplete'=>"off"]) ?>
                <?php
            }
            else {
                 ?>
                 <?= $form->field($model, 'batch_name')->textInput(['maxlength' => 4,'id' =>'batch_name','value'=>date('Y'),'required'=>'required','placeholder'=>'YYYY','autocomplete'=>"off"]) ?>
                 <?php
             } ?>
        ...
        <div class="col-xs-12 col-sm-3 col-lg-3" id="reg">
            <?= $form->field($regulation, 'regulation_year')->textInput(['maxlength' => 4,'id' => 'reg_year','placeholder'=>'YYYY','autocomplete'=>"off"]) ?>
        </div> 
        ...
        <div class="col-xs-12 col-sm-3 col-lg-3" id = "grade">
            ...
            <input class="range_of_grade" type="radio" id="grade100" name="gradee" value="100" checked > <b>Marks Out of 100</b> <br>                        
        </div>   
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12" id="gradepoints" >                                 
        <div class="col-xs-12 col-sm-3 col-lg-3">
            <?= $form->field($regulation, 'grade_point_from')->textInput(['maxlength'=>3,'placeholder'=>'Only Numbers','autocomplete'=>"off"]) ?>
        </div>

        <div class="col-xs-12 col-sm-3 col-lg-3">
            <?= $form->field($regulation, 'grade_point_to')->textInput(['maxlength'=>3,'placeholder'=>'Only Numbers','autocomplete'=>"off"]) ?>
        </div>                  
                            
        <div class="col-xs-12 col-sm-3 col-lg-3">
            <?= $form->field($regulation, 'grade_name')->textInput(['maxlength' => 3,'placeholder'=>'Only Alphabets','style'=>'text-transform:Uppercase','autocomplete'=>"off"]) ?>
        </div> 

        <div class="col-xs-12 col-sm-3 col-lg-3">
            <?= $form->field($regulation, 'grade_point')->textInput(['maxlength' => 2,'placeholder'=>'Only Integer','autocomplete'=>"off"]) ?>
        </div>                              
    </div>          
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12 update_course_div"> 
        ...
        <div class="col-xs-12 col-sm-3 col-lg-3 sec">
            <?= $form->field($model,'No_of_Section')->textInput(['id' => 'section','maxlength'=>1,'pattern'=>'[1-5]','onBlur'=>'validateThisValue(this.id);'])->label(" No of ".ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SECTION)) ?>
        </div>
