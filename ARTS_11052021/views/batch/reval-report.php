    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="form-group col-lg-3 col-sm-3"> 
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                <?= Html::Button('Submit', ['value'=>'Submit','name'=>"consolidate_btn",'batch_report' ,'class' => 'btn  btn-group-lg btn-group btn-success','onclick'=>'getRevalResult($("#batch_year").val(),$("#consolidate_month").val())']) ?>
                
                <?= Html::a("Reset", Url::toRoute(['batch/reval-report']), ['class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
