            ...
            {                
                ...
                for ($loop_sem = $sem_printed_val; $loop_sem <= $total_semesters; $loop_sem++) 
                {
                    ...
                    { 
                        ...
                        $credits_register_row .= "<td width='90px' height='25px' >&nbsp;</td>";
                        $credits_earned_row .= "<td width='90px' height='25px' >&nbsp;</td>";
                        $sgpa_row .= "<td width='90px' height='25px'  >&nbsp;</td>"; 
                ...
                {
                    $credits_register_row .= "<td  width='60px' height='25px' colspan=".(11-$count_col_spans)."  >&nbsp;</td>";
                    $credits_earned_row .= "<td width='60px' height='25px' colspan=".(11-$count_col_spans)."   >&nbsp;</td>";
                    $sgpa_row .= "<td width='60px' height='25px' colspan=".(11-$count_col_spans)."   >&nbsp;</td>";
                }
                ...
                <td colspan='3' width='30px' > &nbsp; </td>
                <td class='print_cumulative_credit_points font_bigger' height='25px' valign='top' > <b>" . $cgpa_calc['cumulative_earned_credits'] . "</b> </td>
                <td colspan='4' width='30px' > &nbsp; </td>
                <td class='print_cumulative_credit_points_cgpa font_bigger' width='60px'  height='25px'  valign='top' > <b>" . $cgpa_calc['cgpa_result_sem'] . "</b> </td>
                ...
                $merge_body = "<tr><td width='100%' valign='top' colspan='11' height='547px' >" . $body . "</td></tr><tr><td colspan='11' width='30px' height='57px' >&nbsp;</td></tr>";
