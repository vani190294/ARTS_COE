    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="btn-group col-lg-12 col-sm-12" role="group" aria-label="Actions to be Perform">
                ...
                <input type="button" id="markpercentbutton" name="markpercentbutton" class="btn btn-success" value="Submit">
                <?= Html::a("Reset", Url::toRoute(['mark-entry/mark-percent']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
        </div>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12 mark_percent_print_btn">
        ...
        <div class="col-xs-3 col-sm-2 col-lg-2">
            <?php 
                ...
                echo Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['/mark-entry/mark-percent-pdf'], [
