    ...
    foreach ($mark_statement as $value) 
    {
        ...
        { 
           ...
           /* if($value['term']=='35')
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td  valign='top' width='60px' style='padding-left:-15px;' align='center'><b>" . $semester_array[$valuess['semester']]. "</b></td>
                                    <td valign='top'  width='115px'  style='padding-left:-15px;'  colspan='3' align='left'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                     <td valign='top' style='padding-left:-60px;' align='left' width='430px'  >" . $subject_name_print . "</td>
                        ...
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px'  colspan='3' align='left'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                    ...
                                    <td valign='top' width='55px'  align='left'  style='padding-left:-10px;'><b>" . $cia_max_disp . "</b></td>
                                    <td valign='top' width='60px'  align='left' style='padding-left:-5px;'><b>" . $total_max_disp . "</b></td>
            ...
            $header .= '<tr>
                           <td height="150px" style="border: none; padding-right: 40px;  padding-top: 25px; text-align: right;" colspan="16" >
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td  valign='top' width='60px' style='padding-left:-15px;' align='center'><b>" . $semester_array[$value['semester']]. "</b></td>
                                    <td valign='top'  width='115px'  style='padding-left:-15px;'  colspan='3' align='left'><b>" . strtoupper($value['subject_code']) . "</b></td>
                                     <td valign='top' style='padding-left:-60px;' align='left' width='430px'  >" . $subject_name_print . "</td>
            ...
            <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                    <tr>
                        ...
                        <td valign='top' width='115px'  colspan='3' align='left'><b>" . strtoupper($value['subject_code']) . "</b></td>
                        <td valign='top' width='435px'  colspan='8' align='left'>" . $subject_name_print . "</td>
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    <td valign='top' width='55px' align='left'><b>" . $semester_array[$value['part_no']]. "</b></td>
                                    <td  valign='top' width='60px' style='padding-left:-15px;' align='center'><b>" . $semester_array[$value['semester']]. "</b></td>
                                    <td valign='top' width='115px'     colspan='3'  style='padding-left:-15px;' align='left'><b>" . strtoupper($value['subject_code']) . "</b></td>
                                     <td valign='top' style='padding-left:-60px;' align='left'  width='430px'  >" . $subject_name_print . "</td>
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    <td valign='top' width='55px' align='left'><b>" . $semester_array[$valuess['part_no']]. "</b></td>
                                    <td  valign='top' width='60px'style='padding-left:-15px;' align='center'><b>" . $semester_array[$valuess['semester']]. "</b></td>
                                    <td valign='top'  width='115px'     colspan='3'  style='padding-left:-15px;' align='left'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                    <td valign='top' style='padding-left:-60px;'  align='left' width='430px'  >" . $subject_name_print. "</td>
