...
if (isset($mark_statement) && !empty($mark_statement)) 
{
     ...
     */
    $add_tr_starting = $print_trimester == 1 ? "<tr><td colspan='11' width='30px'>&nbsp;</td></tr> <tr><td style='font-weight: bold; font-size: 14px; padding-top: -15px; text-align: center;' colspan='11'> TRIMESTER PATTERN </td></td></tr>" : "<tr><td colspan='11' width='30px'>&nbsp;</td></tr> <tr><td style='font-weight: bold; font-size: 14px; padding-top: -18px; text-align: center;' colspan='11'> &nbsp; </td></td></tr>";
    ...
    $date_insert = "<tr><td colspan='11' height='20px' width='50px'> &nbsp;</td></tr> <tr><td  align='left' valign='bottom' class='date_style' colspan='11' width='300px' style='font-size: 12px; padding-top: 24px; padding-left: 36px; ' >".$date."</td></tr> ";
        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            {                
                ...
                for ($loop_sem = 1; $loop_sem <= $total_semesters; $loop_sem++) 
                {
                    if ($loop_sem == $semester_number) 
                    {
                        ...
                        $add_padding = $align_text=='center' ?'padding-left: 15px;':'padding-right: 14px;';
                        $add_padding = $loop_sem==3 && $increment==0  ?'padding-left: 10px;':$add_padding;
                    ...
                    foreach ($check_add as $valuess) 
                    {
                        ...
                        <table border='0' width='100%' >
                            <tr>
                                ...
                                <td width='450px' style='font-size: 12px !important;' colspan='5'  align='left'>" . $subject_name_print . "</td>
                ...
                $merge_body = "<tr><td width='100%' valign='top' colspan='11' height='562px' >" . $body . "</td></tr><tr><td colspan='11' width='30px' height='58px' >&nbsp;</td></tr>";
            ...
            $header .= "<tr>
                        <td style='border: none;' colspan='11' width='100%'  >
                            <table width='100%' id='move_table_right' align='left' style='border: none !important; padding-top: 10px;'  border='0'>
                                <tr  style='padding: 10px;'>
                                    ...
                                    <td class='line_height' align='left'><b style='padding-left: 40px !important;'>" . strtoupper($month_disp)  . "  " . $value['year'] . " </b> </td>
                                </tr>                            
                                <tr style='padding: 10px;'>
                                    <td class='line_height' colspan='4' style='width: 30px;'>&nbsp;</td>
                                    <td class='line_height' align='left'  colspan='3' style='padding-left: 72px;'> <b>" . strtoupper($value['register_number']) . "</b></td>
                                    <td class='line_height head_right_tags' width='190px;' align='left' colspan='3' style='padding-left: 45px !important;' ><b>" . $dob . "</b></td>
                                    <td class='line_height' align='left'><b style='padding-left: 40px !important;'>" . strtoupper($print_gender) . "</b></td>
                                </tr>                            
                                <tr  style='padding: 10px;'>
                                    ...
                                    <td class='line_height' align='left'><b style='padding-left: 40px !important; '>" . $value['regulation_year'] . "</b></td>
                                </tr>
                                <tr>
            ...
            else 
            {
                ...
                if(isset($value['is_additional']))
                {
                    ...
                    <table border='0' width='100%' >
                        <tr>                            
                            <td width='450px' style='font-size: 12px !important;' colspan='5'  align='left'><b> &nbsp;&nbsp;&nbsp;" .strtoupper($get_man_det['sub_cat_code'])." - ". $subject_name_print . "</b></td>
                ...
                if(isset($value['is_additional']))
                {
                    ...
                    <table border='0' width='100%' >
                        <tr>
                            <td width='40px' align='left'><b>" . $semester_array[$value['semester']]. "</b></td>
                            <td width='80px'  align='left'><b>" . strtoupper($value['subject_code']) . "</b></td>
                            <td width='450px' style='font-size: 12px !important;' colspan='6'  align='left'>&nbsp;<b>" . $subject_name_print . "</b></td>
                        </tr></table>";  
                    ...
                    foreach ($check_add as $valuess) 
                    {
                        ...
                        <table border='0' width='100%' >
                            <tr>
                                ...
                                <td width='80px'  align='left'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                <td width='450px' style='font-size: 12px !important;' colspan='5'  align='left'>" . $subject_name_print . "</td>
                                <td width='52px'  align='left'><b>" . $valuess['credits'] . "</td>
                                <td width='45px'  align='left'> <b>" . strtoupper($valuess['grade_name']) . "</b> </td>
                                <td width='55px'  align='center'><b>" . $grade_point_print . "</b></td>
                                <td  style='padding-left: 10px;' width='50px'  align='center'><b>" . $result_stu . "</b></td>
                            </tr>
