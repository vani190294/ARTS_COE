...
if (isset($mark_statement) && !empty($mark_statement)) 
{
      ...
      /**  if($value['month']=='Oct/Nov' ||  $value['month']=='OCT/NOV' ||  $value['month']=='oct/nov')
        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            {    
                ...
                $credits_register_row .= "<td  class='part_no_print_pg' style='padding-bottom:-60'  height='25px'> ".$cgpa_calc['part_3_earned']." </td>";
                $credits_register_row .= "<td  class='part_no_print_pg' style='padding-bottom:-60' height='25px'> ".$cgpa_calc['part_3_gpa']." </td>";
                $credits_register_row .= "<td  class='part_no_print_pg' style='padding-bottom:-60' height='25px'> ".$cgpa_calc['part_3_cgpa']." </td>";
                $credits_register_row .= "</tr>";         
                ...
                <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                    <tr>
                      <td  valign='top'  width='55px' align='center'><b>" . $semester_array[$valuess['semester']]. "</b></td>
                        <td valign='top'  width='120px'  style='padding-left:15px;'    align='left'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
            ...
            ";
                    ...
                    <tr>
                        ...
                        <td  valign='top' width='55px'  align='center'><b>" . $ese_max_disp . "</b></td>
                        <td valign='top'  width='65px'  align='center'><b>" . $cia_max_disp . "</b></td>
                        <td valign='top'  width='60px'  align='left'><b>" . $total_max_disp . "</b></td>
                        <td valign='top'  width='50px'  align='left' style='padding-left:-10px;'><b>" . $disp_ese . "</b></td>
                        <td valign='top'  width='60px'  align='left'><b>" . $disp_cia . "</b></td>
                        <td valign='top'  width='60px' class='tot_gp_pg'  align='left' style='padding-left:-10px;'><b>" . $total_disp_res . "</b></td>
                ...
                if($value['CIA_max'] == 0 && $value['ESE_max'] == 0)
            {
                ...
                <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                    <tr>
                      ...
                      <td valign='top'  width='120px'  style='padding-left:15px;'  align='left'><b>" . strtoupper($value['subject_code']) . "</b></td>
                      <td  valign='top' width='470px' class='put_margin_pg' colspan='4' align='left'>" . $subject_name_print . "</td>
                      <td valign='top' style='padding-right: -95px;' width='350px' colspan=9  align='center'><b>".$RESULT_UPPER."</b></td>
    ...
    $is_additional_printed = 0;
    $credits_register_row .= "<tr> ";   
    $credits_register_row .= "<td  class='part_no_print_pg' style='padding-bottom:-30' height='60px'> ".$cgpa_calc['part_3_earned']." </td>";
    $credits_register_row .= "<td  class='part_no_print_pg' style='padding-bottom:-30' height='60px'> ".$cgpa_calc['part_3_gpa']." </td>";
    $credits_register_row .= "<td  class='part_no_print_pg' style='padding-bottom:-30' height='60px'> ".$cgpa_calc['part_3_cgpa']." </td>";
    $credits_register_row .= "</tr>";            
    $footer .= $credits_register_row ."</table>";
    $check_add = Yii::$app->db->createCommand('SELECT * FROM coe_additional_credits WHERE exam_year="'.$exam_year.'" AND exam_month="'.$add_month.'" and student_map_id="'.$print_student_map_id.'" and result like "%pass%"')->queryAll();
