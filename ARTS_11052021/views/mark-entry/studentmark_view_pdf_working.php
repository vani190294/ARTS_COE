        ...
        foreach ($get_loop_2 as $key => $Transfer) 
        {
            $data .= "
                <tr>
                    ...
                    <td width='80px'  align='left'>" . strtoupper($Transfer['subject_code']) . "</td>
        ...
        $data.="<tr>
                ...
                foreach ($fetch_month as $value_data) 
                {
                    ...
                    foreach ($get_all_details as $stu_mark) 
                    {
                        ...
                        $data.='<td align="left" colspan=2>'.$stu_mark['subject_code'].'</td>';
