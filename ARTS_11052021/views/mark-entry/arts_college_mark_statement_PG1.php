    ...
    foreach ($mark_statement as $value) 
    {
        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            {    
                ...
                $credits_register_row .= "<td  class='part_no_print_pg' height='25px'> ".$cgpa_calc['part_3_earned']." </td>";
                $credits_register_row .= "<td  class='part_no_print_pg' height='25px'> ".$cgpa_calc['part_3_gpa']." </td>";
                $credits_register_row .= "<td  class='part_no_print_pg' height='25px'> ".$cgpa_calc['part_3_cgpa']." </td>";
                $credits_register_row .= "</tr>";         
                ...
                if(!empty($check_add))
                {
                    ...
                    <tr>
                        <td  valign='top'  width='47px' align='center'><b>" . $semester_array[$valuess['semester']]. "</b></td>
                        <td valign='top'  width='110px' class='put_margin_pg'    align='left'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                        ...
                        <td valign='top'  width='50px'  align='left'><b>" . $disp_ese . "</b></td>
                ...
                $margin= $is_additional_printed == 1?(1063+$bottom_margin):($bottom_margin+1032);
                $body .= "
            ...
            $passed_grade_points = '';
                ...
                $print_total_credits[] = ['sem'=>$value['semester'],'credits'=>$value['credit_points'],'grades'=>$value['grade_point'],'res'=>$result_stu,'part_no'=>$value['part_no']];
                    ...
                    <table class='body_print_marks'  style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            <td  valign='top'  width='47px' align='center'><b>" . $semester_array[$value['semester']]. "</b></td>
                            <td  valign='top'  width='110px' class='put_margin_pg'  align='left'><b>" . strtoupper($value['subject_code']) . "</b></td>
                            <td  valign='top'  width='470px' class='put_margin_pg' colspan='4'  align='left'>" . $subject_name_print . "</td>
