...
<?php
    ...
    $data.='<tr style="background: #194d33;color: #fff;">
                <td colspan="13" align="center"><h3 style="background: #194d33;color: #fff;"><b>'.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT).' Mark View </b></h3>
                </td>
            </tr>
            <tr style="background: #0000ff;color: #fff;">
                <td colspan="13" align="center"><h4 style="background: #0000ff;color: #fff;"><b>'.strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT)).' DATE OF BIRTH : '.DATE('d-m-Y',strtotime($stu_dob_display['dob'])).' </b></h3>
                </td>
            </tr>';
$seb_reg_nums = strtoupper($_POST['mark_view_reg_no']);
    $files = glob($absolute_dire.$seb_reg_nums.".*");
     if (count($files) > 0)
        { 
        ...
        $seb_reg_nums = strtoupper($_POST['mark_view_reg_no']);
    $photo_extension = ConfigUtilities::match($supported_extensions,$seb_reg_nums.$extension); 
    $stu_photo = $photo_extension!="" ? $stu_directory.$seb_reg_nums.".".$photo_extension:$stu_directory."stu_sample.jpg";
    ...
    $table_insert = '<table border=1 style="font-weight: bold;" width="100%"><tr style="text-align: center;"><th>SEM</th><th>P-I</th><th>P-II</th><th>P-III</th><th>P-IV</th><th>GPA</th><th>CGPA</th></tr>';
        ...
        if($value['mark_type']=='27')
        {
            ...
            $table_insert .=
                "<tr style='color: #".$color."; font-size: 16px;' >
                    ...
                    <td>".$cgpa_calc['part_1_earned']."</td>
                    <td>".$cgpa_calc['part_2_earned']."</td>
                    <td>".$cgpa_calc['part_3_earned']."</td>
                    <td>".$cgpa_calc['part_4_earned']."</td>
                    <td>".$cgpa_calc['gpa']."</td>
    ...
    $data_1.="<tr><td colspan=4><center>".$student_detail['name']."</center></td>";
 ...
 $data.="<tr>                   
                <td colspan=13 style='text-align: center;'><h3>".ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT)." Information</h3>
                </td>
            </tr>";
    ...
    $data.="<tr>             
                ...
                <th colspan=3><center>Register Number </center></th>
    ...
    $data.="<tr>                    
                <td colspan=13 style='text-align: center;'><h3>Mark Information</h3></td>
            </tr>";
        ...
        $data.="<tr>
                ...
                foreach ($fetch_month as $value_data) 
                {
                    ...
                    $data.='<tr><td align="center" colspan=13> <span style="display: none;">'.$stu_map_hide_id.'</span> <h3 style="color: #138711; font-weight: bold;" > <b style="color: #0d4fba;">'.$print_mark_type." </b> ".$semester_name.'  <b style="color: #b34700;">'.$print_sem.'</b>  DETAILS</h3> </td></tr>';
                    ...
                    foreach ($get_all_details as $stu_mark) 
                    {
                        ...
                        $data.='<td align="left">'.$stu_mark['part_no'].'</td>';
                    ...
                    {
                        $data.='<tr> <td align="right" colspan=13> <h4 style="color: #2157c4; font-weight: bold;" > SGPA : '.$cgpa_calc['gpa'].' </h4> </td></tr>';    
                        $sem_inc++;
                    }
                ...
                if(!empty($check_add))
                {
                    $data.='<tr><td align="center" colspan=13> <h3 style="color: #138711; font-weight: bold;" > <b style="color: #0d4fba;"> ADDITIONAL CREDITS SUBJECT DETAILS</h3> </td></tr>';
    ...
    $data.='<tr>
                <td colspan=13 ><h2>#### END OF STATEMENT ###</h2></td>
                </tr>
                </tbody>';        
    $data.='</table><br /><br />';
    $data.='<table class="color_identification"  width="40%" border=1>
                <tr>
                    <th colspan=3 ><h2>COLOR IDENTIFICATION</h2></th>
                </tr>
                <tr>
