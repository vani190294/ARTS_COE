...
$visible = Yii::$app->user->can("/subjects/view") || Yii::$app->user->can("/subjects/update") ? true : false; 
            ...
            [
                ...
                'buttons' => [
                    'view' => function ($url, $model) {
                            return ((Yii::$app->user->can("/subjects/view")) ? Html::a('<span class="fa fa-hand-o-right increase_size"></span>', $url, ['title' => 'View',]) : '');
                        },
                    'update' => function ($url, $model) {
                            return ((Yii::$app->user->can("/subjects/update")) ? Html::a('<span class="fa fa-pencil-square-o increase_size"></span>', $url, ['title' => 'Update',]) : '');
                        },
                    'delete' => function ($url, $model) {
                            return ((Yii::$app->user->can("/subjects/delete")) ? Html::a('<span class="fa fa-ban increase_size"></span>', $url, ['title' => 'Delete', 
    ...
    echo GridView::widget([
        ...
        'toolbar' => [
            ...
            ['content'=>
                ...
                Html::a('<i class="glyphicon glyphicon-plus"></i> '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT), ['create'], [
                    'data-pjax'=>0, 
                    'class'=>'btn btn-success',
                    'title'=>'Add '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT), 
                ]). ' '.
                Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['subjects/index'], [
                    'data-pjax'=>0, 
                    'class' => 'btn btn-default', 
                    'title'=>'Reset'
                ])
