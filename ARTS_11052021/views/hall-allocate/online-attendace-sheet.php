                ...
                foreach ($get_data as $value) 
                {
                    ...
                    if($stu_count_break%26==0 || $stu_count_break==1)
                    {
                        ...
                        <tr>
                         ...
                         <td width="72px" align="center"> Section A </td> 
                          <td width="72px" align="center"> Section B </td> 
                           <td width="72px" align="center"> Section C </td> 
                            <td width="72px" align="center"> P/AB </td>
                            <td width="75px" align="left"> Remarks </td>  
                        </tr>
                        ';
                        $body .='
                        <tr>
