...
$this->title = STRTOUPPER(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT))." WISE ARREAR";
$this->params['breadcrumbs'][] = ['label' => strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT))." WISE ARREAR", 'url' => ['create']];
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="form-group col-lg-3 col-sm-3">
                ...
                <?= Html::a("Reset", Url::toRoute(['mark-entry/coursewisearrear']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
        </div>
    ...
    if($file_content_available=="Yes")
        {
            ...
            $stu_print_vals = 0;
               ...
               $header .="<table border=1 align='center' class='table table-striped '>";
                    ...
                    $i=1;
                    $footer .='</table>';
                  foreach($coursewisearrear as $rows) 
                  { 
