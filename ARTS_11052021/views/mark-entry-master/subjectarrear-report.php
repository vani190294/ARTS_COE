...
$this->title = ' SUBJECT WISE ARREAR REPORT';
$this->params['breadcrumbs'][] = ['label' => 'SUBJECT WISE ARREAR REPORT', 'url' => ['create']];
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="col-xs-12 col-lg-2 col-sm-2">
              ...
              <div class="col-lg-2 col-sm-2">
                <?= $form->field($model, 'attendance_remarks')->textInput(['id'=>'mark_year','name'=>'mark_year','name'=>'subject_code'])->label(strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT))." CODE") ?>
            </div>
           ...
           <br/>    
            <div class="form-group col-lg-3 col-sm-3">
                ...
                <?= Html::a("Reset", Url::toRoute(['mark-entry-master/subjectarrear-report']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
        </div>
    ...
    if($file_content_available=="Yes")
        {
            ...
            $stu_print_vals = 0;
               ...
               $header .='<table  style="overflow-x:auto;"  cellspacing="0" cellpadding="0" border="0"  class="table table-bordered table-responsive bulk_edit_table table-hover" id = "student_import_results" >';
                ...
                if(isset($_SESSION['subjectarrear'])){ unset($_SESSION['subjectarrear']);}
                $_SESSION['subjectarrear'] = $print_stu_data;
                ...
                echo Html::a('<i class="fa fa-file-pdf-o"></i> ' . "PDF",array('subjectarrear-report-pdf','exportPDF'=>'PDF'),array('title'=>'Export to PDF','target'=>'_blank','class'=>'pull-right btn btn-warning', 'style'=>'color:#fff'));
                echo Html::a('<i class="fa fa-file-excel-o"></i> ' . "EXCEL ",array('subjectarrear-report-excel','exportPDF'=>'PDF'),array('title'=>'Export to Excel','target'=>'_blank','class'=>'pull-right btn btn-info', 'style'=>'color:#fff')); 
