    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="form-group col-lg-3 col-sm-3">
                ...
                <?= Html::a("Reset", Url::toRoute(['mark-entry/generate-consolidate-cia']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
        </div>
            ...
            $stu_print_vals = 0;
               ...
               $header .='<table class="table" border="1" cellpadding="1" align="center" cellspacing="1">
                ...
                $header .='<td colspan='.($countVal+1).'  ALIGN="CENTER">
                  ...
                  <tr>';
                    $header .='<td colspan='.($countVal+1).' ALIGN="CENTER">
                        CONSOLIDATED CIA MARKS FOR THE END SEMESTER EXAMINATIONS '.$_POST["mark_year"].' / '.$month.'
                    </td>
                  </tr>
                  <tr>';
                    $header .='<td colspan='.($countVal+1).' ALIGN="CENTER">
