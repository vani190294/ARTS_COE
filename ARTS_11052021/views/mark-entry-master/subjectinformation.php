    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="form-group col-lg-6 col-sm-6"> <br />
            <div class="btn-group col-lg-12 col-sm-12" role="group" aria-label="Actions to be Perform">
                <input type="button" id="sub_info_internet" name="sub_info_internet" class="btn btn-success" value="Submit">
            ...
            <div class="col-xs-12 col-sm-12 col-lg-12">
                ...
                <div class="col-xs-2 pull-right">
                    <?php
                        ...
                        echo Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['/mark-entry-master/subjectinformation-pdf'], [
