    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="col-lg-2 col-sm-2">
             ...
             <div class="col-lg-2 col-sm-2">
                <?= $form->field($model, 'semester')->radioList(['UG'=>'UG','PG'=>'PG']) ?>                
            </div>
            ...
            <div class="btn-group col-lg-12 col-sm-12" role="group" aria-label="Actions to be Perform">
                ...
                <input type="button" onClick="getAnalyssis($('#stu_batch_id_selected').val(), $('#year').val(),$('#exam_month').val() )", id="overallresult" name="overallresult" class="btn btn-success" value="Submit">
                <?= Html::a("Reset", Url::toRoute(['mark-entry-master/overall-analysis']), ['onClick'=>'spinner(); ','class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
        </div>
    </div>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12 mark_percent_print_btn">
        ...
        <div class="col-xs-3 col-sm-2 col-lg-2">
            <?php 
                ...
                echo Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['/mark-entry-master/overall-analysis-pdf'], [
