...
$this->title="View Value Added Marks";
...
<?php Yii::$app->ShowFlashMessages->showFlashes();?>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
            <div class="col-lg-2 col-sm-2">
                <?= $form->field($markEntry, 'semester')->textInput(['onblur'=>'getValueAdd(this.value);','name'=>'exam_semester']); ?>
                ...
                <?php echo $form->field($model, 'subject_map_id')->widget(
                    Select2::classname(), [
                        'options' => [
                            ...
                            'name'=>'sub_val',
                            'onchange' => 'getExternalMarksStudeListAdd();',
                        ],
                        'pluginOptions' => [
                            'allowClear' => true,
        ...
        <br />
                <div class="btn-group col-lg-2 col-sm-2" role="group" aria-label="Actions to be Perform">
                    ...
                    <?= Html::a("Reset", Url::toRoute(['coe-value-mark-entry/create']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
                </div>
        </div>
