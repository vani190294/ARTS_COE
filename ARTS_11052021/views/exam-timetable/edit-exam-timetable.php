...
<div class="col-xs-12 col-sm-12 col-lg-12">
    <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <?php echo $form->field($model,'exam_month')->widget(
                Select2::classname(), [
                    ...
                    'options' => [
                        ...
                        'id' => 'exam_month',
                        'onchange'=>'geteditSubjects(this.value,$("#exam_year").val())',
                    ],
                    'pluginOptions' => [
                        'allowClear' => true,
                    ],
            ...
            <?php echo $form->field($model,'subject_code')->widget(
                Select2::classname(), [
                    ...
                    'options' => [
                        ...
                        'onchange'=>'geteditExamDate(this.value,$("#exam_month").val(),$("#exam_year").val())',
                    ],
                    'pluginOptions' => [
                        'allowClear' => true,
                    ],
            ...
            <?php echo $form->field($model,'exam_date')->widget(
                Select2::classname(), [
                    ...
                    'options' => [
                        ...
                        'onchange'=>'geteditExamSession(this.value, $("#exam_subject_code").val(), $("#exam_month").val(), $("#exam_year").val())',
                        'autocomplete' => 'OFF',
                        'id' => 'exam_date',
                    ],
                    'pluginOptions' => [
        ...
        <div class="col-xs-12 col-sm-2 col-lg-2">
            <?php 
                echo '<label>New '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_EXAM).' Date </label>';
                echo DatePicker::widget([
                    ...
                    'options' => [
                        'placeholder' => '-- Select '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_EXAM).' Date ...',
                        'autoChange' => 'OFF',
                        'onchange'=>'getPreconfirm(this.value, $("#exam_session").val(), $("#exam_date").val(), $("#exam_subject_code").val(), $("#exam_month").val(), $("#exam_year").val())',
                    ],
                    'pluginOptions' => [
                        'autoclose'=>true,
                        'format' => 'dd-mm-yyyy',
