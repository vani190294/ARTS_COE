...
<div class="box box-success">
	<div class="box-header">
		<h3 class="box-title"><i class="fa fa-list-ul"></i> <?php echo 'Marks Import Results'; ?></h3>
			...
			<section class="col-lg-12 connectedSortable">
              ...
              <?php 
            	...
            	<?php
					...
					$headerTr.= Html::tag('th', 'ESE');
					$headerTr.= Html::tag('th', 'Year');
					$headerTr.= Html::tag('th', 'Month');
					$headerTr.= Html::tag('th', 'Year of Passing');
				...
				<table style="overflow-x:auto;"  cellspacing="0" cellpadding="0" border="0"  class="table table-bordered table-responsive bulk_edit_table table-hover" id = "programme_import_results">
					...
					foreach($importResults['dispResults'] as $line) {
						...
						$content.= Html::tag('td', isset($line['C'])?$line['C']." - ".$line['D']:"");
