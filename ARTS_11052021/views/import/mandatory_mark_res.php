        ...
        <section class="content">
            <section class="col-lg-12 connectedSortable">
              ...
              <!-- /. tools -->
                ...
                <?php
                    $headerTr.= Html::tag('th', strtoupper('Sr No'));                    
                    $headerTr.= Html::tag('th', strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_EXAM))." YEAR");
                    $headerTr.= Html::tag('th', strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_EXAM))." MONTH");
                    $headerTr.= Html::tag('th', strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_EXAM_TYPE)));
                    $headerTr.= Html::tag('th', strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_EXAM_TERM)));
                    $headerTr.= Html::tag('th', 'SEMESTER');
                    $headerTr.= Html::tag('th', strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT))." CODE");
                    $headerTr.= Html::tag('th', "CATEGORY CODE");
                    $headerTr.= Html::tag('th', "REGISTER NUMBER");
                    $headerTr.= Html::tag('th', "MARKS"); 
