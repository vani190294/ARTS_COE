...
<div class="box box-success">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-list-ul"></i> <?php echo ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_DUMMY).' Import Results'; ?></h3>
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <?php 
                ...
                <?php if(!empty($importResults['totalSuccess'])) : ?>
                    <div class="alert alert-success">
                        ...
                        <?= "{$importResults['totalSuccess']} ".ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_DUMMY)."  importing successfully." ?>
                    </div>
                <?php endif; ?>
                ...
                <?php if(!empty($totalError)) : ?>
                    <div class="alert alert-danger">
                        ...
                        <?= "{$totalError}  ".ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_DUMMY)." importing error." ?>
                    </div>
                <?php endif; ?>
              <!-- Tools Box -->
              ...
              <!-- Tools -->
                <?php
                    ...
                    $headerTr.= Html::tag('th', ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_DUMMY)." Number");
