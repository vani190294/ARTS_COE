...
<div class="box box-success">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-list-ul"></i> <?php echo 'Fees Import Results'; ?></h3>
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <?php 
                ...
                <?php if(!empty($importResults['totalSuccess'])) : ?>
                    <div class="alert alert-success">
                        ...
                        <?= "{$importResults['totalSuccess']} Fees Status importing successfully." ?>
                    </div>
                <?php endif; ?>
                ...
                <?php if(!empty($totalError)) : ?>
                    <div class="alert alert-danger">
                        ...
                        <?= "{$totalError} Fees Status importing error." ?>
                    </div>
                <?php endif; ?>
              <!-- Tools Box -->
              ...
              <!-- Tools -->
                <?php
                    ...
                    $headerTr.= Html::tag('th', "Fees Status");
