...
<?php Yii::$app->ShowFlashMessages->showFlashes();?>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-2 col-lg-2">
                ...
                <?php echo $form->field($model, 'subject_map_id')->widget(
                    Select2::classname(), [
                        'options' => [
                            ...
                            'onchange'=>'getExaminerDet(this.value,$("#stu_section_select").val());',                
                        ],
                        'pluginOptions' => [
                            'allowClear' => true,
                        ],
            ...
            <div class="col-lg-2 col-sm-2">
                <?php echo $form->field($model, 'internal_examiner_name')->widget(
                    Select2::classname(), [
                        'options' => [
            ...
            <div class="col-lg-2 col-sm-2">
                <?= $form->field($model, 'internal_examiner_name')->textInput(['id'=>'maximum_students','required'=>'required','value'=>38])->label('Max '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT).' Count'); ?>
            </div> 
            <div class="btn-group col-lg-2 col-sm-2" role="group" aria-label="Actions to be Perform">
                <br />
                <?= Html::Button('Get '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT), ['onClick'=>'getPracticalExamOnlyStuList()','id'=>'change_name_get_stu','class' => 'btn btn-success' ]) ?>
                <?= Html::a("Reset", Url::toRoute(['practical-exam-timetable/mark-entry']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>                     
        </div>
