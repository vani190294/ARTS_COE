...
<?php Yii::$app->ShowFlashMessages->showFlashes();?>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-2 col-lg-2">
            ...
            <div class="col-lg-2 col-sm-2">
                <?= $form->field($model, 'external_examiner_name')->textInput(['id'=>'examiner_name','required'=>'required','style'=>'text-transform: uppercase','readonly'=>'readonly']); ?>
            </div>   
            <div class="btn-group col-lg-2 col-sm-2" role="group" aria-label="Actions to be Perform">
                <br />
                <?= Html::Button('Get '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT), ['onClick'=>'getPracticalExamEditOnlyStuList()','id'=>'change_name_get_stu','class' => 'btn btn-success' ]) ?>
                <?= Html::a("Reset", Url::toRoute(['practical-exam-timetable/edit-mark-entry']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>                     
        </div>
