    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="col-xs-12 col-sm-12 col-lg-12">
                    ...
                    <br />
                    <?= Html::Button('Get '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT), ['onClick'=>'EditPractDates($("#exam_date").val(), $("#exam_session").val() , $("#mark_subject_code").val() ,$("#exam_month").val(), $("#mark_year").val())','id'=>'change_name','class' => 'btn btn-success' ]) ?>
                
                    <?= Html::a("Reset", Url::toRoute(['practical-exam-timetable/edit-dates']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
                </div>                     
        </div>
