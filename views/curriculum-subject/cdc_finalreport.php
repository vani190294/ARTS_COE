...
<div class="box-body">
    ...
    <?php $form = ActiveForm::begin(); ?>
            ...
            <div class="col-xs-12 col-sm-12 col-lg-12">
                ...
                <div class="col-md-2 form-group"><br>
                        <?= Html::Button('Show', ['id'=>'cdc_finalreport','class' =>  'btn btn-success', 'onClick'=>'cdcfinalreport();spinner();']) ?>
                         <?= Html::a("Reset", Url::toRoute(['curriculum-subject/cdc-finalreport']), ['onClick'=>"spinner();",'class' => 'btn btn-warning']) ?>
                    </div>
        ...
        <div  class="col-xs-12 col-sm-12 col-lg-12" id="curpdf" style="display: none;"> <br /><br />
            <?php 
            $print_pdf = Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['/curriculum-subject/cdc-finalreport-pdf'], [
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12" id="curriculumdataview" style="display: none;" >
            ...
            <div id="curriculumdata"></div>
              ...
              <div class="form-group pull-right "><br>
                    <?= Html::submitButton('Approve', ['id'=>'approvecurriculum','class' =>  'btn btn-success','data-confirm' => 'Are you sure you want to Continue <br /> This can not be Un-Done once the values were Submitted.','style'=>'display:none;']) ?>
