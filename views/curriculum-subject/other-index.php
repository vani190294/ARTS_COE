...
$visible =Yii::$app->user->can("/curriculum-subject/delete-other") || Yii::$app->user->can("/curriculum-subject/updateother") ? true : false;
$this->title = 'Other Service Courses';
...
<div class="curriculum-subject-index">
    ...
    <p>
        <?= Html::a('Create', ['create-other'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
            ...
            [
                ...
                'buttons' => [
                    ...
                    'delete' => function ($url, $model) 
                    {
                        ...
                        {
                            return ((Yii::$app->user->can("/curriculum-subject/delete-other")) ? Html::a('<span class="fa fa-remove increase_size"></span>', ['/curriculum-subject/delete-other','id'=>$model->coe_cur_id], ['title' => 'Delete',]) : '');
                        }
                    },
