...
$this->title = "AC Curriculum Report Generate";
    ...
    <?php $form = ActiveForm::begin(); ?>
            ...
            <div class="col-xs-12 col-sm-12 col-lg-12">
                ...
                <div class="col-md-2 form-group"><br>
                        <?= Html::Button('Show', ['class' =>  'btn btn-success', 'onClick'=>'accurriculumreport();']) ?>
                         <?= Html::a("Reset", Url::toRoute(['curriculum-subject/acm-cdc-finalreport']), ['onClick'=>"spinner();",'class' => 'btn btn-warning']) ?>
                    </div>
        ...
        <div  class="col-xs-12 col-sm-12 col-lg-12" id="curpdf" style="display: none;"> <br /><br />
            <?php 
            $print_pdf = Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['/curriculum-subject/curriculum-ac-pdf'], [
