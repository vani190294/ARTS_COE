...
$this->title = 'Create Other Service Course';
$this->params['breadcrumbs'][] = ['label' => 'Other Course', 'url' => ['other-index']];
...
<div class="box-body"> 
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
                ...
                <input type="hidden" name="coe_dept_id" id="coe_dept_id" value="0">
                    ...
                    <?= $form->field($model, 'coe_regulation_id')->widget(
                            Select2::classname(), [  
                                ...
                                'options' => [
                                    ...
                                    'onchange'=>'getLTPdetails();assigntodept();getstream1();',
                                ],
                               'pluginOptions' => [
                                   'allowClear' => true,
                                ],
                    ...
                    <?= $form->field($model, 'semester')->widget(
                            Select2::classname(), [                      
                                ...
                                'options' => [
                                    ...
                                    'onchange'=>'checkserviceotherprefix();'
                                ],
                               'pluginOptions' => [
                                   'allowClear' => true,
                                ],
