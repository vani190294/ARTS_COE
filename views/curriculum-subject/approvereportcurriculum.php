    ...
    <?php $form = ActiveForm::begin(); ?>
            ...
            <div class="col-xs-12 col-sm-12 col-lg-12">
                ...
                {?>
                 ...
                 <div class="col-md-2">
                   <?= $form->field($model, 'degree_type')->dropDownList($model->getDegreeType(), ['id'=>'degree_type','name'=>'degree_type','prompt' => Yii::t('app', '--- Select Degree Type ---'),'onchange'=>'getdeptid();']) ?>
                </div>
                ...
                <div class="col-md-2 form-group"><br>
                        <?= Html::Button('Show', ['id'=>'showservicecurriculum','class' =>  'btn btn-success', 'onClick'=>'curriculumreport();']) ?>
                         <?= Html::a("Reset", Url::toRoute(['curriculum-subject/approve-report-curriculum']), ['onClick'=>"spinner();",'class' => 'btn btn-warning']) ?>
                    </div>
