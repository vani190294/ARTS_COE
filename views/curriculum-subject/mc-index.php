...
$visible =Yii::$app->user->can("/curriculum-subject/delete-mc") || Yii::$app->user->can("/curriculum-subject/update-mc") ? true : false;
$this->title = 'Mandatory Courses';
...
<div class="curriculum-subject-index">
    ...
    <p>
        <?= Html::a('Create', ['create-mc'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
            ...
            [
                ...
                'buttons' => [
                    ...
                    'delete' => function ($url, $model) 
                    {
                        ...
                        {
                            return ((Yii::$app->user->can("/curriculum-subject/delete-mc")) ? Html::a('<span class="fa fa-remove increase_size"></span>', ['/curriculum-subject/delete-mc','id'=>$model->coe_cur_id], ['title' => 'Delete',]) : '');
                        }
                    },
