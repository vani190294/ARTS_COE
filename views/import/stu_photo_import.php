...
<div class="box box-success">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-list-ul"></i> <?php echo 'Hall Import Results'; ?></h3>
        ...
        <section class="content">
            <section class="col-lg-12 connectedSortable">
              ...
              <?php 
                ...
                <?php if(!empty($importResults['totalSuccess'])) : ?>
                    <div class="alert alert-success">
                        ...
                        <?= "{$importResults['totalSuccess']} Photos imported successfully." ?>
                    </div>
                <?php endif; ?>
                ...
                <?php if(!empty($totalError)) : ?>
                    <div class="alert alert-danger">
                        ...
                        <?= "{$totalError}  Halls importing error." ?>
                    </div>
                <?php endif; ?>
              <!-- tools box -->
              ...
              <!-- /. tools -->
                ...
                ?>
                <table style="overflow-x:auto;"  class="table table-bordered table-responsive bulk_edit_table table-hover" id="stu_photo_import_results" >
                    <thead>
...
$this->registerJs(<<<JS
    $(function () {
    $('#stu_photo_import_results').DataTable({
      'paging'      : true,
      'lengthChange': false,
      'searching'   : false,
      'ordering'    : true,
