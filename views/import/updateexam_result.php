            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <!-- /. tools -->
                ...
                <?php
                    ...
                    $headerTr.= Html::tag('th', "Old ".ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_EXAM)." Date");
                    ...
                    $headerTr.= Html::tag('th', "Qp Code");                    
                     $headerTr.= Html::tag('th', "New ".ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_EXAM)." Date");
                     $headerTr.= Html::tag('th', "New ".ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_EXAM_SESSION));
                ...
                <table style="overflow-x:auto;"  class="table table-bordered table-responsive bulk_edit_table table-hover"  id = "exam_import_results" >
                    ...
                    foreach($importResults['dispResults'] as $line) {                       
                        ...
                        $content.= Html::tag('td', isset($line['H'])?date("d-m-Y", PHPExcel_Shared_Date::ExcelToPHP($line['H'])):""); 
                        ...
                        $content.= Html::tag('td', isset($line['L'])?$line['L']:"");
                         $content.= Html::tag('td', isset($line['M'])?date("d-m-Y", PHPExcel_Shared_Date::ExcelToPHP($line['M'])):""); 
