...
<div class="box box-success">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-list-ul"></i> <?php echo 'Valuation Faculty'; ?></h3>
              ...
              <?php 
                ...
                <?php if(!empty($importResults['totalSuccess'])) : ?>
                    <div class="alert alert-success">
                        ...
                        <?= "{$importResults['totalSuccess']} Valuation Faculty importing success." ?>
                    </div>
                <?php endif; ?>
                ...
                <?php if(!empty($totalError)) : ?>
                    <div class="alert alert-danger">
                        ...
                        <?= "{$totalError} Valuation Faculty importing error." ?>
                    </div>
                <?php endif; ?>
                ...
                <?php
                    ...
                    $headerTr.= Html::tag('th', 'Faculty Mode');
                    $headerTr.= Html::tag('th', 'Experience');
                    $headerTr.= Html::tag('th', 'Phone');
                     $headerTr.= Html::tag('th', 'Email');
                    $headerTr.= Html::tag('th', 'College Name');
                     $headerTr.= Html::tag('th', 'Bank Acc No.');
                     $headerTr.= Html::tag('th', 'Bank Name');
                    $headerTr.= Html::tag('th', 'Bank Branch');
                    $headerTr.= Html::tag('th', 'Bank IFSC');
                ...
                <table style="overflow-x:auto;"  class="table table-bordered table-responsive bulk_edit_table table-hover" id="hall_import_results" >
                    ...
                    foreach($importResults['dispResults'] as $line) {    
                        ...
                        $content.= Html::tag('td', isset($line['F'])?$line['F']:"");
                         $content.= Html::tag('td', isset($line['F'])?$line['L']:"");
                        $content.= Html::tag('td', isset($line['G'])?$line['G']:"");
                         $content.= Html::tag('td', isset($bank_accno)?$bank_accno:"");
