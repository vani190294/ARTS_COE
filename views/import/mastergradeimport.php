...
<div class="box box-success">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-list-ul"></i> <?php echo 'Transfer Credit ESE 100 Import Insert'; ?></h3>
              ...
              <?php 
                ...
                <?php if(!empty($importResults['totalSuccess'])) : ?>
                    <div class="alert alert-success">
                        ...
                        <?= "{$importResults['totalSuccess']} Transfer Credit importing success." ?>
                    </div>
                <?php endif; ?>
                ...
                <?php if(!empty($totalError)) : ?>
                    <div class="alert alert-danger">
                        ...
                        <?= "{$totalError}  Transfer Credit importing error." ?>
                    </div>
                <?php endif; ?>
