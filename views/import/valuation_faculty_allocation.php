...
<div class="box box-success">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-list-ul"></i> <?php echo 'Valuation Faculty Allocation'; ?></h3>
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <?php 
                ...
                <?php
                    ...
                    $headerTr.= Html::tag('th', 'Cover Number');
                    $headerTr.= Html::tag('th', 'Board');
                     $headerTr.= Html::tag('th', 'Faculty Email');
                    $headerTr.= Html::tag('th', 'Valuation Date');
                      $headerTr.= Html::tag('th', 'Valuation Session');
