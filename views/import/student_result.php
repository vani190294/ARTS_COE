...
<div class="box box-success">
	<div class="box-header">
		<h3 class="box-title"><i class="fa fa-list-ul"></i> <?php echo ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT).' Import Results'; ?></h3>
              ...
              <?php 
				...
				<table style="overflow-x:auto;"  cellspacing="0" cellpadding="0" border="0"  class="table table-bordered table-responsive bulk_edit_table table-hover" id = "student_import_results">
					...
					foreach($importResults['dispResults'] as $line) {
						...
						$content.= Html::tag('td', isset($line['U'])?$line['U']:""); 
						$content.= Html::tag('td', isset($line['E'])?$line['E']:""); 
						$content.= Html::tag('td', isset($line['G'])?$line['G']:""); 
						$content.= Html::tag('td', isset($line['F'])?date("d-m-Y", PHPExcel_Shared_Date::ExcelToPHP($line['F'])):""); 
						$content.= Html::tag('td', isset($line['Q'])?$line['Q']:""); 
						$content.= Html::tag('td', isset($line['T'])?$line['T']:""); 
						//$content.= Html::tag('td', isset($line['AJ'])?$line['AJ']:""); 
