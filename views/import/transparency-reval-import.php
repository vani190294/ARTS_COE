              ...
              <?php 
                ...
                <?php if(!empty($importResults['totalSuccess'])) : ?>
                    <div class="alert alert-success">
                        ...
                        <?= "{$importResults['totalSuccess']} Transparency / Revaluation importing success." ?>
                    </div>
                <?php endif; ?>
                ...
                <?php if(!empty($totalError)) : ?>
                    <div class="alert alert-danger">
                        ...
                        <?= "{$totalError}  Transparency / Revaluation importing error." ?>
                    </div>
                <?php endif; ?>
                ...
                <?php
                    ...
                    $headerTr.= Html::tag('th', 'Transparency');
                    $headerTr.= Html::tag('th', 'Revaluation');
                ?>
