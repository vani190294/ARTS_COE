...
/* @var $searchModel app\models\ScrutinySearch */
/* @var $dataProvider yii\data\ActiveDataProvider */
$this->title = 'Scrutiny';
$this->params['breadcrumbs'][] = $this->title;

$visible = Yii::$app->user->can("/scrutiny/view") || Yii::$app->user->can("/scrutiny/update") ? true : false;
?>
...
<div class="scrutiny-index">
    ...
    [
        ...
        'value' => 'designationName.category_type',
        'vAlign'=>'middle',
        'width'=>'190px',
        'format'=>'raw',
        'pageSummary' => true,
    ...
    [
        ...
        'value' => 'departmentName.dept_code',
        'vAlign'=>'middle',
        'width'=>'190px',
        'format'=>'raw',
        'pageSummary' => true,
    ...
    [
     ...
     [
        ...
        'buttons' => [
            ...
            return ((Yii::$app->user->can("/scrutiny/view")) ? Html::a('<span class="fa fa-hand-o-right increase_size"></span>', $url, ['title' => 'View',]) : '');
            },
            'update' => function ($url, $model) {
            return ((Yii::$app->user->can("/scrutiny/update")) ? Html::a('<span class="fa fa-pencil-square-o increase_size"></span>', $url, ['title' => 'Update',]) : '');
            },
            ],
    'visible' => $visible,
    ],
...
$userid=Yii::$app->user->getId();
    ...
    'panel' => [
            'type' => GridView::TYPE_PRIMARY,
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i>Scrutiny </h3>',
        ],
      // set a label for default menu
      'export' => [
          'label' => 'Page',
          'filename' => "Scrutiny Reports",
          'fontAwesome' => true,
    ...
    'toolbar' => [        
        '{export}',
        ['content'=>
            Html::a('<i class="glyphicon glyphicon-plus"></i>Create Scrutiny', ['create'], [
                    'data-pjax'=>0, 
