...
<div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-3 col-sm-2 col-lg-2">
          ...
          echo Html::a('<i class="fa fa-file-excel-o"></i> ' ."Excel",array('excel-value-added-reports-pdf','exportPDF'=>'PDF'),array('title'=>'Export to Excel','target'=>'_blank','class'=>'btn btn-info', 'style'=>'color:#fff'));
