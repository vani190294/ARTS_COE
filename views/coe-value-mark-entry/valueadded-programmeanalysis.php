...
$this->title=" Value Added Branch Result Analysis";
...
<div>&nbsp;</div>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="btn-group col-lg-3 col-sm-3" role="group" aria-label="Actions to be Perform">
                ...
                <input onClick="spinner();" type="button" id="pgmanalysisbutton_marks_value" name="pgmanalysisbutton_marks_value" class="btn btn-success" value="Submit">
                <?= Html::a("Reset", Url::toRoute(['coe-value-mark-entry/valueadded-programmeresultanalysis']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12 pgm_analysis_print_btn">
        ...
        <div class="col-xs-3 col-sm-2 col-lg-2">
            <?php 
                echo Html::a('<i class="fa fa-file-excel-o"></i> ' ."Excel",array('excel-valueadded-programmeanalysis','exportPDF'=>'PDF'),array('title'=>'Export to Excel','target'=>'_blank','class'=>'btn btn-info', 'style'=>'color:#fff'));
                echo Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['/coe-value-mark-entry/valueadded-programme-analysis-pdf'], [
