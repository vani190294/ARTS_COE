...
<div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-3 col-sm-2 col-lg-2">
           <?php 
                ...
                echo Html::a('<i class="fa fa-file-excel-o"></i> ' ."Excel",array('excel-value-add','exportPDF'=>'PDF'),array('title'=>'Export to Excel','target'=>'_blank','class'=>'btn btn-info', 'style'=>'color:#fff'));
                echo Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['/coe-value-mark-entry/value-add-pdf'], [
...
<?php
  ...
  $data ='<div class="box-body table-responsive"><table style="overflow-x:auto;"  cellspacing="0" cellpadding="0" border="0"  class="table table-bordered table-responsive bulk_edit_table table-hover" >'; 
   $data.='<tr>
            ...
            $data.='<tr><b><td colspan="11" align="center"><h5 align="center"><b>'.strtoupper('End '.$semester_name.'  Notice Board Copy for Value Added Subjects- '.$month_name.' '.$_POST["year"]).'</h5></b> <b><h5 align="center"><b>'.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_DEGREE).' - '.$degree_name.'</h5></b></td></tr>';
      ...
      if($prev_value!=$curr_value)
        {
         ...
         // $data.='<td>'.strtoupper($markdetails['degree_code']." ".$markdetails['programme_name']).'</td>';
          ...
          $data.='<td> <center>'.$notice['CIA'].'</td></center>';
          $data.='<td> <center>'.$notice['ESE'].'</td></center>';
