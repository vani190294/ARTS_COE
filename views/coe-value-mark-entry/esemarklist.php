...
$this->title = "VALUE ADDED SUBJECT ESE MARK LIST";
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="form-group col-lg-3 col-sm-3">
                ...
                <?= Html::a("Reset", Url::toRoute(['mark-entry/esemarklist']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
        </div>
    ...
    if($file_content_available=="Yes")
        {
            ...
            $stu_print_vals = 0;
               ...
               $header .='<div class="box-body table-responsive"><table class="table" border="1" cellpadding="1" align="center" cellspacing="1">
                    ...
                    { 
                        ...
                        { 
                          ...
                          foreach($ese_list as $stus) 
                          {
                            ...
                            {                                     
                                if($stus['grade_name']=='WH')
                                {
                                $ese=$stus['ESE']." (WH)";
                                }
                                else if($stus['grade_name']=='WD')
                                {
                                $ese=$stus['ESE']." (WD)";
                                }
                                else if($stus['grade_name']=='AB')
                                {
                ...
                echo Html::a('<i class="fa fa-file-pdf-o"></i> ' . "PDF",array('ese-mark-list-pdf','exportPDF'=>'PDF'),array('title'=>'Export to PDF','target'=>'_blank','class'=>'pull-right btn btn-warning', 'style'=>'color:#fff'));
                echo Html::a('<i class="fa fa-file-excel-o"></i> ' . "EXCEL ",array('excel-ese-mark-list','exportPDF'=>'PDF'),array('title'=>'Export to Excel','target'=>'_blank','class'=>'pull-right btn btn-info', 'style'=>'color:#fff')); 
