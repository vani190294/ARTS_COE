...
$this->title="Value Added Notice Board Copy";
...
<div>&nbsp;</div>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
            <div class="form-group col-lg-3 col-sm-3"><br />
                ...
                <?= Html::a("Reset", Url::toRoute(['coe-value-mark-entry/value-add']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
        </div>
    </div>
    ...
    <?php ActiveForm::end(); ?>
     ...
     <?php
        include_once("value-add-pdf.php");
    ?>
