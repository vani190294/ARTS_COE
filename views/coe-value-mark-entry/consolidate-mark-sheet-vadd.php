...
{       
    ...
    foreach ($get_console_list as  $value) 
    {
      ...
      //  $app_month_name = ConfigUtilities::getMonthName($value['exam_month']);
        ...
        $body.='<div style="text-align: right; padding-top:50px; padding-right: 26px;"><img  class"img_print_dat" width="100px" height="100px" src='.$stu_photo.' alt='.$stu_photo.' Photo ></div>';
        $body.='<div style="font-style: italic; padding-top:125px; font-size:24px"><b>'.strtoupper($value["name"]).'<br>'.strtoupper($value["register_number"]).'</div>';
        ...
        if($wordcount==5 || $wordcount==4)
        {
            ...
            else
            {
             ...
             $body1.='<div style="text-align:center;font-style: italic; padding-top:40px;font-size:17px;color:#FF5733;"><b>'.$from_date.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$to_date.'</b></div>';
        ...
        {
             $body1.='<div style="text-align:center;font-style: italic; padding-top:40px;font-size:17px;color: #1F0092 ;"><b>'.$from_date.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$to_date.'</b></div>';
        ...
        $body1.='</div>';
        $print_stu_data.="<div style='position: fixed !important;color: #1F0092 ;'>".$body."</div><div style='padding-top:90px;'>".$body1."</div>";
        if($i!=$count)
        {
