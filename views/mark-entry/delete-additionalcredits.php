...
$this->title="Delete Additional Credits Mark Entry";
...
<?php $form = ActiveForm::begin([
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="form-group col-lg-4 col-sm-4"> <br />
                <div class="btn-group" role="group" aria-label="Actions to be Perform">

                    <?= Html::Button('Submit', ['value'=>'Submit','name'=>"del_add_credit_btn" ,'id'=>"del_add_credit_btn",'class' => 'btn  btn-group-lg btn-group btn-success']) ?>
                    
                    <?= Html::a("Reset", Url::toRoute(['mark-entry/delete-additionalcredits']), ['class' => 'btn btn-group btn-group-lg btn-warning ']) ?>                
