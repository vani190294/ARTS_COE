...
if (isset($mark_statement) && !empty($mark_statement)) 
{
    ...
    {
        $bottom_margin = 565+$bottom_margin;        
    }
    else
    {
        $bottom_margin = 565;
    ...
    foreach ($mark_statement as $value) 
    {
       ...
       // print_r($mark_statement);exit;
        ...
        else if($value['degree_code']=="MBABISEM")
        {
            $deg =strtoupper($value['programme_name']);
        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            {                
                    ...
                    foreach ($final_total_credits as $key => $total_cre) 
                    {
                        ...
                        { 
                            ...
                            if($total_cre['sem']==$loop_sems)
                            {
                                ...
                                <td width='30px' class='print_credit_points arrear_sem_credits' height='25px' valign='bottom'  > <b>".$total_cre['register']."</b> </td>";
                                $credits_earned_row .= "<td class='print_credit_points arrear_sem_credits' height='25px' valign='bottom' width='30px' > <b>".$print_ear."</b></td>";
                                $sgpa_row .= "<td class='print_credit_points arrear_sem_credits' width='30px' height='25px'  valign='bottom' ><b> ".$print_gpaa."</b> </td>";
                ...
                <td class='print_cumulative_credit_points creditpg' height='25px' valign='top' > <b>" . $cgpa_calc['cumulative_earned_credits'] . "</b> </td>
                <td colspan='4' width='20px' > &nbsp; </td>
                <td class='print_cumulative_credit_points_cgpa' width='60px'  height='25px'  valign='top' > <b>" . $cgpa_calc['cgpa_result_sem'] . "</b> </td>
               ...
               $check_add = Yii::$app->db->createCommand('SELECT C.subject_name,A.grade_point,A.result,C.subject_code,B.credit_points as credits,A.grade_name  FROM coe_mandatory_stu_marks as A JOIN coe_mandatory_subcat_subjects as B ON B.coe_mandatory_subcat_subjects_id=A.subject_map_id join coe_mandatory_subjects  as C on C.coe_mandatory_subjects_id=B.man_subject_id where result like "%Pass%" and student_map_id="'.$print_student_map_id.'" and year<="'.$exam_year.'"')->queryAll();
                      ...
                      /*  $subject_name_print = str_replace('ADDITIONAL CREDIT COURSE: ', '<b>ADDITIONAL CREDIT COURSE: </b>', $subject_name_print);
                        ...
                        <table border='0' width='100%' >
                            <tr>
                                ...
                                <td width='52px'  align='left' class='credit'><b>" . $valuess['credits'] . "</b></td>
                                <td width='45px'  align='left' class='credit'><b> " . strtoupper($valuess['grade_name']) . "</b> </td>
                                <td width='55px'  align='center' class='credit'><b>" . $grade_point_print . "</b></td>
                                <td  style='padding-left: -15px;'  width='50px'  align='center' class='credit'><b>" . $result_stu . "</b></td>
                            </tr>
                        </table>";*/
                    }
                       ...
                       /* if(!empty($check_arrear) && $value['batch_name']!=2019   and $value['degree_type']="PG"  )
                         {
                ...
                if(!empty($cgpa_calc['cumulative_additional_credits']) && $cgpa_calc['cumulative_additional_credits']!=0)
        {
            ...
            $header .= '<tr>
                           <td height="113px" style="border: none; text-align: right;" colspan="11" >
                                <img class="img-responsive" style="padding-right: 25px;"width="80" height="80" src="' . $stu_photo . '" alt="' . $stu_photo . '" Photo >
                    ...
                    <tr>
                        <td colspan='11' width='100%'  >
                            <table width='100%' align='left' style='border: none !important; padding-top: 3px;'  border='0'>
                                ...
                                <tr  style='padding: 10px;'>
                                    <td class='line_height' colspan='4' width='100px;' >&nbsp;</td>
                                    <td class='line_height mba' colspan='6' width='250px;'  > <b>" . $deg . "</b></td>
                                    <td class='line_height mba'  width='100px;' ><b>" . $value['regulation_year'] . "</b></td>
                                </tr>
                                <tr>
                ...
                $body .= "
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            ...
                            <td width='450px' class='put_margin submba' colspan='5'  align='left'>" . $subject_name_print . "</td>
                            <td colspan='4' class='credit' width='205px'  align='center' class='credit'> ".$result_stu." </td>
                        </tr>
                    </table>";
            } 
            else 
                ...
                if(isset($value['is_additional']))
                {
                    ...
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            ...
                            <td width='67px' align='left' class='subjectcode'><b>" . strtoupper($value['subject_code']) . "</b></td>
                            <td width='450px' class='put_margin submba' colspan='5'  align='left'>" . $subject_name_print . "</b></td>
                            <td width='52px'  colspan=4  align='left' class='credit' ><b>" . $value['credit_points'] . "</b></td>
                           </tr></table>";  
                    ...
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>    
                            ...
                            <td width='45px'  class='credit' align='left'> <b>" . strtoupper($grade_name) . " </b></td>
                            <td width='55px'  align='center'><b>" . $grade_point_print . "</b></td>
                            <td  style='padding-left: 3px;' width='50px' class='year'  align='center'>" . $result_stu . "</b></td></tr></table>";  
                }
                else
                {
                    $body .= "
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            ...
                            <td width='67px'  align='left' class='subjectcode'><b>" . strtoupper($value['subject_code']) . "</b></td>
                            <td width='450px' class='put_margin submba'   colspan='5'  align='left'>" . $subject_name_print . "</td>
                            <td width='52px'  class='credit' align='left'><b>" . $value['credit_points'] . "</b></td>
                            <td width='45px'  align='left' class='credit'><b> " . strtoupper($grade_name) . " </b></td>
                            <td width='55px'  align='center' class='credit'><b>" . $grade_point_print . "</b></td>
                            <td  style='padding-left: -15px;' width='50px' class='credit' align='center' ><b>" . $result_stu . "</b></td></tr></table>";  
                }
            ...
            if ($value['CIA_max'] == 0 && $value['ESE_max'] == 0) 
            {
                ...
                $body .= "
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            <td width='40px' align='left' ><b>" . $semester_array[$value['semester']]. "</b></td>
                            <td width='67px'  align='left' class='subjectcode'><b>" . $value['subject_code'] . "</b></td>
                            <td width='450px' class='put_margin submba'   colspan='5'  align='left'>" . $subject_name_print . "</td>
                            <td colspan='4'  class='credit' width='205px'  align='center'><b> ".$result_stu."</b> </td>
                        </tr>
                    </table>";
            } 
            else
                ...
                if(isset($value['is_additional']))
                {
                    ...
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            <td width='40px' align='left'><b>" . $semester_array[$value['semester']]. "</b></td>
                            <td width='67px'  align='left' class='subjectcode'><b>" . strtoupper($value['subject_code']) . "</b></td>
                            <td width='450px' class='put_margin submba'   colspan='6'  align='left'><b>" . $subject_name_print . "</b></td>
                    ...
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>                            
                            ...
                            <td width='45px'  class='credit' align='left'> <b>" . strtoupper($grade_name) . " </b></td>
                            <td width='55px'  align='center' class='credit'><b>" . $grade_point_print . "</b></td>
                            <td  style='padding-left: -15px;' width='50px' class='year' align='center' ><b>" . $result_stu . "</b></td></tr></table>";  
                }
                else
                {
                    $body .= "
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            ...
                            <td width='45px' class='credit'  align='left'> <b>" . strtoupper($grade_name) . " </b></td>
                            <td width='55px'  align='center' class='credit'><b>" . $grade_point_print . "</b></td>
                            <td  style='padding-left: -15px;' width='50px'   align='center' class='credit'><b>" . $result_stu . "</b></td></tr></table>";  
                }
            }
        }
