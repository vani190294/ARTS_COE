...
if($value['batch_name']=='2022'  && $value['programme_code']=='U109')
        ...
        {
            $deg =$value['degree_code']. strtoupper($deg);
        }
        else
        {
            $deg =strtoupper($value['degree_code']) . ". ". strtoupper($deg);
        }
        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            {                
                ...
                for ($loop_sem = $sem_printed_val; $loop_sem <= $total_semesters; $loop_sem++) 
                {
                    if ($loop_sem == $semester_number) 
                    {
                        ...
                        $increment = 0;
                            $credits_register_row .= "<td class='print_credit_points $align_text register ' valign='bottom' width='60px'   ".$merge_col." > <b>" . $registered_p . "</b> </td>";
                            $credits_earned_row .= "<td class='print_credit_points $align_text register' valign='bottom' width='60px' height='23px'  ".$merge_col." > <b>" . $sem_credits_earned_p . "</b> </td>";
                            $sgpa_row .= "<td width='60px' class='print_credit_points $align_text register ' valign='bottom' height='23px'  ".$merge_col."  > <b>" . $sgpa_row_p . "</b> </td>";
                    }
                    else 
                    { 
                ...
                <td class='print_cumulative_credit_points sem' height='23px' valign='top'> <b>" . $cgpa_calc['cumulative_earned_credits'] . "</b> </td>
                <td colspan='4' width='20px' > &nbsp; </td>
                <td class='print_cumulative_credit_points_cgpa sem' width='60px'  height='23px' valign='top' > <b>" . $cgpa_calc['cgpa_result_sem'] . "</b> </td>
             ...
             // print_r($check_arrear);exit;
                    ...
                    foreach ($check_add as $valuess) 
                    {
                        ...
                        <table border='0' width='100%' >
                            <tr>
                                ...
                                <td valign='top' width='450px' class='put_margin' colspan='5'  align='left' class='subjectname'><b>" . trim($subject_name_print) . "</td>
                        ...
                        <table border=0  >
                            <tr>
                                <td colspan='4'  width='75px' align='left'>&nbsp;</td>
                                 <td  valign='top' class='additional_credits put_margin' width='450px'  colspan='3'  align='center'> # ADDITIONAL CREDITS EARNED WILL NOT  BE CONSIDERED FOR GPA/CGPA CALCULATION</td>
                                <td valign='top' colspan='4' width='170px'  align='right'>&nbsp;</td>
                            </tr>
                        </table>";
                         
                //$add_points= Yii::$app->db->createCommand('SELECT  distinct B.subject_code,B.subject_name,A.duration FROM coe_activity_marks as A join coe_add_points as B on B.subject_code=A.subject_code  WHERE register_number="'.$print_student_map_id.'" order by subject_code')->queryAll();

                // if($value['batch_name']==2020 && $value['semester']==8 && !empty($add_points))
                // {   
                //     $body .= "
                //             <table border='0' width='100%' >
                //                 <tr>
                //                     <td width='40px' align='left'></td>
                //                     <td width='67px' align='left' class='subjectcode'></td>
                //                     <td width='450px' class='put_margin' colspan='5'  align='left' class='subjectname2 aic'><br><b>AICTE ACTIVITY POINT PROGRAMMES #<br></td></b><td class='subjectname2' style='padding-right:35px;padding-top:12px;'><b>POINTS</b></td></td>
                //                     <td width='52px'  class='credits' align='left'></td>
                //                     <td width='45px'  class='gradename' align='left'></td>
                //                     <td width='55px'  class='gradepoint' align='center'></td>
                //                     <td  style='padding-left: -15px;' width='50px'  align='center'></td>
                //             </table>";

                //         foreach($add_points as $value1)
                //         {
                ...
                //                     <td width='40px' align='left'></td>
                //                     <td width='67px' align='left' class='subjectcode'></td>
                //                     <td width='450px' class='put_margin' colspan='5'  align='left' class='subjectname3'><b>" . $value1['subject_code'] . ": " . $subject_name_print . "<td class='subjectname2' style='padding-right:50px;'><b>" . $value1['duration'] . "</b></td></td>
                //                     <td width='52px'  class='credits' align='left'></td>
                //                     <td width='45px'  class='gradename' align='left'></td>
                //                     <td width='55px'  class='gradepoint' align='center'></td>
                //                     <td  style='padding-left: -15px;' width='50px'  align='center'></td>
                ...
                //         //$total_duration= Yii::$app->db->createCommand('SELECT  sum(A.duration) as total FROM coe_activity_marks as A join coe_add_points as B on B.subject_code=A.subject_code  WHERE register_number="'.$print_student_map_id.'"')->queryScalar();
                         
                //         //echo('SELECT sum(A.duration) as total FROM coe_activity_marks as A join coe_add_points as B on B.subject_code=A.subject_code  WHERE register_number="'.$print_student_map_id.'"');exit;
                ...
                //        //              <td width='40px' align='left'></td>
                //        //              <td width='67px' align='left' class='subjectcode'></td>
                //        //              <td width='450px' class='put_margin' colspan='5'  align='left' class='subjectname3'><b>TOTAL ACTIVITY POINTS EARNED <td   class='subjectname3' style='padding-right:48px;'><b>" . $total_duration . "</b></td></td>
                //        //              <td width='52px'  class='credits' align='left'></td>
                //        //              <td width='45px'  class='gradename' align='left'></td>
                //        //              <td width='55px'  class='gradepoint' align='center'></td>
                //        //              <td  style='padding-left: -15px;' width='50px'  align='center'></td>
                ...
                //             <tr>
                //                 <td colspan='4'  width='75px' align='left'>&nbsp;</td>
                //                 <td class='additional_credits put_margin' width='450px' colspan='3'  align='center'> # ACTIVITY POINTS EARNED WILL NOT TO BE CONSIDERED FOR GPA/CGPA CALCULATION</td>
                //                 <td colspan='4' width='170px'  align='right'>&nbsp;</td>
                //             </tr>
                //         </table>";
             ...
             /*if(!empty($check_arrear) && $value['batch_name']!=2017  && $value['batch_name']!=2018 && $value['batch_name']!=2019 and $value['degree_type']="UG" &&  $year=2020 && $month=29   )
                ...
                $merge_body = "<tr><td width='100%' valign='top' colspan='11' height='".$bottom_margin."px' >" . $body . "</td></tr><tr><td colspan='11' width='30px' height='64px' >&nbsp;</td></tr>";
                if(!empty($getWaiverStatus) && count($check_add_attemot)>=$config_elect)
                {
                    ...
                    {
                        $merge_body = "<tr><td width='100%' valign='top' colspan='11' height='".$bottom_margin."px' >" . $body . "</td></tr><tr><td colspan='2' width='50px' height='30px' >&nbsp;</td><td colspan='9' width='300px' height='64px' ><b style='text-align: left' >CUMULATIVE ADDITIONAL CREDITS EARNED : ".$esrned_credits."</b></td></tr>";
                    }
                }
                else if($is_additional_printed==1 && $print_additional_text==0 )
                {
                    if(!empty($cgpa_calc['cumulative_additional_credits']) && $cgpa_calc['cumulative_additional_credits']!=0)
                    {
                            $merge_body = "<tr><td width='100%' valign='top' colspan='11' height='".$bottom_margin."px' >" . $body . "</td></tr><tr><td colspan='2' width='50px' height='30px' >&nbsp;</td><td colspan='9' width='300px' height='64px' ><b style='text-align: left' >CUMULATIVE ADDITIONAL CREDITS EARNED : ".$cgpa_calc['cumulative_additional_credits']."</b></td></tr>";
                    }
                }
            ...
            $header .= '<tr>
                           <td height="113px" style="border: none; text-align: right;" colspan="11" >
                                <img class="img-responsive"  style="padding-right: 18px;"  width="80" height="80" src="' . $stu_photo . '" alt="' . $stu_photo . '" Photo >
                        ...
                        $umis=''; $namepadding='padding-top:-2px;';
                        if($with_umis=='on')
            {
                $header .='<tr>
                    ...
                    <tr>
                        <td colspan='11' width='100%'  >
                            <table class='font_bigger' width='100%' align='left' style='border: none !important; ".$namepadding."'  border='0'>
                                ...
                                <tr  style='padding: 10px;'>
                                    <td class='line_height pull_down' colspan='4' width='75px;' >&nbsp;</td>
                                    <td class='line_height pull_down' colspan='6'   width='230px;'  style='font-weight:bold;'> <b>" . $deg . "</b></td>
                                    <td class='line_height pull_down'  width='100px;' ><b>" . $value['regulation_year'] . "</b></td>
                                </tr>
                                <tr>
            ...
            if ($value['CIA_max'] == 0 && $value['ESE_max'] == 0) 
            {
                ...
                $body .= "
                    <table style='line-height: 1.2em; ' border='0' width='100%'  class='semrow'>
                        <tr>
                            ...
                            <td width='450px' class='put_margin' colspan='5'  align='left' class='subjectname'>" . $subject_name_print . "</td>
                        ...
                        if(count($check_add_pass)>0 && !empty($check_add_pass))
                        {
                            if($prev_add_pint_code==$value['subject_code'])
                            {
                                ...
                                <table style='line-height: 1.2em; ' border='0' width='100%' >
                                    <tr>    
                                        <td valign='top' colspan=2  width='108px'  align='right'>&nbsp;</td>                        
                                        <td valign='top' width='450px' class='put_margin' colspan='5'  align='left' class='subjectcode'><b> " .strtoupper($get_man_det['sub_cat_code'])." - ". $subject_name_print . " </b></td>
                            ...
                            else
                            {
                                ...
                                <table style='line-height: 1.2em; ' border='0' width='100%'  class='semrow'>
                                    <tr>
                                        ...
                                        <td valign='top' width='450px' class='put_margin' colspan='5'  align='left' class='subjectname'>" . $subject_name_print . "</b></td>
                    ...
                    $result_stu=$result_stu.'<sup>*</sup>';
                     ...
                     $result_stu=$result_stu;
                            ...
                            <table style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>    
                                    <td valign='top' colspan=2  width='108px'  align='right'>&nbsp;</td>                        
                                    <td valign='top' width='450px' class='put_margin' colspan='5'  class='subjectcode' align='left' ><b> " .strtoupper($get_man_det['sub_cat_code'])." - ". $subject_name_print . "</b></td>
                ...
                $body .= "
                    <table style='line-height: 1.2em; ' border='0' width='100%'  class='semrow'>
                        <tr>
                            ...
                            <td valign='top' width='450px' class='put_margin'   colspan='5'  align='left' class='subjectname'>" . $subject_name_print . "</td>
                    ...
                    $result_stu=$result_stu.'<sup>*</sup>';
                     ...
                     $result_stu=$result_stu;
                                ...
                                <table style='line-height: 1.2em; ' border='0' width='100%' >
                                    <tr>    
                                        <td valign='top' colspan=2  width='108px'  align='right'>&nbsp;</td>                        
                                        <td valign='top' width='450px' class='put_margin' colspan='5'  align='left' class='subjectname'><b> " .strtoupper($get_man_det['sub_cat_code'])." - ". $subject_name_print . "</b></td>
                                        <td valign='top'  class='credits' width='52px'  align='left'><b>" . $value['credit_points'] . "</b></td>
                                        <td valign='top' width='45px'  align='left' class='gradename'> <b>" . strtoupper($grade_name) . " </b></td>
                                        <td valign='top' width='55px'  align='center' class='gradepoint'><b>" . $grade_point_print . "</b></td>
                                        <td valign='top'  style='padding-left: -15px;' width='50px'  align='center'><b>" . $result_stu . "</b></td></tr></table>";
                ...
                if(!empty($final_total_credits))
                {
                    ...
                    foreach ($final_total_credits as $key => $total_cre) 
                    {
                        ...
                        { 
                            ...
                            {
                                $credits_register_row .= "<td width='30px'  class='register'  height='23px' valign='bottom' align='left' >&nbsp;</td>";
                                $credits_earned_row .= "<td width='30px' height='23px' valign='bottom' align='left' class='register'  >&nbsp;</td>";
                     ...
                     $result_stu=$result_stu;
                        ...
                        <table border='0' width='100%' >
                            <tr>
                                ...
                                <td width='450px' class='put_margin' colspan='5'  align='left' class='subjectname'><b>" . $subject_name_print . "</td>
                        ...
                        <table border=0  >
                            <tr>
                                <td colspan='4'  width='75px' align='left'>&nbsp;</td>
                                <td class='additional_credits put_margin' width='450px' colspan='3'  align='center'> # ADDITIONAL CREDITS EARNED WILL NOT  BE CONSIDERED FOR GPA/CGPA CALCULATION</td>
                                <td colspan='4' width='170px'  align='right'>&nbsp;</td>
                            </tr>
                        </table>";
