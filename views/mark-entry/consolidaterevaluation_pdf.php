...
<?php
    ...
    if($report_type==1)
    {
        if($withar==1)
        {
            $reporttype=strtoupper(' <center> Consolidate Revaluation Programme Wise '.$month_name . '-' . $exam_year.' with Arrear</center>');

        }
        else
        {
            $reporttype=strtoupper(' <center> Consolidate Revaluation Programme Wise '.$month_name . '-' . $exam_year.' Regular</center>');
