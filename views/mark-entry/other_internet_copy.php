...
$add_duiv ='<div class="col-xs-12 col-sm-12 col-lg-12" style="overflow-x:auto;" >'; 
    ...
    {
      //$grade_name = $markdetails['result'];
      $result=$markdetails['result'];
    }
   /* else if($markdetails['CIA_max']==0 && $markdetails['ESE_max']==0 && $markdetails['CIA_min']==0 && $markdetails['ESE_min']==0  && $markdetails['result']=="Pass" || $markdetails['result']=="pass" || $markdetails['result']=="PASS")
    {
