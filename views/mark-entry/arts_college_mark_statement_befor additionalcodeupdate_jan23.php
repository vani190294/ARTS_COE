         ...
         //print_r($semester_number);exit;
            ...
            {    
               ...
               $credits_register_row .= "<tr> 
                ...
                if(!empty($check_add))
                {
                    ...
                    {                
                        $result_stu = 'PASS';        
                        $sub_na = wordwrap(strtoupper($valuess['subject_name']), 38, "\n", true);
...

            {
                $body .= "
                        ...
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    <td valign='top' width='55px' align='left' style='padding-left:4px;'><b>" . $semester_array[$valuess['part_no']]. "</b></td>
                                    <td  valign='top' width='65px' align='center' style='padding-left:-25px;'><b>" . $semester_array[$valuess['semester']]. "</b></td>
                                    ...
                                    <td valign='top' width='50px'  align='left' style='padding-left:-2px;padding-left:10px;'><b>" . $valuess['credits'] . "</b></td>
                                    <td valign='top' width='60px'  align='left' style='padding-right:-10px;'><b>" . $ese_max_disp . "</b></td>
                                    <td valign='top' width='55px'  align='left' style='padding-right:-10px;'><b>" . $cia_max_disp . "</b></td>
            ...
            $passed_grade_points = '';
               ...
               /* if ($value['batch_name']<2021)
               {
                ...
                $sub_na = wordwrap(strtoupper($value['subject_name']), 38, "\n", true);
                $sub_na = htmlentities($sub_na);
                $subject_name_print = "<b>".strtoupper(nl2br($sub_na))."</b>";
                $subject_name_print = str_replace('&AMP;', '&', $subject_name_print);
            ...
            <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                    <tr>
                        <td valign='top' width='55px' align='left' style='padding-left:4px;'><b>" . $semester_array[$value['part_no']]. "</b></td>
                        <td  valign='top' width='65px' align='center' style='padding-left:-25px;'><b>" . $semester_array[$value['semester']]. "</b></td>
                        ...
                        <td valign='top' width='435px'  colspan='8' align='left'>" . $subject_name_print . "</td>
                        <td valign='top' width='50px'  align='left' style='padding-left:-2px;padding-left:10px;'><b>" . $value['credit_points'] . "</b></td>
                        <td valign='top' width='60px'  align='left' style='padding-right:-10px;'><b>" . $ese_max_disp . "</b></td>
                        <td valign='top' width='55px'  align='left' style='padding-right:-10px;'><b>" . $cia_max_disp . "</b></td>
                        <td valign='top' width='60px'  align='left' style='padding-left:-5px;'><b>" . $total_max_disp . "</b></td>
                        <td valign='top' width='55px'  align='left' style='padding-left:5px;'><b>" . $disp_ese . "</b></td>
