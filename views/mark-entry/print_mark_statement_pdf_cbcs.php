                ...
                if(!empty($final_total_credits))
                {
                    ...
                    foreach ($final_total_credits as $key => $print_row) 
                    {
                        ...
                        if($print_status!=$increment)
                        {
                            ...
                            <td width='30px' class='print_credit_points' height='25px' valign='bottom' align='".$align_text."' > <b>".$print_row['register']."</b> </td>";
                            $credits_earned_row .= "<td class='print_credit_points' height='25px' valign='bottom' width='30px'  align='".$align_text."' > <b>".$print_ear."</b></td>";
                            $sgpa_row .= "<td class='print_credit_points' width='30px' height='25px' align='".$align_text."' valign='bottom' ><b> ".$print_gpaa."</b> </td>";
                    ...
                    if ($loop_sem == $semester_number) 
                    {
                        $count_col_spans = $count_col_spans+1;
                            ...
                            if($increment==1)
                            {
                                ...
                                {
                                    $credits_register_row .= "<td class='sem_one_print_credit_points' valign='bottom' width='30px' style='' height='25px' align='left' ".$merge_col." > <b>" . $registered_p . "</b> </td>";
                                    $credits_earned_row .= "<td class='sem_one_print_credit_points' valign='bottom' width='30px' height='25px' style='' align='left'  ".$merge_col." > <b>" . $sem_credits_earned_p . "</b> </td>";
                                    $sgpa_row .= "<td width='30px' class='sem_one_print_credit_points' valign='bottom' height='25px' style='' align='left' ".$merge_col." > <b>" . $sgpa_row_p . "</b> </td>";
                                }
                ...
                if(isset($value['is_additional']))
                {
                    ...
                    <table border='0' width='100%' >
                        <tr>
                            ...
                            <td width='450px' style='font-size: 11px !important;' colspan='5'  align='left'>" . $subject_name_print . "</td>
                            <td width='52px' colspan=4  align='left'>" . $value['credit_points'] . "</td>
                           </tr></table>";  
                    ...
                    <table border='0' width='100%' >
                        <tr>                            
                            <td colspan=2  width='80px'  align='center'>" . strtoupper($get_man_det['sub_cat_code']) . "</td>
                            <td width='450px' style='font-size: 11px !important;' colspan='5'  align='left'>" . $subject_name_print . "</td>
                ...
                if(isset($value['is_additional']))
                {
                    ...
                    <table border='0' width='100%' >
                        <tr>
                            <td width='40px' align='left'>" . $semester_array[$value['semester']]. "</td>
                            <td width='80px'  align='left'>" . strtoupper($value['subject_code']) . "</td>
                            <td width='450px' style='font-size: 11px !important;' colspan='6'  align='left'>" . $subject_name_print . "</td>
                    ...
                    <table border='0' width='100%' >
                        <tr>                            
                            ...
                            <td width='450px' style='font-size: 11px !important;' colspan='5'  align='left'>" .strtoupper($get_man_det['sub_cat_code'])." - ". $subject_name_print . "</td>
                            <td width='52px'  align='left'>" . $value['credit_points'] . "</td>
                            <td width='45px'  align='left'> " . strtoupper($grade_name) . " </td>
                            <td width='53px'  align='center'>" . $grade_point_print . "</td>
                            <td  style='padding-left: 10px;' width='50px'  align='center'>" . $result_stu . "</td></tr></table>";  
