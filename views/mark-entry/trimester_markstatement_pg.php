    ...
    add_month']=29)
                ...
                if(!empty($check_add))
                {
                    foreach ($check_add as $valuess) 
                    {
                        ...
                        <table border=0  >
                            <tr>
                                <td  width='10px' class='mark' colspan='7'  align='center' style='padding-left: 90px !important;' >  Due to COVID - 19 Pandemic, April/May 2020 Examinations were conducted during Nov/Dec 2020 as per Anna University guidelines.  </td>
