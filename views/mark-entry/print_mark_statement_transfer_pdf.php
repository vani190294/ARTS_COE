...
if (isset($mark_statement) && !empty($mark_statement)) {
    ...
    echo Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['/mark-entry/mark-statement-transfer-print-pdf'], [
    ...
    if (isset($_SESSION['mark_statement_transfer_spdf'])) {
        unset($_SESSION['mark_statement_transfer_pdf']);
    }
