    ...
    foreach ($mark_statement as $value) 
    {
        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            {                
                ...
                if(!empty($check_arrear) && $value['exam_year']=2020 && $value['
add_month']=29)
                {
                    $is_arrear_printed = 1;
                }
                ...
                if(!empty($check_add))
                {
                    foreach ($check_add as $valuess) 
                    {
                        ...
                        if(!empty($check_arrear) && $value['batch_name']!=2017  && $value['batch_name']!=2018 and $value['degree_type']="UG"  )
                         {

                        $body .= " 
                        <table border=0  >
                            <tr>
                                <td  width='300px' colspan='15'  align='right'> Due to COVID - 19 Pandemic, April/May 2020 Arrear Examinations were conducted during Nov/Dec 2020 as per Anna University guidelines.   </td>
                         ...
                         <table border=0  >
                            <tr>
                                <td  width='300px' colspan='15'  align='right'> Due to COVID - 19 Pandemic, April/May 2020 Regular/Arrear Examinations were processed/conducted during Nov/Dec 2020 as per Anna University guidelines. </td>
                ...
                $body .= "
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            ...
                            <td valign='top' colspan='4' width='205px'  align='center'><b> ".$result_stu."</b> </td>
                        </tr>
                    </table>";
                $total_subs_count++;
            } 
