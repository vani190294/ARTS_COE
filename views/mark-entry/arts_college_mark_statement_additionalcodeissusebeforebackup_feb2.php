        ...
        if ($previous_reg_number != $value['register_number']) 
        {
         ...
         //print_r($check_add_print);exit;
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px'   colspan='3'  align='left' class='sub' style='padding-left:1px;'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                        ...
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    <td valign='top' width='55px' align='left' style='padding-left:1px;'><b>" . $semester_array[$valuess['part_no']]. "</b></td>
                                    <td  valign='top' width='65px' align='center' style='padding-left:-35px;'><b>" . $semester_array[$valuess['semester']]. "</b></td>
                                    <td valign='top' width='115px'  colspan='3' class='subject_code' align='left' style='padding-left:-5px;'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                    <td valign='top' width='435px' colspan='8' align='left'>" . $subject_name_print . "</td>
                                    <td valign='top' width='60px' align='left' ><b>" . $valuess['credits'] . "</b></td>
                                    <td valign='top' width='60px'   align='left' ><b>" . $ese_max_disp . "</b></td>
                                  <td  valign='top'  width='65px'  align='left' class='cia_max'><b>" . $cia_max_disp . "</b></td>
                                    <td valign='top' width='60px'  align='left' style='padding-left:-15px;'><b>" . $total_max_disp . "</b></td>
                                    <td valign='top' width='55px'  align='left' style='padding-left:-10px;' ><b>" . $disp_ese . "</b></td>
                                     
                                    <td valign='top' width='95px'  align='left' style='padding-left:-10px;'><b>" . $disp_cia . "</b></td>
          ...
          else
          {
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px'   colspan='3'  align='left' class='sub' style='padding-left:1px;'><b>" . strtoupper($valuessadd['subject_code']) . "</b></td>
                                      <td valign='top' style='padding-left:-135px;' align='left' width='430px'  >" . $subject_name_print . "</td>
                        ...
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    <td valign='top' width='55px' align='left' style='padding-left:1px;'><b>" . $semester_array[$valuessadd['part_no']]. "</b></td>
                                    <td  valign='top' width='65px' align='center' style='padding-left:-35px;'><b>" . $semester_array[$valuessadd['semester']]. "</b></td>
                                    <td valign='top' width='115px'  colspan='3' class='subject_code' align='left' style='padding-left:-5px;'><b>" . strtoupper($valuessadd['subject_code']) . "</b></td>
                                    <td valign='top' width='435px' colspan='8' align='left'>" . $subject_name_print . "</td>
                                    <td valign='top' width='60px'  align='right' ><b>" . $valuessadd['credits'] . "</b></td>
                                    <td valign='top' width='60px'  align='left' ><b>" . $ese_max_disp . "</b></td>
                                    <td  valign='top'  width='65px'  align='left' class='cia_max'><b>" . $cia_max_disp . "</b></td>
                                    <td valign='top' width='60px'  align='left' style='padding-left:-15px;'><b>" . $total_max_disp . "</b></td>
                                    <td valign='top' width='55px'  align='left' style='padding-left:-10px;'><b>" . $disp_ese . "</b></td>
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px' class='sub' colspan='3'  align='left' style='padding-left:1px;'><b>" . strtoupper($value['subject_code']) . "</b></td>
                                      <td valign='top' style='padding-left:-135px;' align='left' width='430px'  >" . $subject_name_print . "</td>
            ...
            <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                    <tr>
                        <td valign='top' width='55px' align='left' style='padding-left:1px;'><b>" . $semester_array[$value['part_no']]. "</b></td>
                        <td  valign='top' width='65px' align='center' style='padding-left:-35px;'><b>" . $semester_array[$value['semester']]. "</b></td>
                        <td valign='top' width='115px'  colspan='3' class='subject_code' align='left' style='padding-left:-5px;'><b>" . strtoupper($value['subject_code']) . "</b></td>
                        <td valign='top' width='435px'  colspan='8' align='left'>" . $subject_name_print . "</td>
                        <td valign='top' width='50px'  align='left' ><b>" . $value['credit_points'] . "</b></td>
                        <td valign='top' width='60px'  align='left' ><b>" . $ese_max_disp . "</b></td>
                         <td  valign='top'  width='65px'  align='left' class='cia_max'><b>" . $cia_max_disp . "</b></td>
                        <td valign='top' width='60px'  align='left' style='padding-left:-15px;'><b>" . $total_max_disp . "</b></td>
                        <td valign='top' width='55px'  align='left' style='padding-left:-10px;'><b>" . $disp_ese . "</b></td>
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px'  colspan='3'   class='sub' align='left' style='padding-left:1px;'><b>" . strtoupper($value['subject_code']) . "</b></td>
                                     <td valign='top' style='padding-left:-135px;' align='left' width='430px'  >" . $subject_name_print . "</td>
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px'  colspan='3'   class='sub' align='left' style='padding-left:1px;'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                    <td valign='top' style='padding-left:-135px;' align='left' width='430px'  >" . $subject_name_print . "</td>
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px'  colspan='3'   class='sub' align='left' style='padding-left:1px;'><b>" . strtoupper($valuessadd['subject_code']) . "</b></td>
                                    <td valign='top' style='padding-left:-135px;' align='left' width='430px'  >" . $subject_name_print . "</td>
           ...
           // ZERO ZERO SUBJECTS
            ...
            <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                    <tr>
                        ...
                        <td valign='top' width='115px' colspan='3' class='subject_code'   align='left' style='padding-left:-5px;'><b>" . strtoupper($valuessadd['subject_code']) . "</b></td>
                        <td valign='top' width='435px'  colspan='8' align='left'>" . $subject_name_print . "</td>
                        <td valign='top' width='60px' class='credits' align='left' ><b>" . $valuessadd['credits'] . "</b></td>
                        <td valign='top' width='60px' align='left'><b>" . $ese_max_disp . "</b></td>
                         <td  valign='top'  width='65px'  align='left' class='cia_max'><b>" . $cia_max_disp . "</b></td>
                        <td valign='top' width='60px'  align='left' style='padding-left:-15px;'><b>" . $total_max_disp . "</b></td>
                        <td valign='top' width='55px'  align='left' style='padding-left:-10px;'><b>" . $disp_ese . "</b></td>
