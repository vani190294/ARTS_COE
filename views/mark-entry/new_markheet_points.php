...
if($value['batch_name']=='2022'  && $value['programme_code']=='U109')
        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            {                
                ...
                <td class='print_cumulative_credit_points sem' height='23px' valign='top' style='padding-top:3px;' > <b>" . $cgpa_calc['cumulative_earned_credits'] . "</b> </td>
                <td colspan='4' width='20px' > &nbsp; </td>
                <td class='print_cumulative_credit_points_cgpa sem' width='60px'  height='23px'  style='padding-top:3px;' valign='top' > <b>" . $cgpa_calc['cgpa_result_sem'] . "</b> </td>
