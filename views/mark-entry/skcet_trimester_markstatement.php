...
$this->registerCssFile("@web/css/skcet_newmarkstatement_pg.css");
?>
...
if (isset($mark_statement) && !empty($mark_statement)) 
{
    ...
    $add_tr_starting = $print_trimester == 1 ? "<tr><td colspan='9' width='30px'>&nbsp;</td></tr> <tr><td class='make_bold_font' id='print_trimester' colspan='9'> TRIMESTER PATTERN </td></td></tr>" : "<tr><td class='make_bold_font' id='no_print_trimester' colspan='9'> &nbsp; </td></td></tr>";
    $change_mba_class = $print_trimester == 1 ? 'stu_sub_gap':'no_stu_sub_gap';
    ...
    $date_insert = "<tr><td colspan='9' height='20px' width='50px'> &nbsp;</td></tr> <tr><td  valign='bottom' class='date_style font_bigger' colspan='9' width='300px' >".$date."</td></tr> ";
    $credits_register_row = $credits_earned_row = $sgpa_row = $cumulative_row = '';
    echo Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['/mark-entry/mark-statement-print-skcet-new-pg-pdf'], [
    ...
    foreach ($mark_statement as $value) 
    {
        ...
        if($value['degree_code']=="MBA" || $value['degree_code']=="mba" || $value['degree_code']=="mca" || $value['degree_code']=="MCA" || $value['degree_code']=="Mca" || $value['degree_code']=="Mba")
        {
        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            {                
                    ...
                    foreach ($final_total_credits as $key => $total_cre) 
                    {
                        ...
                        { 
                            ...
                            if($total_cre['sem']==$loop_sems)
                            {
                                ...
                                <td width='60px' class='print_credit_points arrear_sem_credits font_bigger' height='25px' valign='bottom'  > <b>".$total_cre['register']."</b> </td>";
                                $credits_earned_row .= "<td class='print_credit_points arrear_sem_credits font_bigger' height='25px' valign='bottom' width='60px' > <b>".$print_ear."</td>";
                                $sgpa_row .= "<td class='print_credit_points arrear_sem_credits font_bigger' width='60px' height='25px'  valign='bottom' ><b> ".$print_gpaa."</b> </td>";
                            ...
                            {
                                $credits_register_row .= "<td width='60px' height='25px' valign='bottom' align='left' >&nbsp;</td>";
                                $credits_earned_row .= "<td width='60px' height='25px' valign='bottom' align='left' >&nbsp;</td>";
                                $sgpa_row .= "<td width='60px' height='25px' valign='bottom' align='left' >&nbsp;</td>";
                ...
                for ($loop_sem = $sem_printed_val; $loop_sem <= $total_semesters; $loop_sem++) 
                {
                    if ($loop_sem == $semester_number) 
                    {
                        ...
                        $align_text = $semester_number==8  ? 'sem_8':($semester_number==4?'some_padding':'');
                        $merge_col =  'colspan='.$td_printe; 
                        $increment = 0;
                            $credits_register_row .= "<td class='print_credit_points $align_text font_bigger' valign='bottom' width='90px' ".$merge_col." > <b>" . $registered_p . "</b> </td>";
                            $credits_earned_row .= "<td class='print_credit_points $align_text font_bigger' valign='bottom' width='90px' height='25px'  ".$merge_col." > <b>" . $sem_credits_earned_p . "</b> </td>";
                            $sgpa_row .= "<td width='90px' class='print_credit_points $align_text font_bigger' valign='bottom' height='25px'  ".$merge_col."  > <b>" . $sgpa_row_p . "</b> </td>";
                    }
                    else 
                    { 
                        /*if($increment!=0)
                ...
                if($count_col_spans<9)
                {
                    $credits_register_row .= "<td  width='60px' height='25px' colspan=".(9-$count_col_spans)."  >&nbsp;</td>";
                    $credits_earned_row .= "<td width='60px' height='25px' colspan=".(9-$count_col_spans)."   >&nbsp;</td>";
                    $sgpa_row .= "<td width='60px' height='25px' colspan=".(9-$count_col_spans)."   >&nbsp;</td>";
                }
                ...
                if($total_subs_count>=23)
                {
                    ...
                    $splitted_body = "<tr><td width='100%' valign='top' colspan='9' height='544px' >" . $body . "</td></tr><tr><td colspan='9' width='30px' height='64px' >&nbsp;</td></tr>";
                ...
                <td class='print_cumulative_credit_points font_bigger' height='25px' valign='top' > <b>" . $cgpa_calc['cumulative_earned_credits'] . "</b> </td>
                <td colspan='2' width='30px' > &nbsp; </td>
                <td colspan='3' class='print_cumulative_credit_points_cgpa font_bigger' width='100px'  height='25px'  valign='top' > <b>" . $cgpa_calc['cgpa_result_sem'] . "</b> </td>
                <td width='30px'> &nbsp; </td>
                </tr>";
                
                $footer .= $credits_register_row . $credits_earned_row . $sgpa_row . $cumulative_row . "<tr><td valign='middle' colspan=9 height=32px >&nbsp;</td></tr>".$date_insert."</table>";
                ...
                if(!empty($check_add))
                {
                    ...
                    <table border='0' width='100%' >
                        <tr>
                            ...
                            <td width='450px' class='put_margin' colspan='7'  align='left'><b>ADDITIONAL CREDIT COURSE(S)*</b></td>
                        </tr>
                    </table>";
                    ...
                    foreach ($check_add as $valuess) 
                    {
                        ...
                        <table border='0' width='100%' >
                            <tr>
                                ...
                                <td width='650px' class='put_margin' colspan='4'  align='left'>" . $subject_name_print . "</td>
                                <td width='52px'  align='left'>" . $valuess['credits'] . "</td>
                                <td width='150px' colspan=2  align='left'> COMPLETED </td>
                            </tr>
                        </table>";
                    }
                        ...
                        <table border=0  >
                            <tr>
                                <td colspan='2'  width='75px' align='left'>&nbsp;</td>
                                <td class='additional_credits' width='450px' class='additional_credits' colspan='5'  align='center'> *ADDITIONAL CREDITS WILL NOT TO BE CONSIDERED FOR CGPA CALCULATION</td>
                                <td colspan='2' width='170px'  align='right'>&nbsp;</td>
                            </tr>
                        </table>";
                        $body .= " 
                        <table border=0  >
                            <tr>
                                <td class='make_bold_font font_bigger' width='600px' colspan='6'  align='center'> ~ END OF STATEMENT ~ </td>
                                
                                <td colspan='3' width='170px'  align='right'>&nbsp;&nbsp; </td>
                            </tr>
                        </table>";
                ...
                if($is_additional_printed==1 )
                {
                    
                    $merge_body = "<tr><td width='100%' valign='top' colspan='9' height='544px' >" . $body . "</td></tr><tr><td colspan='2' width='50px' height='64px' >&nbsp;</td><td colspan='7' width='300px' height='64px' ><b style='text-align: left' >CUMULATIVE ADDITIONAL CREDITS EARNED : ".$cgpa_calc['normal_additional_credits']."</b></td></tr>";
                }
                else
                {
                    $merge_body = "<tr><td width='100%' valign='top' colspan='9' height='544px' >" . $body . "</td></tr><tr><td colspan='9' width='30px' height='64px' >&nbsp;</td></tr>";
                }
            ...
            $header .= '<tr>
                           <td height="113px" style="border: none; padding-top: 15px; text-align: right; padding-right: 10px; " colspan="9" >
            ...
            $header .= "
                    <tr>
                        <td colspan='9' width='100%'  >
                            <table class='font_bigger' width='100%' align='left' style='border: none !important; padding-top: 0px;'  border='0'>
                                <tr  style='padding: 10px;'>
                                    <td class='line_height' colspan='3' width='100px;' >&nbsp;</td>
                                    <td class='line_height' colspan='5' width='250px;'  > <b>" . strtoupper($value['name']) . "</b> </td>
                                    <td class='line_height' width='100px;'  ><b>" . strtoupper($month_disp)  . "  " . $value['year'] . " </b> </td>
                                </tr>
                            
                                <tr style='padding: 10px;'>
                                    <td class='line_height pull_down' colspan='3' width='100px;' >&nbsp;</td>
                                    <td class='line_height pull_down' colspan='4' width='250px;'  > <b>" . strtoupper($value['register_number']) . "</td>
                                ...
                                <tr  style='padding: 10px;'>
                                    <td class='line_height pull_down' colspan='3' width='100px;' >&nbsp;</td>
                                    <td class='line_height pull_down' colspan='5' width='250px;'  > <b>" . $deg . "</td>
                                    <td class='line_height pull_down'  width='100px;' ><b>" . $value['regulation_year'] . "</td>
                                </tr>
                                <tr>
                                    <td class='line_height' colspan='9' class='".$change_mba_class."' >&nbsp; </td>
                                </tr>
                            </table>
                        </td>
                    </tr>";
                ...
                $body .= "
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            ...
                            <td colspan='3' width='205px'  align='center'> ".$result_stu." </td>
                        </tr>
                    </table>";
                $total_subs_count++;
            } 
            else 
            {
                ...
                if(isset($value['is_additional']))
                {
                    if($prev_add_pint_code==$value['subject_code'])
                    {
                        ...
                        <table style='line-height: 1.2em; ' border='0' width='100%' >
                            <tr>    
                                <td colspan=1  width='108px'  align='right'>&nbsp;</td>                        
                                <td width='450px' class='put_margin' colspan='4'  align='left'> " .strtoupper($get_man_det['sub_cat_code'])." - ". $subject_name_print . "</td>
                    ...
                    else
                    {
                        ...
                        <table style='line-height: 1.2em; ' border='0' width='100%' >
                            <tr>
                                ...
                                <td width='450px' class='put_margin' colspan='4'  align='left'>" . $subject_name_print . "</td>
                                <td width='52px' colspan=3  align='left'>" . $disp_credit. "</td>
                               </tr></table>";  
                ...
                else
                {
                    ...
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            <td width='40px' align='left'>" . $semester_array[$value['semester']]. "</td>
                            <td width='67px'  align='left'>" . strtoupper($value['subject_code']) . "</td>
                            <td width='450px' class='put_margin'   colspan='3'  align='left'>" . $subject_name_print . "</td>
                            <td width='52px'  align='left'>" . $disp_credit . "</td>
                            <td width='45px'  align='left'> " . strtoupper($grade_name) . " </td>
                            <td width='55px'  align='center'>" . $grade_point_print . "</td>
                            <td  style='padding-left: 10px;' width='50px'  align='center'>" . $result_stu . "</td></tr></table>"; 
                ...
                $body .= "
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            ...
                            <td width='67px'  align='left'>" . $value['subject_code'] . "</td>
                            <td width='450px' class='put_margin'   colspan='4'  align='left'>" . $subject_name_print . "</td>
                            <td colspan='3' width='205px'  align='center'> ".$result_stu."</b> </td>
                        </tr>
                    </table>";
                $total_subs_count++;
            } 
                    ...
                    else
                    {
                        ...
                        <table style='line-height: 1.2em; ' border='0' width='100%' >
                            <tr>
                                ...
                                <td width='67px' align='left'>" . strtoupper($value['subject_code']) . "</td>
                                <td width='450px' class='put_margin' colspan='4'  align='left'>" . $subject_name_print . "</td>
                                <td width='52px' colspan=3  align='left'>&nbsp;</td>
                               </tr></table>";  
    ...
    $final_total_credits =array_filter(array()); 
                ...
                if($count_col_spans<9)
                {
                    $credits_register_row .= "<td  width='30px' height='25px' colspan=".(9-$count_col_spans)."  >&nbsp;</td>";
                    $credits_earned_row .= "<td width='30px' height='25px' colspan=".(9-$count_col_spans)."   >&nbsp;</td>";
                    $sgpa_row .= "<td width='30px' height='25px' colspan=".(9-$count_col_spans)."   >&nbsp;</td>";
                }
                $credits_register_row .= "</tr>";
                $credits_earned_row .= "</tr>";
                $sgpa_row .= "</tr>";
                ...
                if(!empty($check_add))
                {
                    ...
                    foreach ($check_add as $valuess) 
                    {
                        ...
                        <table border=0  >
                            <tr>
                                <td colspan='3'  width='75px' align='left'>&nbsp;</td>
