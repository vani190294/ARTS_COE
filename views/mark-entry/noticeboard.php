...
<div>&nbsp;</div>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="col-lg-2 col-sm-2">
                ...
                <?= $form->field($model, 'mark_type')->checkboxList(['yes'=>'YES']) ->label('Revaluation Only') ?>
            </div>
        </div>
        <div class="col-xs-12 col-sm-12 col-lg-12">
       		<div class="form-group col-lg-3 col-sm-3"><br />
                ...
                <?= Html::a("Reset", Url::toRoute(['mark-entry/noticeboard']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
       	</div>
    </div>
	...
	<?php
        ...
        if($org_email=='coe@skcet.ac.in')
        {
            include_once("noticeboard_pdf_rem_gpa.php");
        }
        else
        {
            include_once("noticeboard_pdf.php");    
        }
