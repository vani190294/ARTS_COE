    ...
    foreach ($mark_statement as $value) 
    {
        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            {                
                ...
                <td class='print_cumulative_credit_points' height='25px' valign='top' > <b>" . $cgpa_calc['cumulative_earned_credits'] . "</b> </td>
    ...
    add_month']=29)
                ...
                if(!empty($check_add))
                {
                    foreach ($check_add as $valuess) 
                    {
                        ...
                        <table border='0' width='100%' >
                            <tr>
                                <td width='40px' align='left' class='sempg'><b>" . $semester_array[$semester_number]. "</b></td>
                                <td width='67px' align='left' class='subpg'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
            ...
            if ($value['CIA_max'] == 0 && $value['ESE_max'] == 0) 
            {
                ...
                $body .= "
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            <td width='40px'  class='sempg' align='left' >" . $semester_array[$value['semester']]. "</td>
                            <td width='67px'  align='left' class='subpg'>" . $value['subject_code'] . "</td>
            ...
            else 
            {
                ...
                if(isset($value['is_additional']))
                {
                    ...
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            <td width='40px' align='left' class='sempg'><b>" . $semester_array[$value['semester']]. "</b></td>
                            <td width='67px' align='left' class='subpg'><b>" . strtoupper($value['subject_code']) . "</b></td>
           ...
           $cgpa_calc = ConfigUtilities::getCgpaCaluclation($exam_year,$app_month,$batch_mapping_id,$value['student_map_id'],$semester_number);
            if ($value['CIA_max'] == 0 && $value['ESE_max'] == 0) 
            {
                ...
                $body .= "
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            <td width='40px' align='left' class='sempg' ><b>" . $semester_array[$value['semester']]. "</b></td>
                            <td width='67px'  align='left' class='subpg'><b>" . $value['subject_code'] . "</b></td>
                            <td width='450px' class='put_margin'   colspan='5'  align='left'>" . $subject_name_print . "</td>
            ...
            else
            {
                ...
                if(isset($value['is_additional']))
                {
                    ...
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            <td width='40px' class='sempg' align='left'><b>" . $semester_array[$value['semester']]. "</b></td>
                            <td width='67px'  align='left' class='subpg'><b>" . strtoupper($value['subject_code']) . "</b></td>
...
add_month']=29)
                ...
                if(!empty($check_add))
                {
                    foreach ($check_add as $valuess) 
                    {
                        ...
                        <table border='0' width='100%' >
                            <tr>
                                <td width='40px'  class='sempg' align='left'><b>" . $semester_array[$semester_number]. "</b></td>
                                <td width='67px'  class='subpg' align='left' class='subjectcode'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                <td width='450px' class='put_margin' colspan='5'  align='left'><b>" . $subject_name_print . "#</td>
                                <td width='52px'  align='left' class='credit'><b>" . $valuess['credits'] . "</b></td>
                                <td width='45px'  align='left' class='credit'><b> " . strtoupper($valuess['grade_name']) . "</b> </td>
                                <td width='55px'  align='center' class='credit'><b>" . $grade_point_print . "</b></td>
