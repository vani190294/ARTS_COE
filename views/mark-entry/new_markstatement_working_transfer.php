    ...
    foreach ($mark_statement as $value) 
    {
        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            {                
                ...
                $sgpa_row .= "<tr height='23px'> <td height='23px'  width='40px' colspan='" . $colspan_merge . "' > &nbsp; </td>";
                    ...
                    foreach ($final_total_credits as $key => $total_cre) 
                    {
                        ...
                        { 
                            ...
                            if($total_cre['sem']==$loop_sems)
                            {
                                ...
                                <td width='30px' class='print_credit_points arrear_sem_credits' height='23px' valign='bottom'  > <b>".$total_cre['register']."</b> </td>";
                                $credits_earned_row .= "<td class='print_credit_points arrear_sem_credits' height='23px' valign='bottom' width='30px' > <b>".$print_ear."</b></td>";
                                $sgpa_row .= "<td class='print_credit_points arrear_sem_credits' width='30px' height='23px'  valign='bottom' ><b> ".$print_gpaa."</b> </td>";
                            ...
                            {
                                $credits_register_row .= "<td width='30px' height='23px' valign='bottom' align='left' >&nbsp;</td>";
                                $credits_earned_row .= "<td width='30px' height='23px' valign='bottom' align='left' >&nbsp;</td>";
                                $sgpa_row .= "<td width='30px' height='23px' valign='bottom' align='left' >&nbsp;</td>";
                ...
                for ($loop_sem = $sem_printed_val; $loop_sem <= $total_semesters; $loop_sem++) 
                {
                    if ($loop_sem == $semester_number) 
                    {
                        ...
                        $increment = 0;
                            ...
                            $credits_earned_row .= "<td class='print_credit_points $align_text' valign='bottom' width='60px' height='23px'  ".$merge_col." > <b>" . $sem_credits_earned_p . "</b> </td>";
                            $sgpa_row .= "<td width='60px' class='print_credit_points $align_text ' valign='bottom' height='23px'  ".$merge_col."  > <b>" . $sgpa_row_p . "</b> </td>";
                    }
                    else 
                    { 
                        $credits_register_row .= "<td width='60px' height='23px' >&nbsp;</td>";
                        $credits_earned_row .= "<td width='60px' height='23px' >&nbsp;</td>";
                        $sgpa_row .= "<td width='60px' height='23px'  >&nbsp;</td>";  
                    }
                    $count_col_spans = $count_col_spans+1;
                }
                if($count_col_spans<11)
                {
                    $credits_register_row .= "<td  width='30px' height='23px' colspan=".(11-$count_col_spans)."  >&nbsp;</td>";
                    $credits_earned_row .= "<td width='30px' height='23px' colspan=".(11-$count_col_spans)."   >&nbsp;</td>";
                    $sgpa_row .= "<td width='30px' height='23px' colspan=".(11-$count_col_spans)."   >&nbsp;</td>";
                }
                ...
                if($total_subs_count>=$count_of_subs)
                {
                 ...
                 $cgpa_calculation = ConfigUtilities::getCgpaCaluclationtransfer1($value['course_batch_mapping_id'],$value['student_map_id'],$value['semester'],$value['year'],$value['month']);
                $cumulative_row .= "<tr class='cumulative_row' height='23px'>
                <td colspan='3' width='20px' > &nbsp; </td>
                <td class='print_cumulative_credit_points' height='23px' valign='top' > <b>" . $cgpa_calculation['transfer_cumulative'] . "</b> </td>
                <td colspan='4' width='20px' > &nbsp; </td>
                <td class='print_cumulative_credit_points_cgpa' width='60px'  height='23px'  valign='top' > <b>" . $cgpa_calculation['final_cgpa'] . "</b> </td>
                ...
                $check_add_attemot = Yii::$app->db->createCommand('SELECT * FROM coe_mandatory_stu_marks as A JOIN coe_mandatory_subcat_subjects as B ON B.coe_mandatory_subcat_subjects_id=A.subject_map_id where result like "%Pass%" and student_map_id="'.$print_student_map_id.'" and result like "%Pass%" and is_additional="YES" ')->queryAll();
                ...
                if(!empty($getWaiverStatus) && count($check_add_attemot)>=$config_elect)
                {
                    ...
                    if(!empty($esrned_credits) && $esrned_credits!=0)
                    {
                ...
                else if($is_additional_printed==1 && $print_additional_text==0)
                {
                    ...
                    {
                        $merge_body = "<tr><td width='100%' valign='top' colspan='11' height='".$bottom_margin."px' >" . $body . "</td></tr><tr><td colspan='2' width='30px' height='64px' >&nbsp;</td><td colspan='9' width='300px' height='64px' ><b style='text-align: left' >CUMULATIVE ADDITIONAL CREDITS EARNED : ".$cgpa_calc['cumulative_additional_credits']."</b></td></tr>";
                    }
                }
            ...
            $header .= '<tr>
                           <td height="113px" style="border: none; text-align: right;" colspan="11" >
                                <img class="transimg-responsive"   width="80" height="80"  src="' . $stu_photo . '" alt="' . $stu_photo . '" Photo >
            ...
            $header .= "
                    <tr>
                        <td colspan='11' width='100%'  >
                            <table width='100%' align='left' style='border: none !important; padding-top: 10px;'  border='0'>
                                ...
                                <tr  style='padding: 10px;'>
                                    <td class='line_height pull_down' colspan='4' width='75px;' >&nbsp;</td>
                                    <td class='line_height pull_down' colspan='6' width='230px;'  > <b>" . $deg . "</b></td>
            ...
            {
                $sub_na = wordwrap(strtoupper(trim($value['subject_name'])), 50, "\n", true);
                $sub_na = htmlentities($sub_na);
                $subject_name_print = "<b>".strtoupper(nl2br($sub_na))."</b>";
            ...
            else 
            {
                ...
                if(isset($value['is_additional']))
                {
                    ...
                    $getWaiverStatus = Yii::$app->db->createCommand($checkWaiver)->queryAll();
                    $config_elect = ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_ELECTIVE_WAIVER); 
                        $check_add_attemot = Yii::$app->db->createCommand('SELECT * FROM coe_mandatory_stu_marks as A JOIN coe_mandatory_subcat_subjects as B ON B.coe_mandatory_subcat_subjects_id=A.subject_map_id where result like "%Pass%" and student_map_id="'.$value['student_map_id'].'" and result like "%Pass%" and is_additional="YES" ')->queryAll();
                            ...
                            if($prev_add_pint_code==$value['subject_code'])
                            {
                                ...
                                <table style='line-height: 1.2em; ' border='0' width='100%' >
                                    <tr>    
                                        ...
                                        <td valign='top' width='52px'  align='left'><b>" . $value['credit_points'] . "</b></td>
                                        <td valign='top' width='45px'  align='left'> <b>" . strtoupper($grade_name) . " </b></td>
                                        <td valign='top' width='55px'  align='center'><b>" . $grade_point_print . "</b></td>
                                        <td valign='top'  style='padding-left: 10px;' width='50px'  align='center'><b>" . $result_stu . "</b></td></tr></table>";
                            }
                            else
                            {
                                $body .= "
                                <table style='line-height: 1.2em; ' border='0' width='100%' >
                                    <tr>
                                        <td valign='top' width='40px' align='left'><b>" . $semester_array[$value['semester']]. "</b></td>
                                        <td valign='top' width='67px' align='left'><b>" . strtoupper($value['subject_code']) . "</b></td>
                                        <td valign='top' width='450px' class='put_margin' colspan='5'  align='left'>" . $subject_name_print . "</b></td>
                ...
                else
                {
                    ...
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            <td valign='top' width='40px' align='left'><b>" . $semester_array[$value['semester']]. "</b></td>
                            <td valign='top' width='".$with_add."'  align='left'><b>" . strtoupper($value['subject_code']) . "</b></td>
                            <td valign='top' width='450px' class='".$change_class."'   colspan='5'  align='left'>" . $subject_name_print . "</td>
                            <td valign='top' width='52px'  align='left'><b>" . $value['credit_points'] . "</b></td>
                            <td valign='top' width='45px'  align='left'><b> " . strtoupper($grade_name) . " </b></td>
                            <td valign='top' width='55px'  align='center'><b>" . $grade_point_print . "</b></td>
                            <td valign='top'  style='padding-left: -15px;'  width='50px'  align='center'><b>" . $result_stu . "</b></td></tr></table>";  
            ...
            if ($value['CIA_max'] == 0 && $value['ESE_max'] == 0) 
            {
                ...
                $body .= "
                    <table style='line-height: 1.2em; ' border='0' width='100%' >
                        <tr>
                            <td valign='top' width='40px' align='left' ><b>" . $semester_array[$value['semester']]. "</b></td>
                            <td valign='top' width='67px'  align='left'><b>" . $value['subject_code'] . "</b></td>
                            <td valign='top' width='450px' class='put_margin'   colspan='5'  align='left'>" . $subject_name_print . "</td>
                            <td valign='top' colspan='4' width='205px' style='padding-left: -15px;'   align='center'><b> ".$result_stu."</b> </td>
                        </tr>
                    </table>";
                $total_subs_count++;
            } 
