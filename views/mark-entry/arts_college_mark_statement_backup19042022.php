...
if (isset($mark_statement) && !empty($mark_statement)) 
{
        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            {                
                $credits_register_row .= "<tr> 
                             <td width='40px' class='part_no_print adj' height='25px' colspan=2 > I </td>";
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px' style='padding-left:8px;'  colspan='3' align='left'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px' style='padding-left:8px;'  colspan='3' align='left'><b>" . strtoupper($value['subject_code']) . "</b></td>
                                     <td valign='top' style='padding-left:-135px;' align='left' width='430px'  >" . $subject_name_print . "</td>
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    <td valign='top' width='55px' align='left'><b>" . $semester_array[$value['part_no']]. "</b></td>
                                    <td  valign='top' width='60px' style='padding-right:-5px;' align='center'><b>" . $semester_array[$value['semester']]. "</b></td>
                                    <td valign='top' width='115px'  colspan='3' style='padding-left:8px;' align='left'><b>" . strtoupper($value['subject_code']) . "</b></td>
                                     <td valign='top' style='padding-left:-135px;' align='left'  width='430px'  >" . $subject_name_print . "</td>
    ...
    if(!empty($check_add))
    {
        ...
        $ese_max_disp = $valuess['ese_maximum']==0?'--':100;
        //print_r($ese_max_disp);exit;
        $cia_max_disp = $valuess['cia_maximum']==0?'--':100;
       // $cia_max_disp = $valuess['cia_maximum']==0 &&($valuess['cia_maximum']==100  && $valuess['ese_maximum']!=0)?'--':100;
         $total_max_disp = ($ese_max_disp!='--' && $cia_max_disp!='--') ?$valuess['ese_maximum']+$valuess['cia_maximum']:($ese_max_disp=='--'?$cia_max_disp:$ese_max_disp);
        $disp_ese = $valuess['ese_maximum']==0?'--':$valuess['ESE'];
        $disp_cia = $valuess['cia_maximum']==0?'--':$valuess['CIA'];
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    <td valign='top' width='55px' align='left'><b>" . $semester_array[$valuess['part_no']]. "</b></td>
                                    <td  valign='top' width='60px'style='padding-right:-5px;' align='center'><b>" . $semester_array[$valuess['semester']]. "</b></td>
                                    <td valign='top' width='115px'  colspan='3'  style='padding-left:8px;' align='left'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                    <td valign='top' style='padding-left:-135px;'  align='left' width='430px'  >" . $subject_name_print . "</td>
