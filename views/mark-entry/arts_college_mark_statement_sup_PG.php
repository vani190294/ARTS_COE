...
if (isset($mark_statement) && !empty($mark_statement)) 
{
    ...
    echo Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['/mark-entry/mark-statement-arts-print-sup-pg-pdf'], [
        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            ";
                    ...
                    <tr>
                        ...
                        <td valign='top'  width='60px'  align='left'><b> " . strtoupper($Ab) . " </b></td>
           ...
           /*  if ($value['batch_name']<2021)
               ...
               // $grade_name = ($value['grade_name'] == "WD" || $value['grade_name'] == "wd") ? 'W' : $grade_name;
                ...
                $grade_point_print = ($value['grade_point']==0 || $grade_point_send==0 || $Ab=='--') ?"--":$grade_point_send;
    ...
    if (isset($_SESSION['mark_statement_sub_pg_pdf']))
    {
        unset($_SESSION['mark_statement_sub_pg_pdf']);
    }
    $_SESSION['mark_statement_sub_pg_pdf'] = $print_stu_data;
