	...
	<div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="form-group col-lg-2 col-sm-2"> <br />
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                <?= Html::Button('Submit', ['value'=>'Submit','name'=>"withheld_btn1" ,'id'=>"withheld_btn1",'class' => 'btn  btn-group-lg btn-group btn-success']) ?>
                
                <?= Html::a("Reset", Url::toRoute(['mark-entry/malpractice']), ['class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
