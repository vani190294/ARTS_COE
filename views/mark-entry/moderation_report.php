...
$this->title="ESE MODERATED MARK REPORT";
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-2 col-lg-2">
            ...
            <div class="btn-group col-lg-12 col-sm-12" role="group" aria-label="Actions to be Perform">
                ...
                <input type="button" id="moderationreport" name="moderationreport" class="btn btn-success" value="Submit">
                <?= Html::a("Reset", Url::toRoute(['mark-entry/moderationreport']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
