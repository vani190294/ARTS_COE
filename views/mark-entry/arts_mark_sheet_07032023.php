         ...
         //print_r($semester_number);exit;
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px'   colspan='3'  align='left' style='padding-left:-1px;'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                     <td valign='top' style='padding-left:-90px;' align='left' width='430px'  >" . $subject_name_print . "</td>
                                     
                                    <td valign='top'  width='95px' colspan='8'  align='center' style='padding-right:-1250px;'><b>" . $result_stu . "</b></td></tr>
                        </table>";  
                        ...
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px'  colspan='3' align='left' style='padding-left:-5px;'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                    <td valign='top' width='435px' colspan='8' align='left'>" . $subject_name_print . "</td>
                                    <td valign='top' width='50px'  align='left' style='padding-left:-2px;'><b>" . $valuess['credits'] . "</b></td>
                                    <td valign='top' width='60px'  align='left' style='padding-left:-5px;'><b>" . $ese_max_disp . "</b></td>
                                    <td valign='top' width='55px'  align='left' style='padding-left:-5px;'><b>" . $cia_max_disp . "</b></td>
                                    <td valign='top' width='60px'  align='left' style='padding-left:-10px;'><b>" . $total_max_disp . "</b></td>
                                    <td valign='top' width='55px'  align='left' style='padding-left:-5px;'><b>" . $disp_ese . "</b></td>
                                    <td valign='top' width='60px'  align='left' style='padding-left:-5px;'><b>" . $disp_cia . "</b></td>
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px'  colspan='3'  align='left' style='padding-left:-1px;'><b>" . strtoupper($value['subject_code']) . "</b></td>
                                     <td valign='top' style='padding-left:-90px;' align='left' width='430px'  >" . $subject_name_print . "</td>
                                  
                                    <td valign='top'  width='95px'   colspan='8' align='center' style='padding-right:-125px;'><b>" . $result_stu . "</b></td></tr>
                        </table>";  
            ...
            <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                    <tr>
                        ...
                        <td valign='top' width='435px'  colspan='8' align='left'>" . $subject_name_print . "</td>
                        <td valign='top' width='50px'  align='left' style='padding-left:-2px;'><b>" . $value['credit_points'] . "</b></td>
                        <td valign='top' width='60px'  align='left' style='padding-left:-5px;'><b>" . $ese_max_disp . "</b></td>
                        <td valign='top' width='55px'  align='left' style='padding-left:-5px;'><b>" . $cia_max_disp . "</b></td>
                        <td valign='top' width='60px'  align='left' style='padding-left:-10px;'><b>" . $total_max_disp . "</b></td>
                        <td valign='top' width='55px'  align='left' style='padding-left:-5px;'><b>" . $disp_ese . "</b></td>
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    <td valign='top' width='55px' align='left' style='padding-left:-1px;'><b>" . $semester_array[$value['part_no']]. "</b></td>
                                    <td  valign='top' width='60px'  align='center' style='padding-left:-30px;'><b>" . $semester_array[$value['semester']]. "</b></td>
                                    <td valign='top' width='115px'  colspan='3'   class='subject_code1' align='left' style='padding-left:-1px;'><b>" . strtoupper($value['subject_code']) . "</b></td>
                                     <td valign='top' style='padding-left:-90px;' align='left'  width='430px'  >" . $subject_name_print . "</td>
         ...
         if($valuess['cia_maximum'] == 0 && $valuess['ese_maximum'] == 0)
            {
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    <td valign='top' width='55px' align='left' style='padding-left:-1px;'><b>" . $semester_array[$valuess['part_no']]. "</b></td>
                                    <td  valign='top' width='60px' align='center' style='padding-left:-30px;'><b>" . $semester_array[$valuess['semester']]. "</b></td>
                                    <td valign='top' width='115px'  colspan='3'   class='subject_code1' align='left' style='padding-left:-1x;'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                    <td valign='top' style='padding-left:-90px;'  align='left' width='430px'  >" . $subject_name_print . "</td>
