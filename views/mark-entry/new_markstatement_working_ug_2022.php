...
$this->registerCssFile("@web/css/newmarkstatement_ug_2022.css");
?>
   ...
   
{
    ...
    if($mark_statement[0]['batch_name']>='2022' && ($mark_statement[0]['programme_code']=='U109' || $mark_statement[0]['programme_code']=='U111'))
    {
    ...
    else
    {
        ...
        $register='register';
        $footheight= "height='61px'";
    }

    if($mark_statement[0]['degree_code']=="MBA" || $mark_statement[0]['degree_code']=="mba" || $mark_statement[0]['degree_code']=="Mba")
    {
        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            {                
                ...
                if($total_subs_count>=$count_of_subs)
                {
                    ...
                    $splitted_body = "<tr><td width='100%' valign='top' colspan='11' height='547px' >" . $body . "</td></tr><tr><td colspan='11' width='30px' ".$footheight." >&nbsp;</td></tr>";
             ...
             /*if(!empty($check_arrear) && $value['batch_name']!=2017  && $value['batch_name']!=2018 && $value['batch_name']!=2019 and $value['degree_type']="UG" &&  $year=2020 && $month=29   )
                ...
                $merge_body = "<tr><td class='".$middlecontent."' width='100%' valign='top' colspan='11' height='".$bottom_margin."px' >" . $body . "</td></tr><tr><td colspan='11' width='30px' ".$footheight." >&nbsp;</td></tr>";
            ...
            $header .= '<tr>
                           <td height="113px" class="imageclass" style="padding-right: 10px !important; border: none; text-align: right;" colspan="11" >
            ...
            $header .= "
                    <tr>
                        <td colspan='11' width='100%'  >
                            <table class='font_bigger' width='100%' align='left' style='border: none !important;'  border='0'>
