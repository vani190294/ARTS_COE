...
if (isset($mark_statement) && !empty($mark_statement)) 
{
    ...
    echo Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['/mark-entry/mark-statement-arts-print-sup-pdf'], [
    ...
    foreach ($mark_statement as $value) 
    {
        ...
        $cgpa_calc = ConfigUtilities::getCgpaCaluclation($exam_year,$app_month,$batch_mapping_id,$print_student_map_id,$value['term'],$semester_number);
         ...
         //print_r($semester_number);exit;
...

            {
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    <td valign='top' width='55px' align='left'><b>" . $semester_array[$valuess['part_no']]. "</b></td>
                                    <td  valign='top' width='60px' style='padding-right:-5px;' align='center'><b>" . $semester_array[$valuess['semester']]. "</b></td>
                                    <td valign='top' width='115px'   colspan='3' class='subject_code' align='left'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                     <td valign='top' style='padding-right:-110;' align='left' width='200px'  >" . $subject_name_print . "</td>
                                     
                                    <td valign='top'  width='95px' colspan='8'  align='right' class='sub_ncc'><b>" . $result_stu . "</b></td></tr>
                        </table>";  
                        ...
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    <td valign='top' width='55px' align='left'><b>" . $semester_array[$valuess['part_no']]. "</b></td>
                                    <td  valign='top' width='65px' align='center'><b>" . $semester_array[$valuess['semester']]. "</b></td>
                                    <td valign='top' width='115px'  colspan='3' align='left' class='subject_code'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                    <td valign='top' width='435px' colspan='8' align='left'>" . $subject_name_print . "</td>
                                    <td valign='top' width='50px'  align='left'><b>" . $valuess['credits'] . "</b></td>
                                    <td valign='top' width='60px'  align='left'><b>" . $ese_max_disp . "</b></td>
                                    <td valign='top' width='55px'  align='left'><b>" . $cia_max_disp . "</b></td>
                                    <td valign='top' width='60px'  align='left'><b>" . $total_max_disp . "</b></td>
                                    <td valign='top' width='55px'  align='left'><b>" . $disp_ese . "</b></td>
                                    <td valign='top' width='60px'  align='left'><b>" . $disp_cia . "</b></td>
                        ...
                        <td colspan='16' width='100%'  >
                            <table width='100%' style='border: none !important; text-align: center !important; padding-top: 1px; font-size: 22px;'  border='0'>
                                ...
                                <tr style='padding: 10px; ' class='push_down' >
                                    <td  class='line_height' style='padding-left: 40px; padding-bottom: 40px;' colspan='2' align='left' width='100px; padding-top:-5px;' ><b>" . strtoupper($value['degree_code']) . "</b></td>
                                    ...
                                    <td style='padding-bottom: 29px;' class='line_height_reg2' colspan='3' align='right' width='80px;'  >".$date."</td>
                                ...
                                <tr>
                                    ...
                                    <td colspan='3' align='right' width='150px;' class='line_height_reg2' ><b>" . $dob . "</b></td>
                ...
                if($value['CIA_max'] == 0 && $value['ESE_max'] == 0)
            {
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    <td valign='top' width='55px' align='left'><b>" . $semester_array[$value['part_no']]. "</b></td>
                                    <td  valign='top' width='60px' style='padding-right:-5px;' align='center'><b>" . $semester_array[$value['semester']]. "</b></td>
                                    <td valign='top' width='115px'  colspan='3' class='subject_code1' align='left'><b>" . strtoupper($value['subject_code']) . "</b></td>
                                     <td valign='top' style='padding-right:-110;' align='left' width='200px'  >" . $subject_name_print . "</td>
            ...
            <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                    <tr>
                        <td valign='top' width='55px' align='left'><b>" . $semester_array[$value['part_no']]. "</b></td>
                        <td  valign='top' width='65px' align='center'><b>" . $semester_array[$value['semester']]. "</b></td>
                        <td valign='top' width='115px'  colspan='3' class='subject_code' align='left'><b>" . strtoupper($value['subject_code']) . "</b></td>
                        <td valign='top' width='435px'  colspan='8' align='left'>" . $subject_name_print . "</td>
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    <td valign='top' width='55px' align='left'><b>" . $semester_array[$valuess['part_no']]. "</b></td>
                                    <td  valign='top' width='60px'style='padding-right:-5px;' align='center'><b>" . $semester_array[$valuess['semester']]. "</b></td>
                                    <td valign='top' width='115px'  colspan='3'   class='subject_code1' align='left'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                    <td valign='top' style='padding-right:-110;'  align='left' width='200px'  >" . $subject_name_print . "</td>
   ...
   // $html = $header . $merge_body . $footer;
    ...
    if (isset($_SESSION['mark_statement_sup_pdf']))
    {
        unset($_SESSION['mark_statement_sup_pdf']);
    }
    $_SESSION['mark_statement_sup_pdf'] = $print_stu_data;
