        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            {                
             ...
             // print_r($check_arrear);exit;
                         ...
                         if( $rest=="TAM")
                {
                   ...
                   $sub_na = substr($valuess['subject_name'], 0,-32);
                ...
                {
                   $sub_na = wordwrap(strtoupper(trim($valuess['subject_name'])), 100, "\n", true);
            ...
            if ($value['CIA_max'] == 0 && $value['ESE_max'] == 0) 
            {
                  ...
                  if( $rest=="TAM")
                {
                 ...
                 $sub_na = substr($value['subject_name'], 0,-32);
                    $subject_name_print = "<b>".strtoupper(nl2br($sub_na))."</b>";
            ...
            else 
            {
             ...
             /*  if($value['semester']!=$semester_number)
                                  ...
                                  if( $rest=="TAM")
                {
                   ...
                   $sub_na = substr($get_man_det['sub_cat_name'], 0,-32);
                    $subject_name_print = "<b>".strtoupper(nl2br($sub_na))."</b>";
