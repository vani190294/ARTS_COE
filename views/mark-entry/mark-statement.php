            ...
            <div class="row">
                <div class="col-xs-12 col-lg-12 col-sm-12">
                   ...
                   <div class="col-xs-12 col-sm-2 col-sm-2">
                        <?php 
                            echo '<label>Mark Statement Date</label>';
                ...
                <?= Html::submitButton('Print Mark Statement', ['onClick' => "spinner(); validateMarkStatement();", 'name' => 'get_marks', 'class' => 'btn btn-success']) ?>
<?= Html::a("Reset", Url::toRoute(['mark-entry/mark-statement']), ['onClick' => "spinner();", 'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
                    </div>
                </div>
...
{
    if(isset($deg_info) && !empty($deg_info))
    {
...

        {
           ...
           if($term==35)
            {
               include_once("arts_college_mark_statement_sup.php");
            }           
            else
            {
                include_once("arts_college_mark_statement.php");
            }
        }
      else if($deg_info->degree_type=="PG")
         {
            if($term==35)
            {
               include_once("arts_college_mark_statement_sup_PG.php");
            }
            else
            {
                include_once("arts_college_mark_statement_PG.php");
            }
...
else if($org_email=='coe@skcet.in')
{
    if(isset($mark_statement_type) && !empty($mark_statement_type))
    {
        if($mark_statement_type=='CBCS')
        {
            ...
            {
                include_once("skcet_trimester_markstatement.php");
            }
            else if($deg_info->degree_type=='PG')
            {
                include_once("skcet_trimester_markstatement.php");
            ...
            {
                include_once("skcet_old_format_markstatement.php");
            }
        }
        if($mark_statement_type=='CBCS-NEW')
        {
            if($print_trimester==1)
            {
                include_once("skcet_trimester_markstatement.php");
            ...
            {
                include_once("skcet_new_format_markstatement.php");
            }
        }
        if($mark_statement_type=='CBCS-NEW-PG')
        {            
            include_once("skcet_trimester_markstatement.php");
        }
    } 
   ...
   if(isset($mark_statement_type) && !empty($mark_statement_type))
    {
       ...
       /* else 
        {
            //include_once("new_markstatement.php");
            include_once("print_mark_statement_pdf.php");
        }    */
    } 
}
