         ...
         //print_r($semester_number);exit;
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px'   colspan='3'  align='left' class='sub2' style='padding-left:-1px;padding-left:6px;'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                        ...
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px'  colspan='3' class='subject_code' align='left' style='padding-left:3px;'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                    <td valign='top' width='435px' colspan='8' align='left'>" . $subject_name_print . "</td>
                                    <td valign='top' width='50px'  align='left' style='padding-left:-2px;padding-left:4px;'><b>" . $valuess['credits'] . "</b></td>
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px'  colspan='3'  align='left' style='padding-left:-1px;padding-left:6px;'><b>" . strtoupper($value['subject_code']) . "</b></td>
                                      <td valign='top' style='padding-left:-135px;' align='left' width='430px'  >" . $subject_name_print . "</td>
            ...
            <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                    <tr>
                        ...
                        <td valign='top' width='115px'  colspan='3' class='subject_code' align='left' style='padding-left:3px;'><b>" . strtoupper($value['subject_code']) . "</b></td>
                        <td valign='top' width='435px'  colspan='8' align='left'>" . $subject_name_print . "</td>
                        <td valign='top' width='50px'  align='left' style='padding-left:-2px;padding-left:4px;'><b>" . $value['credit_points'] . "</b></td>
                        <td valign='top' width='60px'  align='left' style='padding-left:-5px;'><b>" . $ese_max_disp . "</b></td>
                        <td valign='top' width='55px'  align='left' style='padding-left:-5px;'><b>" . $cia_max_disp . "</b></td>
                        <td valign='top' width='60px'  align='left' style='padding-left:-10px;'><b>" . $total_max_disp . "</b></td>
                        <td valign='top' width='55px'  align='left' style='padding-left:-5px;'><b>" . $disp_ese . "</b></td>
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px'  colspan='3'   class='subject_code1' align='left' style='padding-left:-1px;padding-left:6px;'><b>" . strtoupper($value['subject_code']) . "</b></td>
                                     <td valign='top' style='padding-left:-135px;' align='left' width='430px'  >" . $subject_name_print . "</td>
                ...
                $body .= "
                        <table class='body_print_marks' style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    ...
                                    <td valign='top' width='115px'  colspan='3'   class='subject_code1' align='left' style='padding-left:-1x;padding-left:6px;'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                    <td valign='top' style='padding-left:-135px;' align='left' width='430px'  >" . $subject_name_print . "</td>
