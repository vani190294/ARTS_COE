...
$this->title = "Mark Statement Transfer";
    ...
    <div class="box box-success">
        <div class="box-body"> 
            ...
            <div class="row">
             ...
             <?= Html::a("Reset", Url::toRoute(['mark-entry/mark-statement-transfer']), ['onClick' => "spinner();", 'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
                    </div>
                </div>
         <?php ActiveForm::end(); ?>
            </div>
...
else if($org_email=='coe@skcet.in')
{
    if(isset($mark_statement_type) && !empty($mark_statement_type))
    {
        if($mark_statement_type=='CBCS')
        {
            ...
            {
                include_once("skcet_old_format_markstatement_transfer.php");
            }
        }
        else if($mark_statement_type=='CBCS-NEW')
        {
            if($print_trimester==1)
            {
                include_once("skcet_trimester_markstatement.php");
            ...
            {
                include_once("skcet_new_format_markstatement_transfer.php");
            }
        }
        else if($mark_statement_type=='CBCS-NEW-PG')
        {            
            include_once("skcet_trimester_markstatement.php");
        }
        else if($mark_statement_type=='NON-CBCS')
        {            
            include_once("skcet_non_cbcs_mark_statement.php");
        }
        else
        {
            include_once("skcet_new_format_markstatement_transfer.php");
   ...
   if(isset($mark_statement_type) && !empty($mark_statement_type))
    {
        if($mark_statement_type=='CBCS')
        {
            ...
            else
            {
                ...
                include_once("new_markstatement_working_transfer.php");
            }
        }
       /* else 
        {
