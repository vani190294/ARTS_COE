...
<?php
$change_date = ['16TPMB035','16TPMB015','16TPMB032','16TPMB031','16TPMB030','16TPMB020','16TPMB117','16TPMB119'];
    ...
    foreach ($mark_statement as $value) 
    {
        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            {                
               ...
               {
                    $date_insert = "<tr><td colspan='11' height='20px' width='50px'> &nbsp;</td></tr> <tr><td  align='left' valign='bottom' class='date_style' colspan='11' width='300px' style='font-size: 13px; padding-top: 21px;padding-left: 36px; ' >".$date."</td></tr> ";
               }
                    ...
                    foreach ($check_add as $valuess) 
                    {
                        ...
                        <table border='0' width='100%' >
                            <tr>
                                ...
                                <td width='450px' style='font-size: 12.8px !important;'  colspan='5'  align='left'><b>" . $subject_name_print . "</td>
                ...
                $merge_body = "<tr><td width='100%' valign='top' colspan='11' height='565px' >" . $body . "</td></tr><tr><td colspan='11' width='30px' height='58px' >&nbsp;</td></tr>";
            ...
            if(in_array($previous_reg_number, $change_date))
           {
                $header .="<tr><td colspan='11' width='30px'>&nbsp;</td></tr> <tr><td style='font-weight: bold; font-size: 14px; padding-top: -25px; text-align: center;' colspan='11'> TRIMESTER PATTERN </td></td></tr>";
           } 
           else{
                ...
                $body .= "
                    <table border='0' width='100%' >
                        <tr>
                            ...
                            <td width='450px' style='font-size: 12.8px !important;'  colspan='5'  align='left'>" . $subject_name_print . "</td>
                ...
                if(isset($value['is_additional']))
                {
                    ...
                    <table border='0' width='100%' >
                        <tr>
                            ...
                            <td width='450px' style='font-size: 12.8px !important;'  colspan='5'  align='left'> &nbsp;" . $subject_name_print . "</b></td>
                    ...
                    <table border='0' width='100%' >
                        <tr>                            
                            <td width='450px' style='font-size: 12.8px !important;'  colspan='5'  align='left'><b> &nbsp;&nbsp;&nbsp;" .strtoupper($get_man_det['sub_cat_code'])." - ". $subject_name_print . "</b></td>
                ...
                if(isset($value['is_additional']))
                {
                    ...
                    <table border='0' width='100%' >
                        <tr>
                            <td width='40px' align='left'><b>" . $semester_array[$value['semester']]. "</b></td>
                            <td width='80px'  align='left'><b>" . strtoupper($value['subject_code']) . "</b></td>
                            <td width='450px' style='font-size: 12.8px !important;'  colspan='6'  align='left'>&nbsp;<b>" . $subject_name_print . "</b></td>
