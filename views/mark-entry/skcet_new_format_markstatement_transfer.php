        ...
        if ($previous_reg_number != $value['register_number']) 
        {
            ...
            {                
                ...
                if($is_additional_printed==1 && !empty($cgpa_calc['normal_additional_credits']) && $cgpa_calc['normal_additional_credits']!=0  )
                {
                    ...
                    $merge_body = "<tr><td width='100%' valign='top' colspan='11' height='538px' >" . $body . "</td></tr><tr><td colspan='2' width='50px' height='64px' >&nbsp;</td><td colspan='9' width='300px' height='64px' ><b style='text-align: left' >CUMULATIVE ADDITIONAL CREDITS EARNED : ".$cgpa_calc['normal_additional_credits']."</b></td></tr>";
                }
                else
                {
                    $merge_body = "<tr><td width='100%' valign='top' colspan='11' height='538px' >" . $body . "</td></tr><tr><td colspan='11' width='30px' height='64px' >&nbsp;</td></tr>";
                }
