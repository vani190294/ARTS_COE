    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-2 col-lg-2" style="text-align: center;">
            ...
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                ...
                <?= Html::Button("Reset", ['class' => 'btn btn-group btn-group-lg btn-primary ','value'=>'reset_data','name'=>'reset_data','id'=>'clear_id','onclick'=>'js:resetHalls1();']) ?>
...
<div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12 stu_cnt_text">
       <div class="col-xs-12 col-sm-2 col-lg-2">
            ...
            <input type='text' name='stu_count' id='stu_cnt' >
      </div>
    </div>
</div>
