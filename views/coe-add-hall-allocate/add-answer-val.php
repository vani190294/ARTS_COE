...
use yii\helpers\Url;
echo Dialog::widget();
$this->title = 'ADC Valuation Answer Cover Generate';
?>
...
<div class="box-body"> 
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">  
      ...
      <div class="col-lg-2 col-sm-2">
       ...
       <div class="col-xs-12 col-sm-2 col-lg-2">
           <?php echo $form->field($examTimetable,'qp_code')->widget(
                Select2::classname(), [
                    'options' => [
                        'placeholder' => '-----Select ----',   
                        'id' => 'ans_qp_code1',                      
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-2 col-lg-2">
            <?= $form->field($model, 'answer_packet_serial')->textInput(['id'=>'ans_pack_serial','name'=>'ans_pack_serial']) ?>
        </div>
       ...
       <div class="col-xs-12 col-sm-2 col-lg-2">
    	...
    	<div class="col-xs-12 col-sm-4 col-lg-4">
            <br>
 			<?= Html::Button('Show & Print' , ['onClick'=>"spinner();",'class' => 'btn btn-group-lg btn-group btn-success','id'=>'answer_packets_btn_add' ]) ?>
             <?= Html::Button("Reset Answer Cover", ['onClick'=>"deleteanswerpacket();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            <?= Html::a("Reset Selection", Url::toRoute(['coe-add-hall-allocate/add-answer-val']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
    	</div>
    </div>
