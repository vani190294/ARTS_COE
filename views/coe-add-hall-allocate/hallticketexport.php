    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="form-group col-lg-9 col-sm-9"> <br />
            <div class="btn-group col-lg-3 col-sm-3" role="group" aria-label="Actions to be Perform">
                <input type="button" id="hallticket_export1" name="hallticket_export1" class="btn btn-success" value="Submit">

                <?= Html::a("Reset", Url::toRoute(['coe-add-hall-allocate/hallticketexport']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
            ...
            <div class="col-xs-12 col-sm-12 col-lg-12">
                ...
                <div class="col-xs-2 pull-right">
                    <?php
                        ...
                        echo Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['/mark-entry/addhallticketexport-pdf'], [
