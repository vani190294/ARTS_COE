...
<div class="hall-allocate-view">
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-3 col-sm-4 col-lg-4">
            <?php 
                echo Html::a('<i class="fa fa-file-pdf-o"></i> Arrange New', ['/coe-add-hall-allocate/create'], [
                ...
                echo Html::a('<i class="fa fa-file-pdf-o"></i> Print', ['/coe-add-hall-allocate/hallpdf'], [
