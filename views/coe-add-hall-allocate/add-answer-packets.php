    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
       ...
       <div class="col-xs-12 col-sm-2 col-lg-2">
    	...
    	<div class="col-xs-12 col-sm-4 col-lg-4">
            <br>
 			<?= Html::Button('Show & Print' , ['onClick'=>"spinner();",'class' => 'btn btn-group-lg btn-group btn-success','id'=>'answer_packets_btn_add1' ]) ?>
             <?= Html::Button("Reset Answer Cover", ['onClick'=>"deleteanswerpacket();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
          
               <?= Html::a("Reset Selection", Url::toRoute(['coe-add-hall-allocate/add-answer-packets']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
    	</div>
    </div>
