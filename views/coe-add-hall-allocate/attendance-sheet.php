...
<div class="box-body"> 
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">                
        ...
        <div class="col-xs-12 col-sm-3 col-lg-3">
            ...
            <?= Html::a("Reset", Url::toRoute(['coe-add-hall-allocat/attendance-sheet']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
                ...
                foreach ($get_data as $value) 
                {
                    ...
                    if($prev_hall_name!=$value['hall_name'])
                    {
                        ...
                        <tr>
                         ...
                         ADDITIONAL CREDITS ATTENDANCE SHEET FOR SEMESTER EXAMINATIONS : '.strtoupper($value['month'])." - ".$value['year'].' </h4>
                         </td>                          
                        </tr>
                        <tr>
                          <td colspan=8 align="center"> <h4>
                        ...
                        <tr>
                         <td colspan=8 align="center"> <h3><b>
                               HALL NO  : '.$value['hall_name'].' </b></h3>
                         </td>                          
                        </tr>
                        
                        <tr>
                         <td width="20px" align="left"> S.NO </td>
                         ...
                         <td width="70px" align="left"> '.strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT)).' CODE </td> 
                         <td width="190px" colspan=3 align="left"> ANSWER BOOK NO </td> 
                         <td width="70px" align="left"> '.strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT)).'\'S SIGNATURE </td>  
                        </tr>
                        ';
                        $body .='
                        <tr>
                            <td width="20px" align="left"> '.$value['seat_no'].'</td>
                            <td width="125px" align="left" > '.strtoupper($value['register_number']).'</td>
                            <td width="150px" align="left"> '.strtoupper($value['name']).'</td>
                            <td width="70px" align="left"> '.strtoupper($value['subject_code']).'</td>
                        ...
                        <tr><td colspan=8 height="50px">&nbsp;</td></tr>
                        <tr>
