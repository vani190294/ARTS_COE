...
<?php Yii::$app->ShowFlashMessages->showFlashes();?>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="col-lg-2 col-sm-2">
                <?php $markEntry->term='34'; $markEntry->mark_type='27'; ?>
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="col-lg-2 col-sm-2">
                <?= $form->field($markEntry, 'semester')->textInput(['onblur'=>'getViewInternalArrearSubs(this.value);','name'=>'exam_semester']); ?>
                ...
                <?php echo $form->field($markEntry, 'subject_map_id')->widget(
                    Select2::classname(), [
                        'options' => [
                            ...
                            'name'=>'sub_val',
                            'onchange' => 'getViewIntArrearStuList();'
            ...
            <br />
                ...
                <div class="btn-group col-lg-2 col-sm-2" role="group" aria-label="Actions to be Perform">
                    <?= Html::a("Reset", Url::toRoute(['categorytype/view-internals']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
                </div>
        ...
        <div class="row">
            <div id='disp_show_details_subs' class="col-xs-12 col-sm-12 col-lg-12">
                ...
                <?= Html::submitButton('Updated & Save', ['id'=>'change_style_int','class' => 'btn btn-success' ]) ?>
            </div>
        </div>
