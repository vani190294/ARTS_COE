...
<div class="box-body"> 
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
                    ...
                    <?= $form->field($model, 'from_regulation_id')->widget(
                            Select2::classname(), [  
                                ...
                                'options' => [
                                    ...
                                    'onchange'=>'getregulation(); getmappedsubject();'
                                ],
                               'pluginOptions' => [
                                   'allowClear' => true,
                                ],
                            ])->label("Regulation(Batch)") ?>
             ...
             <div class="col-md-2">
                    ...
                    <?= $form->field($model, 'from_subject_code')->widget(
                                ...
                                'options' => [
                                    ...
                                    'onchange'=>'gettosyllabisubject();'
                                ],
                               'pluginOptions' => [
                                   'allowClear' => true,
                                ],
                            ])->label("Mapped Syllabi") ?>
            </div>           
           ...
           <div class="col-md-2 form-group"><br>
            ...
            <?= Html::a('Cancel', ['pre-index'], ['class' => 'btn btn-warning']) ?>
        </div>
        </div>
