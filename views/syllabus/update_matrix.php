...
$this->title = 'Update Syllabus Matrix';
                    ...
                    <table border="1" width="100%">
                        ...
                        <?php $html='';
                                ...
                                for($l=1;$l<=6;$l++)
                                {
                                    ...
                                    $co_matrixdata = Yii::$app->db->createCommand("SELECT * FROM cur_course_articulation_matrix WHERE co='".$coo."' AND coe_dept_id ='".$coe_dept_id."' AND cur_syllabus_id=".$codatalist['cur_syllabus_id'])->queryOne();
                                    ...
                                    if($codatalist[$cot]!='')
                                    {
                                        ...
                                        $pso_value=(!empty($co_matrixdata['pso_value']))?explode(",", $co_matrixdata['pso_value']):$colspan;
                                        
                                        $pi=0;
                                        for ($p=1; $p <=$co_matrixdata['pso_count'] ; $p++) 
                                        {
                                            $select='';$select1='';$select2='';

                                             $psoname="pso_matrix".$p.$l."[]";

                                            if($pso_value[$pi]==1){$select='selected';}
                                            if($pso_value[$pi]==2){$select1='selected';}
                                            if($pso_value[$pi]==3){$select2='selected';}
           ...
           <?php if($degree_type=='PG')
            {
                ...
                <div class="col-xs-12 col-sm-12 col-lg-12">
                    ...
                    <table border="1" width="100%">
                        <tr>
                            <th rowspan="2" width="10%" style="text-align: center;">Course Outcome (CO)</th>
                             <th colspan="4" width="50%" style="text-align: center;">Programme Outcomes (PO)</th>
         ...
         <?php } ?>
           ...
           <?php if($degree_type=='MBA')
            ...
            <input type="hidden" name="degree_type" value="<?= $degree_type;?>">
                ...
                <div class="form-group pull-right"><br>
                    <?= Html::submitButton('Finish', ['id'=>'finishsyllabus','name'=>'finishsyllabus','class' => 'btn btn-primary']) ?>
