...
$this->title = 'Create Service Syllabus Matrix';
                                        ...
                                        for($l=1;$l<=6;$l++)
                                            {
                                                ...
                                                $co_matrixdata = Yii::$app->db->createCommand("SELECT * FROM cur_course_service_matrix WHERE co='".$coo."' AND cur_syllabus_id=".$codatalist['cur_syllabus_id'])->queryOne();
