...
$this->title = 'View';
$this->params['breadcrumbs'][] = ['label' => 'Syllabus', 'url' => ['service-index']];
...
<div class="cur-syllabus-view">
    ...
    <div class="box-body"> 
        ...
        <div class="col-lg-1" > <?= Html::a('<i class="fa fa-book"></i> Back', ['/syllabus/service-index'], [
            ...
            if(!empty($codatalist)) 
            {
                ...
                $html.='<table class="table" width="100%">
                   ...
                   $html.=' <tr>
                    ...
                    {
                        //print_r($codatalist['module_title1']); exit();
                          $html.='<tr>
                                <td colspan="4">
                                    <b>Cource Content:</b>
                                </td>
                        ...
                        for($l=1;$l<=3;$l++)
                        {
                            ...
                            if($codatalist[$module_title]!='' && $codatalist[$module_hr]!='' && $codatalist[$module_content]!='')
                            {
                                ...
                                $html.='<tr>';
                                $html.='<td width=80% colspan=3><b>Module Title '.$l.': </b>'.$codatalist[$module_title].'</td>';
                   ...
                   $html.=' <tr>
                    ...
                    if(!empty($codatalist)) 
                    {
                     ...
                     $html.=' </table> ';
                    $co_matrix_dept = Yii::$app->db->createCommand("SELECT A.coe_dept_id,B.dept_name,B.degree_type FROM cur_course_service_matrix A JOIN cur_department B ON B.coe_dept_id=A.coe_dept_id WHERE cur_syllabus_id=".$cur_syllabus_id." GROUP BY A.coe_dept_id")->queryAll();
