...
$this->title = 'Update Service Syllabus Matrix';
                    ...
                    <table border="1" width="100%">
                        ...
                        <?php $html='';
                                ...
                                for($l=1;$l<=6;$l++)
                                {
                                    ...
                                    $co_matrixdata = Yii::$app->db->createCommand("SELECT * FROM cur_course_service_matrix WHERE co='".$coo."' AND coe_dept_id ='".$coe_dept_id."'  AND cur_syllabus_id=".$codatalist['cur_syllabus_id'])->queryOne();
