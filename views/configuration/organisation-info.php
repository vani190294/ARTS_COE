    ...
    <div class="row">
      ...
      <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-lg-4">
             ...
             <div class="col-xs-12 col-sm-4 col-lg-4">
                <?= $form->field($model, 'org_tagline')->textInput(['maxlength' => true,'placeholder'=>'An Autonomous college Affiliated to Bharathiyar University Re-Accredited by NAAC with "A" Grade An ISO 9001:2008 Certified Institution','style'=>'resize: none;','required'=>'required','id'=>'org_tagline','value'=>$org_tagline,'disabled'=>$status]) ?>
            </div>       
