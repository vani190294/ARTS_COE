    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
                ...
                <?php echo $form->field($model, 'subject_map_id')->widget(
                    Select2::classname(), [
                        'options' => [
                            ...
                            'name'=>'sub_val',
                            'onchange' => 'getExternalEnggStudentsList();',
                        ],
                        'pluginOptions' => [
                            'allowClear' => true,
        ...
        <br />
                <div class="btn-group col-lg-2 col-sm-2" role="group" aria-label="Actions to be Perform">
                    ...
                    <?= Html::a("Reset", Url::toRoute(['mar-entry-master/external-markentry-engg']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
                </div>
        </div>
