...
$this->registerCssFile("@web/css/consolidate-markstatement-pg.css");
?>
...
{       
    ...
    $credits_register_row = $credits_earned_row = $sgpa_row = $cumulative_row = '';
            echo Html::a('<i class="fa fa-file-pdf-o"></i> Print Pdf', ['/mark-entry-master/skcet-consolidate-mark-sheet-pg-pdf'], [
                ...
                {                    
                    ...
                    if($new_stu_flag > 1) 
                    {
                        ...
                        $cumulative_row = "<tr height='15px'>
                            <td  width='20px' height='15px' valign='top' align='left' > &nbsp; </td>
                            <td class='cumulative_credits' colspan='4' height='15px' valign='top' align='left'  > <b>" . $cgpa_calc['consolidate_cre'] . "</b> </td>
                            <td width='60px' class='cumulative_cgpa'  height='15px' colspan='3' align='left' valign='top' > <b>" . $cgpa_calc['final_cgpa'] . "</b> </td>
                            <td colspan='3' class='print_classification' align='center' ><b>" . $classification . " </td>
                        ...
                        if(!empty($check_add))
                        {
                            ...
                            foreach ($check_add as $valuess) 
                            {
                                ...
                                <tr>
                                    ...
                                    <td width='85px'  align='left' >" . strtoupper($valuess['subject_code']) . "</td>
                                    <td width='300px' class='".$change_class."' colspan='5'  align='left'>" . $subject_name_print . "</td>
                                    <td width='50px'  align='left'>" . $valuess['credits']  . "</td>
                                    <td width='50px'  align='left'> " . strtoupper($valuess['grade_name']) . " </td>
                                    <td width='50px'  align='left'>" . $grade_point_print. "</td>
                                    <td width='52px'  align='right'>" . $year_of_passing . "</td>
                                </tr>
                                </table>";
                            }
                            $body .= "
                            <table border=0  >
                                <tr>
                                    ...
                                    <td colspan='4' width='80px'  align='right'>&nbsp;</td>
                                </tr>
                                <tr>
                        ...
                        $merge_body = "<tr><td width='100%' valign='top' colspan='11' height='725px' >" . $body . "</td></tr>";
         ...
         $year_of_passing = ConfigUtilities::getYearOfPassing($value['year_of_passing']);
                ...
                $body .= "
                    <table class='subjects_tables' border='0' width='100%' >
                        <tr>
                            ...
                            <td width='85px'  align='left' >" . $value['subject_code'] . "</td>
                            <td width='300px' colspan='5'  align='left'>" . strtoupper($value['subject_name']). "</td>
           ...
           else
           {
                ...
                $body .= $add_tr_starting."
                    ...
                    <tr>
                        <td  width='40px' align='left'>" . $semester_array[$value['semester']]. "</td>
                        <td width='85px'  align='left' >" . strtoupper($value['subject_code']) . "</td>
                        <td width='300px' style='".$line_height_sub."' colspan='5'  align='left'>" . strtoupper($value['subject_name']) . "</td>
    ...
    if(!empty($check_add_last))
    {
        ...
        foreach ($check_add_last as $valuess) 
        {
            ...
            <tr>
                <td  width='40px' align='left'>" . $semester_array[$sem_nu]. "</td>
                <td width='85px'  align='left' >" . strtoupper($valuess['subject_code']) . "</td>
                <td width='300px' colspan='5'  align='left'>" . $subject_name_print . "</td>
                <td width='50px'  align='left'>" . $valuess['credits']  . "</td>
                <td width='50px'  align='left'> " . strtoupper($valuess['grade_name']) . " </td>
                <td width='50px'  align='left'>" . $grade_point_print. "</td>
                <td width='52px'  align='right'>" . $year_of_passing . "</td>
