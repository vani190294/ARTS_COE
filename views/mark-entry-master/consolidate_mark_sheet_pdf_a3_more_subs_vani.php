                        ...
                        if(!empty($get_console_list_man))
                        {
                            ...
                            foreach ($get_console_list_man as $key => $mandato) 
                            {
                                ...
                                <tr>
                                    ...
                                    <td valign='top'  class='line_height subjects_tables gradepoint' width='250px'  style='padding-left:-15px;'  colspan=2 >".strtoupper($man_year_of_passing)." </td>
                                </tr>
                                </table>";
                                $total_sub_count++;
                            }
                            ...
                            if(!empty($get_console_list_man))
                            {
                                ...
                                foreach ($get_console_list_man as $key => $mandato) 
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td valign='top'  class='line_height subjects_tables gradepoint' width='80px' >".strtoupper($mandato['grade_name'])." </td>
                                        <td valign='top'  class='line_height subjects_tables gradepoint' width='80px' >".strtoupper($mandato['grade_point'])." </td>
                                        <td valign='top'  class='line_height subjects_tables gradepoint'  style='padding-left:-15px;'  width='250px' colspan=2 >".strtoupper($man_year_of_passing)." </td>
                                    </tr>
                                    </table>";
                                    $total_sub_count++;
                                }
                    ...
                    $is_arrear_printed = 1;
                            ...
                            if(count($check_add_pass)>0 && !empty($check_add_pass) && $additional_creditsPrinte==0)
                            {
                                ...
                                foreach ($check_add_pass as $key => $mandato) 
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td valign='top'  class='line_height subjects_tables gradepoint' width='80px' >".strtoupper($mandato['grade_name'])." </td>
                                        <td valign='top'  class='line_height subjects_tables gradepoint' width='80px' >".strtoupper($mandato['grade_point'])." </td>
                                        <td valign='top'  class='line_height subjects_tables gradepoint' width='250px' style='padding-left:-15px;' ssscolspan=2 >".strtoupper($man_year_of_passing)." </td>
                                    </tr>
                                    </table>";
                                    $total_sub_count++;
                       ...
                       if(isset($_SESSION['transcript']) && $_SESSION['transcript']==1)
                        ...
                        <tr>
                            ...
                            <td valign='top'   class='line_height print_cgpa_size makeitBigger' colspan=7 width='480px'  > ".$total_credits_cgpa." </td>
               ...
               if($value['ESE_max']==0 && $value['CIA_max']==0)
               {
                    ...
                    <table style='line-height: 1.2em; ' border='0' width='100%'  >
                        <tr>
                            ...
                            <td valign='top'  class='line_height subjects_tables subject_code' width='120px' >".$value['subject_code']."</td>
                    ...
                    $subject_name_print = "<b>".strtoupper(nl2br($sub_na))."</b>";
                        ...
                        <table style='line-height: 1.2em; ' border='0' width='100%' >
                            <tr>
                                ...
                                <td valign='top'  class='line_height subjects_tables gradepoint'  width='250px' style='padding-left:-15px;'  colspan=2 >".$year_of_passing."</td>
                            </tr>
                        </table>    
                    ";
                    $total_sub_count++;
