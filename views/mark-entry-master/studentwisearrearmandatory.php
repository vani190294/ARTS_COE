...
$this->title = 'MANDATORY COPY ARREAR LIST';
$this->params['breadcrumbs'][] = ['label' => 'INTERNET COPY ARREAR LIST', 'url' => ['create']];
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="form-group col-lg-3 col-sm-3">
                ...
                <?= Html::a("Reset", Url::toRoute(['mark-entry-master/studentwisearrear']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
        </div>
