...
<?php Yii::$app->ShowFlashMessages->showFlashes(); 
    ...
    $add_tr_starting = $print_trimester == 1 ? "<tr><td class='make_bold_font' id='print_trimester' colspan='26'> TRIMESTER PATTERN </td></td></tr>" : "<tr><td class='make_bold_font' id='no_print_trimester' colspan='26'> &nbsp; </td></tr>";
    if($file_content_available=="Yes")
    {
        ...
        $app_month='';
        $batch_mapping_id = $withDrawStatus = $add_star_text ='' ;
        $total_sub_count = 0;
        $first_reg_no = 0;
        $cgpa_calc = [];
        ...
        foreach ($get_console_list as $value) 
        {
            ...
            if($previous_reg_number!=$value['register_number'])
            {
                $files = glob($absolute_dire.$value['register_number'].".*"); // Will find 2.JPG, 2.php, 2.gif
                    ...
                    if($new_stu_flag > 1) 
                    {
                        ...
                        $check_add = Yii::$app->db->createCommand('SELECT * FROM coe_additional_credits WHERE   student_map_id="'.$prev_stu_map_id.'" and result like "%pass%" and exam_year="'.$prev_exam_year.'" and exam_month="'.$prev_exam_mont.'" ')->queryAll();
                        ...
                        {                           
                            ...
                            <table border=0  >
                                <tr>
                                    <td valign='top'  colspan='13'  width='180px' align='left'>&nbsp;</td>
                                </tr>
                            </table>
                            <table border=0  >
                                <tr>
                                    <td valign='top'  colspan='4'  width='180px' align='left'>&nbsp;</td>
                                    <td valign='top'  class='make_bold_font'  width='600px' colspan='5'  align='left' >*CUMULATIVE ADDITIONAL CREDITS EARNED : ".$cgpa_calculation['cumulative_normal_additional_credits']."</td>
                        ...
                        if($withDrawStatus==1)
                        {
                            ...
                            <table border=0   >
                                <tr>
                                    <td valign='top'  colspan='4'  width='75px' align='left'>&nbsp;</td>
                                    <td valign='top'  class='make_bold_font'  width='600px' colspan='5'  align='center'> @ Permitted to Withdraw to Appear in the Next Semester </td>                            
                                    <td valign='top'  colspan='4' width='170px'  align='right'>&nbsp;</td>
                                </tr>
                            </table>";
                        }
                        ...
                        $header =$body_1 = $add_body_1 = $body_2 = $withDrawStatus= $add_star_text = "";
                        $body ="";
                        $footer = "";
            ...
            $course_batch_mapping_id =  CoeBatDegReg::findOne($batch_mapping_id);
            $degree_years = Degree::findOne($course_batch_mapping_id->coe_degree_id);
            $total_degree_years = $degree_years->degree_total_years;
            $total_semesters = $degree_years->degree_total_semesters;
            if(isset($_SESSION['transcript']) && $_SESSION['transcript']==1)
            {
                $header.='<td valign="top" class="bring_to_the_right" height="150" colspan="13">
                        ...
                        <tr>
                            ...
                            <td valign="top" width="100" class="this_should_be_up push_regulation make_bold_font" colspan="6">'.strtoupper($value["register_number"]).'</td>
                            <td valign="top" colspan="3" class="push_regulation make_bold_font  " style="text-align: left;" >'.$value["regulation_year"].'</td>
                        </tr>
                        <tr>
                            <td valign="top"  colspan="3" width="100" >&nbsp;</td>
                            <td valign="top" width="100" style="padding-top: 8px;" class="this_should_be_up push_regulation  make_bold_font move_gender" colspan="6">'.$print_gender.'</td>
                            <td valign="top" colspan="3" class="push_regulation make_bold_font " style="text-align: left;" >'.$last_appearance.'</td>
                        </tr>
                        <tr>
                            <td valign="top"  colspan="3" width="100" >&nbsp; </td>
                            <td valign="top" width="100" class="this_should_be_up make_bold_font bring_transcript" colspan="6">'.$total_degree_years.' YEARS / '.$total_semesters.' SEMESTERS</td>
                            <td valign="top" colspan="3"  class="make_bold_font  " style="text-align: left;" >&nbsp; </td>
            ...
            $header.='</tr><tr><td valign="top"  colspan="26" height="'.$height.'" >&nbsp;</td></tr>'; //main tr
            ...
            $total_credits ='';
             ...
             $getStatus = ConfigUtilities::checkWithDrawStatus($value['student_map_id'],$value['subject_map_id']);
             if($getStatus=='YES')
             {
                $withDrawStatus = 1;
                $add_star_text = '@ ';
               ...
               if($value['ESE_max']==0 && $value['CIA_max']==0)
               {
                    ...
                    <table style='line-height: 1.0em; ' border='0' width='100%'  >
                        <tr>
                            ...
                            <td valign='top'  class='line_height subjects_tables' width='665px' colspan=6 >".strtoupper($value['subject_name'])." $add_star_text</td>
            ...
            $year_of_passing = ConfigUtilities::getYearOfPassing($value['year_of_passing']); 
            if($total_sub_count>=40 || $value['semester']>4 )
            {
                ...
                {   
                    if($same_semester==4)
                    {
                        ...
                        $exam_year = $prev_exam_year;
                        $exam_month = $prev_exam_mont;        
