...
$this->title=ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT)." Result Analysis";
...
<div>&nbsp;</div>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">        
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
            <div class="btn-group col-lg-3 col-sm-3" role="group" aria-label="Actions to be Perform">
                ...
                <input type="button" id="crseanalysisbutton_marks" name="crseanalysisbutton" class="btn btn-success" value="Submit">
                <?= Html::a("Reset", Url::toRoute(['mark-entry-master/courseanalysis']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12 crse_analysis_print_btn">
        <div class="col-xs-3 col-sm-10 col-lg-10">
        </div>    
        <div class="col-xs-3 col-sm-2 col-lg-2">
            <?php 
                echo Html::a('<i class="fa fa-file-excel-o"></i> ' ."Excel",array('excel-courseanalysis','exportPDF'=>'PDF'),array('title'=>'Export to Excel','target'=>'_blank','class'=>'btn btn-info', 'style'=>'color:#fff'));
                echo Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['/mark-entry-master/course-analysis-pdf'], [
