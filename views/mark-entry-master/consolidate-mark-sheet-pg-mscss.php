...
$image_path = parse_url($url, PHP_URL_SCHEME)."://".parse_url($url, PHP_URL_HOST).":".parse_url($url, PHP_URL_PORT).$removed_path.'css/consolidate-markstatement-pg.css'; 
...
{       
      ...
      //print_r($get_console_list);exit;
        ...
        $page2='';
        $page3='';
        $page11=$page22=$page33=$print_stu_data1='';
        $count_suject=count($get_console_list);
        $div_b=ceil($count_suject/3)+7;

   //$div_b=1;
  // print_r($div_b);exit;

            $html = $body_1 = $body_2 = "";
            $additional_credit_count=0;
            $cumulative_part = '';
    ...
    $credits_register_row = $credits_earned_row = $sgpa_row = $cumulative_row = '';
            ...
            foreach ($get_console_list as  $value) 
            {
                          ...
                          $body_1 .="<table style='line-height: 1.0em; ' border='0' width='100%' >
                            ...
                            foreach ($check_add as $valuess) 
                            {
                                 ...
                                 // $year_of_passing = ConfigUtilities::getYearOfPassing($valuess['year_of_passing']);
                                   if($valuess['year_of_passing']=="29-2022")
                                   {
                                           $year_of_passing="JUNE-2022";
                                   }
                                  elseif ($valuess['year_of_passing']=="29-2023")
                                    {
                                          
                                           $year_of_passing="MAY-2023";
                                    }
                               else{
                                             $year_of_passing = ConfigUtilities::getYearOfPassing($valuess['year_of_passing']);
                                    }
                                 ...
                                 // $subject_name_print = "<b>".strtoupper($sub_na)."</b>";
                                   ...
                                   $subject_name_print= wordwrap($str,40,"<br>\n");
              ...
              $body_1 .=" 
                <table style='line-height: 1.0em; ' class='additional' border='0' width='100%' >
                   <tr>
                        
                        <td valign='top' width='35px' align='left' class='semester'><b>" . $semester_array[$valuess['semester']]. "</b></td>
                        ...
                        <td valign='top' width='65px' class='credit_points_add' align='center'><b>" . $credit_points . "</b></td>
                        <td valign='top' width='75px' class='ese_max_disp' align='center'><b>" . $ese_max_disp . "</b></td>
                        <td valign='top' width='20px' class='cia_max_disp_add' align='center'><b>" . $cia_max_disp . "</b></td>
                        <td valign='top' width='90px' class='total_max_disp' align='center'><b>" . $total_max_disp . "</b></td>
                        <td valign='top' width='20px' class='disp_ese' align='center'><b>" . $disp_ese . "</b></td>
                        <td valign='top' width='93px' class='disp_cia' align='center'><b>" . $disp_cia . "</b></td>
                        ...
                        <td valign='top' width='50px'  align='left' class='grade_name'><b> " . $valuess['grade_name'] . " </b></td>
     ...
     /*  $body_1 .="<table style='line-height: 1em; ' class='subjects_tables' border='0' width='100%' >
      <tr>
                ...
                <td width='95px'  align='left'>&nbsp;</td>
                        ...
                        <td valign='top'  colspan=16 width='100px;' > &nbsp; </td></tr></table>";
                        $part_info = ConfigUtilities::getPartDetails($previous_reg_number,3);
                        $cahnge_width ='325px';// strlen($part_info['part_class'])>=13?'180px':'325px';
                      ...
                      if(empty($checkData))
                       {
                        ...
                        $cumulative_part_star="<table style='line-height: 1.0em; ' border='0' width='100%' ><tr>
                    <td valign='top'  colspan=16 width='100px;' > &nbsp; </td></tr></table>
                    <table style='line-height: 1.0em;' class='makeitBigger' border='0' width='100%' > 
              <tr>
                <td valign='top'  class='line_height_print_cgpa_size1' colspan=2  width='90px;' > *** </td>
                <td valign='top'   class='line_height_print_cgpa_size1 ' colspan=6 width='".$cahnge_width."'  > REFER NEXT PAGE </td>
                <td valign='top'  class='line_height_print_cgpa_size1' colspan=2  width='80px;' > *** </td>
                <td valign='top'  class='line_height_print_cgpa_size1' colspan=2  width='70px;' > *** </td>
                <td valign='top'  class='line_height_print_cgpa_size1' colspan=2  width='80px;' > ***  </td>
                <td valign='top'   class='line_height_print_cgpa_size1' colspan=2 width='80px;'  ></td>                                                             
            </tr>
              </table>";
                        /*$merge_two_body_tags = "<tr>".$body_1."</td></tr>";
                       ...
                       // print_r($cumulative_part);exit;
                        ...
                        $print_stu_data1.="<pagebreak sheet-size='A4-P' >";
                        $print_stu_data.= $html.$cumulative_part."<pagebreak sheet-size='A4-P' >";*/
                    ...
                    $header.='<td valign="top"  height="160px" colspan="16">'; //first td
                     $header.='<table class="makeitBigger" width="100%">
                                <tr>
                                  ...
                                  <td valign="top" class="student_name"colspan=3 align="left" width="100" >2018-2023</td>
                                </tr>
        ...
        // $year_of_passing = ConfigUtilities::getYearOfPassing($value['year_of_passing']);
          if($value['year_of_passing']=="29-2022")
            {
                                           
                $year_of_passing="JUNE-2022";

              }
              elseif ($value['year_of_passing']=="29-2023")
              {
          ...
          if($value['CIA_max'] == 0 && $value['ESE_max'] == 0)
            {
                ...
                <table style='line-height: 1.0em; ' border='0' width='100%'  >
                    <tr>
                      <td valign='top' width='35px' align='left' class='semester'><b>" . $semester_array[$value['semester']]. "</b></td>
           ...
           else
           {
                ...
                <table style='line-height: 1.0em; ' border='0' width='100%' >
                    <tr>                       
                        ...
                        <td valign='top' width='53px' class='total_disp_res'  align='center'><b>" . $total_disp_res . "</b></td>
                        <td valign='top' width='60px'  align='center' class='grade_point'><b>" . $grade_point_print  . "</b></td>
                        <td valign='top' width='50px'  align='left' class='grade_name'><b> " . $value['grade_name'] . " </b></td>
                        <td valign='top' width='95px' class='print_month_year'  align='center'><b>" . strtoupper($year_of_passing) . "</b></td>
                    </tr>
                </table>";
                $total_sub_count++;
   ...
   if($value['year_of_passing']=="29-2022")
       ...
       elseif ($value['year_of_passing']=="29-2023")
      {
        ...
        //$subject_name_print = "<b>".strtoupper(mb_convert_encoding($value['subject_name'],"HTML-ENTITIES","UTF-8"))."</b>";
          ...
          $total_disp_res = ($value['total']==0 || $value['total']=="") ? '--':$stu_total;
           $grade_point_print = strlen($value['grade_point'])==2 ?$value['grade_point'].".0":(strlen($value['grade_point'])==1 ?$value['grade_point'].".0":$value['grade_point']);
           if($div_b==$subject_loop)
              {
                //echo "<br>".$subject_loop;
                $subject_loop=0;
                $body_1.="</table>";
                //$body_1.="<pagebreak>";
                ...
                $body_1='';
                $body_1.=$header."<tr><td valign='top' colspan='16' width='100%' style='padding-top:12px !important;'>";
         ...
         if($same_semester==$value['semester'])
            {   
                ...
                $body_1.="<tr><td valign='top' colspan='16' width='100%'>";
                $body_1 .=" 
                        <table style='line-height: 1.0em; ' border='0'  width='100%' >
         ...
         if($value['CIA_max'] == 0 && $value['ESE_max'] == 0)
           ...
           else
           {
              if($pagecount==3)
              {
                  ...
                  $body_1 .=" 
                    <table style='line-height: 1.0em; ' border='0' class='page333' width='100%' >
                    <tr>                       
                        <td valign='top' width='35px'  align='left' class='semester3'><b>" . $semester_array[$value['semester']]. "</b></td>
                        <td valign='top' width='90px' class='subject_code' align='center'><b>" . strtoupper($value['subject_code']) . "</b></td>
                        <td valign='top' class='subject_name' width='280px' colspan='3'  align='left'><b>" . $subject_name_print . "</b></td>
                         <td valign='top' width='60px' class='credit_points' align='center'><b>" . $credit_points . "</b></td>
                        <td valign='top' width='60px'  class='ese_max_disp' align='center'><b>" . $ese_max_disp . "</b></td>
                      <td valign='top' width='60px' class='cia_max_disp'  align='center'><b>" . $cia_max_disp . "</b></td>
                        <td valign='top' width='60px' class='total_max_disp3' align='center'><b>" . $total_max_disp . "</b></td>
                        <td valign='top' width='60px' class='disp_ese3' align='center'><b>" . $disp_ese . "</b></td>
                        <td valign='top' width='53px' class='disp_cia3' align='center'><b>" . $disp_cia . "</b></td>
                        <td valign='top' width='53px' class='total_disp_res3' align='center'><b>" . $total_disp_res . "</b></td>
                        <td valign='top' width='60px'  align='center' class='grade_point'><b>" . $grade_point_print . "</b></td>
                        <td valign='top' width='50px'  align='left' class='grade_name'><b> " . $value['grade_name'] . " </b></td>
                        <td valign='top' width='95px' class='print_month_year'  align='center'><b>" . strtoupper($year_of_passing) . "</b></td>
                    </tr>
    ...
    /*  $body_1 .="<table style='line-height: 1em; ' class='subjects_tables' border='0' width='100%' >
      <tr>
                ...
                <td valign='top' width='50px' align='left'>&nbsp;</td>
                <td valign='top' width='95px'  align='left'>&nbsp;</td>
                <td valign='top' width='380px' colspan='4'  align='center'><b>**IV Semester Examinations held in September-2020 & Supplementary & Arrear Examinations held in December-2020**</b><b>**IV Semester Examinations held in September-2020 & Supplementary & Arrear Examinations held in December-2020**</b></td>
                <td valign='top' width='50px'  align='left'>&nbsp;</td>
                <td valign='top' width='50px'  align='left'>&nbsp;</td>
                <td valign='top' width='50px'  align='left'>&nbsp;</td>
                <td valign='top' width='50px'  align='left'>&nbsp;</td>
  ...
  if(empty($checkData))
   {
    ...
    $cumulative_part_star="<table style='line-height: 1.0em; ' border='0' width='100%' ><tr>
      ...
      <tr>
        <td valign='top'  class='line_height_print_cgpa_size1' colspan=2  width='90px;' > *** </td>
        <td valign='top'   class='line_height_print_cgpa_size1 ' colspan=6 width='".$cahnge_width."'  style=' font-size: 12px !important;'> REFER NEXT PAGE </td>
        <td valign='top'  class='line_height_print_cgpa_size1' colspan=2  width='80px;' > *** </td>
        <td valign='top'  class='line_height_print_cgpa_size1' colspan=2  width='70px;' > *** </td>
        <td valign='top'  class='line_height_print_cgpa_size1' colspan=2  width='80px;' > ***  </td>
        <td valign='top'   class='line_height_print_cgpa_size1' colspan=2 width='80px;'  ></td>                                                             
...
$page11=$header ."<tbody><tr>".$page1."</tr></tbody></table>";
    $print_stu_data1.="<div class='myfixed'>".$page11."</div><div  class='myfixed1'>".$cumulative_part_star."</div><pagebreak>";
    $page22="<tbody>".$page2."</td></tr></tbody></table>";
    $print_stu_data1.="<div class='myfixed'>".$page22."</div><div  class='myfixed2'>".$cumulative_part_star."</div><pagebreak>"; 
    $page33="<tbody>".$page3."</td></tr></tbody></table>";
    $print_stu_data1.="<div class='myfixed11'>".$page33."</div><div  class='myfixed3'>".$cumulative_part."</div>";
    $print_stu_data =$print_stu_data1;
   //print_r($page11);exit;
    $header = $body = $body_1 = $html = $cumulative_part = $footer = $add_body_1 = $body_2 = "";             
    $page11=$page22=$page33=$print_stu_data1='';   
