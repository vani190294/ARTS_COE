...
<?php Yii::$app->ShowFlashMessages->showFlashes(); 
 require(Yii::getAlias('@webroot/includes/use_institute_info.php'));
    ...
    if($file_content_available=="Yes")
    {
        ...
        $body ="";
        $footer = "";
        $det_disc_type = Yii::$app->db->createCommand("select coe_category_type_id from coe_category_type where category_type like '%Discontinue%'")->queryScalar();
 ...
 foreach ($get_console_list as $value) 
        {
		  ...
		  if($first_reg_no==0)
            {
			$cgpa_calculation = ConfigUtilities::getCgpaCaluclationtransfer1($value['course_batch_mapping_id'],$value['student_map_id'],$value['semester'],$value['exam_year'],$value['exam_month']);
               $first_reg_no=5;
			 ...
			 if($previous_reg_number!=$value['register_number'])
            {
                $files = glob($absolute_dire.$value['register_number'].".*"); // Will find 2.JPG, 2.php, 2.gif
                    ...
                    if($new_stu_flag > 1) 
                    {
                        ...
                        $final_cgpa = $cgpa_calculation['final_cgpa'];
                        $total_credits_cgpa = $cgpa_calculation['transfer_cumulative'];
                        ...
                        if(!empty($get_console_list_man))
                        {
                            ...
                            foreach ($get_console_list_man as $key => $mandato) 
                            {
                                ...
                                <tr>
                                    ...
                                    <td valign='top'  class='line_height subjects_tables credit_2' width='80px' >".strtoupper($mandato['grade_name'])." </td>
                                    <td valign='top'  class='line_height subjects_tables credit_2' width='80px' >".strtoupper($mandato['grade_point'])." </td>
                            ...
                            if(!empty($get_console_list_man))
                            {
                                ...
                                foreach ($get_console_list_man as $key => $mandato) 
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td valign='top'  class='line_height subjects_tables credit_2' width='80px' >".strtoupper($mandato['grade_name'])." </td>
                                        <td valign='top'  class='line_height subjects_tables credit_2' width='80px' >".strtoupper($mandato['grade_point'])." </td>
                                        <td valign='top'  class='line_height subjects_tables passing' width='250px' colspan=2 >".strtoupper($man_year_of_passing)." </td>
                                    </tr>
                                    </table>";
                                    $total_sub_count++;
                                }
                        ...
                        <tr>
                            ...
                            <td valign='top'   class='line_height print_cgpa_size makeitBigger trcredit' colspan=7 width='400px'  > ".$total_credits_cgpa." </td>
                            
                            <td valign='top'   class='line_height print_cgpa_size makeitBigger PRINT_finalfinal_cgpa trcredit' colspan=6 width='100px;'  >".$final_cgpa."</td>
                            <td valign='top' colspan=10 class='line_height print_cgpa_size'  >".$cahnge_text."</td>                                       
                        </tr>
                        <tr>
                            <td valign='top'  colspan=2 width='200px'  > &nbsp; </td>
                            <td valign='top'  class='print_classification print_cgpa_size makeitBigger class' valign='top' colspan=6 height=123px >".$classification."</td>
                    ...
                    $subject_name_print = "<b>".strtoupper(nl2br($sub_na))."</b>";
                        ...
                        <table style='line-height: 1.2em; ' border='0' width='100%' >
                            <tr>
                                ...
                                <td valign='top'  class='line_height subjects_tables' width='80px' >".$value['credit_points']."</td>
                                <td valign='top'  class='line_height subjects_tables' width='80x' >".$value['grade_name']."</td>
                                <td valign='top'  class='line_height subjects_tables credit_2' width='80x' >".$value['grade_point']."</td>
                                <td valign='top'  class='line_height subjects_tables passing' width='250px' colspan=2 >".$year_of_passing."</td>
                            </tr>
                        </table>    
                    ";
                    $total_sub_count++;
                            ...
                            foreach ($get_console_list_man as $key => $mandato) 
                            {
                                ...
                                if($prev_man_sub_codde!=$mandato['subject_code'])
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td valign='top'  class='line_height subjects_tables' width='680px' colspan=6 >".strtoupper($mandato['subject_name'])."</td>
                                        <td valign='top'  class='line_height subjects_tables' width='80px' >&nbsp;</td>
                                        <td valign='top'  class='line_hesight subjects_tables' width='80px' >&nbsp;</td>
                                        <td valign='top'  class='line_height subjects_tables' width='80px' >&nbsp;</td>
                                        <td valign='top'  class='line_height subjects_tables' width='250px' colspan=2 >&nbsp;</td>
                                    </tr>
                                    </table>";
                    ...
                    $subject_name_print = "<b>".strtoupper(nl2br($sub_na))."</b>";
                        ...
                        <table style='line-height: 1.2em; ' border='0' width='100%' >
                            <tr>
                                ...
                                <td valign='top'  class='line_height subjects_tables credit_2' width='80x' >".$value['grade_name']."</td>
                                <td valign='top'  class='line_height subjects_tables credit_2' width='80x' >".$value['grade_point']."</td>
                                <td valign='top'  class='line_height subjects_tables passing' width='250px' colspan=2 >".$year_of_passing."</td>
                            </tr>
                        </table>    
