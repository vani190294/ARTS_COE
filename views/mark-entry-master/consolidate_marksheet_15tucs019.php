        ...
        foreach ($get_console_list as $value) 
        {
          ...
          //print_r($esrned_credits);exit;
                        ...
                        if(!empty($get_console_list_man))
                        {
                            ...
                            foreach ($get_console_list_man as $key => $mandato) 
                            {
                                ...
                                <tr>
                                    ...
                                    <td valign='top'  class='line_height subjects_tables gradepoint' width='250px'  style='padding-left:-20px;'  colspan=2 >".strtoupper($man_year_of_passing)." </td>
                                </tr>
                                </table>";
                                $total_sub_count++;
                            }
                            ...
                            if(!empty($get_console_list_man))
                            {
                                ...
                                foreach ($get_console_list_man as $key => $mandato) 
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td valign='top'  class='line_height subjects_tables gradepoint' width='80px' >".strtoupper($mandato['grade_name'])." </td>
                                        <td valign='top'  class='line_height subjects_tables gradepoint' width='80px' >".strtoupper($mandato['grade_point'])." </td>
                                        <td valign='top'  class='line_height subjects_tables gradepoint'  style='padding-left:-20px;'  width='250px' colspan=2 >".strtoupper($man_year_of_passing)." </td>
                                    </tr>
                                    </table>";
                                    $total_sub_count++;
                                }
                            ...
                            if(count($check_add_pass)>0 && !empty($check_add_pass) && $additional_creditsPrinte==0)
                            {
                                ...
                                $body_2 .="<table style='line-height: 1.2em; ' border='0' width='100%' >
                                        <tr>
                                            <td valign='top'  class='line_height subjects_tables' width='70px' >&nbsp;</td>
                                            <td valign='top'  class='line_height subjects_tables' width='120px' >&nbsp;</td>
                                            <td valign='top'  class='line_height subjects_tables subject_name' width='680px' colspan=6 >ADDITIONAL CREDITS EARNED # </td>
                    ...
                    $is_arrear_printed = 1;
                            ...
                            if(count($check_add_pass)>0 && !empty($check_add_pass) && $additional_creditsPrinte==0)
                            {
                                ...
                                foreach ($check_add_pass as $key => $mandato) 
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td valign='top'  class='line_height subjects_tables gradepoint' width='80px' >".strtoupper($mandato['grade_name'])." </td>
                                        <td valign='top'  class='line_height subjects_tables gradepoint' width='80px' >".strtoupper($mandato['grade_point'])." </td>
                                        <td valign='top'  class='line_height subjects_tables gradepoint' width='250px' style='padding-left:-20px;' ssscolspan=2 >".strtoupper($man_year_of_passing)." </td>
                                    </tr>
                                    </table>";
                                    $total_sub_count++;
                       ...
                       /*if(isset($_SESSION['transcript']) && $_SESSION['transcript']==1)
                        ...
                        <tr>
                            ...
                            <td valign='top'   class='line_height print_cgpa_size makeitBigger final trcredit ' colspan=7 width='480px'  > ".$total_credits_cgpa." </td>
                            
                            <td valign='top'   class='line_height print_cgpa_size makeitBigger PRINT_finalfinal_cgpa final trcredit' colspan=6 width='100px;'  >".$final_cgpa."</td>
                            <td valign='top' colspan=10 class='line_height print_cgpa_size'  style='padding-top:-16px;' >".$cahnge_text."</td>                                       
                        </tr>
                        <tr>
                            <td valign='top'  colspan=2 width='200px'  > &nbsp; </td>
                            <td valign='top'  class='print_classification print_cgpa_size makeitBigger class' valign='top' colspan=6 height=123px style='padding-top:-16px;' >".$classification."</td>
                            <td valign='top'  class=' print_cgpa_size' valign='top' colspan=18 height=30px >&nbsp;</td>
       

                        </tr>                       
                        <tr>                            
                            <td class='line_height print_cgpa_size makeitBigger date_print ' valign='top' colspan=6 height=30px style='padding-top:-20px;' > ".$publish_date."
                            </td>
                       ...
                       if($additional_creditsPrinte==1)
                        {
                            $add_body_1 .="<table style='line-height: 1.5em; '  class='additional_credits'  border='0' width='100%' >
                                <tr>
                                    <td valign='top'  class='line_height subjects_tables' width='70px' >&nbsp;</td>
                                    <td valign='top'  class='line_height subjects_tables' width='120px' >&nbsp;</td>
                                    <td valign='top'  class='line_height subjects_tables additional_credits_print subject_name' width='685px' colspan=6 style='font-size: 8px !important;' ># ADDITIONAL CREDIT ".strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT))."S WILL NOT TO BE CONSIDERED FOR CGPA CALCULATION</td>
                                    <td valign='top'  class='line_height subjects_tables' width='80px' > &nbsp; </td>
                                    <td valign='top'  class='line_height subjects_tables' width='80px' > &nbsp; </td>
                                    <td valign='top'  class='line_height subjects_tables' width='80px' > &nbsp; </td>
                                    <td valign='top'  class='line_height subjects_tables' width='250px' colspan=2 >&nbsp; </td>
            ...
            $header.='<td valign="top"  height="150" colspan="13">'; //first td
             $header.='<table class="makeitBigger" width="100%">left_alignment
                        <tr>
                        ...
                        <tr>
                            <td valign="top" width="350"  colspan="6"></td>
                            <td valign="top"  align="left" class="make_bold_font left_alignment " colspan="7" style="padding-top:39px;">'.strtoupper($value["degree_code"].". ".$value["programme_name"]).'</td>
                        </tr>
                       </table>
                       </td>';
            $stu_dob = date('d-m-Y',strtotime($value["dob"]));
            $header.='<td valign="top" class="bring_to_the_right reg"  height="150" colspan="13">
             ...
             $body_2 .= "<td valign='top'  class='line_height subjects_tables right_table_td' valign='top' $add_css colspan='13' >"; //1st td
               if($value['ESE_max']==0 && $value['CIA_max']==0)
               {
                    ...
                    <table style='line-height: 1.2em; ' border='0' width='100%'  >
                        <tr>
                            <td valign='top'  class='line_height subjects_tables sem man' width='70px' >".$semester_array[$value['semester']]."</td>
                            <td valign='top'  style='padding-left:16px;'    class='line_height subjects_tables subject_code' width='120px' >".$value['subject_code']."</td>
                            <td valign='top'  class='line_height subjects_tables subject_name' style='padding-left:14px;' width='685px' colspan=6 >".strtoupper($subject_name_print)."</td>
                        ...
                        foreach ($get_console_list_man as $key => $mandato) 
                        {
                            ...
                            if($prev_man_sub_codde!=$mandato['subject_code'])
                            {
                                 $body_1 .="<table style='line-height: 1.2em; ' border='0' width='100%' >
                                    <tr>
                                        <td valign='top'  class='line_height subjects_tables sem man' width='70px' >".$semester_array[$mandato['semester']]."</td>
                                        <td valign='top'  class='line_height subjects_tables subject_code' width='120px' >".$mandato['subject_code']."</td>
                                        <td valign='top'  style='padding-left:15px;'
                                        class='line_height subjects_tables subject_name' width='685px' colspan=6 >".strtoupper($mandato['subject_name'])."</td>
                                        <td valign='top'  class='line_height subjects_tables' width='80px' >&nbsp;</td>
                                        <td valign='top'  class='line_height subjects_tables' width='80px' >&nbsp;</td>
                                        <td valign='top'  class='line_height subjects_tables' width='90px' >&nbsp;</td>
                                        <td valign='top'  class='line_height subjects_tables' width='250px' colspan=2 >&nbsp;</td>
                    ...
                    $subject_name_print = "<b>".strtoupper(nl2br($sub_na))."</b>";
                        ...
                        <table style='line-height: 1.2em; ' border='0' width='100%' >
                            <tr>
                                ...
                                <td valign='top'  class='line_height subjects_tables gradepoint'  width='250px' style='padding-left:-20px;'  colspan=2 >".$year_of_passing."</td>
                            </tr>
                        </table>    
                    ";
                    $total_sub_count++;
                        ...
                        foreach ($get_console_list_man as $key => $mandato) 
                        {
                            ...
                            if($prev_man_sub_codde!=$mandato['subject_code'])
                            {
                                ...
                                <tr>
                                    ...
                                    <td valign='top' class='line_height subjects_tables subject_name' width='685px' colspan=6 >".strtoupper($mandato['subject_name'])."</td>
                                    <td valign='top'  class='line_height subjects_tables' width='80px' >&nbsp;</td>
                                    <td valign='top'  class='line_height subjects_tables' width='80px' >&nbsp;</td>
                                    <td valign='top'  class='line_height subjects_tables' width='90px' >&nbsp;</td>
                                    <td valign='top'  class='line_height subjects_tables' width='250px' colspan=2 >&nbsp;</td>
                ...
                { 
                   ...
                   if($value['ESE_max']==0 && $value['CIA_max']==0)
                   {
                    ...
                    $subject_name_print = "<b>".strtoupper(nl2br($sub_na))."</b>";
                        ...
                        <table style='line-height: 1.2em; ' border='0' width='100%' >
                            <tr>
                                <td valign='top'  class='line_height subjects_tables sem_2 man' width='70px' >".$semester_array[$value['semester']]."</td>
                                <td valign='top'  style='padding-left:16px;'   class='line_height subjects_tables subject_code' width='120px' >".$value['subject_code']."</td>
                                <td valign='top'class='line_height subjects_tables subject_name ' style='padding-left:14px;' width='685px' colspan=6 >".strtoupper($subject_name_print)."</td>
                                <td valign='top'  class='line_height subjects_tables' width='450px' colspan=5 > <b>COMPLETED</b> </td>
                            </tr>
            ...
            if($additional_creditsPrinte==1)
            {
                $add_body_1 .="<table style='line-height: 1.5em; ' class='additional_credits' border='0' width='100%' >
                        <tr>
                            <td valign='top'  class='line_height subjects_tables' width='70px' >&nbsp;</td>
                            <td valign='top'  class='line_height subjects_tables' width='120px' >&nbsp;</td>
                            <td valign='top'  class='line_height subjects_tables additional_credits_print subject_name' width='685px' style='font-size: 9px !important;' colspan=6 ># ADDITIONAL CREDIT ".strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT))."S WILL NOT TO BE CONSIDERED FOR CGPA CALCULATION</td>
                            <td valign='top'  class='line_height subjects_tables' width='80px' > &nbsp; </td>
                            <td valign='top'  class='line_height subjects_tables' width='80px' > &nbsp; </td>
                            <td valign='top'  class='line_height subjects_tables' width='80px' > &nbsp; </td>
                            <td valign='top'  class='line_height subjects_tables' width='250px' colspan=2 >&nbsp; </td>
           ...
           /*if(isset($_SESSION['transcript']) && $_SESSION['transcript']==1)
            ...
            $cumulative_row ="                        
                        ...
                        <tr>
                            <td valign='top'  colspan=2 width='200px'  > &nbsp; </td>
                            <td valign='top'  class='print_classification print_cgpa_size makeitBigger class' valign='top' colspan=2 height=123px style='padding-top:-16px;' >".$classification."</td>
                            <td valign='top'  class='print_cgpa_size' valign='top' colspan=18 height=30px >&nbsp;</td>
                        </tr>                       
                        <tr>                            
                            <td  class='line_height print_cgpa_size makeitBigger date_print '  valign='top' colspan=6 height=30px  style='padding-top:-20px;'> ".$publish_date."
