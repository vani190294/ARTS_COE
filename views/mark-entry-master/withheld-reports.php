    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="btn-group col-lg-3 col-sm-3" role="group" aria-label="Actions to be Perform"> <br />
                ...
                <?= Html::a("Reset", Url::toRoute(['mark-entry-master/withheld-reports']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
    ...
    <?php 
        ...
        if(isset($fetched_data))
        {
            ...
            echo '
                ...
                echo Html::a('<i class="fa fa-file-pdf-o"></i> ' . "PDF",array('withheld-reports-pdf','exportPDF'=>'PDF'),array('title'=>'Export to PDF','target'=>'_blank','class'=>'pull-right btn btn-warning', 'style'=>'color:#fff'));
                echo Html::a('<i class="fa fa-file-excel-o"></i> ' . "EXCEL ",array('withheld-reports-excel','exportPDF'=>'PDF'),array('title'=>'Export to Excel','target'=>'_blank','class'=>'pull-right btn btn-info', 'style'=>'color:#fff')); 
                echo '
                            </div>
                        </div>
                      ';
$header .='<table style="overflow-x:auto;"  cellspacing="0" cellpadding="0" border="0"  class="table table-bordered table-responsive bulk_edit_table table-hover" id = "student_import_results">';            
            ...
            $header .=' <tr>
                      <th colspan=10 align="center"><h2>
                        WITHHELD REPORT FOR '.$_POST['MarkEntryMaster']['year'].'</h2>
                      </th>
                    </tr>
            <tr>
                <th>SNO</th>
            ...
            $body .="<tbody>";
                ...
                $sno=1;
                    ...
                    {   
                        $monthDisp = Categorytype::findOne($values['month']);
                        $body .="<tr><td>".$sno."</td>";
                        $body .= "<td>".$values['year']."</td>";
                        $body .= "<td>".$monthDisp->description."</td>";
                ...
                $html = $header.$body;
                $html_1 = $html;
                if(isset($_SESSION['withheld_report_sem']))
                {
                    unset($_SESSION['withheld_report_sem']);
                }
                 $_SESSION['withheld_report_sem'] = $html_1;
