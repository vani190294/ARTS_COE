      ...
      <tr>
        ...
        $header.='<td valign="top"   height="150px" colspan="16">'; //first td
         $header.='<table class="makeitBigger" width="100%">
                     <tr>
                        <td valign="top" colspan=3 align="center" width="100" style="padding-top: 21px;padding-left:-30px;">'.strtoupper($value["degree_code"]).'  </td>
                        <td valign="top" colspan=7 align="center" width="350" style="padding-top: 21px;" >'.strtoupper($value["programme_name"]).'</td>
                        <td valign="top" colspan=3 align="left" width="100" style="padding-top: 21px;padding-left:105px;" >'.strtoupper($show_date_publication).'</td>
                        <td valign="top" colspan=3  align="left" width="100" style="padding-top: 20px;" >2018-2021</td>
                    </tr>
                    <tr><td valign="top"  colspan="16" height="40px" >&nbsp;</td></tr>
                    <tr>
                        <td valign="top" class="student_name"  colspan="10">'.strtoupper($value["name"]).'</td>
                        <td valign="top"  colspan=3  class="dob" align="left" width="100" style="padding-left:105px;">'.$dob.'</td>
                        
                        <td valign="top" class="student_name" colspan=3 align="left" width="200"  style="padding-left: 5px;">'.strtoupper($value["register_number"]).'</td>
                    </tr>
                   </table>
                   </td>';
