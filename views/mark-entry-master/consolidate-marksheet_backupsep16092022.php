        ...
        $header.='<td valign="top"   height="150px" colspan="16">'; //first td
         $header.='<table class="makeitBigger" width="100%">
                    <tr>
                        ...
                        <td valign="top" colspan=7 align="left" width="320" style="padding-top: 16px;" >'.strtoupper($value["programme_name"]).'</td>
                        <td valign="top" colspan=3 align="left" width="100" style="padding-top: 16px;padding-right: 40;" >'.strtoupper($show_date_publication).'</td>
                        <td valign="top" colspan=3  align="left" width="200" style="padding-top: 20px;padding-left:-70px;" >2019-2022</td>
                    </tr>
