...
$this->title = 'NCC/ONLINE ARREAR LIST';
$this->params['breadcrumbs'][] = ['label' => ' NCC/ONLINE ARREAR REPORT', 'url' => ['create']];
         ...
         <div class="col-lg-2 col-sm-2">
           ...
           <br>
            <div class="form-group col-lg-3 col-sm-3">
                ...
                <?= Html::a("Reset", Url::toRoute(['mark-entry-master/onlinearrear']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
        </div>
               ...
               $header .='<table  style="overflow-x:auto;"  cellspacing="0" cellpadding="0" border="0"  class="table table-bordered table-responsive bulk_edit_table table-hover" id = "student_import_results" >';
                    $header .= '<tr>
                                    <th style="border: none;" colspan=10>
                                          ...
                                          <center class="tag_line"><b> NCC/ONLINE ARREAR REPORT FOR '.strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_BATCH)).'-'.$batch.' </b></center>
                                    </th>
                                </tr>';
                    $header .="
                    <tr>
                ...
                echo Html::a('<i class="fa fa-file-pdf-o"></i> ' . "PDF",array('onlinearrear-pdf','exportPDF'=>'PDF'),array('title'=>'Export to PDF','target'=>'_blank','class'=>'pull-right btn btn-warning', 'style'=>'color:#fff'));
                echo Html::a('<i class="fa fa-file-excel-o"></i> ' . "EXCEL ",array('onlinearrear-excel','exportPDF'=>'PDF'),array('title'=>'Export to Excel','target'=>'_blank','class'=>'pull-right btn btn-info', 'style'=>'color:#fff')); 
