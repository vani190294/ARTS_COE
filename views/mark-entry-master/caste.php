...
<div>&nbsp;</div>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="col-lg-2 col-sm-2">
                <?php echo $form->field($galley,'month')->widget(
                    Select2::classname(), [
...
<div class="box box-primary">
    <div class="box-body">
                ...
                <div class="col-lg-12"  style="overflow-x:auto;"> 
                    ...
                    $html .='<table  style="overflow-x:auto;" width="100%"  cellspacing="0" cellpadding="0" border="0" class="table table-bordered table-responsive dum_edit_table table-hover" >
                        ...
                        <tr class="table-danger">
                            ...
                            <th rowspan="1">Degree</th>
                            <th rowspan="1">Programme</th>
                            
                            <th colspan="1" style="text-align:center;">BC</th>
                             <th colspan="1" style="text-align:center;">MBC</th>
                             <th colspan="1" style="text-align:center;">OBC</th>
                             <th colspan="1" style="text-align:center;">OC</th>
                             <th colspan="1" style="text-align:center;">SC</th>
                              <th colspan="1" style="text-align:center;">ST</th>

                              <th colspan="1" style="text-align:center;">Total student passed BC</th>
                              <th colspan="1" style="text-align:center;">Total student passed MBC</th>
                               <th colspan="1" style="text-align:center;">Total student passed OBC</th>
                                 <th colspan="1" style="text-align:center;">Total student passed OC</th>
                                    <th colspan="1" style="text-align:center;">Total student passed SC</th>
                                     <th colspan="1" style="text-align:center;">Total student passed ST</th>
                                      <th colspan="1" style="text-align:center;">Total student BC 60 percent above</th>
                                      <th colspan="1" style="text-align:center;">Total student MBC 60 percent above</th>
                                       <th colspan="1" style="text-align:center;">Total student OBC 60 percent above</th>
                                       <th colspan="1" style="text-align:center;">Total student OC 60 percent above</th>

                                       <th colspan="1" style="text-align:center;">Total student SC 60 percent above</th>
                                       <th colspan="1" style="text-align:center;">Total student ST 60 percent above</th>
        ...
        $men->select('count(register_number) as  total,course_batch_mapping_id,degree_code')
            ...
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.gender'=>'M','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
        ...
        $women->select('count(register_number) as  total,course_batch_mapping_id,degree_code')
            ...
            ->join('JOIN', 'coe_programme g', 'e.coe_programme_id=g.coe_programme_id')
            ->join('JOIN', 'coe_batch h', 'h.coe_batch_id=e.coe_batch_id')
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.gender'=>'F','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
        ...
        $BC->select('count(register_number) as  totalBC,d.coe_student_mapping_id,register_number,course_batch_mapping_id,degree_code')
            ...
            ->join('JOIN', 'coe_programme g', 'e.coe_programme_id=g.coe_programme_id')
            ->join('JOIN', 'coe_batch h', 'h.coe_batch_id=e.coe_batch_id')
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'BC','a.gender'=>'M','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
      ...
      $BCF->select('count(register_number) as  totalBCF,course_batch_mapping_id,degree_code')
            ...
            ->join('JOIN', 'coe_programme g', 'e.coe_programme_id=g.coe_programme_id')
            ->join('JOIN', 'coe_batch h', 'h.coe_batch_id=e.coe_batch_id')
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'BC','a.gender'=>'F','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
       ...
       // print_r($casteBCF);exit;
        ...
        $MBC->select('count(register_number) as  total,course_batch_mapping_id,degree_code')
            ...
            ->join('JOIN', 'coe_programme g', 'e.coe_programme_id=g.coe_programme_id')
            ->join('JOIN', 'coe_batch h', 'h.coe_batch_id=e.coe_batch_id')
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'MBC','a.gender'=>'M','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
        ...
        $MBCF->select('count(register_number) as  total,course_batch_mapping_id,degree_code')
            ...
            ->join('JOIN', 'coe_programme g', 'e.coe_programme_id=g.coe_programme_id')
            ->join('JOIN', 'coe_batch h', 'h.coe_batch_id=e.coe_batch_id')
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'MBC','a.gender'=>'F','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
        ...
        $OBC->select('count(register_number) as  total,course_batch_mapping_id,degree_code')
            ...
            ->join('JOIN', 'coe_programme g', 'e.coe_programme_id=g.coe_programme_id')
            ->join('JOIN', 'coe_batch h', 'h.coe_batch_id=e.coe_batch_id')
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'OBC','a.gender'=>'M','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
        ...
        $OBCF->select('count(register_number) as  total,course_batch_mapping_id,degree_code')
            ...
            ->join('JOIN', 'coe_programme g', 'e.coe_programme_id=g.coe_programme_id')
            ->join('JOIN', 'coe_batch h', 'h.coe_batch_id=e.coe_batch_id')
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'OBC','a.gender'=>'F','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
        ...
        $SC->select('count(register_number) as  total,course_batch_mapping_id,degree_code')
            ...
            ->join('JOIN', 'coe_programme g', 'e.coe_programme_id=g.coe_programme_id')
            ->join('JOIN', 'coe_batch h', 'h.coe_batch_id=e.coe_batch_id')
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'SC','a.gender'=>'M','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
        ...
        $SCF->select('count(register_number) as  total,course_batch_mapping_id,degree_code')
            ...
            ->join('JOIN', 'coe_programme g', 'e.coe_programme_id=g.coe_programme_id')
            ->join('JOIN', 'coe_batch h', 'h.coe_batch_id=e.coe_batch_id')
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'SC','a.gender'=>'F','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
        ...
        $ST->select('count(register_number) as  total,course_batch_mapping_id,degree_code')
            ...
            ->join('JOIN', 'coe_programme g', 'e.coe_programme_id=g.coe_programme_id')
            ->join('JOIN', 'coe_batch h', 'h.coe_batch_id=e.coe_batch_id')
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'ST','a.gender'=>'M','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
        ...
        $STF->select('count(register_number) as  total,course_batch_mapping_id,degree_code')
            ...
            ->join('JOIN', 'coe_programme g', 'e.coe_programme_id=g.coe_programme_id')
            ->join('JOIN', 'coe_batch h', 'h.coe_batch_id=e.coe_batch_id')
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'ST','a.gender'=>'F','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
        ...
        $OC->select('count(register_number) as  total,course_batch_mapping_id,degree_code')
            ...
            ->join('JOIN', 'coe_programme g', 'e.coe_programme_id=g.coe_programme_id')
            ->join('JOIN', 'coe_batch h', 'h.coe_batch_id=e.coe_batch_id')
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'OC','a.gender'=>'M','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
        ...
        $OCF->select('count(register_number) as  total,course_batch_mapping_id,degree_code')
            ...
            ->join('JOIN', 'coe_programme g', 'e.coe_programme_id=g.coe_programme_id')
            ->join('JOIN', 'coe_batch h', 'h.coe_batch_id=e.coe_batch_id')
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'OC','a.gender'=>'F','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
      ...
      // $get_stu_query = "SELECT count(distinct A.register_number) as count FROM coe_student as A JOIN coe_student_mapping as B ON B.student_rel_id=A.coe_student_id  JOIN coe_mark_entry_master as F ON F.student_map_id=B.coe_student_mapping_id JOIN coe_subjects_mapping as G ON G.coe_subjects_mapping_id=F.subject_map_id where  B.coe_student_mapping_id NOT IN(select student_map_id from coe_mark_entry_master where year_of_passing='' and subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where student_map_id=F.student_map_id and result like '%pass%')) and status_category_type_id NOT IN('".$det_cat_type."','".$det_disc_type."') AND F.grade_name not IN ('U','wh','AB','ab','WH','ra','wd','WD') and A.caste='BC' and A.gender='M'"; 
        ...
        $get_stu_query= new Query();
         $get_stu_query->select('count(register_number) as  count,d.coe_student_mapping_id,register_number,course_batch_mapping_id,degree_code')
            ...
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'BC','a.gender'=>'M','x.part_no'=>'3','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
        ...
        $final_student_M =  $get_stu_query->createCommand()->queryAll();
          ...
          $get_stu_query_F->select('count(register_number) as  count,d.coe_student_mapping_id,register_number,course_batch_mapping_id,degree_code')
            ...
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'BC','a.gender'=>'F','x.part_no'=>'3','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
        ...
        $final_student_F =   $get_stu_query_F->createCommand()->queryAll();
         ...
         $get_stu_query_MBC ->select('count(register_number) as  count,d.coe_student_mapping_id,register_number,course_batch_mapping_id,degree_code')
            ...
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'MBC','a.gender'=>'M','x.part_no'=>'3','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
       ...
       $get_stu_query_MBCF = new Query();
         $get_stu_query_MBCF ->select('count(register_number) as  count,d.coe_student_mapping_id,register_number,course_batch_mapping_id,degree_code')
            ...
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'MBC','a.gender'=>'F','x.part_no'=>'3','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
         ...
         $get_stu_query_OBCM ->select('count(register_number) as  count,d.coe_student_mapping_id,register_number,course_batch_mapping_id,degree_code')
            ...
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'OBC','a.gender'=>'M','x.part_no'=>'3','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
       ...
       $get_stu_query_OBCF = new Query();
          $get_stu_query_OBCF ->select('count(register_number) as  count,d.coe_student_mapping_id,register_number,course_batch_mapping_id,degree_code')
            ...
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'OBC','a.gender'=>'F','x.part_no'=>'3','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
       ...
       $get_stu_query_OCM = new Query();
         $get_stu_query_OCM ->select('count(register_number) as  count,d.coe_student_mapping_id,register_number,course_batch_mapping_id,degree_code')
            ...
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'OC','a.gender'=>'M','x.part_no'=>'3','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
         ...
         $get_stu_query_OCF ->select('count(register_number) as  count,d.coe_student_mapping_id,register_number,course_batch_mapping_id,degree_code')
            ...
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'OC','a.gender'=>'F','x.part_no'=>'3','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
         ...
         $get_stu_query_SC ->select('count(register_number) as  count,d.coe_student_mapping_id,register_number,course_batch_mapping_id,degree_code')
            ...
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'SC','a.gender'=>'M','x.part_no'=>'3','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
         ...
         $get_stu_query_SCF ->select('count(register_number) as  count,d.coe_student_mapping_id,register_number,course_batch_mapping_id,degree_code')
            ...
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'SC','a.gender'=>'F','x.part_no'=>'3','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
         ...
         $get_stu_query_ST ->select('count(register_number) as  count,d.coe_student_mapping_id,register_number,course_batch_mapping_id,degree_code')
            ...
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'ST','a.gender'=>'M','x.part_no'=>'3','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
       ...
       $get_stu_query_STF= new Query();
         $get_stu_query_STF ->select('count(register_number) as  count,d.coe_student_mapping_id,register_number,course_batch_mapping_id,degree_code')
            ...
            ->where([ 'h.coe_batch_id' => $_POST['bat_val'],'a.Caste'=>'ST','a.gender'=>'F','x.part_no'=>'3','d.course_batch_mapping_id'=>$values['course_batch_mapping_id']]);
