      ...
      <tr>
        ...
        $header.='<td valign="top"   height="150px" colspan="16">'; //first td
         $header.='<table class="makeitBigger" width="100%">
                     <tr>
                        <td valign="top" colspan=3 align="center" width="100" style="padding-top: 21px;padding-left:-150px;">'.strtoupper($value["degree_code"]).'  </td>
                        <td valign="top" colspan=7 align="left" width="600" style="padding-top: 21px;padding-right:45px;" >'.strtoupper($value["programme_name"]).'</td>
                        <td valign="top" colspan=3 align="left" width="100" style="padding-top: 21px;padding-left:30px;" >'.strtoupper($show_date_publication).'</td>
                    ...
                    <tr>
                        ...
                        <td valign="top"  class="dob" align="left" width="100" style="padding-left:30px;">'.$dob.'</td>
                        
                        <td valign="top" class="student_name" colspan=3 align="left" width="160"  style="padding-right: 75px;">'.strtoupper($value["register_number"]).'</td>
                    </tr>
                   </table>
                   </td>';
