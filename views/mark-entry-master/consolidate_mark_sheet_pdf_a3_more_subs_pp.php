...
<?php Yii::$app->ShowFlashMessages->showFlashes(); 
    ...
    if($file_content_available=="Yes")
    {
        ...
        $is_arrear_printed = 0;
        $cgpa_calc = [];
        echo Html::a('<i class="fa fa-file-pdf-o"></i> Print Pdf', ['/mark-entry-master/consolidate-mark-sheet-pdf1'], [
...
$sub_na = wordwrap(strtoupper($mandato['sub_cat_name']), 50, "\n", true);
            ...
            if(!empty($check_arrear) && $value['exam_year']=2020 && $value['exam_month']=29)
                {
                    $is_arrear_printed = 1;
                            ...
                            if(count($check_add_pass)>0 && !empty($check_add_pass) && $additional_creditsPrinte==0)
                            {
                                ...
                                <tr>
                                    <td valign='top'  class='line_height subjects_tables' width='70px' >&nbsp;</td>
                                    <td valign='top'  class='line_height subjects_tables' width='120px' >&nbsp;</td>
                                    <td valign='top'  class='line_height subjects_tables subject_name add'  style='padding-left:14px;' width='680px' colspan=6 >ADDITIONAL CREDITS EARNED # </td>
                                    <td valign='top'  class='line_height subjects_tables' width='80px' > &nbsp; </td>
                                    <td valign='top'  class='line_height subjects_tables' width='80px' > &nbsp; </td>
                                    <td valign='top'  class='line_height subjects_tables' width='80px' > &nbsp; </td>
                                    <td valign='top'  class='line_height subjects_tables' width='250px' colspan=2 >&nbsp; </td>
                    ...
                    $subject_name_print = "<b>".strtoupper(nl2br($sub_na))."</b>";
                      ...
                      if(isset($_SESSION['transcript']) && $_SESSION['transcript']==1 && $sem!='8')
                        ...
                        <tr>
                            <td valign='top'   class='line_height print_cgpa_size' colspan=2 width='210px'  > &nbsp; </td>
                            <td valign='top'   class='line_height print_cgpa_size makeitBigger final trcredit ' style='padding-left:35px; padding-top:5px;' colspan=7 width='480px'  > ".$total_credits_cgpa." </td>
                            
                            <td valign='top'   class='line_height print_cgpa_size makeitBigger PRINT_finalfinal_cgpa final trcredit ' colspan=6 width='100px;' style='padding-top:5px;' >".$final_cgpa."</td>
                            <td valign='top' colspan=10 class='line_height print_cgpa_size text' style='padding-top:5px;' >".$cahnge_text."</td>                                       
                        </tr>
                        <tr>
                            <td valign='top'  colspan=2 width='200px'  > &nbsp; </td>
                            <td valign='top'  class='print_classification print_cgpa_size makeitBigger class trans firsts ' valign='top' colspan=6 height=123px style='padding-top:21px; padding-left:38px;' >".$classification."</td>
                            <td valign='top'  class=' print_cgpa_size' valign='top' colspan=18 height=30px >&nbsp;</td>
       

                        </tr>                       
                        <tr>                            
                            <td class='line_height print_cgpa_size makeitBigger date_print ' valign='top' colspan=6 height=30px style='padding-left:85px; padding-top:5px;' >".$publish_date."
                            </td>
                ...
                $total_sub_count++;
                  $body_2 .="<table style='line-height: 1.4em; ' border='0' width='100%' >
                      ...
                      /*if(!empty($check_arrear))
                        ...
                        $merge_body ="<tbody><tr>".$body."</tr></tbody><tr><td valign='top'  colspan=26  class='".$changeClass."'  >&nbsp;</td></tr>";
       ...
       //else if($value['status_category_type_id']!=$lateral_entry_id && ($total_sub_count>=42 || $value['semester']>5) )
           ...
           if(!empty($trans_semester_pass))
                ...
                if(count($check_add_pass)>0 && !empty($check_add_pass) && $additional_creditsPrinte==0)
                {
                    ...
                    $body_2 .="<table style='line-height: 1.0em; ' border='0' width='100%' >
                            <tr>
                                <td valign='top'  class='line_height subjects_tables' width='70px' >&nbsp;</td>
                                <td valign='top'  class='line_height subjects_tables' width='120px' >&nbsp;</td>
                                <td valign='top'  class='line_height subjects_tables subject_name add' width='680px' style='padding-left:14px;' colspan=6 >ADDITIONAL CREDITS EARNED # </td>
                                <td valign='top'  class='line_height subjects_tables' width='90px' > &nbsp; </td>
                                <td valign='top'  class='line_height subjects_tables' width='90px' > &nbsp; </td>
                                <td valign='top'  class='line_height subjects_tables' width='90px' > &nbsp; </td>
                                <td valign='top'  class='line_height subjects_tables' width='250px' colspan=2 >&nbsp; </td>
            ...
            $merge_body ="<tbody><tr>".$body."</tr></tbody><tr><td valign='top' class='".$changeClass."' colspan=26  >&nbsp;</td></tr>";
            $gpa = 0;
            $total_credits_cgpa=0;
          ...
          if(isset($_SESSION['transcript']) && $_SESSION['transcript']==1 && $sem!='8')
            ...
            $cumulative_row ="                        
                        <tr>
                            ...
                            <td valign='top'   class='line_height print_cgpa_size' colspan=2 width='210px'  > &nbsp; </td>
                            <td valign='top'   class='line_height print_cgpa_size makeitBigger final trcredit ' colspan=7 width='480px' style='padding-left:35px; padding-top:5px;'  > ".$total_credits_cgpa." </td>
                            <td valign='top'   class='line_height print_cgpa_size makeitBigger PRINT_finalfinal_cgpa final trcredit' colspan=6 width='100px;' style='padding-top:5px;'>".$final_cgpa."</td>
                            <td valign='top' colspan=10 class='line_height print_cgpa_size text' style='padding-top:5px;'>".$cahnge_text."</td>                                       
                        </tr>
            ...
            $footer .=$cumulative_row."</table>";
            $html = '<div class="markheader">'.$header .'</table></div>
            <div class="markbody">
            <table width="100%">'.$merge_body.'</table>
            </div>
            <div class="markfooter">
            <table width="100%">'.$footer.'</div>';
            $print_stu_data .=$html;
