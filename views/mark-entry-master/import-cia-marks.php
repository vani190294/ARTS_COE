    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">            
            ...
            <div class="btn-group col-lg-3 col-sm-3" role="group" aria-label="Actions to be Perform">
                ...
                <?= Html::a("Reset", Url::toRoute(['mark-entry-master/import-cia-marks']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
            <br /><br />
              ...
              <!-- /. tools -->
                ...
                <table style="overflow-x:auto;"  class="table table-bordered table-responsive bulk_edit_table table-hover" id="hall_import_results" >
                    ...
                    {                       
                        ...
                        $content.= Html::tag('td', $line['marks']); 
