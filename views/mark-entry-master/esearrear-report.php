...
$this->title = 'ESE WISE ARREAR REPORT';
         ...
         <div class="col-lg-2 col-sm-2">
           ...
           <br>
            <div class="form-group col-lg-3 col-sm-3">
                ...
                <?= Html::a("Reset", Url::toRoute(['mark-entry-master/esearrear-report']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
        </div>
               ...
               $header .='<table  style="overflow-x:auto;"  cellspacing="0" cellpadding="0" border="0"  class="table table-bordered table-responsive bulk_edit_table table-hover" id = "student_import_results" >';
                    $header .= '<tr>
                                    <th style="border: none;" colspan=10>
                                          ...
                                          <center class="tag_line"><b>ESE WISE ARREAR REPORT FOR '.strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_BATCH)).'-'.$batch.' </b></center>
                                          <center class="tag_line">'.$org_address.' Phone : '.$org_phone.' </center>
