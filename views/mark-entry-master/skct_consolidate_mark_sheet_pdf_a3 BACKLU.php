        ...
        foreach ($get_console_list as $value) 
        {
            ...
            if($previous_reg_number!=$value['register_number'])
            {
                $files = glob($absolute_dire.$value['register_number'].".*"); // Will find 2.JPG, 2.php, 2.gif
                    ...
                    if($new_stu_flag > 1) 
                    {
                        ...
                        <tr>
                            ...
                            <td valign='top'  class='print_classification print_cgpa_size makeitBigger' valign='top' colspan=6 height=135px >".$classification."</td>
                ...
                $get_console_list_man = Yii::$app->db->createCommand($get_stu_query_man)->queryAll();
                    ...
                    if(!empty($get_console_list_man))
                    {
                        ...
                        {                           
                            $check_add_pass = Yii::$app->db->createCommand('SELECT * FROM coe_mandatory_stu_marks as A JOIN coe_mandatory_subcat_subjects as B ON B.coe_mandatory_subcat_subjects_id=A.subject_map_id where result like "%Pass%" and student_map_id="'.$mandato['student_map_id'].'" and result like "%Pass%" and is_additional="YES" ')->queryAll();
                            if(count($check_add_pass)>0 && !empty($check_add_pass) && $additional_creditsPrinte==0)
                            {
                                $additional_creditsPrinte = 1;
                                foreach ($check_add_pass as $key => $add_vals) 
                                {
                                    ...
                                    <tr>
                                        <td valign='top'  class='line_height subjects_tables' width='80px' >".$semester_array[$mandato['semester']]."</td>
                                        <td valign='top'  class='line_height subjects_tables' width='120px' >".$mandato['subject_code']."</td>
                                        <td valign='top'  class='line_height subjects_tables' width='750px' colspan=6 >".strtoupper($mandato['subject_name'])."</td>
                                        <td valign='top'  class='line_height subjects_tables' width='80px' >&nbsp;</td>
                                        <td valign='top'  class='line_height subjects_tables' width='100px' >&nbsp;</td>
                                        <td valign='top'  class='line_height subjects_tables' width='100px' >&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td valign='top'  class='line_height subjects_tables' width='750px' colspan=6 >".$mandato['sub_cat_code']."-".strtoupper($mandato['sub_cat_name'])."</td>
                                        <td valign='top'  class='line_height subjects_tables' width='80px' > ".$mandato['credit_points']." </td>
                                        <td valign='top'  class='line_height subjects_tables' width='90px' >".strtoupper($mandato['grade_name'])." </td>
                        ...
                        $body ="";
                        $footer = "";
                        $new_stu_flag = 1; $additional_creditsPrinte=0;
            ...
            $header.='<td valign="top" class="bring_to_the_right"  height="150" colspan="13">
                        ...
                        <tr>
                            ...
                            <td valign="top" width="300" style="padding-top: 5px;"  class="this_should_be_up make_bold_font" colspan="6">'.strtoupper($value["register_number"]).'</td>
                            <td valign="top"  class="push_regulation make_bold_font  " style="text-align: left;" >'.$value["regulation_year"].'</td>
                        </tr>
                        <tr>
                            <td valign="top"  colspan="6" width="100" >&nbsp;</td>
                            <td valign="top" width="300" style="padding-top: 8px;" class=" this_should_be_up make_bold_font " colspan="6">'.$print_gender.'</td>
                            <td valign="top"  class="push_regulation make_bold_font " style="text-align: left;" >'.$last_appearance.'</td>
                        </tr>
                        <tr>
                            <td valign="top"  colspan="6" width="100" >&nbsp;</td>
                            <td valign="top"  style="padding-top: 8px;" class=" this_should_be_up make_bold_font " colspan="6">'.$stu_dob.'</td>
                            <td valign="top"  >&nbsp;</td>
                        </tr>
                    </table>
                    </td>';
               ...
               if($value['ESE_max']==0 && $value['CIA_max']==0)
               {
                    ...
                    <table style='line-height: 1.2em; ' border='0' width='100%'  >
                        <tr>
                            ...
                            <td valign='top'  class='line_height subjects_tables' width='750px' colspan=6 >".strtoupper($value['subject_name'])."</td>
                    ...
                    $body_1 .=" 
                        <table style='line-height: 1.2em; ' border='0' width='100%' >
                            <tr>
                                ...
                                <td valign='top'  class='line_height subjects_tables' width='90x' >".$value['grade_name']."</td>
            ...
            if($value['status_category_type_id']==$lateral_entry_id && $value['semester']>5)
            {
                ...
                {   
                    if($same_semester==5)
                    {
                          $get_stu_query_man = "SELECT F.student_map_id,A.register_number,A.dob,A.name,A.gender,D.degree_code,D.degree_name,E.programme_name,H.subject_code,C.regulation_year,H.subject_name,F.semester,G.credit_points,H.CIA_max,H.ESE_max,F.grade_point,F.grade_name,F.subject_map_id,F.year,F.month,B.course_batch_mapping_id,is_additional,sub_cat_code,sub_cat_name,F.year_of_passing,paper_no,F.result,max(F.year_of_passing) as last_appearance FROM coe_student as A JOIN coe_student_mapping as B ON B.student_rel_id=A.coe_student_id JOIN coe_bat_deg_reg as C ON C.coe_bat_deg_reg_id=B.course_batch_mapping_id JOIN coe_degree as D ON D.coe_degree_id=C.coe_degree_id JOIN coe_programme as E ON E.coe_programme_id=C.coe_programme_id JOIN coe_mandatory_stu_marks as F ON F.student_map_id=B.coe_student_mapping_id JOIN coe_mandatory_subcat_subjects as G ON G.coe_mandatory_subcat_subjects_id=F.subject_map_id JOIN coe_mandatory_subjects as H ON H.coe_mandatory_subjects_id=G.man_subject_id JOIN coe_batch as I ON I.coe_batch_id=C.coe_batch_id and I.coe_batch_id=G.coe_batch_id and I.coe_batch_id=H.man_batch_id and G.batch_map_id=C.coe_bat_deg_reg_id and H.batch_mapping_id=C.coe_bat_deg_reg_id where H.batch_mapping_id='".$value['course_batch_mapping_id']."' and G.batch_map_id='".$value['course_batch_mapping_id']."' AND B.coe_student_mapping_id NOT IN(select student_map_id from coe_mark_entry_master where year_of_passing='' and subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where student_map_id=F.student_map_id and result like '%pass%')) and status_category_type_id NOT IN('".$det_disc_type."') AND A.register_number ='".$value['register_number']."' and F.semester='".$value['semester']."' group by A.register_number,H.subject_code order by A.register_number,F.semester,paper_no";
                    ...
                    $same_semester=$value['semester'];
                    $prev_exam_year = $value['exam_year'];
                    $prev_exam_mont = $value['exam_month'];
                    $total_sub_count++;
                }
                if($value['ESE_max']==0 && $value['CIA_max']==0)
                   {
            ...
            else if($total_sub_count>=40 || $value['semester']>4 )
            {
                if($same_semester!=$value['semester'])
                {   
                    $get_stu_query_man = "SELECT F.student_map_id,A.register_number,A.dob,A.name,A.gender,D.degree_code,D.degree_name,E.programme_name,H.subject_code,C.regulation_year,H.subject_name,F.semester,G.credit_points,H.CIA_max,H.ESE_max,F.grade_point,F.grade_name,F.subject_map_id,F.year,F.month,B.course_batch_mapping_id,is_additional,sub_cat_code,sub_cat_name,F.year_of_passing,paper_no,F.result,max(F.year_of_passing) as last_appearance FROM coe_student as A JOIN coe_student_mapping as B ON B.student_rel_id=A.coe_student_id JOIN coe_bat_deg_reg as C ON C.coe_bat_deg_reg_id=B.course_batch_mapping_id JOIN coe_degree as D ON D.coe_degree_id=C.coe_degree_id JOIN coe_programme as E ON E.coe_programme_id=C.coe_programme_id JOIN coe_mandatory_stu_marks as F ON F.student_map_id=B.coe_student_mapping_id JOIN coe_mandatory_subcat_subjects as G ON G.coe_mandatory_subcat_subjects_id=F.subject_map_id JOIN coe_mandatory_subjects as H ON H.coe_mandatory_subjects_id=G.man_subject_id JOIN coe_batch as I ON I.coe_batch_id=C.coe_batch_id and I.coe_batch_id=G.coe_batch_id and I.coe_batch_id=H.man_batch_id and G.batch_map_id=C.coe_bat_deg_reg_id and H.batch_mapping_id=C.coe_bat_deg_reg_id where H.batch_mapping_id='".$value['course_batch_mapping_id']."' and G.batch_map_id='".$value['course_batch_mapping_id']."' AND B.coe_student_mapping_id NOT IN(select student_map_id from coe_mark_entry_master where year_of_passing='' and subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where student_map_id=F.student_map_id and result like '%pass%')) and status_category_type_id NOT IN('".$det_disc_type."') AND A.register_number ='".$value['register_number']."' and F.semester='".$value['semester']."' group by A.register_number,H.subject_code order by A.register_number,F.semester,paper_no";
           ...
           $get_stu_query_man = "SELECT F.student_map_id,A.register_number,A.dob,A.name,A.gender,D.degree_code,D.degree_name,E.programme_name,H.subject_code,C.regulation_year,H.subject_name,F.semester,G.credit_points,H.CIA_max,H.ESE_max,F.grade_point,F.grade_name,F.subject_map_id,F.year,F.month,B.course_batch_mapping_id,is_additional,sub_cat_code,sub_cat_name,F.year_of_passing,paper_no,F.result,max(F.year_of_passing) as last_appearance FROM coe_student as A JOIN coe_student_mapping as B ON B.student_rel_id=A.coe_student_id JOIN coe_bat_deg_reg as C ON C.coe_bat_deg_reg_id=B.course_batch_mapping_id JOIN coe_degree as D ON D.coe_degree_id=C.coe_degree_id JOIN coe_programme as E ON E.coe_programme_id=C.coe_programme_id JOIN coe_mandatory_stu_marks as F ON F.student_map_id=B.coe_student_mapping_id JOIN coe_mandatory_subcat_subjects as G ON G.coe_mandatory_subcat_subjects_id=F.subject_map_id JOIN coe_mandatory_subjects as H ON H.coe_mandatory_subjects_id=G.man_subject_id JOIN coe_batch as I ON I.coe_batch_id=C.coe_batch_id and I.coe_batch_id=G.coe_batch_id and I.coe_batch_id=H.man_batch_id and G.batch_map_id=C.coe_bat_deg_reg_id and H.batch_mapping_id=C.coe_bat_deg_reg_id where H.batch_mapping_id='".$last_num_bat."' and G.batch_map_id='".$batch_mapping_id."' AND B.coe_student_mapping_id NOT IN(select student_map_id from coe_mark_entry_master where year_of_passing='' and subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where student_map_id=F.student_map_id and result like '%pass%')) and status_category_type_id NOT IN('".$det_disc_type."') AND A.register_number ='".$previous_reg_number."' and F.semester='".$same_semester."' and is_additional='NO' and F.year='".$prev_exam_year."' and F.month='".$prev_exam_mont."' group by A.register_number,H.subject_code order by A.register_number,F.semester,paper_no";
                ...
                if(!empty($get_console_list_man))
                {
                    ...
                    {                        
                        ...
                        if(count($check_add_pass)>0 && !empty($check_add_pass) && $additional_creditsPrinte==0)
                        {
                            ...
                            foreach ($check_add_pass as $key => $add_vals) 
                            {
                                $man_year_of_passing = ConfigUtilities::getYearOfPassing($add_vals['year_of_passing']); 
                                $body_2 .="<table style='line-height: 1.2em; ' border='0' width='100%' >
                                <tr>
                                    <td valign='top'  class='line_height subjects_tables' width='80px' >".$semester_array[$add_vals['semester']]."</td>
                                    <td valign='top'  class='line_height subjects_tables' width='120px' >".$add_vals['subject_code']."</td>
                                    <td valign='top'  class='line_height subjects_tables' width='750px' colspan=6 >".strtoupper($add_vals['subject_name'])."</td>
                                    <td valign='top'  class='line_height subjects_tables' width='80px' >&nbsp;</td>
                                    <td valign='top'  class='line_height subjects_tables' width='90px' >&nbsp;</td>
                                    <td valign='top'  class='line_height subjects_tables' width='90px' >&nbsp;</td>
                                    <td valign='top'  class='line_height subjects_tables' width='250px' colspan=2 >&nbsp;</td>
                                ...
                                <tr>
                                    <td valign='top'  class='line_height subjects_tables' width='80px' >&nbsp;</td>
                                    <td valign='top'  class='line_height subjects_tables' width='120px' >&nbsp;</td>
                                    <td valign='top'  class='line_height subjects_tables' width='750px' colspan=6 >".$add_vals['sub_cat_code']."-".strtoupper($add_vals['sub_cat_name'])."</td>
                                    <td valign='top'  class='line_height subjects_tables' width='80px' > ".$add_vals['credit_points']." </td>
                                    <td valign='top'  class='line_height subjects_tables' width='90px' >".strtoupper($add_vals['grade_name'])." </td>
                                    <td valign='top'  class='line_height subjects_tables' width='90px' >".strtoupper($add_vals['grade_point'])." </td>
                                    <td valign='top'  class='line_height subjects_tables' width='250px' colspan=2 >".strtoupper($man_year_of_passing)." </td>
                                </tr>
                                </table>";
                                $total_sub_count++;
            ...
            $merge_two_body_tags = $body_1.'</td>'.$body_2.$add_body_1."</td>";
            $body = $merge_two_body_tags;
            $merge_body ="<tbody><tr>".$body."</tr></tbody><tr><td valign='top'  colspan=26 height='100px' >&nbsp;</td></tr>";

            $gpa = $additional_creditsPrinte= 0;
            $total_credits_cgpa=0;
