                    ...
                    if($new_stu_flag > 1) 
                    {
                        ...
                        if(!empty($check_add))
                        {
                            ...
                            foreach ($check_add as $valuess) 
                            {
                               ...
                               // $subject_name_print = "<b>".strtoupper(mb_convert_encoding($valuess['subject_name'],"HTML-ENTITIES","UTF-8"))."</b>";
                                ...
                                $subject_name_print= "<b>". wordwrap($str,48,"<br>\n");
                                ...
                                if($valuess['ese_maximum']!=NULL && !empty($valuess['ese_maximum']))
                               ...
                               else
                                 {
                                  ...
                                  <table style='line-height: 1.2em; ' border='0' width='100%' >
                                      <tr>
                                          <td valign='top' width='40px'  align='left'><b>" . $semester_array[$send_data]. "</b></td>
                                          <td valign='top' width='35px' class='semester2' align='left'><b>" . $semester_array[$valuess['semester']]. "</b></td>
                                          <td valign='top' width='80px'  class='subject_code2' align='left'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                                         ...
                                         <td valign='top' width='42px' class='credit_points2' align='left'><b>" . $credit_points . "</b></td>
                                          ...
                                          <td valign='top' width='42px' class='cia_max_disp2' align='center'><b>" . $cia_max_disp . "</b></td>
                                          <td valign='top' width='53px'  align='center' class='total_max_disp2'><b>" . $total_max_disp . "</b></td>
                                          ...
                                          <td valign='top' width='60px'  align='left' class='grade_point2'><b>" . $valuess['grade_point'] . "</b></td>
                                          <td valign='top' width='50px'  align='center'><b> " . $valuess['grade_name'] . " </b></td>
                       ...
                       $body_2 .="<table style='line-height: 3em; ' border='0' width='100%' >
                        ...
                        { 
                         ...
                         $cumulative_part .="<table style='line-height: 1.2em;   ' class='makeitBiggerSize' border='0' colspan='16' width='100%' > 
                          <tr>
                            <td valign='top'  class='line_height print_cgpa_size' style='padding-left:-120px;' width='100px;' > ".$semester_array[$i]." </td>
                            <td valign='top'  class='line_height print_cgpa_size' style='padding-left:-120px;' width='100px;' > ".$part_info['part_credits']." </td>
                            ...
                            <td valign='top'   class='line_height print_cgpa_size print_class' colspan=6 width='200px' style='padding-left:-120px;' > ".$part_info['part_class']." </td>
                         ...
                         $merge_two_body_tags = $body_1.'</td>'.$body_2."</td></tr><tr ><td valign='top' class='".$change_css_class."' valign='top' colspan='16' > &nbsp; </td><td valign='top' class='".$change_css_class."' valign='top' colspan='16' >".$cumulative_part."</td></tr>";
        ...
        $header.='<td valign="top"  height="150px" colspan="16">'; //first td
         $header.='<table class="makeitBigger" width="100%">
                    <tr>
                        ...
                        <td valign="top" colspan=7 align="center" width="350" style="padding-top: 10px;" >'.strtoupper($value["programme_name"]).'</td>
                        <td valign="top" colspan=3 align="left" width="100" style="padding-top: 10px;" >'.strtoupper($show_date_publication).'</td>
                        <td valign="top" colspan=3  align="left" width="100" style="padding-top: 10px;" >2018-2021</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td valign="top" class="student_name" colspan=3 align="left" width="100"  style="padding-left: 5px;">'.strtoupper($value["register_number"]).'</td>
                    </tr>
                   </table>
                   </td>';
           ...
           else
           {
                ...
                <table style='line-height: 1.2em; ' border='0' width='100%' >
                    <tr>
                        ...
                        <td valign='top' width='60px' class='grade_point' align='left'><b>" . $value['grade_point'] . "</b></td>
              ...
              {  
                $body_1 .="<table style='line-height: 1.2em; ' border='0' width='100%' >
                  <tr>
                            ...
                            <td valign='top' width='50px' align='left'>&nbsp;</td>
                            <td valign='top' width='95px'  align='left'>&nbsp;</td>
                            <td valign='top' width='300px' colspan='4'  align='center'>~ CONTINUE ~</td>
                            <td valign='top' width='50px'  align='left'>&nbsp;</td>
                            <td valign='top' width='50px'  align='left'>&nbsp;</td>
                            <td valign='top' width='50px'  align='left'>&nbsp;</td>
                            <td valign='top' width='50px'  align='left'>&nbsp;</td>
                ...
                <table style='line-height: 1.2em; ' border='0' width='100%' >
                    <tr>
                       ...
                       <td valign='top' width='210px' colspan='3' class='subject_name_print2' align='left'>" . trim($subject_name_print) . "</td>
                        ...
                        <td valign='top' width='50px'  align='left' class='total_disp_res2'><b>" . $total_disp_res . "</b></td>
                        <td valign='top' width='60px'  align='left' class='grade_point2'><b>" . $value['grade_point'] . "</b></td>
                        <td valign='top' width='50px'  align='left'><b> " . $value['grade_name'] . " </b></td>
                         <td valign='top' width='95px' class='print_month_year'  align='center'><b>" . strtoupper($year_of_passing) . "</b></td>
                    </tr>
                </table>";
                $total_sub_count++;$stu_subjects++;
        ...
        $body_2 .="<table style='line-height: 1.2em; ' border='0' width='100%' >
          ...
          foreach ($check_add as $valuess) 
          {
             ...
             // $sub_na = wordwrap(strtoupper(mb_convert_encoding($subjectname['subject_name'],"HTML-ENTITIES","UTF-8")), 60, "\n", true);
              ...
              $subject_name_print= "<b>". wordwrap($str,48,"<r>\n");
              if($valuess['ese_maximum']!=NULL && !empty($valuess['ese_maximum']))
               {
                  $ese_max_disp = $valuess['ese_maximum']=100;      
               }
              ...
              <table style='line-height: 1.2em; ' border='0' width='100%' >
                  <tr>
                      ...
                      <td valign='top' width='35px' class='semester2' align='left'><b>" . $semester_array[$valuess['semester']]. "</b></td>
                      <td valign='top' width='80px' class='subject_code2' align='left'><b>" . strtoupper($valuess['subject_code']) . "</b></td>
                      <td valign='top' width='210px' colspan='3' class='subject_name_print2' align='left'><b>" . strtoupper($valuess['subject_name']) . "</b></td>
                        <td valign='top' width='42px' class='credit_points2' align='left'><b>" . $credit_points . "</b></td>
                      <td valign='top' width='42px' class='ese_max_disp2'  align='left'><b>" . $ese_max_disp . "</b></td>
                      <td valign='top' width='42px'  align='center' class='cia_max_disp2'><b>" . $cia_max_disp . "</b></td>
                      <td valign='top' width='53px'  align='center' class='total_max_disp2'><b>" . $total_max_disp . "</b></td>
                      ...
                      <td valign='top' width='50px'  align='left' class='total_disp_res2'><b>" . $total_disp_res . "</b></td>
                      <td valign='top' width='60px'  align='left' class='grade_point2'><b>" . $valuess['grade_point'] . "</b></td>
                      <td valign='top' width='50px'  align='left'><b> " . $valuess['grade_name'] . " </b></td>
                      <td valign='top' width='95px' class='print_month_year'  align='center'><b>" . strtoupper($year_of_passing) . "</b></td>
