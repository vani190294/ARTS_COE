...
$subject_array_ncc = ['18NCC01','18NCC01','18NCC02','18NCC02','18NCC03','18NCC03','18NCC04','18NCC04','18CSS28','18BTU17','18CDU35','18CUG62','18ENU34','18MAU33','18MBU17','18MSU34','18NCC18','18BSU20','18HMU29','18NCC21','18SWP33','18PSU25'];
?>
<style type="text/css">
    ...
    if($file_content_available=="Yes")
    {
      ...
      <tr>
        ...
        $header.='<table class="makeitBigger" width="100%">
                    <tr>
                        <td valign="top" colspan=3 align="left" width="100" style="padding-top: 20px;">'.strtoupper($value["degree_code"]).'  </td>
                        <td valign="top" colspan=7 align="left" width="350" style="padding-top: 15px;padding-right:-25" >'.strtoupper($value["programme_name"]).'</td>
                        <td valign="top" colspan=3 align="left" width="100" style="padding-top: 15px;padding-left:-85" >'.strtoupper($show_date_publication).'</td>
                        <td valign="top" colspan=3  align="left" width="150" style="padding-top: 15px;padding-right:25" >2018-2021</td>
                    </tr>
                    <tr><td valign="top"  colspan="16" height="40px" >&nbsp;</td></tr>
                    <tr>
                        <td valign="top" class="student_name" style="padding-left: 10px" colspan="10">'.strtoupper($value["name"]).'</td>
                        <td valign="top"  colspan=3   class="dob" style="padding-left:-140" align="center" width="100" >'.$dob.'</td>
