    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">        
        ...
        <div class="col-xs-12 col-sm-4 col-lg-4"> <br />
             <div class="col-lg-6 col-sm-6">
                <?= Html::Button('Get '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT), ['onClick'=>'getfeespaidstulist()','id'=>'change_name','class' => 'btn btn-success' ]) ?>
                <?= Html::a("Reset", Url::toRoute(['mark-entry-master/view-fees-paid']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
             </div>
