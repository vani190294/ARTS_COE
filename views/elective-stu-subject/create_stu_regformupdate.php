...
<div class="box-body">
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
    		...
    		<div class="col-xs-4 col-sm-4 col-lg-4">
    			...
    			<div class="col-xs-12 col-sm-12 col-lg-12">
    				...
    				<?php 
				    	...
				    	{ 
				    		$checked='';
				    		$elective_nominal= Yii::$app->db->createCommand("SELECT register_number FROM cur_elective_nominal WHERE cur_erss_id='".$cur_erss_id."' AND register_number='".$regnums[$i]['register_number']."'")->queryScalar();
				    		if($elective_nominal!='')
				    		{
				    			$checked='checked';
				    			$checkedcout++;
				    		...
				    		?>
				    	 	<div class="col-xs-12 col-sm-12 col-lg-12">
				    	 		<label>
				    	 		<input type="checkbox" name="register_number[]" class="<?= $checkstu;?>" onclick="checkelectstucount(<?= count($getsection);?>,<?= $sectionid;?>)" value="<?= $regnums[$i]['register_number'];?>" <?= $checked;?>>
    	...
    	//echo	$checkedcout; exit;
    	?>
    </div>
     <div class="col-xs-12 col-sm-12 col-lg-12" <?php if($checkedcout==0){?> style="display: none;"<?php }?> id="saveelectstudent">
