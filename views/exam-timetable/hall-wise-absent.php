...
/* @var $form ActiveForm */
$this->title= "Hall Wise ".ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_ABSENT);
        ...
        <?php echo $form->field($model,'exam_session')->widget(
                Select2::classname(), [
                    ...
                    'options' => [
                        ...
                        'onchange'=>'getChangeHalls(this.value,$("#exam_date").val(), $("#hallallocate-year").val(), $("#exam_month").val());'  
                    ],
                    'pluginOptions' => [
                        'allowClear' => true,
                    ],
    ...
    <div class="col-lg-8 col-sm-8"> 
        <br />
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                <?= Html::Button('Submit', ['onClick'=>'getExamHallStudents($("#hall_names").val(), $("#exam_date").val(), $("#absententry-exam_session").val(), $("#hallallocate-year").val(), $("#exam_month").val(),);','class' => 'btn  btn-group-lg btn-group btn-primary']) ?>
