...
/* @var $form ActiveForm */
$this->title= 'Practical '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_ABSENT).' List';
    ...
    <div class="col-lg-3 col-sm-3"> 
        <br />
            ...
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                <?= Html::Button('Submit', ['onClick'=>'showPracticalAbdata($("#prac_exam_year").val(), $("#prac_exam_month").val(), $("#prac_exam_date").val(),$("#prac_exam_session").val(), $("#stu_batch_id_selected").val() );','class' => 'btn  btn-group-lg btn-group btn-primary']) ?>
