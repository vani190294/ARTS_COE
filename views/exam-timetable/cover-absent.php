    ...
    <div class="col-lg-3 col-sm-3"> 
        <br />
            ...
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                <?= Html::Button('Submit', ['onClick'=>'show($("#hallallocate-year").val(), $("#exam_month").val(), $("#exam_date").val(),$("#absententry-exam_session").val(),$("#exam_type").val() );','class' => 'btn  btn-group-lg btn-group btn-primary']) ?>
