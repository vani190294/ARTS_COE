    ...
    <div class="col-lg-3 col-sm-3"> 
        <br />
            ...
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                <?= Html::Button('Submit', ['onClick'=>'showboardlist($("#hallallocate-year").val(), $("#exam_month").val(), $("#exam_type").val(),$("#ans_pack_serial").val());','class' => 'btn  btn-group-lg btn-group btn-primary']) ?>
                <?= Html::a("Reset", Url::toRoute(['exam-timetable/board-wise-absent-list']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
