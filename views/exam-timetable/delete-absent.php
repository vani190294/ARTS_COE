...
/* @var $form ActiveForm */
$this->title= "Delete ".ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_ABSENT);
...
?>
<h1><?php echo "Delete ".ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_ABSENT); ?></h1>
    ...
    <div class="col-lg-3 col-sm-3"> 
        <br />
            ...
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                <?= Html::Button('Submit', ['onClick'=>'showAbdatadelete( $("#hallallocate-year").val(), $("#exam_month").val());','class' => 'btn  btn-group-lg btn-group btn-primary']) ?>
                <?= Html::a("Reset", Url::toRoute(['exam-timetable/delete-absent']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
