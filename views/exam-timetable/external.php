...
/* @var $form ActiveForm */
$this->title= "EXTERNAL SCORE CARD OUT OF 100";
    ...
    <div class="col-lg-2 col-sm-2"> 
        <br />
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                ...
                <?= Html::a("Reset", Url::toRoute(['exam-timetable/external']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
...
<?php 
    if(isset($external_score) && !empty($external_score))
    {
        ...
        include('external-score-pdf.php');
    }
    else
    {
