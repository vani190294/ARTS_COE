...
/* @var $form ActiveForm */
$this->title= "Consolidate Absentees Approve";
    ...
    <div class="col-lg-3 col-sm-3"> 
        <br />
            ...
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                <?= Html::Button('Submit', ['onClick'=>'showConsolidateAbdata($("#hallallocate-year").val(), $("#exam_month").val(), $("#exam_date").val(),$("#absententry-exam_session").val() );','class' => 'btn  btn-group-lg btn-group btn-primary']) ?>
...
<div class="row hide_ab_list">
    <div class="col-12">
        <div class="col-lg-12 col-sm-12" id="hide_ab_pdf" style="display: none !important;">
            <?php 
        ...
        <div class="col-lg-12 col-sm-12">
           ...
           <div class="btn-group pull-right"  id="hide_ab_approve" aria-label="Actions to be Perform">
                <?= Html::SubmitButton('Approve', ['class' => 'btn  btn-group-lg btn-group btn-primary']) ?>
                <?= Html::a("Cancel", Url::toRoute(['exam-timetable/consolidate-absent-list']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
