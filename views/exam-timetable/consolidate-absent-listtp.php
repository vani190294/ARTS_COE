...
/* @var $form ActiveForm */
$this->title= "Consolidate Absent TP LIST";
    ...
    <div class="col-lg-3 col-sm-3"> 
        <br />
            ...
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                <?= Html::Button('Submit', ['onClick'=>'showAbdataList($("#hallallocate-year").val(), $("#exam_month").val(), $("#stu_batch_id_selected").val() );','class' => 'btn  btn-group-lg btn-group btn-primary']) ?>
                <?= Html::a("Reset", Url::toRoute(['exam-timetable/consolidate-absent-listtp']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
