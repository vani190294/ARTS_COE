                ...
                'items' => [
                        ...
                        'items' => [
                            ...
                            [
                             ...
                             [
                                ...
                                'icon' => 'hand-o-right',
                                'url' => ['/hall-allocate/hall-invigilator'],
                                'visible' => Yii::$app->user->can('/hall-allocate/hall-invigilator'),
                            ],
                             
                             [
                                'label' => "Hall Invigilator Report", 
                                'icon' => 'hand-o-right',
                                'url' => ['/hall-allocate/hall-duty'],
                                'visible' => Yii::$app->user->can('/hall-allocate/hall-duty'),
                            ],
                            [
                                'label' => "Hall Invigilator Faculty Duty Report", 
                                'icon' => 'hand-o-right',
                                'url' => ['/hall-allocate/hall-faculty'],
                                'visible' => Yii::$app->user->can('/hall-allocate/hall-faculty'),
                            ]
                                ...
                                'options' => ['class' => 'dropdown-submenu', 
                                            ...
                                            'items' => [
                                                ...
                                                ['label' => "Re-Print",
                                                 ...
                                                 ['label' => "Practical Proforma",
                                                     'icon' => 'hand-o-right',
                                                     'visible' => Yii::$app->user->can('/batch/practical'),
                                                     'url' => ['/batch/practical'],
                                                ],


                                                ['label' => "Practical Attendance Sheet",
                                                     'icon' => 'hand-o-right',
                                                     'visible' => Yii::$app->user->can('/batch/practical'),
                                                     'url' => ['/practical-entry/practical-attendance-sheet'],
                                                ],
                                                ['label' => "Cover Number Practical",
                                                     'icon' => 'hand-o-right',
                                                     'visible' => Yii::$app->user->can('/batch/cover-number-prac'),
                                                     'url' => ['/batch/cover-number-prac'],
                                                ],
                                                 ['label' => "Practical Proforma Programme wise",
                                                     'icon' => 'hand-o-right',
                                                     'visible' => Yii::$app->user->can('/batch/practical-programme'),
                                                     'url' => ['/batch/practical-programme'],
                                                ],
                    ...
                    ['label' => 'Valuation', 
                            ...
                            'items' => [
                                    ...
                                    ['label' => " Generate Datewise Answer Covers!!",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/hall-allocate/answer-packets'],
                                        'visible' => Yii::$app->user->can('/hall-allocate/answer-packets'),
                                    ],

                                      ['label' => " Report Valuation Datewise Answer Covers!!",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/hall-allocate/answer-val'],
                                        'visible' => Yii::$app->user->can('/hall-allocate/answer-val'),
                                    ], 

 

                                    ['label' => "Print Register Numbers",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/hall-allocate/print-register-numbers'],
                                        'visible' => Yii::$app->user->can('/hall-allocate/print-register-numbers'),
                                    ], 
                                  
                                    ['label' => "Valuation Faculty Details",
                                        'icon' => 'hand-o-right',
                                    ...
                                    ['label' => "Valuation Scrutiny Details",
                                        'icon' => 'hand-o-right',
                                ...
                                ['label' => "Valuation Mark Entry Approve",
                                         'icon' => 'hand-o-right',
                                         'url' => ['/dummy-numbers/dummy-number-entrynew'],
                                         'visible' => Yii::$app->user->can('/dummy-numbers/dummy-number-entrynew'),
                                    ],
                                     ['label' => "Scrutiny MarkEntry Report",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/dummy-numbers/scrutinyentryreport'],
                                        'visible' => Yii::$app->user->can('/dummy-numbers/scrutinyentryreport'),
                                    ],
                                     ['label' => "Scrutiny MarkEntry QPcode Report",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/dummy-numbers/scrutinyentryreportqp'],
                                        'visible' => Yii::$app->user->can('/dummy-numbers/scrutinyentryreport'),
                                    ],
                                    ['label' => "Scrutiny MarkEntry Update",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/dummy-numbers/scrutinyentryupdate'],
                                        'visible' => Yii::$app->user->can('/dummy-numbers/scrutinyentryupdate'),
                                    ],

                                    ['label' => "Absent Approve",
                                         'icon' => 'hand-o-right',
                                         'url' => ['/dummy-numbers/absent-approve'],
                                         'visible' => Yii::$app->user->can('/dummy-numbers/absent-approve'),
                                    ],


                                      ['label' => "Cover Number Absent List(ExamDatewise)",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/exam-timetable/cover-absent'],
                                        'visible' => Yii::$app->user->can('/exam-timetable/cover-absent'),
                                    ],

                                      ['label' => "Board Wise Absent List(ExamDatewise)",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/exam-timetable/board-wise-absent'],
                                        'visible' => Yii::$app->user->can('/exam-timetable/board-wise-absent'),
                                    ],

                                      ['label' => "Board Wise Absent List",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/exam-timetable/board-wise-absent-list'],
                                        'visible' => Yii::$app->user->can('/exam-timetable/board-wise-absent'),
                                    ],

                                     [
                                                'label' => "Evaluator Mark Entry",
                                                'icon' => 'hand-o-right',
                                                'url' => ['/mark-entry/valuator-markentry'],
                                                'visible' => Yii::$app->user->can('/mark-entry/valuator-markentry'),
                                  ],

                                            [
                                                'label' => " Evaluator Mark Entry Report",
                                                'icon' => 'hand-o-right',
                                                'url' => ['/mark-entry/valuator-markentry-report'],
                                                'visible' => Yii::$app->user->can('/mark-entry/valuator-markentry-report'),
                                            ],

                                             [
                                                'label' => "Mark Entry Update",
                                                'icon' => 'hand-o-right',
                                                'url' => ['/mark-entry/valuator-markentry-update'],
                                                'visible' => Yii::$app->user->can('/mark-entry/valuator-markentry-update'),
                                            ],

                                             [
                                                'label' => "Scrutiny MarkEntry New",
                                                'icon' => 'hand-o-right',
                                                'url' => ['/dummy-numbers/valuation-marks-entry-new'],
                                                'visible' => Yii::$app->user->can('/dummy-numbers/valuation-marks-entry-new'),
                                            ],
                            ...
                            'visible' => Yii::$app->user->can('/sub/index'),
                                    ...
                                    'items' => [
                                        ['label' => 'View Value Added Marks',
                                         ...
                                         ['label' => 'Value Added Marksheet',
                                             'icon' => 'hand-o-right',
                                             'visible' => Yii::$app->user->can('/coe-value-mark-entry/consolidate-mark-sheet'), 
                                             'url' => ['coe-value-mark-entry/consolidate-mark-sheet'],
                                        ],
                                 ...
                                 'options' => ['class' => 'dropdown-submenu', 'data-widget'=> 'tree'],
                                    'items' => [
                                        ...
                                        [   
                                          ...
                                          [
                                'label' => 'Exam Time Table Additional Credits', 
                                'icon' => 'hand-o-right', 
                                'visible' => Yii::$app->user->can('/coe-add-exam-timetable/index'),
                                'url' => ['/coe-add-exam-timetable/index'],
                            ],

                               [
                                'label' => 'Galley Additional Credits', 
                                'icon' => 'hand-o-right', 
                                'visible' => Yii::$app->user->can('/coe-add-hall-allocate/create'),
                                'url' => ['/coe-add-hall-allocate/create'],
                            ],
                             [
                                'label' => 'Galley Additional Credits Reports', 
                                'icon' => 'hand-o-right', 
                                'visible' => Yii::$app->user->can('/coe-add-hall-allocate/galley-report'),
                                'url' => ['/coe-add-hall-allocate/galley-report'],
                            ],
                            [
                                'label' => 'Additional Attendance Sheet', 
                                'icon' => 'hand-o-right', 
                                'visible' => Yii::$app->user->can('/coe-add-hall-allocate/attendance-sheet'),
                                'url' => ['/coe-add-hall-allocate/attendance-sheet'],
                            ],
                             [
                                'label' => 'Additional Credits qpdistribution', 
                                'icon' => 'hand-o-right', 
                                'visible' => Yii::$app->user->can('/coe-add-hall-allocate/qpdistribution'),
                                'url' => ['/coe-add-hall-allocate/qpdistribution'],
                            ],
                            [
                                'label' => 'Additional Credits Hall Ticket', 
                                'icon' => 'hand-o-right', 
                                'visible' => Yii::$app->user->can('/coe-add-hall-allocate/qpdistribution'),
                                'url' => ['/coe-add-hall-allocate/hall-ticket'],
                            ],
                             [
                                'label' => 'Internet Copy Hall Ticket', 
                                'icon' => 'hand-o-right', 
                                'visible' => Yii::$app->user->can('/coe-add-hall-allocate/qpdistribution'),
                                'url' => ['/coe-add-hall-allocate/hallticketexport'],
                            ],
                            
                             [   
                                'label' => 'Additional Credits Pass Count Report',
                                 'icon' => 'hand-o-right', 
                                 'visible' => Yii::$app->user->can('/mark-entry/internet-copy-additional-credits'), 
                                 'url' => ['/mark-entry/add-count'],
                             ],
                              [   
                                'label' => 'Notice board marks(Additional credits)',
                                 'icon' => 'hand-o-right', 
                                 'visible' => Yii::$app->user->can('/mark-entry/internet-copy-additional-credits'), 
                                 'url' => ['/mark-entry/sub-add'],
                             ],
                             
                               
                             [   
                                'label' => 'Additional credits Reports',
                                 'icon' => 'hand-o-right', 
                                 'visible' => Yii::$app->user->can('/mark-entry/internet-copy-additional-credits'), 
                                 'url' => ['/mark-entry/sub-additional'],
                             ],
                              [   
                                'label' => 'Full Additional Credits Reports',
                                 'icon' => 'hand-o-right', 
                                 'visible' => Yii::$app->user->can('/mark-entry/internet-copy-additional-credits'), 
                                 'url' => ['/mark-entry/add'],
                             ],
                              ...
                              [   
                                'label' => 'Subjects wise Count',
                                 'icon' => 'hand-o-right', 
                                 'visible' => Yii::$app->user->can('/mark-entry/internet-copy-additional-credits'), 
                                 'url' => ['/mark-entry/countadd'],
                             ],


                             [   
                                'label' => 'Adc,Nptel,Coursers-wise Count',
                                 'icon' => 'hand-o-right', 
                                 'visible' => Yii::$app->user->can('/mark-entry/internet-copy-additional-credits'), 
                                 'url' => ['/mark-entry/adc-nptl-coursera'],
                             ],
                              ...
                              [
                                ...
                                ['label' => " Generate Datewise Answer Covers",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/coe-add-hall-allocate/add-answer-packets'],
                                        'visible' => Yii::$app->user->can('/hall-allocate/answer-packets'),
                              ...
                              ['label' => " Report valuation Datewise Answer Covers",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/coe-add-hall-allocate/add-answer-val'],
                                        'visible' => Yii::$app->user->can('/coe-add-hall-allocate/add-answer-val'),

                                            
                              ],
                              ['label' => "Print Register Numbers",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/coe-add-hall-allocate/add-print-register-numbers'],
                                        'visible' => Yii::$app->user->can('/hall-allocate/print-register-numbers'),
                              ],
                              ...
                              ['label' => "Cover Number Absent List(ExamDatewise)",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/coe-add-exam-timetable/cover-absent'],
                                        'visible' => Yii::$app->user->can('/hall-allocate/print-register-numbers'),
                              ],
                              ...
                              ['label' => "Board Wise Absent List(ExamDatewise)",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/coe-add-exam-timetable/board-wise-absent'],
                                        'visible' => Yii::$app->user->can('/exam-timetable/board-wise-absent'),
                              ],

                               ['label' => "Board Wise Absent List",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/coe-add-exam-timetable/board-wise-absent-add'],
                                        'visible' => Yii::$app->user->can('/coe-add-exam-timetable/board-wise-absent'),
                              ],
                               ['label' => "Add External Score Card",
                                        'icon' => 'hand-o-right',
                                        'url' => ['/coe-add-exam-timetable/external-score'],
                                        'visible' => Yii::$app->user->can('/coe-add-exam-timetable/external-score'),
                              ],
