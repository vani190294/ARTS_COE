...
echo Dialog::widget();
$this->title = 'Hall Invigilation Internal Exam';
?>
...
<div class="box-body"> 
   ...
   <div class="row">
        ...
        <div class="col-xs-12 col-sm-2 col-lg-2">
         ...
         <div class="col-xs-12 col-sm-2 col-lg-2" id="fhboarddata">
           <?php echo $form->field($modelfa,'board')->widget(
                Select2::classname(), [
                    'data' => ['CIVIL'=>'CIVIL','CSE/IT'=>'CSE/IT','ECE'=>'ECE','EEE'=>'EEE','MCT'=>'MCT','MECH'=>'MECH','MBA'=>'MBA','MATHS'=>'MATHS','PHYSICS'=>'PHYSICS','CHEMISTRY'=>'CHEMISTRY','ENGLISH'=>'ENGLISH'],
                    'options' => [
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-2 col-lg-2" id="showdelete_fh" style="display: none;">
            ...
            <div class="col-xs-12 col-sm-6 col-lg-6">
                <?php if(Yii::$app->user->getId()==1 || Yii::$app->user->getId()==11 || Yii::$app->user->getId()==18)
                { echo Html::Button('Delete Hall Arrange' ,['class' => 'btn btn-group btn-group-lg btn-warning', 'id'=>'delete_fh_int' , 'onclick'=>'js:spinner();']); } ?> 
            </div>
        </div>
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12" id="show_facultydetails">  
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-12">
                    <div class="col-xs-12 col-sm-5 col-lg-5">
                        ...
                        <select name="multi_halls" multiple size="10" id="from_int" class="form-control multi_selecthalls">
                            <option>-----Select ----</option>
                        </select>
                    </div>
                    <div class="col-lg-2 col-sm-2 col-xs-12 text-center"> <br />
                        <a href="javascript:moveSelected11('from_int', 'to_int');" id="fget" class="btn btn-success">&gt;</a>
                            <br><br>
                        <a href="javascript:moveSelected11('to_int', 'from_int');" id="tget" class="btn btn-primary">&lt;</a>
                            <br><br>
                    ...
                    <div class="col-xs-12 col-sm-5 col-lg-5">
                        ...
                        <select multiple id="to_int" size="10" name="topics[]" class="form-control"></select>
                    </div>
                </div>   
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-lg-12">
                    ...
                    <div class="col-xs-12 col-sm-5 col-lg-5">
                        <form name="selection" method="post" onSubmit="return selectAll()">
                            <label class="control-label">RHS</label><br>
                        <select name="multi_halls_rhs" multiple size="10" id="from_rhs_int" class="form-control multi_selecthalls">
                            <option>-----Select ----</option>
                        </select>
                    </div>
                    <div class="col-lg-2 col-sm-2 col-xs-12 text-center">
                        <br>
                        <a href="javascript:moveSelected2('from_rhs_int', 'to_rhs_int');" id="fget1" class="btn btn-success">&gt;</a>
                            <br><br>
                        <a href="javascript:moveSelected2('to_rhs_int', 'from_rhs_int');" id="tget1" class="btn btn-primary">&lt;</a>
                            <br><br>
                        <!--a href="javascript:moveAll1('from_rhs', 'to_rhs');" id="ffget1" class="btn btn-success">&gt;&gt;</a>
                            <br><br>            
                        <a href="javascript:moveAll1('to_rhs', 'from_rhs');" id="ttget1" class="btn btn-primary">&lt;&lt;</a!-->
                    </div>
                    <div class="col-xs-12 col-sm-5 col-lg-5">
                        <label class="control-label">Alloted RHS Faculty</label><br>
                        <select multiple id="to_rhs_int" size="10" name="topics[]" class="form-control"></select>
                    </div>
                </div>   
            </div>
            ...
            <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-lg-12">
                        <div class="col-xs-12 col-sm-5 col-lg-5">
                            Available RHS Faculty(s)
                            <input type="text" name="countFrom_rhs" id="countFrom_rhs" class="form-control" readonly>
                        </div>
                        ...
                        <div class="col-xs-12 col-sm-5 col-lg-5">
                            Alloted RHS Faculty Count
                            <input type="text" name="countTo_rhs" id="countTo_rhs" class="form-control" readonly>
                        </div>
                    </div>
            </div>
            ...
            <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-12 col-lg-12" style="text-align: center;">
                        ...
                        <div class="btn-group" role="group" aria-label="Actions to be Perform">
                                <?= Html::submitButton('Save' ,['class' => 'btn btn-group btn-group-lg btn-success', 'id'=>'save_fh_int' , 'onclick'=>'js:getValues11();spinner();']) ?>  
                                
                                <?= Html::a("Cancel", Url::toRoute(['hall-allocate-int/faculty-hall-arrange']), ['class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
 ...
 <?php }
            ...
            if(!empty($faculty_hall_data))
            {
                ...
                $print_pdf = Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['hall-allocate-int/qpfacultyhall-pdf'], [
                            'class' => 'pull-right btn btn-block btn-primary',
                            'target' => '_blank',
                            'data-toggle' => 'tooltip',
                            'title' => 'Will open the generated PDF file in a new window'
                    ]);
                    $print_excel = Html::a('<i class="fa fa-file-pdf-o"></i> EXCEL', ['hall-allocate-int/qpfacultyhall-excel'], [
                    ...
                    $back = Html::a('Back to Arrange', ['hall-allocate-int/faculty-hall-arrange'], [
                                'class' => 'pull-right btn btn-block btn-warning',
                                'data-toggle' => 'tooltip',
                                'title' => 'Will open the generated PDF file in a new window'
                    ]);
