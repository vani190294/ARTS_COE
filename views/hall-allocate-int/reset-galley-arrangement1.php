...
$this->title = 'RESET INTERNAL EXAM GALLEY ARRANGEMENT REPORT';
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">                
        ...
        <div class="col-xs-12 col-sm-4 col-lg-4"> <br />
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                <?= Html::Button("Delete", ['class' => 'btn btn-group btn-group-lg btn-primary ','value'=>'reset_data','name'=>'reset_data','id'=>'clear_id','onclick'=>'js:resetHalls1();']) ?>
                  <?=Html::a("Cancel", Url::toRoute(['hall-allocate-int/reset-galley-arrangement1']), ['class' => 'btn btn-group btn-group-lg btn-warning ']) ?>             
            </div>
        </div>
    </div>
</div>
