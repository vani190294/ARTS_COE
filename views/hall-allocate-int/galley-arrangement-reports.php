            ...
            if($file_content_available=="Yes")
            {
                ...
                foreach ($get_data as $value) 
                {
                    if($prev_hall_name!=$value['hall_name'])
                    {
                        ...
                        $_time = $org_email=='coe@skasc.ac.in' ? '(10.30 AM TO 12.00 PM)':'(10.30 AM TO 12.00 PM)';
                        $_time_an = $org_email=='coe@skasc.ac.in' ? '(02.30 PM TO 04.00 PM)':'(02.30 PM TO 04.00 PM)';
                        ...
                        <tr>
                          <td colspan=6 align="center"> <h4>
                               END SEMESTER EXAMINATIONS : '.strtoupper($value['month']." - ".$value['year']).' </h4>
                        ...
                        <tr>
                         <td colspan=6 align="center"> <h2><b>
                              EXAMINATION HALL NAME : '.$value['hall_name'].'</b> </h2>
                         </td>                          
                        </tr>
