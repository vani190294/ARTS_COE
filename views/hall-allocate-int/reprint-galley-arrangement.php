...
$this->title = 'RE PRINT INTERNAL EXAM GALLEY ARRANGEMENT REPORT';
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">                
        ...
        <div class="col-xs-12 col-sm-4 col-lg-4"> <br />
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                ...
                <?=Html::a("Cancel", Url::toRoute(['hall-allocate-int/reprint-galley-arrangement']), ['class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
