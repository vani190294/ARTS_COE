...
$this->title=ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT)." ".ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_EXAM)." Reports";
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">        
            ...
            <div class="col-lg-3 col-sm-3"><br />
                ...
                <?= Html::a("Reset", Url::toRoute(['hall-allocate/courseexamreports']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
            </div>
...
<?php 
include_once("course_count_report.php");
?>