...
$this->title=ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT)." Wise Reports";
...
<?php Yii::$app->ShowFlashMessages->showFlashes();?>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="col-lg-2 col-sm-2">
                <?php echo $form->field($hallModel,'subject_code')->widget(
                    Select2::classname(), [
            ...
            <div class="col-lg-3 col-sm-3"><br />
                ...
                <?= Html::submitButton('Print Reports', ['onClick'=>"spinner();", 'name'=>'get_subject_reports','class' => 'btn btn-success' ]) ?>
                <?= Html::a("Reset", Url::toRoute(['hall-allocate/subjectwisereports']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
...
<?php 
include_once("subject_report.php");
?>