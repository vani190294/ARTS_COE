...
use yii\helpers\Url;
echo Dialog::widget();
$this->title = 'Internal - Hall Vs '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT);
?>
...
<div class="box-body"> 
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">                
        ...
        <br>
    	<div class="col-xs-12 col-sm-2 col-lg-2">
 			<input type="button" class="btn btn-success" name="hallvsstu" value="Submit" id="hallstu">
            <?= Html::a("Reset", Url::toRoute(['hall-allocate/hallvsstudent']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
    	</div>
    </div>
     ...
     <div class="show_hall_vs_stu_print row">
        <div class="pull-right col-md-4">
            <?php 
                ...
                echo Html::a('<i class="fa fa-file-pdf-o"></i> ' . "PDF",array('hallvsstudentpdf','exportPDF'=>'PDF'),array('title'=>'Export to PDF','target'=>'_blank','class'=>'pull-right btn btn-warning', 'style'=>'color:#fff'));
                
                echo Html::a('<i class="fa fa-file-excel-o"></i> ' . "EXCEL ",array('excelhallvsstudent','exportPDF'=>'PDF'),array('title'=>'Export to Excel','target'=>'_blank','class'=>'pull-right btn btn-info', 'style'=>'color:#fff'));
