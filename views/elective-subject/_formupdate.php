    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
                    ...
                    <?= $form->field($model, 'coe_dept_id')->widget(
                            Select2::classname(), [  
                                ...
                                'options' => [
                                    ...
                                    //'onchange'=>'assigntodeptelective();checkcreditdistrubtion();',
                                ],
                               'pluginOptions' => [
                                   'allowClear' => true,
                                ],
         ...
         <div class="col-xs-12 col-sm-12 col-lg-12">
             ...
             <?php  $prefix=substr($model->subject_code,0,5); $code=substr($model->subject_code,5,6);?>
            <div class="col-md-4">
                 <div class="col-md-6">
            ...
            <!-- <div class="col-md-3">
                    ...
                    //             Select2::classname(), [  
                    //                 'data' => $electivemodel->getDepartmentdetails($model->coe_dept_id),                      
                    //                 'theme' => Select2::THEME_BOOTSTRAP,
                    //                 'options' => [
                    //                     'multiple'=>'multiple',
                    //                     'required'=>'required',
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
                <div class="form-group pull-right">
                    <?= Html::submitButton($model->isNewRecord ? 'Create' : 'Update', ['id'=>'savecurriculum','class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
                     <?= Html::a("Cancel", Url::toRoute(['elective-subject/index']), ['onClick'=>"spinner();",'class' => 'btn btn-warning']) ?>
                </div>
        </div>
        <?php ActiveForm::end(); ?>
