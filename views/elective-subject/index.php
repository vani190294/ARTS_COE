...
$visible =Yii::$app->user->can("/elective-subject/delete") || Yii::$app->user->can("/elective-subject/update") ? true : false;

$this->title = 'Open Elective Courses';
...
<div class="curriculum-subject-index">
    ...
    <p>
        <?= Html::a('Create Open Elective Subject', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
            ...
            [
                ...
                'buttons' => [
                    ...
                    'delete' => function ($url, $model) 
                    {
                        ...
                        {
                            return ((Yii::$app->user->can("/elective-subject/delete-oec")) ? Html::a('<span class="fa fa-remove increase_size"></span>', ['/elective-subject/delete-oec','id'=>$model->coe_elective_id], ['title' => 'delete',]) : '');
                        }
                    },
