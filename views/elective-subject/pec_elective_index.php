...
$this->title = 'Professional Elective Courses';
...
<div class="curriculum-subject-index">
    ...
    <p>
        <?= Html::a('Create', ['create-pec'], ['class' => 'btn btn-success']) ?>
    </p>
    <?= GridView::widget([
                ...
                'buttons' => [
                    ...
                    'delete' => function ($url, $model) {
                         if($model->approve_status==0)
                        {
                             ...
                             return ((Yii::$app->user->can("/elective-subject/delete-pec")) ? Html::a('<span class="fa fa-remove increase_size"></span>', ['/elective-subject/delete-pec','id'=>$model->coe_elective_id], ['title' => 'delete',]) : '');
                        }
                    },
