                        ...
                        <?= $form->field($model, 'coe_regulation_id')->widget(
                                Select2::classname(), [  
                                    ...
                                    'options' => [
                                        ...
                                        'onchange'=>'getLTPdetails();checkcreditdistrubtion();',
                                    ],
                                   'pluginOptions' => [
                                       'allowClear' => true,
                                    ],
             ...
             <?= $form->field($model, 'coe_ltp_id')->widget(
                            Select2::classname(), [  
                                ...
                                'options' => [
                                    'placeholder' => '-----Select----',
                                    'id' => 'coe_ltp_id', 
                                    'onchange'=>'getsubjecttype();checksubjectprefix1("O");',
                                ],
                               'pluginOptions' => [
                                   'allowClear' => true,
                                ],
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
                <div class="form-group pull-right">
                    <?= Html::submitButton($model->isNewRecord ? 'Create' : 'Update', ['id'=>'savecurriculum','class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
                     <?= Html::a("Cancel", Url::toRoute(['elective-subject/eec-index']), ['onClick'=>"spinner();",'class' => 'btn btn-warning']) ?>
                </div>
        </div>
        <?php ActiveForm::end(); ?>
