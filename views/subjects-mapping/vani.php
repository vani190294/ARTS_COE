                    ...
                    $html .='<table  style="overflow-x:auto;" width="100%"  cellspacing="0" cellpadding="0" border="0" class="table table-bordered table-responsive dum_edit_table table-hover" >
                        ...
                        foreach ($content_1 as $key => $value) 
                        {
                            ...
                            if($value['degree_type']=='PG'  && $printed==0 &&$value['degree_code']!=='Ph.D' )
                            {
                                ...
                                $body .='<tr><td colspan=4 algin="right" ><strong>TOTAL STRENGTH UG</strong></td><td>'.$total_strength.'</td><td>'.$detain_total.'</td><td>'.$disc_total.'</td><td>'.$rejoin_total.'</td><td>'.$transfer_total.'</td><td>'.$latearl_total.'</td><td>'.$others_count_total_disp.'</td><td>'.$GRAND_TOTAL.'</td></tr>';
                            ...
                            if($value['degree_type']=='PG' && ($value['degree_code']=='Ph.D' || $value['degree_code']=='Ph.d') )
                            {
                                ...
                                $total_strength_phd +=$value['count'];
                                $phd_printed = 1;
                            }
                        ...
                        $body .='<tr><td colspan=4 algin="center" ><strong>TOTAL STRENGTH PG</strong> </td><td>'.$total_strength.'</td><td>'.$detain_total.'</td><td>'.$disc_total.'</td><td>'.$rejoin_total.'</td><td>'.$transfer_total.'</td><td>'.$latearl_total.'</td><td>'.$others_count_total.'</td><td>'.$GRAND_TOTAL.'</td></tr>';
                        if($phd_printed==1)
                        {
