...
$this->title= "THEORY FACULTY REVALUATION CLAIM";
?>
   ...
   <div class="col-xs-12 col-sm-12 col-lg-12"> 
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12"> 
        ...
        <div class="btn-group col-lg-4 col-sm-4" role="group" aria-label="Actions to be Perform">
                <?= Html::Button( 'Show' , ['onClick'=>"gettheoryfacultyrevclaim();",'class' => 'btn btn-success' ]) ?>

                <?= Html::a("Reset", Url::toRoute(['coe-val-claim-amt/theory-faculty-revclaim']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
