...
$this->title= "THEORY FACULTY VALUATION CLAIM";
?>
...
<div class="row">
   <div class="col-xs-12 col-sm-12 col-lg-12"> 
        ...
        <?= $form->field($model, 'exam_month')->widget(
                Select2::classname(), [  
                    ...
                    'options' => [
                        ...
                        'id' => 'tvclaim_exam_month',
                        'name' => 'tvclaim_exam_month',       
                    ],
                   'pluginOptions' => [
                       'allowClear' => true,
                    ],
    ...
    <div class="col-xs-12 col-sm-2 col-lg-2">
            <?php 
        echo $form->field($model,'valuation_date')->widget(
                Select2::classname(), [
                    'options' => [
                        'placeholder' => '-----Select Date----', 
                        'id' => 'tvaluation_date',  
                        'name' => 'tvaluation_date',         
                    ],
                    'pluginOptions' => [
                        'allowClear' => true,
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12"> 
        ...
        <div class="btn-group col-lg-4 col-sm-4" role="group" aria-label="Actions to be Perform" id="showclaim">
                <?= Html::Button( 'Show' , ['onClick'=>"gettheoryfacultyvclaim();",'class' => 'btn btn-success' ]) ?>

                <?= Html::a("Reset", Url::toRoute(['coe-val-claim-amt/theory-faculty-vclaim']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
