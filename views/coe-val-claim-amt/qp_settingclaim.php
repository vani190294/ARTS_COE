...
$this->title= "QP SETTING FACULTY CLAIM";
?>
   ...
   <div class="col-xs-12 col-sm-12 col-lg-12"> 
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12"> 
        ...
        <div class="btn-group col-lg-4 col-sm-4" role="group" aria-label="Actions to be Perform" id="showclaim">
                <?= Html::Button( 'Show' , ['onClick'=>"getqpsettingclaim();",'class' => 'btn btn-success' ]) ?>

                <?= Html::a("Reset", Url::toRoute(['coe-val-claim-amt/qpsettingclaim']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>

                
            </div>        
    </div><br /><br />
    <div class="col-xs-12 col-sm-12 col-lg-12" id="claimpdf" style="display: none"> 
         <?php  echo Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['/qp/qpsetting-pdf'], [
          ...
          <?php  echo Html::a('<i class="fa fa-file-pdf-o"></i> Excel', ['/qp/qpsetting-excel1'], [
                'class'=>'pull-right btn btn-primary', 
                'target'=>'_blank', 
                'data-toggle'=>'tooltip', 
                'title'=>'Will open the generated PDF file in a new window'
