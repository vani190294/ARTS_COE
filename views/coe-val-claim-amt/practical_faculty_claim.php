...
$this->title= "PRACTICAL FACULTY CLAIM";
?>
   ...
   <div class="col-xs-12 col-sm-12 col-lg-12"> 
    ...
    <div class="col-xs-12 col-sm-2 col-lg-2">
     ...
     <div class="col-lg-2 col-sm-2" style="display: none;">
        ...
        <?php 
        echo $form->field($model,'val_faculty_id')->widget(
                Select2::classname(), [
                    'options' => [
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12"> 
        ...
        <div class="btn-group col-lg-4 col-sm-4" role="group" aria-label="Actions to be Perform" id="showclaim">
                <?= Html::Button( 'Show' , ['onClick'=>"getpracticalfacultyclaim();",'class' => 'btn btn-success' ]) ?>

                <?= Html::a("Reset", Url::toRoute(['coe-val-claim-amt/practical-faculty-claim']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
