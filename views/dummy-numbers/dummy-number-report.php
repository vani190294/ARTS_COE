...
<div class="row">
   <div class="col-xs-12 col-sm-12 col-lg-12"> 
        ...
        <div class="btn-group col-lg-6 col-sm-6" role="group" aria-label="Actions to be Perform">
                <?= Html::Button( 'Download' , ['onClick'=>'get_dummy_num_info();','class' => 'btn btn-success' ]) ?>

                <?= Html::a("Reset", Url::toRoute(['dummy-numbers/dummy-number-report']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
