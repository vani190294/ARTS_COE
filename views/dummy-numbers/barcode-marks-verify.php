...
<div class="col-xs-12 col-sm-12 col-lg-12">
   <div class="col-xs-12 col-sm-12 col-lg-12"> 
        ...
        <div class="col-xs-12 col-sm-2 col-lg-2">
         ...
         <div class="col-xs-12 col-sm-2 col-lg-2">
            <?= $form->field($model, 'student_map_id')->passwordInput(['placeholder'=>'Place Cursor and Scan'  ,'onfocus'=>" if (this.value==this.defaultValue) this.value = '' " ,'autocomplete'=>"off",'onblur'=>'getVCerifyBarMarks(this.id,this.value,$("#exam_year").val(),$("#exam_month").val())'])->label('Scan Barcode Here') ?>
             
        </div>

        <input type="hidden" id="dum_num"/>

        <?php if(($user_id==1 || $user_id==11))
        { ?>
        <!--  <div class="col-xs-12 col-sm-2 col-lg-2">
                        <label class="control-label">Booklet S.No.</label>
                        <input type="text" class="form-control" id="vbooklet_sno" required="required" placeholder="Enter Booklet S.No." />
                    </div> --> 
