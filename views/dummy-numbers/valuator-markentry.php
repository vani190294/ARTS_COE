   ...
   <div class="col-xs-12 col-sm-12 col-lg-12"> 
        ...
        <div class="row"  id='hide_bar_code_data1'>
            <div  class="col-xs-12"> <br /><br />
                <div class="col-xs-10">
                    ...
                    <div class="col-xs-12 col-sm-4 col-lg-4">
                        <?= $form->field($model, 'student_map_id')->passwordInput(['placeholder'=>'Place Cursor and Scan', 'autocomplete'=>"off",'onblur'=>'valuatormarkentry(this.id, this.value, $("#exam_year").val(), $("#exam_month").val())'])->label('Scan Barcode Here') ?>
                    </div>
            ...
            <div class="col-xs-12" style="text-align:right; padding-top:10px; display: none !important;" id='savevaluatorentryid'> 
                <div  class="col-xs-8"> 
                    <?= Html::Button('Save',['class' => 'btn btn-success', 'onClick'=>'savevaluatorentry()']) ?>
                </div>
                <div  class="col-xs-2"></div>
            </div>
