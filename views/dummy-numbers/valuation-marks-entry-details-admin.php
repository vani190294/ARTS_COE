...
$this->title = "Scrutiny mark entry Report";
    ...
    <div  class="col-xs-12" style="overflow-x: auto; display: none;" id="verification_details_data">
        ...
        <div class="col-xs-3 col-sm-2 col-lg-2">
         ...
         <div class="col-xs-2 col-sm-2 ">
            <?php 
                echo Html::a('<i class="fa fa-file-excel-o"></i> ' ."Excel",array('verifydetails-export-excel'),array('title'=>'Export to Excel','target'=>'_blank','class'=>'btn btn-block btn-primary', 'style'=>'color:#fff'));
