...
$this->title ="Verify & Migrate For Result";
$this->params['breadcrumbs'][] = $this->title;


?>
<h1><?php echo "Verify & Migrate For Result"; ?></h1>
                ...
                <?php echo $form->field($model, 'subject_map_id')->widget(
                    Select2::classname(), [
                        'options' => [
                            ...
                            'name'=>'sub_val',
                            'onchange' => 'getExaminerNames1(this.value);',
                        ],
                        'pluginOptions' => [
                            'allowClear' => true,
                        ],
   ...
   <div class="col-xs-12 col-sm-12 col-lg-12">
    ...
    <div id='hide_dum_data' class="row">
        <div  class="col-xs-12"> <br /><br />
            <div class="col-xs-1"> &nbsp; </div>
            <div class="col-xs-10">
                <?php //Html::submitButton('Migrate' , ['id' =>'submit_dummy', 'class' => 'btn btn-primary','data-confirm' => 'Are you sure you want to Continue <br /> This can not be Un-Done once the values were Submitted.']) ?>
