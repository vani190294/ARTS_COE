...
/* @var $form ActiveForm */
$this->title= "Board Wise Absent List";
...
?>
<h1><?php echo "Board Wise Absent List" ?></h1>
...
<div class="col-12">
    ...
    <div class="col-xs-12 col-sm-2 col-lg-2">
            <?= $form->field($ans, 'answer_packet_serial')->textInput(['id'=>'ans_pack_serial','name'=>'ans_pack_serial']) ?>
        </div>
    ...
    <div class="col-lg-3 col-sm-3"> 
        <br />
            ...
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                <?= Html::Button('Submit', ['onClick'=>'showboard1($("#exam_year").val(), $("#exam_month_add").val(), $("#exam_date_add").val(),$("#exam_type1").val(),$("#ans_pack_serial").val() ,$("#exam_session").val());','class' => 'btn  btn-group-lg btn-group btn-primary']) ?>
                <?= Html::a("Reset", Url::toRoute(['coe-add-exam-timetable/board-wise-absent']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
...
<div class="row hide_ab_list">
    <div class="col-12">
        <div class="col-lg-12 col-sm-12">
            ...
            echo Html::a('<i class="fa fa-file-pdf-o"></i> ' . "PDF",array('consolidate-absent-board-pdf','exportPDF'=>'PDF'),array('title'=>'Export to PDF','target'=>'_blank','class'=>'pull-right btn btn-warning', 'style'=>'color:#fff'));
            
            echo Html::a('<i class="fa fa-file-excel-o"></i> ' . "EXCEL ",array('consolidate-excel-board-pdf','exportPDF'=>'PDF'),array('title'=>'Export to Excel','target'=>'_blank','class'=>'pull-right btn btn-info', 'style'=>'color:#fff'));
