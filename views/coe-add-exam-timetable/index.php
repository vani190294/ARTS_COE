...
$this->title = ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_EXAM).' Timetables Additional';
$this->params['breadcrumbs'][] = $this->title;
?>
<?php Yii::$app->ShowFlashMessages->showFlashes();?> 
<div class="coe-add-exam-timetable-index">
...
<?php $visible = Yii::$app->user->can("/coe-add-exam-timetable/view") || Yii::$app->user->can("/coe-add-exam-timetable/update") ? true : false; ?>  
...
<?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                return ['value'=> $data['coe_add_exam_timetable_id']];
            }],
        ],
    ]); ?>
<?php Pjax::end(); ?></div>
