...
/* @var $form ActiveForm */
$this->title= "Cover Number Absent List";
...
?>
<h1><?php echo "Cover Number Absent List" ?></h1>
    ...
    <div class="col-lg-3 col-sm-3"> 
        <br />
            ...
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                <?= Html::Button('Submit', ['onClick'=>'show_add($("#exam_year").val(), $("#exam_month_add").val(), $("#exam_date_add").val(),$("#exam_session").val(),$("#exam_type1").val() );','class' => 'btn  btn-group-lg btn-group btn-primary']) ?>
                <?= Html::a("Reset", Url::toRoute(['coe-add-exam-timetable/cover-absent']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
