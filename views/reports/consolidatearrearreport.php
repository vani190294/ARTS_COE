                  ...
                  //echo $curyear; exit();
                    $html .='<table  style="overflow-x:auto;" width="100%"  cellspacing="0" cellpadding="0" border="0" class="table table-bordered table-responsive dum_edit_table table-hover" >
                      ...
                      foreach ($content_data as $value1) 
                      {
                          ...
                          else if(($curyear-$value1['batch_name'])<=7)
                          {
                            ...
                            $course_type_id=' AND course_type_id NOT IN (230,231,232)';
                            if($value1['batch_name']>=2021)
                            {
                                $tpaper_type_id=' AND (paper_type_id IN (8,9,121,136,38)  AND type_id IN (140,141,142,143))';

                                $thpaper_type_id=' AND (paper_type_id IN (8) AND type_id IN (143))';
                                $thpaper_type_id_12sem=' AND (paper_type_id IN (8,9,121,136,38) AND type_id IN (143))';
                                $thppaper_type_id=' AND (paper_type_id IN (9,121,136,38) AND type_id IN (140,141,142))';

                                $tpp_paper_type_id=' AND (paper_type_id IN (9,121,136,38,137) AND type_id IN (144))';

                                $ppaper_type_id=' AND (paper_type_id IN (10,11,12,22,61,68,100,123,137,105) AND type_id IN (143))';

                                $tsubject_type_id=''; 
                                $tpsubject_type_id='';

                                $ty50_in=' AND type_id IN (144)';
                                $ty50_notin=' AND type_id NOT IN (144)';
                            }
                            else
                            {
                            ...
                            $regrejoin=''; $rejoin_stu_count=$t_count_rejoin=$p_count_rejoin=$th_count_rejoin=$tp_count_rejoin=0;
                             ...
                             $stu_count_gen=Yii::$app->db->createCommand('SELECT count(distinct A.student_map_id) FROM coe_mark_entry_master as A 
                              ...
                              where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (3,7,6,253) AND B.status_category_type_id NOT IN('.$det_disc_type.')'.$course_type_id)->queryScalar();
                              ...
                              JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                              where degree_type="UG" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                              where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (3,7,6,253) AND B.status_category_type_id NOT IN('.$det_disc_type.') '.$tpaper_type_id.$course_type_id; //exit;
                              ...
                              JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                              where degree_type="UG" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                              where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (3,7,6,253) AND B.status_category_type_id NOT IN('.$det_disc_type.')'.$ppaper_type_id.$course_type_id; //exit;
                             ...
                             $tpgry='SELECT count(A.student_map_id) FROM coe_mark_entry_master as A 
                              ...
                              where  B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (3,7,6,253) AND B.status_category_type_id NOT IN('.$det_disc_type.') '.$thpaper_type_id.$course_type_id; //exit;
                              ...
                              where  B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (3,7,6,253) AND B.status_category_type_id NOT IN('.$det_disc_type.') '.$thpaper_type_id_12sem.$course_type_id; //exit;
                              ...
                              JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                              where C.semester>=3 AND degree_type="UG" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                              where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (3,7,6,253) AND B.status_category_type_id NOT IN('.$det_disc_type.')'.$thppaper_type_id.$course_type_id; //exit;
                              ...
                              JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                              where degree_type="UG" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                              where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (3,7,6,253) AND B.status_category_type_id NOT IN('.$det_disc_type.')'.$thppaper_type_id.$course_type_id;
                           
                                $thp_count=Yii::$app->db->createCommand($thpgry1)->queryScalar();

                                 $tpp_gry1='SELECT count(A.student_map_id) FROM coe_mark_entry_master as A 
                              JOIN coe_student_mapping as B ON B.coe_student_mapping_id=A.student_map_id 
                              JOIN coe_subjects_mapping as C ON C.coe_subjects_mapping_id=A.subject_map_id and B.course_batch_mapping_id=C.batch_mapping_id 
                              JOIN coe_bat_deg_reg as F ON F.coe_bat_deg_reg_id=B.course_batch_mapping_id and F.coe_bat_deg_reg_id=C.batch_mapping_id  
                              JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                              where degree_type="UG" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                              where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (3,7,6,253) AND B.status_category_type_id NOT IN('.$det_disc_type.')'.$tpp_paper_type_id.$course_type_id;
                           
                                $tpp_count=Yii::$app->db->createCommand($tpp_gry1)->queryScalar();
                              ...
                              JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                              where degree_type="UG" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                              where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (4) AND B.status_category_type_id NOT IN('.$det_disc_type.')'.$rejoin.$course_type_id; //exit;
                              ...
                              JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                              where degree_type="UG" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                              where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (4) AND B.status_category_type_id NOT IN('.$det_disc_type.') '.$tpaper_type_id.$rejoin.$course_type_id;
                              ...
                              JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                              where C.semester>=3 and degree_type="UG" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                              where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (4) AND B.status_category_type_id NOT IN('.$det_disc_type.') '.$thpaper_type_id.$course_type_id; //exit();
                             ...
                             $thdqry12='SELECT count(A.student_map_id) FROM coe_mark_entry_master as A 
                              ...
                              JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                              where C.semester<=2 AND degree_type="UG" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                              where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (4) AND B.status_category_type_id NOT IN('.$det_disc_type.') '.$thpaper_type_id_12sem.$course_type_id; //exit();
                              ...
                              JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                              where C.semester>=3 AND degree_type="UG" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                              where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (4) AND B.status_category_type_id NOT IN('.$det_disc_type.') '.$thppaper_type_id.$course_type_id;
                             ...
                             $tpqery12='SELECT count(A.student_map_id) FROM coe_mark_entry_master as A 
                              ...
                              where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (4) AND B.status_category_type_id NOT IN('.$det_disc_type.') '.$thppaper_type_id.$course_type_id;
                                ...
                                $tpp_qery='SELECT count(A.student_map_id) FROM coe_mark_entry_master as A 
                              JOIN coe_student_mapping as B ON B.coe_student_mapping_id=A.student_map_id
                              JOIN coe_subjects_mapping as C ON C.coe_subjects_mapping_id=A.subject_map_id and B.course_batch_mapping_id=C.batch_mapping_id 
                              JOIN coe_bat_deg_reg as F ON F.coe_bat_deg_reg_id=B.course_batch_mapping_id and F.coe_bat_deg_reg_id=C.batch_mapping_id  
                              JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                              where degree_type="UG" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                              where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (4) AND B.status_category_type_id NOT IN('.$det_disc_type.') '.$tpp_paper_type_id.$course_type_id;

                                $tpp_count_detain1=Yii::$app->db->createCommand($tpp_qery)->queryScalar();
                              ...
                              JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                              where degree_type="UG" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                              where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (4) AND B.status_category_type_id NOT IN('.$det_disc_type.') '.$ppaper_type_id.$course_type_id)->queryScalar();
                            ...
                            if($value1['batch_name']>=2021)
                            {
                              ...
                              $body .='<td align="center">'.($p_count+$tpp_count+$tp_count).' (P:'.($p_count).' TPP:'.($tpp_count).' TP:'.($tp_count).')</td>';
                               $p_count=($p_count+$tpp_count+$tp_count);
                              $body .='<td align="center">'.($t_count+($p_count-$tp_count)).'</td>';
                              
                              $body .='<td align="center">'.$stu_count_detain.'</td>';
                              $body .='<td align="center">'.$t_count_detain.' (T:'.$th_count_detain.' TP:'.$th_p_count_detain.')</td>';
                              $p_count_detain=$p_count_detain+$tpp_count_detain+$tpp_count_detain1;
                              $body .='<td align="center">'.($p_count_detain+$tpp_count_detain1).' (P:'.($p_count_detain-$tpp_count_detain).' TPP:'.($tpp_count_detain1).' TP:'.($tpp_count_detain).')</td>';
                              $body .='<td align="center">'.($t_count_detain+($p_count_detain-$tpp_count_detain)).'</td>';

                              $body .='<td align="center">'.($stu_count_gen+$stu_count_detain).'</td>';
                              $body .='<td align="center">'.($t_count+$t_count_detain).'</td>';
                              $body .='<td align="center">'.(($p_count-$tp_count)+($p_count_detain-$tpp_count_detain)).'</td>';
                              //$body .='<td align="center">'.(($t_count+$p_count)+($t_count_detain+$p_count_detain)).'</td>';
                              $ot=($t_count+($p_count-$tp_count))+($t_count_detain+($p_count_detain-$tpp_count_detain));
                       ...
                       <td align="center">'.$tot_stu.'</td><td align="center">'.$tot_t.'</td><td align="center">'.$tot_p.'</td><td align="center">'.$overalltotal.'</td></tr>';
                    ...
                    foreach ($content_data as $value1) 
                    {
                          ...
                          else if(($curyear-$value1['batch_name'])<=4)
                          {
                            ...
                            if($value1['batch_name']>=2021)
                            {
                                $tpaper_type_id=' AND paper_type_id NOT IN (10,11,12,22,61,68,100,123,137,106)';

                                $ppaper_type_id=' AND paper_type_id IN (10,11,12,22,61,68,100,123,137,105,106)';
                            ...
                            {
                                $tpaper_type_id=' AND paper_type_id NOT IN (10,11,12,22,61,68,100,123)';

                                $ppaper_type_id=' AND paper_type_id IN (10,11,12,22,61,68,100,123,137,105)';
                            }
                        
                            //$cur_rejoin=Yii::$app->db->createCommand('SELECT coe_student_mapping_id,S.previous_reg_number FROM coe_student_mapping SM JOIN coe_bat_deg_reg as F ON F.coe_bat_deg_reg_id=SM.course_batch_mapping_id JOIN coe_student S ON S.coe_student_id=SM.student_rel_id WHERE SM.status_category_type_id NOT IN('.$det_disc_type.') AND F.coe_batch_id="'.$value1['coe_batch_id'].'" AND SM.status_category_type_id =4 AND semester_detain>='.$sem_verify)->queryAll();

                            $regrejoin=''; $rejoin_stu_count=$t_count_rejoin=$p_count_rejoin=$th_count_rejoin=$tp_count_rejoin=0;

                            
                            $detain_arr=Yii::$app->db->createCommand('SELECT SM.coe_student_mapping_id,B.register_number FROM coe_student_mapping SM JOIN coe_bat_deg_reg as F ON F.coe_bat_deg_reg_id=SM.course_batch_mapping_id JOIN coe_student B ON B.coe_student_id=SM.student_rel_id JOIN coe_student_mapping DE ON DE.previous_reg_number=B.register_number WHERE SM.status_category_type_id NOT IN('.$det_disc_type.') AND F.coe_batch_id="'.$value1['coe_batch_id'].'" AND SM.status_category_type_id IN (4)')->queryAll();
                          ...
                          JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                          where degree_type="PG" AND G.degree_code!="Ph.D" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                          where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (3,7,6,253) AND B.status_category_type_id NOT IN('.$det_disc_type.')')->queryScalar();
                          ...
                          JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                          where degree_type="PG" AND G.degree_code!="Ph.D" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                          where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (3,7,6,253) AND B.status_category_type_id NOT IN('.$det_disc_type.') '.$tpaper_type_id)->queryScalar();
                          ...
                          JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                          where degree_type="PG" AND G.degree_code!="Ph.D" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                          where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (3,7,6,253) AND B.status_category_type_id NOT IN('.$det_disc_type.')'.$ppaper_type_id)->queryScalar();
                          ...
                          JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id
                          where degree_type="PG" AND G.degree_code!="Ph.D" AND year_of_passing="" and subject_map_id NOT IN(select B.subject_map_id from coe_mark_entry_master B
                          where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (3,7,6,253) AND B.status_category_type_id NOT IN('.$det_disc_type.')'.$tpaper_type_id.$tpsubject_type_id)->queryScalar();
                          ...
                          where B.student_map_id=A.student_map_id and B.result like "%Pass%" AND B.year='.$year.' AND B.month='.$month.') AND F.coe_batch_id='.$value1['coe_batch_id'].' AND A.year='.$year.' AND A.month='.$month.' AND B.status_category_type_id IN (4) AND B.status_category_type_id NOT IN('.$det_disc_type.') '.$tpaper_type_id.$rejoin.$tpsubject_type_id)->queryScalar();
                            ...
                            $pgtot_p=$pgtot_p+($p_count+$p_count_detain);
                        }
                    }
                       ...
                       <td align="center">'.$pgtot_stu.'</td><td align="center">'.$pgtot_t.'</td><td align="center">'.$pgtot_p.'</td><td align="center">'.$poveralltotal.'</td></tr>';
                       $body.='<tr><td>Grand Total</td>
                       <td align="center">'.$tot_gstu.'</td><td align="center">'.$tot_gt.'</td><td align="center">'.$tot_gp.'</td><td align="center">'.$grand_gtot.'</td>
                       <td align="center">'.$tot_dstu.'</td><td align="center">'.$tot_dt.'</td><td align="center">'.$tot_dp.'</td><td align="center">'.$grand_dtot.'</td>
                       <td align="center">'.$tot_stu.'</td><td align="center">'.$tot_t.'</td><td align="center">'.$tot_p.'</td><td align="center">'.($overalltotal+$poveralltotal).'</td></tr></tbody> </table>';
