   ...
   <div class="col-xs-12 col-sm-12 col-lg-12"> 
        ...
        <?= $form->field($model, 'month')->widget(
                Select2::classname(), [  
                    ...
                    'options' => [
                        ...
                        'onchange' => 'bringYearMonthSubsNew(this.value,$("#year").val());',                           
                    ],
                   'pluginOptions' => [
                       'allowClear' => true,
                    ],
       ...
       <br />
        <div class="btn-group col-lg-4 col-sm-4" role="group" aria-label="Actions to be Perform">
                <?= Html::Button( 'Download' , ['onClick'=>'get_tempmark_info();','class' => 'btn btn-success' ]) ?>

                <?= Html::a("Reset", Url::toRoute(['reports/exporttempmark']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
