...
$this->title="IMPORT SOFTWARE BASED ESE MARKS";
...
<?php Yii::$app->ShowFlashMessages->showFlashes();?>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-lg-4 col-sm-4">
        <br />
            <?= Html::submitButton('Import Excel', ['onclick'=>'spinner();','class' => 'btn btn-success' ]) ?>
              ...
              <?php if(!empty($importResults['dispResults']))
              {
                ...
                <table style="overflow-x:auto;"  class="table table-bordered table-responsive bulk_edit_table table-hover" id="hall_import_results" >
                    ...
                    foreach($importResults['dispResults'] as $line) {                       
                        ...
                        //$content.= Html::tag('td', isset($line['C'])?$line['C']:"0");
                        $content.= Html::tag('td', isset($line['grand_total'])?$line['grand_total']:"0");
