                ...
                <div class="box box-info active box-solid">                
                 ...
                 <div class="col-md-2">
                  ...
                  <div class="col-md-2">
                   ...
                   <div class="col-md-4">
                      <?= Html::a("Notice board marks(Additional credits)", Url::toRoute(['mark-entry/sub-add']), ['class' => 'btn btn-block btn-primary']) ?>
                      </div>
                     <div class="col-md-3">
                      <?= Html::a("Additional credit Reports", Url::toRoute(['mark-entry/sub-additional']), ['class' => 'btn btn-block btn-info']) ?>
                    </div>
                    <div class="col-md-3">
                      <?= Html::a("FULL ADDITIONAL  CREDITS REPORTS", Url::toRoute(['mark-entry/add']), ['class' => 'btn btn-block btn-success']) ?>
                    </div>
                    </div>
                </div>
