            ...
            <div class="panel  box box-solid box-primary"> 
              ...
              <div id="collapseOne" class="panel-collapse collapse in">
                <div class="box-body">
                  ...
                  <br></br>
                   <div class="col-md-3">
                        <?= Html::a("ABC Acount creation Report", Url::toRoute(['student/abc-account-creation']), ['class' => 'btn btn-block btn-danger ']) ?>
                      
                      
                  </div>

                    <div class="col-md-2">
                        <?= Html::a("PASSED OUT Info", Url::toRoute(['student/passedout']), ['class' => 'btn btn-block btn-primary ']) ?>
                      
                      
                  </div> 

                   <div class="col-md-2">
                        <?= Html::a("STUDENT CGPA", Url::toRoute(['batch/batch-cgpa']), ['class' => 'btn btn-block btn-success ']) ?>
              ...
              <div id="collapseThree" class="panel-collapse collapse">
                ...
                <div class="box box-info active box-solid">   
                  ...
                  <div class="box-body">
                    ...
                    <div class="col-md-3">
                       <?= Html::a("Practical Attendence Sheet", Url::toRoute(['hall-allocate/practical-attendance-sheet']), ['class' => 'btn btn-block btn-success']) ?> 
                    </div>
                   <br></br>
                    <div class="col-md-2">
                ...
                <div class="box box-info active box-solid"> 
                  ...
                  <div class="box-body"> 
                    ...
                    <br /><br />
                    <!--div class="col-md-2">
                       <?php // Html::a("Datewise Answer Packets!!", Url::toRoute(['hall-allocate/answer-packets']), ['class' => 'btn btn-block btn-warning']) ?> 
                    </div>
                    
                    <div class="col-md-2">
                       <?php // Html::a("Print Register Numbers", Url::toRoute(['hall-allocate/print-register-numbers']), ['class' => 'btn btn-block btn-success']) ?> 
                    </div-->         
                  </div>
                </div>
              ...
              <div id="collapseFour" class="panel-collapse collapse">
                ...
                <div class="box box-info active box-solid">                
                  ...
                  <div class="box-body">
                    ...
                    <div class="col-md-3">
                       <?= Html::a("My Class Room Report(Sem Wise) ", Url::toRoute(['mark-entry/myclassroom2']), ['class' => 'btn btn-block btn-success']) ?> 
                    </div>
                     <div class="col-md-2">
                       <?= Html::a("My Class Room Report ", Url::toRoute(['mark-entry/myclassroom']), ['class' => 'btn btn-block btn-success']) ?> 
                    </div>
                     <div class="col-md-2">
                       <?= Html::a("Gender Report ", Url::toRoute(['mark-entry-master/caste']), ['class' => 'btn btn-block btn-success']) ?> 

                    </div><br></br>

                     <div class="col-md-3">
                       <?= Html::a("Pass Count Gender Report ", Url::toRoute(['mark-entry-master/gender-pass']), ['class' => 'btn btn-block btn-warning']) ?> 
                    </div>
                    <div class="col-md-2">
                 ...
                 <div class="col-md-3">
                        <?= Html::a(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT)." ARREAR SUBJECT", Url::toRoute(['mark-entry-master/student-arrear-export']), ['class' => 'btn btn-block btn-success ']) ?>
                  </div>
                  <div class="col-md-3">
                ...
                <div class="box box-info active box-solid"> 
                  ...
                  <div class="box-body">
                    ...
                    <div class="col-md-3">
                       <?= Html::a("Consolidate Practical(ESE)", Url::toRoute(['practical-entry/practicalesemarklist']), ['class' => 'btn btn-block btn-danger']) ?> 
                    </div> 
                    ...
                    <div class="col-md-2">
                       <?= Html::a("TOPPERS LIST BATCH WISE", Url::toRoute(['categorytype/toppers-list-batchwise']), ['class' => 'btn btn-block btn-danger']) ?> 
                    </div>
                    ...
                    <div class="col-md-2">
                      ...
                      <br /><br />
                     <div class="col-md-3">
                       <?= Html::a("Student Degree Info", Url::toRoute(['student/student-degree-info']), ['class' => 'btn btn-block btn-success ']) ?>
                    </div>
                    <div class="col-md-3">
                       <?= Html::a("CIA Wise Arrear Report", Url::toRoute(['mark-entry-master/ciaarrear-report']), ['class' => 'btn btn-block btn-primary']) ?> 
                    </div>
                    <div class="col-md-3">
                       <?= Html::a("ESE Wise Arrear Report", Url::toRoute(['mark-entry-master/esearrear-report']), ['class' => 'btn btn-block btn-primary']) ?> 
                    </div>

                     <div class="col-md-3">
                       <?= Html::a("NCC/Online Arrear List", Url::toRoute(['mark-entry-master/onlinearrear']), ['class' => 'btn btn-block btn-danger']) ?> 
                    </div>
                    <div class="col-md-3">
                       <?= Html::a("Student Wise Arrear Count ", Url::toRoute(['mark-entry/studentarrearcount']), ['class' => 'btn btn-block btn-danger']) ?> 
                    </div>
                   </div>
                  </div>
                    <div class="box box-info active box-solid"> 
                       ...
                       <div class="box-header col-md-3 with-border">
                        <h5 class="box-title"><?php echo "Value Added Subject  ".ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_REPORT); ?></h5>    
                        </div>
                       <div style="clear: both"></div>
                         <div class="box-body">
                       <div class="col-md-3">
                       <?= Html::a("Notice Board Marks(Value Added)", Url::toRoute(['coe-value-mark-entry/value-add']), ['class' => 'btn btn-block btn-danger']) ?>
                      </div> 
                      <div class="col-md-2">
                       <?= Html::a("Value Added Reports", Url::toRoute(['coe-value-mark-entry/value-added-reports']), ['class' => 'btn btn-block btn-warning']) ?>
                      </div> 
                      <div class="col-md-3">
                       <?= Html::a("Internet copy(Value Added)", Url::toRoute(['coe-value-mark-entry/valueadded-internet-copy']), ['class' => 'btn btn-block btn-success']) ?>
                      </div>
                      <div class="col-md-3">
                       <?= Html::a("Branch vs Results(Value Added)", Url::toRoute(['coe-value-mark-entry/valueadded-programmeanalysis']), ['class' => 'btn btn-block btn-primary']) ?>
                      </div>
                      <br></br>
                      <div class="col-md-2">
                       <?= Html::a("Subjects Information!!", Url::toRoute(['coe-value-mark-entry/subvalue']), ['class' => 'btn btn-block btn-success']) ?>
                      </div>
                      <div class="col-md-2">
                       <?= Html::a("Consolidate CIA", Url::toRoute(['coe-value-mark-entry/ciamarklist']), ['class' => 'btn btn-block btn-success']) ?> 
                      </div>
                       <div class="col-md-2">
                       <?= Html::a("Consolidate ESE", Url::toRoute(['coe-value-mark-entry/esemarklist']), ['class' => 'btn btn-block btn-success']) ?> 
                    </div>
                     <div class="col-md-2">
