...
$this->title = "Revaluation Student Count Report";
?>
     ...
     <div class="col-xs-12 col-sm-12 col-lg-12">
           ...
           <div class="col-sm-2">
             ...
             <div class="col-lg-3 col-sm-3">
                <br>
                <label><input type="checkbox" name="withsp"><b>With SplitUp(Arrear)</b></label>
            </div>
            ...
            <div class="col-xs-12" >
                ...
                <div class="col-lg-12"  style="overflow-x:auto;"> 
                     ...
                     if($cmonth==29)
                    {
                        $year=$cyear-1;
                        $year1=$cyear;
                        $academic='No.of Complaints and Grievances <br> Academic Year: '.$year.' - '. $year1;
                    }
                    else
                    {
                        $academic='No.of Complaints and Grievances <br> Academic Year: '.$cyear;
                    }
                    ...
                    if($bat_val!='')
                    {
                        ...
                        if($withsp==1)
                        {
                            ...
                            foreach ($content_data as $key => $value) 
                            {
                                ...
                                $stucount = Yii::$app->db->createCommand("SELECT count(DISTINCT D.coe_student_mapping_id) FROM coe_student_mapping as D JOIN coe_mark_entry_master as C ON C.student_map_id=D.coe_student_mapping_id WHERE C.year='" . $cyear . "' AND C.month='" . $cmonth . "' AND mark_type=27 AND course_batch_mapping_id='".$value['coe_bat_deg_reg_id']."'")->queryScalar();
                                ...
                                $qry= "SELECT DISTINCT A.student_map_id FROM coe_revaluation as A 
                                        JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id  
                                         WHERE A.year='" . $year . "' AND A.month='" . $month . "' AND mark_type=27 AND B.batch_mapping_id='".$value['coe_bat_deg_reg_id']."' AND reval_status='YES'";
                                //echo "<br>".$qry;
                                ...
                                $qry1=  "SELECT DISTINCT A.student_map_id FROM coe_revaluation as A 
                                        JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id  
                                         WHERE A.year='" . $year1 . "' AND A.month='" . $month1 . "' AND mark_type=27 AND B.batch_mapping_id='".$value['coe_bat_deg_reg_id']."' AND reval_status='YES'";
                                ...
                                $qry= "SELECT DISTINCT A.student_map_id FROM coe_revaluation as A 
                                        JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id  
                                         WHERE A.year='" . $year . "' AND A.month='" . $month . "' AND mark_type=28 AND B.batch_mapping_id='".$value['coe_bat_deg_reg_id']."' AND reval_status='YES'";
                                //echo "<br>".$qry;
                                $cont1=Yii::$app->db->createCommand($qry)->queryAll(); 
                                ...
                                $qry1=  "SELECT DISTINCT A.student_map_id FROM coe_revaluation as A 
                                        JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id  
                                         WHERE A.year='" . $year1 . "' AND A.month='" . $month1 . "' AND mark_type=28 AND B.batch_mapping_id='".$value['coe_bat_deg_reg_id']."' AND reval_status='YES'";
                                ...
                                $recountar=$recountar+count($notIn);
                        ...
                        else
                        {
                            ...
                            foreach ($content_data as $key => $value) 
                            {
                               if($value['degree_code']=='MBA' && $cmonth==30)
                                ...
                                $qry= "SELECT DISTINCT A.student_map_id FROM coe_revaluation as A 
                                        JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id  
                                         WHERE A.year='" . $year . "' AND A.month='" . $month . "' AND B.batch_mapping_id='".$value['coe_bat_deg_reg_id']."' AND reval_status='YES'";
                                //echo "<br>".$qry;
                                $cont1=Yii::$app->db->createCommand($qry)->queryAll(); 
                                ...
                                $qry1=  "SELECT DISTINCT A.student_map_id FROM coe_revaluation as A 
                                        JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id  
                                         WHERE A.year='" . $year1 . "' AND A.month='" . $month1 . "' AND  B.batch_mapping_id='".$value['coe_bat_deg_reg_id']."' AND reval_status='YES'";
                        ...
                        if($withsp==1)
                        {
                            ...
                            foreach ($content_data as $key => $value1) 
                            {
                                ...
                                foreach ($value1["content"] as $key => $value) 
                                {
                                    ...
                                    if($value['degree_code']=='MBA' && $stucount==0)
                                    {
                                        if($value['degree_code']=='MBA' && $cmonth==32)
                                        {
                                            $cmonth=84;
                                ...
                                if($recount>0)
                                {
                                    ...
                                    $totrecountar=$totrecountar+$recountar;
                                }
                                $body .='<tr>';
                                $body .='<td colspan=2 align=right>Total</td>';
                                $body .='<td>'.$totstu.'</td>';
                            ...
                            $body1='<table  style="overflow-x:auto;" width="100%"  cellspacing="0" cellpadding="0" border="0" class="table table-bordered table-responsive dum_edit_table table-hover" >';
                                    ...
                                    $body1 .='<td align=right>Total Revaluation Count(Regular): </td>';
                                    $body1 .='<td>'.$totrecount.'</td>';
                                    $body1 .='<td align=right>Total Revaluation Count(Arrear): </td>';
                                    $body1 .='<td>'.$totrecountar.'</td>';
