                    ...
                    foreach ($content_data as $key => $value1) 
                    {
                        ...
                        if(!empty($value1["content"]))
                        {
                            ...
                            <tr class="table-danger">
                                ...
                                <th colspan=5 class="scriptbckgrd" align=center>Scripts</th>
                                <th colspan=4 align=center>Rejoin/Lateral Additional Courses</th>
                                <th colspan=5 class="scriptbckgrd" align=center>Scripts</th>
                            ...
                            {
                                $commonstu_count = StudentMapping::find()->where(['course_batch_mapping_id'=>$value['course_batch_mapping_id']])->andWhere(['NOT IN','status_category_type_id',[$transfer,$rejoin_type,$det_disc_type,$det_cat_type,$det_rejoin_type,$latearl]])->all();
                                ...
                                $det_count = StudentMapping::find()->where(['course_batch_mapping_id'=>$value['course_batch_mapping_id'],'status_category_type_id'=>$det_cat_type1]) ->andWhere(['>', 'semester_detain', $semester])->all();
                                ...
                                if($value['degree_type']=='UG')
                                {
                                    ...
                                    if($value1['year']>=2020)
                                    {
                                        ...
                                        ->andWhere(['NOT IN','b.status_category_type_id',[$det_disc_type,$det_cat_type,$det_rejoin_type]])
