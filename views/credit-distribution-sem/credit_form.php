...
$this->title = 'Create Credit Distributions Form';
...
<div class="box-body"> 
		    	...
		    	<tbody>
		    		...
		    		{?>
		    			...
		    			{ 
		    				$name="sem".$sl.$s;
		    				?>
		    				<td style="text-align: center;"><input style="width: 50%;" type="text" id="<?php echo "sem".$sl.$s;?>" name="<?= $name;?>" onkeyup="sumcreadit(8);" ></td>
		    			<?php } ?>
		    			<td  style="text-align: center;"><input style="width: 50%;" type="text" id="<?php echo "credit".$sl;?>" name="stream_credit[]" readonly="readonly" ></td>
		    			<td  style="text-align: center;"><input style="width: 50%;" type="text" id="<?php echo "aicte_norms".$sl;?>" name="aicte_norms[]" onkeyup="sumaictenorms(8);"></td>
		    			</tr>
		    		<?php $sl++;
		    		...
		    		<tr>
		    			...
		    			{ 
		    				...
		    				<td style="text-align: center;">
		    					<input style="width: 50%;" type="text" id="<?= $idd;?>" name="<?= $name;?>" readonly="readonly" >
		    				</td>
		    			<?php } ?>
		    			<td><input  style="width: 50%;" type="text" readonly="readonly" id="overtotal_credit"></td>
		    			<td><input  style="width: 50%;" type="text" readonly="readonly" id="overaicte_norms"></td>
		    		</tr>
		    	</tbody>
		    </table>
		    	...
		    	<tbody>
		    		...
		    		{?>
		    			...
		    			{ 
		    				$name="sem".$sl.$s;
		    				?>
		    				<td style="text-align: center;"><input style="width: 50%;" type="text" id="<?php echo "sem".$sl.$s;?>" name="<?= $name;?>" onkeyup="sumcreadit(4);" ></td>
		    			<?php } ?>
		    			<td  style="text-align: center;"><input style="width: 50%;" type="text" id="<?php echo "credit".$sl;?>" name="stream_credit[]" readonly="readonly" ></td>
		    			<td  style="text-align: center;"><input style="width: 50%;" type="text" id="<?php echo "aicte_norms".$sl;?>" name="aicte_norms[]" onkeyup="sumaictenorms(4);"></td>
		    			</tr>
		    		<?php $sl++;
		    			//$total_aicte_norms=$total_aicte_norms+$value['aicte_norms'];
		    		} ?>
	...
	<div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="form-group pull-right">
            <br>
            <?= Html::submitButton('Finish', ['class' =>'btn btn-primary','style'=>'display:none', 'id'=>'finishcredit']) ?>
