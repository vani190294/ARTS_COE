    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="btn-group col-lg-3 col-sm-3" role="group" aria-label="Actions to be Perform">
                <br />
                <?= Html::Button('Download Report', ['onClick'=>'getPracticalExamDetails()','class' => 'btn btn-success' ]) ?>
            
                <?= Html::a("Reset", Url::toRoute(['practical-exam-timetable-new/report-examiner']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
            </div>
        ...
        <div  class="col-xs-12"> 
                <br /><br />
                <div class="pull-right col-xs-12 col-sm-3 col-lg-3">
                    <?= $print_pdf = Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['practical-exam-timetable-new/report-examiner-practical-pdf'], [
                        'class' => 'pull-right btn btn-block btn-primary',
                        'target' => '_blank',
                        'data-toggle' => 'tooltip',
                        'title' => 'Will open the generated PDF file in a new window'
                    ]);
                    $print_excel = Html::a('<i class="fa fa-file-pdf-o"></i> EXCEL', ['/practical-exam-timetable-new/excel-report-examiner-sheet'], [
