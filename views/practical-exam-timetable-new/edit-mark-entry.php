...
<?php Yii::$app->ShowFlashMessages->showFlashes();?>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="col-lg-2 col-sm-2">
                <?= $form->field($model, 'exam_year')->textInput(['value'=>2023,'id'=>'mark_year']) ?>
            </div>
            <div class="col-lg-2 col-sm-2">
        ...
        <div class="col-xs-12 col-sm-2 col-lg-2">
                ...
                <?php echo $form->field($model, 'subject_map_id')->widget(
                    Select2::classname(), [
                        'options' => [
                            ...
                            'onchange'=>'getExaminerDet(this.value);',                
                        ],
                        'pluginOptions' => [
                            'allowClear' => true,
                        ],
            ...
            <!--div class="col-lg-2 col-sm-2">
                <?php //$form->field($model, 'external_examiner_name')->textInput(['id'=>'examiner_name','required'=>'required','style'=>'text-transform: uppercase','readonly'=>'readonly']); ?>
            </div-->   
            <div class="btn-group col-lg-2 col-sm-2" role="group" aria-label="Actions to be Perform">
                <br />
                <?= Html::Button('Get '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT), ['onClick'=>'getPracticalExamEditOnlyStuList1()','id'=>'change_name_get_stu','class' => 'btn btn-success' ]) ?>
                <?= Html::a("Reset", Url::toRoute(['practical-exam-timetable-new/edit-mark-entry']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>                     
        </div>
        ...
        <div  class="col-xs-12"> <br /><br />
            ...
            <div id='disp_show_details_subs' class="col-xs-12 col-sm-12 col-lg-12">
                ...
                <?= Html::submitButton('Save & Proceed', ['id'=>'update_comp','class' => 'btn pull-right btn-success' ,'data-confirm' => 'Are you sure you want to Continue <br /> This can not be Un-Done once Submitted.']) ?>
            </div>
        </div> <!-- Row Closed --><br />
