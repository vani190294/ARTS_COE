...
<?php Yii::$app->ShowFlashMessages->showFlashes();?>
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="col-lg-2 col-sm-2">
                <?= $form->field($model, 'exam_type')->radioList(ExamTimetable::getExamType(),['onchange'=>'getPracticalSubslist()']); ?>
        ...
        <div class="col-xs-12 col-sm-12 col-lg-12">
            ...
            <div class="col-lg-2 col-sm-2">
                <?= $form->field($model, 'stu_per_batch_count')->textInput(['id'=>'maximum_students','required'=>'required','value'=>30])->label('Max Count'); ?>
            </div> 
            ...
            <br />
                ...
                <?= Html::a("Reset", Url::toRoute(['practical-exam-timetable-new/index-stu-batch']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div> 
