...
$visible = Yii::$app->user->can("/sub/view") || Yii::$app->user->can("/sub/update") ? true : false; 
            ...
            [
                ...
                'buttons' => [
                    'view' => function ($url, $model) {
                            return ((Yii::$app->user->can("/sub/view")) ? Html::a('<span class="fa fa-hand-o-right increase_size"></span>', $url, ['title' => 'View',]) : '');
                        },
                    'update' => function ($url, $model) {
                            return ((Yii::$app->user->can("/sub/update")) ? Html::a('<span class="fa fa-pencil-square-o increase_size"></span>', $url, ['title' => 'Update',]) : '');
                        },
                    'delete' => function ($url, $model) {
                            return ((Yii::$app->user->can("/sub/delete")) ? Html::a('<span class="fa fa-ban increase_size"></span>', $url, ['title' => 'Delete', 
...
<?php 
    ...
    'panel' => [
            'type' => GridView::TYPE_PRIMARY,
            'heading' => '<h3 class="panel-title"><i class="glyphicon glyphicon-book"></i> '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT).' Value Added </h3>',
            'before'=>Html::a('<i class="glyphicon glyphicon-plus"></i> Add '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT), ['coe-value-subjects/create'], ['class' => 'btn btn-success'])." &nbsp; ".Html::a('<i class="glyphicon glyphicon-repeat"></i> Reset', ['index'], ['class' => 'btn btn-info']),
        ],
    ...
    'toolbar' => [
        '{export}',
        ['content'=>
            Html::a('<i class="glyphicon glyphicon-plus"></i> '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT), ['coe-value-subjects/create'], [
                    'data-pjax'=>0, 
                    'class'=>'btn btn-success',
                    'title'=>'Add '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT), 
                ]) . ' '.
          Html::a('<i class="glyphicon glyphicon-repeat"></i>', ['sub/index'], ['data-pjax'=>0, 'class' => 'btn btn-default', 'title'=>'Reset Grid'])
        ],
    ],
