...
<div class="box-body"> 
    ...
    <input type="button" class="btn btn-success" name="qpsubmit" value="Submit" id="qpsubmit">
    <?= Html::a("Reset", Url::toRoute(['hall-allocate/qpdistribution']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
    	</div>
    </div>
