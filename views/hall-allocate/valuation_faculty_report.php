...
echo Dialog::widget();
$this->title = 'Valuation Chief Examiner/Chairman Report';
?>
...
<div class="box-body"> 
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">                
       <div class="col-xs-12 col-sm-2 col-lg-2">
        ...
        <div class="col-xs-12 col-sm-2 col-lg-2">
             ...
             <?= $form->field($factallModel, 'valuation_date')->widget(
                    Select2::classname(), [  
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        <div class="col-xs-12 col-sm-3 col-lg-3">
            ...
            <?= Html::Button('Show' , ['onClick'=>"spinner();",'class' => 'btn btn-group-lg btn-group btn-success','id'=>'valuationfacultyreport_view' ]) ?>
            
            <?= Html::a("Reset", Url::toRoute(['hall-allocate/Valuationfacultyreport']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
        </div>
    </div>
