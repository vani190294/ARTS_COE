...
use yii\helpers\Url;
echo Dialog::widget();
$this->title = 'Report Answer Packets';
?>
...
<div class="box-body"> 
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
    	<div class="col-xs-12 col-sm-3 col-lg-3">
 			<?= Html::Button('Show & Print' , ['onClick'=>"spinner();",'class' => 'btn btn-group-lg btn-group btn-success','id'=>'report_answer_packets_btn' ]) ?>
            <?= Html::a("Reset", Url::toRoute(['hall-allocate/report-answer-packets']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
    	</div>
    </div>
...
<div id="answer_packets_div">
    ...
    <div class="col-12">
        <div class="col-lg-12 col-sm-12">
            ...
            $print_pdf = Html::a('<i class="fa fa-file-pdf-o"></i> PDF', ['hall-allocate/report-answer-scripts-pdf'], [
                        'class' => 'pull-right btn btn-block btn-primary',
                        'target' => '_blank',
                        'data-toggle' => 'tooltip',
                        'title' => 'Will open the generated PDF file in a new window'
                ]);
                $print_excel = Html::a('<i class="fa fa-file-pdf-o"></i> EXCEL', ['/hall-allocate/report-answer-scripts-excel'], [
