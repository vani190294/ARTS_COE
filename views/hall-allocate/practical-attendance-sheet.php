...
<div class="row">
        ...
        <div class="col-xs-12 col-sm-2 col-lg-2">
         ...
         <div class="col-xs-12 col-sm-2 col-lg-2">
            ...
            <?php 
                    echo '<label for="date" class="required"> Exam Date</label>';
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
    	<div class="col-xs-12 col-sm-3 col-lg-3">
            ...
            <?= Html::a("Reset", Url::toRoute(['hall-allocate/practical-attendance-sheet']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
    	</div>
    </div>
        ...
        if(isset($get_data) && !empty($get_data))
        {
            ...
            */
            ...
            if($file_content_available=="Yes")
            {
                        ...
                        <tr>
                         ...
                         <tr>
                          <td colspan=8 align="center"> <h4>
                            PRACTICAL  ATTENDANCE SHEET FOR SEMESTER EXAMINATIONS : '.$value['month']." - ".$value['year'].' </h4>
                         </td>                          
                        </tr>
                       <tr>
                          <td colspan=4 align="left"> <h4>
                              DATE OF EXAMINATION : '.date('d/m/Y',strtotime($date_prac)).' </h4>
                         </td>   
                ...
                $print_excel = Html::a('<i class="fa fa-file-pdf-o"></i> EXCEL', ['/hall-allocate/excel-practical-attendance-sheet'], [
