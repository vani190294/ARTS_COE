...
$this->title = 'GENERATE DUMMY NUMBER (AFTER CONCOLIDATE ABSENT APPROVE)';
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">                
        ...
        <div class="col-xs-12 col-sm-4 col-lg-4"> <br />
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                <?= Html::submitButton('GENERATE' ,['class' => 'btn btn-group btn-group-lg btn-success']) ?>  

                <?= Html::a("Reset", Url::toRoute(['hall-allocate/generate-galley-barcode']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
