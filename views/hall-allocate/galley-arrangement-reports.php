...
<div class="box-body"> 
    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">                
    	...
    	<div class="col-xs-12 col-sm-3 col-lg-3">
            ...
            <?= Html::a("Reset", Url::toRoute(['hall-allocate/galley-arrangement-reports']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
                    ...
                    if($prev_hall_name!=$value['hall_name'])
                    {
                        ...
                        if($new_stu_flag > 1) 
                        {
                                ...
                                {   
                                  ...
                                  // print_r($count_qpcode);exit; count_qpcode
                        ...
                        $_time_an = $org_email=='coe@skasc.ac.in' ? '(01.30 PM TO 04.30 PM)':'(02.00 PM TO 05.00 PM)';
                        ...
                        <tr>
                          <td colspan=6 align="center"> <h4>
                               END SEMESTER(REGULAR/ARREAR) EXAMINATIONS : '.strtoupper($value['month']." - ".$value['year']).' </h4>
