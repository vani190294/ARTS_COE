...
/* @var $form ActiveForm */
$this->title= 'Consolidate OD LIST';
    ...
    <div class="col-lg-3 col-sm-3"> 
        <br />
            ...
            <div class="btn-group" role="group" aria-label="Actions to be Perform">
                <?= Html::Button('Submit', ['onClick'=>'showConsolidateoddata1($("#intexam_year").val(), $("#intexam_month").val(), $("#exam_date").val(), $("#intexam_session").val(), $("#internal_number").val(), $("#stu_batch_id_selected").val(), $("#stu_programme_selected").val(),$("#time_slot").val());','class' => 'btn  btn-group-lg btn-group btn-primary']) ?>
                <?= Html::a("Reset", Url::toRoute(['exam-timetable-int/consolidate-od-list']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
...
<div class="row hide_ab_list">
    <div class="col-12">
        <div class="col-lg-12 col-sm-12">
            ...
            echo Html::a('<i class="fa fa-file-pdf-o"></i> ' . "PDF",array('consolidate-od-pdf','exportPDF'=>'PDF'),array('title'=>'Export to PDF','target'=>'_blank','class'=>'pull-right btn btn-warning', 'style'=>'color:#fff'));
            
            echo Html::a('<i class="fa fa-file-excel-o"></i> ' . "EXCEL ",array('consolidate-excel-od-pdf','exportPDF'=>'PDF'),array('title'=>'Export to Excel','target'=>'_blank','class'=>'pull-right btn btn-info', 'style'=>'color:#fff'));
