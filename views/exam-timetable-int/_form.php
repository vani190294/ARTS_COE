...
<div class="col-xs-12 col-sm-12 col-lg-12">
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-lg-2 col-sm-2">
            <?php echo $form->field($model,'time_slot')->widget(
                Select2::classname(), [
                    'data' => $model->Examtimeslot,
                    'options' => [
                        'placeholder' => '-----Select ----',
                        'id' => 'time_slot',
                    ],
        ...
        <div class="col-lg-2 col-sm-2">
            <?= $form->field($model, 'subject_name')->textInput(['readonly'=>'readonly','id'=>'exam_subject_name','name'=>'exam_subject_name','value'=>$subject_name])->label(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT).' Name'); ?>
        </div>

        <div class="form-group col-lg-3 col-sm-3">
            <div class="btn-group" role="group" aria-label="Actions to be Perform"><br>
                ...
                <?= Html::a("Reset", Url::toRoute(['exam-timetable/create']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
