...
/* @var $form ActiveForm */
$this->title= "Internal Exam Hall Wise Absent/OD Entry";
        ...
        <div class="col-lg-2 col-sm-2"> 
            <br />
                <div class="btn-group" role="group" aria-label="Actions to be Perform">
                    <?= Html::Button('Submit', ['onClick'=>'getExamHallStudents1($("#hall_names").val(),$("#exam_date").val(), $("#intexam_session").val(), $("#time_slot").val(), $("#internal_number").val());','class' => 'btn  btn-group-lg btn-group btn-primary']) ?>
                    <?= Html::a("Reset", Url::toRoute(['exam-timetable-int/hall-wise-absent']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
...
<div class="col-lg-12 col-sm-12"> 
       ...
       <div class="col-lg-2 col-sm-2">
            <div class="btn-group  hide_hall_submit" role="group" aria-label="Actions to be Perform">
                <?= Html::submitButton('SAVE', ['class' => 'btn btn-group-lg btn-group btn-danger']) ?>
            </div>
        </div>
