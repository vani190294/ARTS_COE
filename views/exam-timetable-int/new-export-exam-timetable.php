...
/* @var $form ActiveForm */
$this->title= " Download Internal Exam Time Table Format";
...
<div class="col-12">
 ...
 <?php echo $form->field($examTimetable,'degree_type')->widget(
                  Select2::classname(), [  
                        'data' => ['B.E'=>'B.E','M.E'=>'M.E','MBA'=>'MBA'],                      
        ...
        <div class="col-lg-2 col-sm-2">
          <?= $form->field($examTimetable, 'exam_year')->textInput(['id' => 'exam_year', 'class'=>'form-control student_disable','value'=>date('Y')]) ?>
        </div>
        <div class="col-lg-2 col-sm-2">
         ...
         <!--div class="col-lg-2 col-sm-2">
            <?php //$form->field($examTimetable, 'qp_code')->radioList(ExamTimetable::getExamSession())->label('Exam Session (Optional)'); ?>
