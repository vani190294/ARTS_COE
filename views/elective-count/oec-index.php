...
$visible = Yii::$app->user->can("/elective-count/oec-update") ? true : false;


$this->title = 'OEC Count';
...
<div class="elective-count-index">
    ...
    <p>
        <?= Html::a('Create OEC Count', ['oec-create'], ['class' => 'btn btn-success']) ?>
    </p>
     <?= GridView::widget([
            ...
            [
                ...
                'buttons' => [
                    ...
                    'update' => function ($url, $model) 
                    {
                        ...
                        {
                            return ((Yii::$app->user->can("/elective-count/oec-update")) ? Html::a('<span class="fa fa-pencil-square-o increase_size"></span>',['/elective-count/oec-update','id'=>$model->cur_ec_id], ['title' => 'Update',]) : '');
                        }
                    },
