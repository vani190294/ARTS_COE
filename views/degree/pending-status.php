    ...
    <div class="col-xs-12 col-sm-12 col-lg-12">
        ...
        <div class="col-xs-12 col-sm-2 col-lg-2">
            ...
            <div class="btn-group col-lg-3 col-sm-3" role="group" aria-label="Actions to be Perform"> <br />
                ...
                <?= Html::a("Reset", Url::toRoute(['degree/pending-status']), ['onClick'=>"spinner();",'class' => 'btn btn-group btn-group-lg btn-warning ']) ?>
            </div>
                    ...
                    {   
                        ...
                        if($values['subject_type_id']==$elective)
                        {
                            ...
                            $checkStuInfo->select('*')
                                ...
                                ->Where(['subject_map_id'=>$values['sub_id'],'year'=>$_POST['exam_year'],'category_type_id'=>$cia_cat_id,'A.semester'=>$values['semester'],'C.semester'=>$values['semester'],'A.batch_mapping_id'=>$values['batch_mapping_id']])->groupBy('register_number');
