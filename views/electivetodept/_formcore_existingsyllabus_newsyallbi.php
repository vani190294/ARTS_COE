                    ...
                    <?= $form->field($model, 'coe_elective_option')->widget(
                                Select2::classname(), [  
                                    ...
                                    'options' => [
                                        ...
                                        'onchange'=>'getsubjectnewsyprefix();getsubjectnewprefixexist();' 
                                    ],
                                   'pluginOptions' => [
                                       'allowClear' => true,
                                    ],
                    ...
                    <?= $form->field($model, 'semester')->widget(
                                Select2::classname(), [                      
                                    ...
                                    'options' => [
                                        ...
                                        'name' => 'semester_e',
                                        //'onchange'=>'getcoursetype();'
                                        'onchange'=>'getsubjectnewprefixexist()'
                                    ],
                                   'pluginOptions' => [
                                       'allowClear' => true,
                                    ],
            ...
            <div class="col-xs-12 col-sm-12 col-lg-12">
                 ...
                 <div class="col-md-9" id="new_subject_code" style="display: none;">
                     ...
                     <div class="col-md-3"><br>
                        <label><input type="checkbox" id="servicecourse" onclick="getsubjectnewprefixexist();">GE Course (Click)</label>
                    </div>
