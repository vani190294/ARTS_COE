...
class CategorytypeController extends Controller
{
    ...
    public function actionToppersList()
    {
     ...
     public function actionToppersListBatchwise()
    {
        $model = new MarkEntry();
        Yii::$app->ShowFlashMessages->setMsg('Welcome', 'Welcome to Toppers List Batch Wise ' . ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_REPORT));
        return $this->render('toppers-list-batchwise', [
            'model' => $model,
        ]);
    }
