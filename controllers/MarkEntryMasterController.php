...
class MarkEntryMasterController extends Controller
{
        ...
        if ($model->load(Yii::$app->request->post())) 
        {
         ...
         /** old query
                ...
                $fetched_data = Yii::$app->db->createCommand("SELECT batch_name,degree_name,subject_code,subject_name,register_number,A.result  FROM coe_mark_entry_master as A JOIN coe_student_mapping as B ON B.coe_student_mapping_id=A.student_map_id JOIN coe_subjects_mapping as C ON C.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student as D ON D.coe_student_id=B.student_rel_id JOIN coe_subjects as E ON E.coe_subjects_id=C.subject_id JOIN coe_bat_deg_reg as F ON F.coe_bat_deg_reg_id=B.course_batch_mapping_id and F.coe_bat_deg_reg_id=C.batch_mapping_id JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id JOIN coe_programme as H ON H.coe_programme_id=F.coe_programme_id JOIN coe_batch as I ON I.coe_batch_id=F.coe_batch_id where student_map_id='".$student_map_id->coe_student_mapping_id."' and subject_map_id NOT IN (select subject_map_id FROM coe_mark_entry_master where student_map_id='".$student_map_id->coe_student_mapping_id."' and student_map_id=A.student_map_id and subject_map_id=A.subject_map_id and result like '%Pass%') group by subject_code")->queryAll();  *****/
                 ...
                 $fetched_data = Yii::$app->db->createCommand("SELECT batch_name,degree_name,subject_code,subject_name,register_number,A.result  FROM coe_mark_entry_master as A JOIN coe_student_mapping as B ON B.coe_student_mapping_id=A.student_map_id JOIN coe_subjects_mapping as C ON C.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student as D ON D.coe_student_id=B.student_rel_id JOIN coe_subjects as E ON E.coe_subjects_id=C.subject_id JOIN coe_bat_deg_reg as F ON F.coe_bat_deg_reg_id=B.course_batch_mapping_id and F.coe_bat_deg_reg_id=C.batch_mapping_id JOIN coe_degree as G ON G.coe_degree_id=F.coe_degree_id JOIN coe_programme as H ON H.coe_programme_id=F.coe_programme_id JOIN coe_batch as I ON I.coe_batch_id=F.coe_batch_id where student_map_id='".$student_map_id->coe_student_mapping_id."' and subject_map_id NOT IN (select subject_map_id FROM coe_mark_entry_master where student_map_id='".$student_map_id->coe_student_mapping_id."' and student_map_id=A.student_map_id and subject_map_id=A.subject_map_id and result like '%Pass%') and subject_map_id NOT IN (select subject_map_id FROM coe_mark_entry_master where student_map_id='".$student_map_id->coe_student_mapping_id."' and student_map_id=A.student_map_id and subject_map_id=A.subject_map_id and result like '%COMPLETED%') and subject_map_id NOT IN (select subject_map_id FROM coe_mark_entry_master where student_map_id='".$student_map_id->coe_student_mapping_id."' and student_map_id=A.student_map_id and subject_map_id=A.subject_map_id and result like '%VERY GOOD%') and subject_map_id NOT IN (select subject_map_id FROM coe_mark_entry_master where student_map_id='".$student_map_id->coe_student_mapping_id."' and student_map_id=A.student_map_id and subject_map_id=A.subject_map_id and result like '%GOOD%') and subject_map_id NOT IN (select subject_map_id FROM coe_mark_entry_master where student_map_id='".$student_map_id->coe_student_mapping_id."' and student_map_id=A.student_map_id and subject_map_id=A.subject_map_id and result like '%EXEMPLARY%') and subject_map_id NOT IN (select subject_map_id FROM coe_mark_entry_master where student_map_id='".$student_map_id->coe_student_mapping_id."' and student_map_id=A.student_map_id and subject_map_id=A.subject_map_id and result like '%FAIR%') and subject_map_id NOT IN (select subject_map_id FROM coe_mark_entry_master where student_map_id='".$student_map_id->coe_student_mapping_id."' and student_map_id=A.student_map_id and subject_map_id=A.subject_map_id and result like '%SATISFACTORY%') group by subject_code")->queryAll();
                ...
                if($totalSuccess>0)
                {
                    ...
                    if(!empty($getSubsInfoDet))
                    {
                            ...
                            <thead class="thead-inverse">
                              <tr>
                                <th colspan=2 align="center">   
                                 ...
                                 <center><b>EXTERNAL SCORE CARD - '.strtoupper($get_month_name['description']).' '.$year.'</b></center>
                                 </th>
                                  <th colspan=2 align="center">  
                                   <img width="75" height="75" class="img-responsive" src="'.Yii::getAlias("@web").'/images/skacas.png" alt="College Logo 2">
                                    ...
                                    <tr>                                        
                                        <td align="left" colspan=9><h6><b>
                                            DATE OF VALUATION : '.date("d/m/Y").'<br />
                                            EXAM SESSION : 
                                        </b></h6></td> 
                                    ...
                                    <tr>
                                     ...
                                     <td colspan=4 align="left" colspan=9> <h6><b>
                                        '.strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT)).' CODE :  '.$subjMax->subject_code.' </b></h6>
                                        <h6><b>
                                        '.strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT)).' NAME :  '.$subjMax->subject_name.'</b></h6>
                                      </td>
                                        
                                    </tr>
                                    <tr class="table-danger" colspan=9>
                                        <th colspan=1>SNO</th>  
                                        <th colspan=2>REGISTER NUMBER</th>
                                        <th colspan=2>'.strtoupper("Marks Out of ".$subjMax->ESE_max).'</th>
                                        <th colspan=5 align="right">'.strtoupper("Marks In Words").'</th>
                                    </tr>               
                                    </thead> 
                                    <tbody>     
                        ...
                        foreach ($getSubsInfoDet as $value)
                        {
                           ...
                           $body .='<tr height="15px">
                           <td colspan=1 align="left">'.$increment.'</td>
                           <td colspan=2 align="left">'.$value["register_number"].'</td>
                           <td colspan=2 align="center" >'.$value["out_of_100"].'</td>
                           <td colspan=5 align="center">'.$print_text.'</td></tr>';
                            $increment++;
                            if($increment%31==0)
                            {
	...
	public function actionVerificationarts()
    {
        ...
        if(!empty($get_subjects))
        {
            ...
            $header.='<tr>
                    ...
                    ';
                    $header.='<tr><td colspan="6" align="center"><h5>EXAMINATION HELD ON '.$exam_year.' '.ConfigUtilities::getCateName($exam_month).'</h5></td></tr>';
                    $header.='<tr><td colspan="6" align="left"><h5><b> '.strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT).' CODE : '.$sub_details->subject_code).'</b></h5></td></tr>';
                    $header.='<tr><td colspan="6" align="left"><h5> <b>'.strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT).' NAME : '.$sub_details->subject_name).'</b></h5></td></tr>';
                    ...
                    $header.='<tr>
                                ...
                                <th align="left">ESE</th>
                                <th align="left">MARK IN WORDS</th>
                    ...
                    foreach($get_subjects as $revaluation1)
                    {
                        ...
                        $split_number = str_split($revaluation1['ESE']);
                        $print_text = $this->valueReplaceNumber($split_number);
                      ...
                      //  $data.='<td colspan=3 align="left">'.$revaluation1['name'].'</td>';
                        ...
                        $data.='<td align="left">'.$revaluation1['ESE'].'</td>';
                        $data.='<td align="left">'.  $print_text.'</td>
    ...
    public function actionAbsentReports()
    {
        ...
        if(Yii::$app->request->post())
        {
            ...
            $fetch_data = "SELECT CONCAT(F.degree_code,'-',G.programme_code) as Degree,D.subject_code,subject_name,register_number,batch_name,A.year,A.month,A.student_map_id,A.subject_map_id,B.semester FROM coe_mark_entry_master as A 
                ...
                JOIN coe_programme as G ON G.coe_programme_id=E.coe_programme_id
                JOIN coe_batch as H ON H.coe_batch_id=E.coe_batch_id
                where A.result like '%Absent%' and A.year='".$_POST['MarkEntryMaster']['year']."' and A.month='".$_POST['month']."' group by A.subject_map_id,A.student_map_id ,A.year,A.month order by batch_name,Degree,semester,subject_code";
    ...
    public function actionConsolidateMarkSheet()
    {
     ...
     /*$get_stu_query = "SELECT F.student_map_id,A.register_number,A.dob,A.name,A.gender,D.degree_code,D.degree_name,G.batch_mapping_id,E.programme_name,H.subject_code,F.subject_map_id,C.regulation_year,mark_type,H.subject_name,G.semester,H.credit_points,H.CIA_max,H.ESE_max,F.grade_point,F.grade_name,F.CIA,F.ESE,H.ESE_max,H.CIA_max,F.year,F.month,status_category_type_id,B.course_batch_mapping_id,F.year_of_passing,part_no,paper_no,F.total,F.year as exam_year,F.month as exam_month,F.result,max(F.year_of_passing) as last_appearance ,F.term FROM coe_student as A JOIN coe_student_mapping as B ON B.student_rel_id=A.coe_student_id JOIN coe_bat_deg_reg as C ON C.coe_bat_deg_reg_id=B.course_batch_mapping_id JOIN coe_degree as D ON D.coe_degree_id=C.coe_degree_id JOIN coe_programme as E ON E.coe_programme_id=C.coe_programme_id JOIN coe_mark_entry_master as F ON F.student_map_id=B.coe_student_mapping_id JOIN coe_subjects_mapping as G ON G.coe_subjects_mapping_id=F.subject_map_id JOIN coe_subjects as H ON H.coe_subjects_id=G.subject_id JOIN coe_batch as I ON I.coe_batch_id=C.coe_batch_id  where G.batch_mapping_id='".$_POST['bat_map_val']."'  AND A.register_number IN (".$trim_reg.") group by A.register_number,H.subject_code order by A.register_number,G.semester,paper_no";*/
        ...
        $get_stu_query = "SELECT F.student_map_id,A.register_number,A.dob,A.name,A.gender,D.degree_code,D.degree_name,G.batch_mapping_id,E.programme_name,H.subject_code,F.subject_map_id,C.regulation_year,mark_type,H.subject_name,G.semester,H.credit_points,H.CIA_max,H.ESE_max,F.grade_point,F.grade_name,F.CIA,F.ESE,H.ESE_max,H.CIA_max,F.year,F.month,status_category_type_id,B.course_batch_mapping_id,F.year_of_passing,part_no,paper_no,F.total,F.year as exam_year,F.month as exam_month,F.result,max(F.year_of_passing) as last_appearance ,F.term FROM coe_student as A JOIN coe_student_mapping as B ON B.student_rel_id=A.coe_student_id JOIN coe_bat_deg_reg as C ON C.coe_bat_deg_reg_id=B.course_batch_mapping_id JOIN coe_degree as D ON D.coe_degree_id=C.coe_degree_id JOIN coe_programme as E ON E.coe_programme_id=C.coe_programme_id JOIN coe_mark_entry_master as F ON F.student_map_id=B.coe_student_mapping_id JOIN coe_subjects_mapping as G ON G.coe_subjects_mapping_id=F.subject_map_id JOIN coe_subjects as H ON H.coe_subjects_id=G.subject_id JOIN coe_batch as I ON I.coe_batch_id=C.coe_batch_id  where G.batch_mapping_id='".$_POST['bat_map_val']."' and B.coe_student_mapping_id NOT IN(select student_map_id from coe_mark_entry_master where year_of_passing='' and subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where student_map_id=F.student_map_id and result like '%pass%')and subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where student_map_id=F.student_map_id and result like '%COMPLETED%'))  and F.result NOT IN ('fail','Fail','FAIL','RA','absent', 'ab','AB','Absent','Not Completed') AND F.grade_name not IN ('RA','wh','AB','ab','WH','wd','WD','U','RA') AND A.register_number IN (".$trim_reg.") group by A.register_number,H.subject_code order by A.register_number,G.semester,paper_no";
    ...
    public function actionConsolidateMarkSheetPgPdf(){
        ...
        $content = $_SESSION['get_console_list_pdf'];
            $pdf = new Pdf([
                ...
                'destination' => Pdf::DEST_BROWSER,                 
                'content' => $content, 
                'cssFile' => 'css/consolidate-markstatement-pg.css',
                'options' => ['title' => strtoupper("consolidate") . ' MARK STATEMENT'],
     ...
     /*public function actionProgrammeresultanalysis()
    {
       ...
       $month = Yii::$app->db->createCommand("select description from coe_category_type where coe_category_type_id='" . $_POST['month'] . "'")->queryScalar();
        ...
        $subject_list = $query_cr->createCommand()->queryAll();
         ...
         /*$query_cr->select('distinct(subject_code),b.semester,subject_name,coe_subjects_mapping_id, description,coe_subjects_id,batch_mapping_id,a.CIA_max,ESE_max')
             ...
             ->join('JOIN', 'coe_subjects_mapping b', 'a.coe_subjects_id=b.subject_id')
             ->join('JOIN', 'coe_category_type d', 'b.subject_type_id=d.coe_category_type_id')
             ->where(['b.batch_mapping_id' => $_POST['batch_map_id'],'b.semester'=>$sem]);
        $subject_list = $query_cr->createCommand()->queryAll();*/
       ...
       /* $count = count($grade_name);
        ...
        if (count($subject_list) > 0) {
            ...
            $course_result_table .= "</tr>";
            //print_r( $course_result_table);exit;
            $course_result_table .= "<tr height='45px'><th colspan='18' >&nbsp; <br /><br /><br /><br /><br /><br /><br /><br /></th></tr>";
            $course_result_table .= "<tr><th colspan='4' >DATE </th><th colspan='4' >SEAL </th><th colspan='6' >PRINCIPAL </th><th colspan='4' >CONTROLLER OF EXAMINATIONS </th></tr>";
            $course_result_table .= '</tbody></table>';
            if (isset($_SESSION['programme_analysis_print'])) {
     ...
     public function actionProgrammeresultanalysis()
    {
       ...
       $month = Yii::$app->db->createCommand("select description from coe_category_type where coe_category_type_id='" . $_POST['month'] . "'")->queryScalar();
        ...
        $query_cr->select('distinct(subject_code),b.semester,subject_name,coe_subjects_mapping_id, description,coe_subjects_id,batch_mapping_id,a.CIA_max,ESE_max')
            ...
            ->join('JOIN', 'coe_subjects_mapping b', 'a.coe_subjects_id=b.subject_id')
            ->join('JOIN', 'coe_mark_entry_master c', 'b.coe_subjects_mapping_id=c.subject_map_id')
               ->join('JOIN', 'coe_student_mapping e', 'e.coe_student_mapping_id=c.student_map_id')
            ->join('JOIN', 'coe_category_type d', 'b.subject_type_id=d.coe_category_type_id')
            ->where(['b.batch_mapping_id' => $_POST['batch_map_id'], 'c.year' => $_POST['year'], 'c.month' => $_POST['month'], 'c.mark_type' => $_POST['mark_type'],'e.section_name'=>$_POST['section']]);
        $subject_list = $query_cr->createCommand()->queryAll();
        ...
        if (count($subject_list) > 0) {
            ...
            <tr><td colspan=18 align="center"><b>' . strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_PROGRAMME)) . strtoupper(' Result Analysis</b> - ') . strtoupper($month . ' ' . $_POST['year']) . '</td></tr>';
            $course_result_table .= '<tr><td colspan=18 align="center"><b>'.strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_BATCH)).'</b> - ' . strtoupper($batch_name) . ' <b>' . strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_PROGRAMME)) . '</b> - ' . strtoupper($degree_name . ' - ' . $_POST['section'] ) . '</td></tr>';
            $colspan = 22 - (count($grade_name) + 11); // is the number of columns
            $course_result_table .= '<tr> <td style="border: none !important;">&nbsp; </td></tr><tr> <td style="border: none !important;">&nbsp; </td></tr> <tr>                                                                                                                                
                            <td> S. NO </td> 
                            <td>' . strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT)) . ' CODE </td>  
            ...
            foreach ($subject_list as $subject) {
                ...
                $query_enroll->select('count(DISTINCT student_map_id)')
                    ...
                    ->join('JOIN', 'coe_mark_entry_master b', 'b.student_map_id=a.coe_student_mapping_id')
                    ->join('JOIN', 'coe_subjects_mapping c', 'c.coe_subjects_mapping_id=b.subject_map_id')
                    ->where(['b.subject_map_id' => $subject['coe_subjects_mapping_id'],'b.year' => $_POST['year'], 'b.month' => $_POST['month'],'mark_type'=>$_POST['mark_type'],'a.section_name'=>$_POST['section']])
                    ->andWhere(['<>', 'status_category_type_id', $det_disc_type]);
                $student_enrol = $query_enroll->createCommand()->queryScalar();
                $course_result_table .= '<td align="center">' . $student_enrol . '</td>';
                ...
                $query_absent->select('count(student_map_id)')
                    ...
                    ->join('JOIN', 'coe_mark_entry_master b', 'b.student_map_id=a.coe_student_mapping_id')
                    ->join('JOIN', 'coe_subjects_mapping c', 'c.coe_subjects_mapping_id=b.subject_map_id')
                    ->where(['b.subject_map_id' => $subject['coe_subjects_mapping_id'], 'b.year' => $_POST['year'], 'b.month' => $_POST['month'], 'b.result' => 'Absent','mark_type'=>$_POST['mark_type'],'a.section_name'=>$_POST['section']])
                    ->andWhere(['<>', 'status_category_type_id', $det_disc_type]);
                    //echo $query_absent->createCommand()->getrawsql();
                $student_absent = $query_absent->createCommand()->queryScalar();
                ...
                $query_withheld->select('count(student_map_id)')
                    ...
                    ->join('JOIN', 'coe_mark_entry_master b', 'b.student_map_id=a.coe_student_mapping_id')
                    ->join('JOIN', 'coe_subjects_mapping c', 'c.coe_subjects_mapping_id=b.subject_map_id')
                    ->where(['subject_map_id' => $subject['coe_subjects_mapping_id'], 'year' => $_POST['year'], 'month' => $_POST['month'], 'withheld' => 'w','mark_type'=>$_POST['mark_type'],'a.section_name'=>$_POST['section']])
                    ->andWhere(['<>', 'status_category_type_id', $det_disc_type]);
                $student_withheld = $query_withheld->createCommand()->queryScalar();
                $student_withheld = $student_withheld==0?'-':$student_withheld;
                $course_result_table .= '<td align="center">' . $student_withheld . '</td>';
                ...
                $query_pass->select('count(student_map_id)')
                    ...
                    ->join('JOIN', 'coe_mark_entry_master b', 'b.student_map_id=a.coe_student_mapping_id')
                    ->join('JOIN', 'coe_subjects_mapping c', 'c.coe_subjects_mapping_id=b.subject_map_id')
                    ->where(['subject_map_id' => $subject['coe_subjects_mapping_id'], 'year' => $_POST['year'], 'month' => $_POST['month'],'mark_type'=>$_POST['mark_type'],'a.section_name'=>$_POST['section']])
                    ->andWhere(['NOT', ['year_of_passing' => '']])
                    ->andWhere(['<>', 'status_category_type_id', $det_disc_type]);
                $student_pass = $query_pass->createCommand()->queryScalar();
                ...
                $course_result_table .= '<td align="center">' . $student_pass . '</td>';
                $query_fail = new Query();
                $select_query = "SELECT count(student_map_id) FROM coe_student_mapping a JOIN coe_mark_entry_master as b ON b.student_map_id=a.coe_student_mapping_id JOIN coe_subjects_mapping c ON c.coe_subjects_mapping_id=b.subject_map_id WHERE subject_map_id='".$subject['coe_subjects_mapping_id']."' AND year='".$_POST['year']."' and month='".$_POST['month']."' and result  not like '%Absent%' AND a.section_name='".$_POST['section']."' AND status_category_type_id NOT IN('".$det_disc_type."') and (year_of_passing is NULL or year_of_passing='' ) and grade_name NOT IN('W','WH','w','wh') ";
                $student_fail = Yii::$app->db->createCommand($select_query)->queryScalar();
                //print_r($student_fail );exit;
                $student_enrol = $student_enrol==0?1:$student_enrol;
                $course_result_table .= '<td align="center">' . $student_fail . '</td>';
                ...
                $query_75->select('count(student_map_id)')
                    ...
                    ->join('JOIN', 'coe_mark_entry_master b', 'b.student_map_id=a.coe_student_mapping_id')
                    ->join('JOIN', 'coe_subjects_mapping c', 'c.coe_subjects_mapping_id=b.subject_map_id')
                    ->where(['subject_map_id' => $subject['coe_subjects_mapping_id'], 'year' => $_POST['year'], 'month' => $_POST['month'],'mark_type'=>$_POST['mark_type'],'result'=>'Pass','a.section_name'=>$_POST['section']])
                    ->andWhere(['>=', 'total', $total_75])
                    ->andWhere(['<>', 'status_category_type_id', $det_disc_type]);
                    //echo "<br>".$query_75->createCommand()->getRawSql();
                $student_75 = $query_75->createCommand()->queryScalar();
    ...
    public function actionStudentwisearrear()
    {
        ...
        if (Yii::$app->request->post()) 
        {
            ...
            $query->select(["distinct (H.subject_code) as subject_code", "concat(D.degree_code,'-',E.programme_code) as degree_code", "A.register_number", "A.name", "H.subject_name", "G.semester", "F.year",'F.student_map_id','F.subject_map_id', "E.programme_name", "K.batch_name", "D.degree_name",'I.description as paper_type'])
                ...
                $query->Where(['A.student_status' => 'Active', 'F.year_of_passing' => '','F.student_map_id'=>''])->andWhere(['<=','F.year',$_POST['mark_year']]);            
...
//$degree_type = Yii::$app->db->createCommand("SELECT degree_type FROM coe_degree AS A JOIN coe_bat_deg_reg as B ON B.coe_degree_id=A.coe_degree_id WHERE coe_bat_deg_reg_id='".$_POST['bat_map_val']."' ")->queryScalar();
    ...
    public function actionCaste()
    {
      ...
      $galley = new HallAllocate();
       ...
       $crse_analysis_query->select('count(register_number) as  total,course_batch_mapping_id,degree_code,programme_name')
            ...
            ->where(['h.coe_batch_id'=> $batch]);
            $crse_analysis_query->groupBy('programme_code,degree_code');
            $crse_analysis_query->orderBy('batch_name,degree_code,programme_code');
        $courseanalysis = $crse_analysis_query->createCommand()->queryAll();
 ...
 if (!empty($courseanalysis)) 
     ...
     public function actionGenderPass()
    {
        $model = new MarkEntry();
        $markentrymaster = new MarkEntryMaster();
         $galley = new HallAllocate();
        ...
        foreach ($failed_stus as $key => $fails) {
            ...
            $crse_analysis_query->select(['course_batch_mapping_id','programme_code','degree_code','batch_name','degree_type','programme_name'])
                ->from('coe_student_mapping a')
                ->join('JOIN', 'coe_student b', 'a.student_rel_id=b.coe_student_id')
                ...
                ->join('JOIN', 'coe_consolidate_marks xy', 'xy.student_map_id=a.coe_student_mapping_id')      
                ->where(['d.coe_batch_id' => $_POST['bat_val'],'c.coe_batch_id' => $_POST['bat_val'], 'b.student_status' => 'Active','e.month'=>$_POST['month'],'e.year'=>$_POST['year'],'result'=>'Pass','e.mark_type'=>27])
              ->andWhere(['<>', 'status_category_type_id', $det_cat_type])
             ->andWhere(['<>', 'status_category_type_id', $det_disc_type])
             ->andWhere(['<>', 'status_category_type_id', $det_long_absent])
               ->andWhere(['NOT IN', 'e.student_map_id', $notIn])
 ...
 if (!empty($courseanalysis)) 
            {
                return $this->render('gender-pass', [
                    'model' => $model,
                    'courseanalysis' => $courseanalysis,'galley'=>$galley,
                ]);
            } else {
                Yii::$app->ShowFlashMessages->setMsg('Error', "No data Found");
                return $this->redirect(['mark-entry-master/gender-pass']);
            }
        } else {
            Yii::$app->ShowFlashMessages->setMsg('Welcome', 'Welcome to ' . ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_SUBJECT) . ' Wise Arrear ' . ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_REPORT));
            return $this->render('gender-pass', [
    ...
    public function actionCiaarrearReport()
    {
        $model = new MarkEntry();
        if (Yii::$app->request->post()) 
        {
          ...
          // $sem_count = ConfigUtilities::SemCaluclation($_POST['mark_year'],$_POST['month'],$_POST['bat_map_val']);
            ...
            $query = new  Query();
            $query->select(["distinct (H.subject_code) as subject_code", "concat(D.degree_code,'-',E.programme_code) as degree_code", "A.register_number", "A.name", "H.subject_name", "G.semester", "F.year",'F.student_map_id','F.subject_map_id',"E.programme_name", "K.batch_name", "D.degree_name","F.CIA","H.CIA_min","F.month"])
                ->from('coe_student as A')
                ->join('JOIN', 'coe_student_mapping as B', 'B.student_rel_id=A.coe_student_id ')
                ->join('JOIN', 'coe_bat_deg_reg as C', 'C.coe_bat_deg_reg_id=B.course_batch_mapping_id')
                ->join('JOIN', 'coe_degree as D', 'D.coe_degree_id=C.coe_degree_id')
                ...
                ->join('JOIN', 'coe_subjects H', 'H.coe_subjects_id=G.subject_id')
                ->join('JOIN', 'coe_category_type I', 'I.coe_category_type_id=G.paper_type_id');
                $query->Where(['A.student_status' => 'Active', 'F.year_of_passing' => '','K.coe_batch_id' => $_POST['bat_val'],'F.year' => $_POST['mark_year'],'F.month'=>$_POST['MarkEntry']['month']]);
                 // $query->andWhere(['G.semester'=>$_POST['exam_semester']]);   
                      
            $query->andWhere(['<>', 'status_category_type_id', $det_disc_type]);
            $query->groupBy('F.subject_map_id,F.student_map_id');
            $query->orderBy('G.semester,degree_code,register_number,CIA_min');
            $arrearreport = $query->createCommand()->queryAll();
           

            if (!empty($arrearreport)) {
                return $this->render('ciaarrear-report', [
                    'model' => $model,
                    'arrearreport' => $arrearreport,
                ]);
            } else {
                Yii::$app->ShowFlashMessages->setMsg('Error', "No data Found");
                return $this->redirect(['mark-entry-master/ciaarrear-report']);
            }
        } else {
            Yii::$app->ShowFlashMessages->setMsg('Welcome', 'Welcome to ARREAR REPORT ');
            return $this->render('ciaarrear-report', [
     ...
     public function actionCiaarrearReportPdf()
    {
        require(Yii::getAlias('@webroot/includes/use_institute_info.php'));
        ...
        $pdf = new Pdf([
            'mode' => Pdf::MODE_CORE,
            'filename' => "CIA WISE ARREAR REPORT.pdf",
            'format' => Pdf::FORMAT_A4,
            'orientation' => Pdf::ORIENT_PORTRAIT,
            'content' => $content,
            'cssFile' => '@vendor/kartik-v/yii2-mpdf/assets/kv-mpdf-bootstrap.min.css',
            'cssInline' => ' @media all{
                ...
                ',
            'options' => ['title' => "CIA WISE ARREAR REPORT "],
            'methods' => [
                'SetHeader' => ["OFFICE OF THE CONTROLLER OF EXAMINATIONS ".$org_name],
    ...
    public function actionCiaarrearReportExcel()
    {        
        $content = $_SESSION['arrearreport'];
        $fileName = "CIA WISE ARREAR REPORT".DATE('d-m-Y-H-i-s').".xls";
        $options = ['mimeType' => 'application/vnd.ms-excel'];
        return Yii::$app->excel->exportExcel($content, $fileName, $options);
    }


    public function actionOnlinearrear()
    {
        $model = new MarkEntry();
        if (Yii::$app->request->post()) 
        {
          ...
          // $sem_count = ConfigUtilities::SemCaluclation($_POST['mark_year'],$_POST['month'],$_POST['bat_map_val']);
            ...
            $query->select(["distinct (H.subject_code) as subject_code", "concat(D.degree_code,'-',E.programme_code) as degree_code", "A.register_number", "A.name", "H.subject_name", "G.semester", "F.year",'F.student_map_id','F.subject_map_id',"E.programme_name", "K.batch_name", "D.degree_name"])
                ...
                ->join('JOIN', 'coe_subjects H', 'H.coe_subjects_id=G.subject_id')
                ->join('JOIN', 'coe_category_type I', 'I.coe_category_type_id=G.paper_type_id');
                $query->Where(['A.student_status' => 'Active', 'F.year_of_passing' => '','K.coe_batch_id' => $_POST['bat_val'],'ESE_min'=>0,'CIA_min'=>0,'total'=>'0']);
                 // $query->andWhere(['G.semester'=>$_POST['exam_semester']]);        
            $query->andWhere(['<>', 'status_category_type_id', $det_disc_type]);
            $query->groupBy('F.subject_map_id,F.student_map_id');
            $query->orderBy('G.semester,degree_code,register_number');
            ...
            if (!empty($arrearreport)) {
                return $this->render('onlinearrear', [
                    'model' => $model,
                    'arrearreport' => $arrearreport,
                ]);
            } else {
                Yii::$app->ShowFlashMessages->setMsg('Error', "No data Found");
                return $this->redirect(['mark-entry-master/onlinearrear']);
            }
        } else {
            Yii::$app->ShowFlashMessages->setMsg('Welcome', 'Welcome to ARREAR REPORT ');
            return $this->render('onlinearrear', [
    ...
    public function actionOnlinearrearPdf()
    {
        require(Yii::getAlias('@webroot/includes/use_institute_info.php'));
        ...
        $pdf = new Pdf([
            'mode' => Pdf::MODE_CORE,
            'filename' => "NCC/ONLINE ARREAR REPORT.pdf",
            'format' => Pdf::FORMAT_A4,
            'orientation' => Pdf::ORIENT_PORTRAIT,
            'content' => $content,
            'cssFile' => '@vendor/kartik-v/yii2-mpdf/assets/kv-mpdf-bootstrap.min.css',
            'cssInline' => ' @media all{
                ...
                ',
            'options' => ['title' =>  " NCC/ONLINE WISE ARREAR "],
            'methods' => [
                'SetHeader' => ["OFFICE OF THE CONTROLLER OF EXAMINATIONS ".$org_name],
    ...
    public function actionOnlinearrearExcel()
    {        
        $content = $_SESSION['arrearreport'];
        $fileName = "NCC/ONLINE ARREAR REPORT".DATE('d-m-Y-H-i-s').".xls";
        $options = ['mimeType' => 'application/vnd.ms-excel'];
        return Yii::$app->excel->exportExcel($content, $fileName, $options);
    } 


    public function actionEsearrearReport()
    {
        $model = new MarkEntry();
        if (Yii::$app->request->post()) 
        {
          ...
          // $sem_count = ConfigUtilities::SemCaluclation($_POST['mark_year'],$_POST['month'],$_POST['bat_map_val']);
            ...
            $query = new  Query();
            $query->select(["distinct (H.subject_code) as subject_code", "concat(D.degree_code,'-',E.programme_code) as degree_code", "A.register_number", "A.name", "H.subject_name", "G.semester", "F.year",'F.student_map_id','F.subject_map_id',"E.programme_name", "K.batch_name", "D.degree_name","F.ESE","H.ESE_min","F.month"])
                ->from('coe_student as A')
                ->join('JOIN', 'coe_student_mapping as B', 'B.student_rel_id=A.coe_student_id ')
                ->join('JOIN', 'coe_bat_deg_reg as C', 'C.coe_bat_deg_reg_id=B.course_batch_mapping_id')
                ->join('JOIN', 'coe_degree as D', 'D.coe_degree_id=C.coe_degree_id')
            ...
            $query->andWhere(['<>', 'status_category_type_id', $det_disc_type]);
            $query->groupBy('F.subject_map_id,F.student_map_id');
            $query->orderBy('G.semester,degree_code,register_number,ESE_min');
            $arrearreport = $query->createCommand()->queryAll();
           

            if (!empty($arrearreport)) {
                return $this->render('esearrear-report', [
                    'model' => $model,
                    'arrearreport' => $arrearreport,
                ]);
            } else {
                Yii::$app->ShowFlashMessages->setMsg('Error', "No data Found");
                return $this->redirect(['mark-entry-master/esearrear-report']);
            }
        } else {
            Yii::$app->ShowFlashMessages->setMsg('Welcome', 'Welcome to ARREAR REPORT ');
            return $this->render('esearrear-report', [
     ...
     public function actionEsearrearReportPdf()
    {
        require(Yii::getAlias('@webroot/includes/use_institute_info.php'));
        ...
        $pdf = new Pdf([
            'mode' => Pdf::MODE_CORE,
            'filename' => "ESE WISE ARREAR REPORT.pdf",
            'format' => Pdf::FORMAT_A4,
            'orientation' => Pdf::ORIENT_PORTRAIT,
            'content' => $content,
            'cssFile' => '@vendor/kartik-v/yii2-mpdf/assets/kv-mpdf-bootstrap.min.css',
            'cssInline' => ' @media all{
                ...
                ',
            'options' => ['title' => "ESE WISE ARREAR REPORT "],
            'methods' => [
                'SetHeader' => ["OFFICE OF THE CONTROLLER OF EXAMINATIONS ".$org_name],
    ...
    public function actionEsearrearReportExcel()
    {        
        $content = $_SESSION['arrearreport'];
        $fileName = "ESE WISE ARREAR REPORT".DATE('d-m-Y-H-i-s').".xls";
        $options = ['mimeType' => 'application/vnd.ms-excel'];
        return Yii::$app->excel->exportExcel($content, $fileName, $options);
    }
