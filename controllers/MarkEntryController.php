...
class MarkEntryController extends Controller
{
    ...
    **/
    ...
    public function actionTransfercerficatedata()
    {
        ...
        $class_studying=Yii::$app->request->post('class_studying');
        $reason=Yii::$app->request->post('reason');
        $char=Yii::$app->request->post('char');
        $get_batc_map = CoeBatDegReg::findOne($_POST['bat_map_id']);
        $deg_info = Degree::findOne($get_batc_map->coe_degree_id); 
        $date_left = Yii::$app->request->post('date_left');
        $date_apply=Yii::$app->request->post('date_apply');
        $degree_name= Yii::$app->db->createCommand("select concat(degree_code) as degree_name from coe_degree a,coe_programme b,coe_bat_deg_reg c where a.coe_degree_id=c.coe_degree_id and b.coe_programme_id=c.coe_programme_id and c.coe_bat_deg_reg_id='" . $_POST['bat_map_id'] . "'")->queryScalar();
         $degree_name1 = Yii::$app->db->createCommand("select concat(programme_name) as degree_name from coe_degree a,coe_programme b,coe_bat_deg_reg c where a.coe_degree_id=c.coe_degree_id and b.coe_programme_id=c.coe_programme_id and c.coe_bat_deg_reg_id='" . $_POST['bat_map_id'] . "'")->queryScalar();
       ...
       // $final_student = TransferCertificates::find()->where(['between','register_number',$reg_from,$reg_to])->all();
        //$get_stu_query = "SELECT  * FROM  coe_transfer_certificates  as A  JOIN coe_student as X ON X.register_number=A.register_number JOIN coe_student_mapping as B ON B.student_rel_id=X.coe_student_id JOIN coe_bat_deg_reg as C ON C.coe_bat_deg_reg_id=B.course_batch_mapping_id JOIN coe_degree as D ON D.coe_degree_id=C.coe_degree_id JOIN coe_programme as E ON E.coe_programme_id=C.coe_programme_id JOIN coe_mark_entry_master as F ON F.student_map_id=B.coe_student_mapping_id JOIN coe_subjects_mapping as G ON G.coe_subjects_mapping_id=F.subject_map_id JOIN coe_subjects as H ON H.coe_subjects_id=G.subject_id JOIN coe_batch as I ON I.coe_batch_id=C.coe_batch_id  where G.batch_mapping_id='".$bat_map_id."'   AND A.register_number between '".$reg_from."' AND '".$reg_to."' group by A.register_number order by A.register_number";


        $get_stu_query = "SELECT  A.name,X.guardian_name,A.nationality,A.religion,A.caste,A.sub_caste,A.dob,A.admission_date FROM  coe_student   as A  JOIN coe_student_mapping  as  B ON B.student_rel_id=A.coe_student_id JOIN coe_bat_deg_reg as C ON C.coe_bat_deg_reg_id=B.course_batch_mapping_id JOIN coe_degree as D ON D.coe_degree_id=C.coe_degree_id JOIN coe_programme as E ON E.coe_programme_id=C.coe_programme_id JOIN coe_batch as I ON I.coe_batch_id=C.coe_batch_id
        join coe_stu_guardian as X on X.stu_guardian_id=A.coe_student_id  where B.course_batch_mapping_id='".$bat_map_id."'   AND A.register_number between '".$reg_from."' AND '".$reg_to."' group by A.register_number order by A.register_number";
            ...
            //print_r($final_student);exit;              
                ...
                <tr>
                    <td colspan="5">
                      ...
                      <table class="right_table"    width="120%">
                        
                            <tr> 
                                <td colspan="4" > &nbsp; </td> 
                                <td  class="stuname" valign="middle" height="70px"><b> '.strtoupper($tc['name']).'</b></td>
                            </tr>
                             <tr> 
                                <td colspan="4" > &nbsp; </td> 
                                <td  class="fatname"  style="padding-bottom:-4px;" valign="middle" height="70px"><b> '.strtoupper($tc['guardian_name']).'</b></td>
                            </tr>
                             <tr> 
                                <td colspan="4" > &nbsp; </td> 
                                <td  class="nationality"  valign="bottom" height="70px"><b> '.strtoupper($tc['nationality']).'</b></td>
                            </tr>

                            <tr> 
                                <td colspan="4" > &nbsp; </td> 
                                <td  class="stu_religions" valign="bottom" height="80px"><b> '.strtoupper($tc['religion']).'</b></td>
                            </tr>
                             <tr>
                                <td colspan="4"> &nbsp; </td> 
                                <td  class="comunity_name" valign="bottom" height="80px"><b></b></td> 
                            </tr>
                            
                             <tr> 
                                <td colspan="4"> &nbsp; </td> 
                                <td  class="subcaste_print" valign="bottom"  height="80px"><b></b></td> 
                             </tr>
                            ...
                            <tr>
                                <td colspan="4"> &nbsp; </td>
                                <td  class="dob_words" valign="bottom" height="80px"><b> '.strtoupper(date("F d, Y", strtotime($tc['dob']))).' </b></td>
                            </tr>
                           <tr>
                                <td colspan="4"> &nbsp; </td>
                                <td  valign="middle"  style="padding-bottom:-115px;"height="110px"><b>'; 

                                 if(isset($deg_info)) 
                                 { 
                                  if($deg_info->degree_type=="UG") 
                                  {  
                                    $table .= "III YEAR   <br>"; 
                                  } 
                                  if($deg_info->degree_type=="PG")
                                  { 
                                    $table .= "V YEAR -  ";
                                    //$table .= "II YEAR   <br>"; 
                                  } 
                                 ...
                                 $table .=  strtoupper($degree_name)."(".strtoupper($degree_name1).")".'</b></td> 
                           </tr> 
                          ...
                          <tr>
                            ...
                            <tr>
                                <td colspan="4"> &nbsp; </td>
                                <td valign="bottom" class="admission_down" height="90px"><b> '.strtoupper('COMPLETED').'</b></td>
                            </tr>
                            <tr>
                                <td colspan="4"> &nbsp; </td>
                                <td valign="bottom" class="char" height="90px"><b> '.strtoupper('GOOD').' </b></td>
                            </tr>
                            <tr class="push_down">
                               
                               <td colspan="4"> &nbsp; </td> 
                               <td valign="bottom" class="date_tc"  height="90px"><b> '.date('d/m/Y', strtotime($date_left)).' </b></td>
                            </tr>
                            <tr class="push_down">
                                
                                <td colspan="4"> &nbsp; </td> 
                                <td  valign="bottom"  class="date_left" height="90px"><b> '.date('d/m/Y', strtotime($date_left)).' </b></td>
                            </tr>
                            <tr class="push_down">
                                <td colspan="4"> &nbsp; </td> 
                    ...
                    <td colspan="5">
                       <table class="right_table_tc_1"   width="190%">
                           ...
                           <tr> 
                             ...
                             <tr> 
                                <td colspan="4" > &nbsp; </td> 
                                <td  class="nationality_print"  valign="bottom" height="70px"><b> '.strtoupper($tc['nationality']).'</b></td>
                            </tr>
                            <tr> 
                                <td colspan="4" > &nbsp; </td> 
                                <td  class="stu_religion" valign="bottom" height="80px"><b> '.strtoupper($tc['religion']).'</b></td>
                            </tr>
    ...
    public function actionMarkStatementArtsPrintSupPdf()
    {
        require(Yii::getAlias('@webroot/includes/use_institute_info.php'));
        $content = $_SESSION['mark_statement_sup_pdf'];
        $pdf = new Pdf([
            'mode' => Pdf::MODE_CORE,
            'filename' => ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT) . ' MARK STATEMENT.pdf',
            'format' => Pdf::FORMAT_A4,
            'orientation' => Pdf::ORIENT_PORTRAIT,
            'content' => $content,         
            'cssFile' => 'css/arts_college_mark_statement_sup.css',
            'options' => ['title' => strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT)) . ' MARK STATEMENT'],
        ]);
    ...
    public function actionMarkStatementArtsPrintSupPgPdf()
    {
        require(Yii::getAlias('@webroot/includes/use_institute_info.php'));
        $content = $_SESSION['mark_statement_sub_pg_pdf'];
        $pdf = new Pdf([
            'mode' => Pdf::MODE_CORE,
            'filename' => ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT) . ' MARK STATEMENT.pdf',
            'format' => Pdf::FORMAT_A4,
            'orientation' => Pdf::ORIENT_PORTRAIT,
            'content' => $content,         
            'cssFile' => 'css/arts_college_mark_statement_sup_pg.css',
            'options' => ['title' => strtoupper(ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_STUDENT)) . ' MARK STATEMENT'],
        ]);
...
B.subject_id=A.coe_subjects_id JOIN coe_mark_entry_master as C ON C.subject_map_id=B.coe_subjects_mapping_id JOIN coe_bat_deg_reg as E ON E.coe_bat_deg_reg_id=B.batch_mapping_id JOIN coe_programme as D ON D.coe_programme_id=E.coe_programme_id JOIN coe_batch as F ON F.coe_batch_id=E.coe_batch_id  JOIN coe_student_mapping as abc ON abc.course_batch_mapping_id=B.batch_mapping_id where C.year<='".$year."' and student_map_id NOT IN (select student_map_id FROM coe_mark_entry_master as abc where abc.subject_map_id=C.subject_map_id and abc.student_map_id=C.student_map_id and result like '%Pass%' ) and C.result not like '%Pass%' and (year_of_passing='' or year_of_passing=NULL) and status_category_type_id!='".$det_disc_type."' group by batch_mapping_id,subject_map_id order by batch_name,D.programme_code asc"; 
    ...
    public function actionCoursewisearrear()
    {
        ...
        if (Yii::$app->request->post()) 
        {
            ...
            $query->select(["distinct (H.subject_code) as subject_code", "concat(D.degree_code,'-',E.programme_code) as degree_code", "A.register_number", "A.name", "H.subject_name", "G.semester", "F.year",'F.student_map_id','F.subject_map_id','H.CIA_max','H.ESE_max',"F.grade_name", "E.programme_name", "K.batch_name", "D.degree_name"])
                ->from('coe_student as A')
                ->join('JOIN', 'coe_student_mapping as B', 'B.student_rel_id=A.coe_student_id ')
                ->join('JOIN', 'coe_bat_deg_reg as C', 'C.coe_bat_deg_reg_id=B.course_batch_mapping_id')
                ->join('JOIN', 'coe_degree as D', 'D.coe_degree_id=C.coe_degree_id')
    ...
    public function actionEsemarklist()
    {
        ...
        if (Yii::$app->request->post()) 
           ...
           $sem_valc = ConfigUtilities::SemCaluclation($_POST['mark_year'],$_POST['month'],$_POST['bat_map_val']);
            $query = new  Query();
            $query->select('distinct (H.subject_code) as subject_code, H.subject_name, H.CIA_max, H.ESE_max,A.register_number,F.CIA,F.ESE,F.grade_name,F.year,J.category_type as month,K.category_type as exam_type,E.programme_name,D.degree_name,B.coe_student_mapping_id,G.coe_subjects_mapping_id,F.month as exam_month,F.result')
                ->from('coe_student as A')
                ->join('JOIN', 'coe_student_mapping as B', 'B.student_rel_id=A.coe_student_id ')
                ->join('JOIN', 'coe_bat_deg_reg as C', 'C.coe_bat_deg_reg_id=B.course_batch_mapping_id')
                ->join('JOIN', 'coe_degree as D', 'D.coe_degree_id=C.coe_degree_id')
            ...
            $query->orderBy('H.subject_code');
            $subjectsInfo = $subject_get_data->createCommand()->queryAll();
           /* $subject_get_data->select('distinct (H.subject_code) as subject_code, H.subject_name, H.CIA_max, H.ESE_max,H.coe_subjects_id')
                ->from('coe_student as A')
                ->join('JOIN', 'coe_student_mapping as B', 'B.student_rel_id=A.coe_student_id ')
                ->join('JOIN', 'coe_bat_deg_reg as C', 'C.coe_bat_deg_reg_id=B.course_batch_mapping_id')
                ->join('JOIN', 'coe_degree as D', 'D.coe_degree_id=C.coe_degree_id')
                ...
                ->join('JOIN', 'coe_subjects H', 'H.coe_subjects_id=G.subject_id');
            $subject_get_data->Where([ 'B.course_batch_mapping_id' => $_POST['bat_map_val'], 'G.semester' => $sem_valc])->andWhere(['<>', 'status_category_type_id', $det_cat_type])
                ->andWhere(['<>', 'status_category_type_id', $det_disc_type]);
            $query->orderBy('H.subject_code');
            $subjectsInfo = $subject_get_data->createCommand()->queryAll();*/
            //print_r($subjectsInfo);exit;
        ...
        $MON_name = Categorytype::findOne($_POST['month']);
         $notIn = array_filter($notIn);
            ...
            if (count($students_map_id_pass) > 0) 
            {
                ...
                $data .= '<tr>
                            <td colspan=8 align="center"><b>Mark Percent : ' . $_POST['year'] . ' ' . $month . '
                            </b></td>
                        </tr>';
               ...
               // $ab=$students_absent;
                ...
                $sn_no = 1;
                $i = $total_pass = $total_strength_active = $ug_strength = $ug_reg = $ug_pass = $pg_strength = $pg_reg = $pg_pass_count = $absent_count= $ug_abs=  $pg_abs= $total_strength = $total_absent= $total_fail =0;
                $prev_deg_name = '';
                foreach ($var_change as $key => $deg) 
                { 
                 $absent = new Query();
               $absent->select(['count(distinct student_map_id) as count'])
                ->from('coe_student_mapping a')
               ->join('JOIN', 'coe_mark_entry_master e', 'e.student_map_id=a.coe_student_mapping_id')
                ->where(['e.month'=>$_POST['month'],'e.mark_type'=>27,'e.year'=>$_POST['year'],'e.result'=>'Absent','a.course_batch_mapping_id'=>$deg['course_batch_mapping_id']])
                ->andWhere(['<>', 'a.status_category_type_id', $det_cat_type])
               // ->andWhere(['IN', 'e.result', 'Absent'])
                ->andWhere(['<>', 'a.status_category_type_id', $det_disc_type])
                ->andWhere(['<>', 'a.status_category_type_id', $det_long_absent]);
                  // echo $absent->createCommand()->getrawsql();
            $absent_count = $absent->createCommand()->queryScalar();             
                    ...
                    $STRENGHT_N = StudentMapping::find()->where(['course_batch_mapping_id'=>$deg['course_batch_mapping_id']])->andWhere(['<>', 'status_category_type_id', $det_cat_type])->andWhere(['<>', 'status_category_type_id', $det_disc_type])->andWhere(['<>', 'status_category_type_id', $det_long_absent])->count();
                    $STRENGHT_NOT= $STRENGHT_N-$absent_count;
                    ...
                    {   
                         ...
                         $data .='<td align="center"><b>'. $ug_abs.'</b></td>';
                         ...
                         $data .='<td align="center">'.$STRENGHT.'</td>';
                          $data .='<td align="center">'.$absent_count.'<b></b></td>';
                ...
                $pg_reg = $pg_reg==0 ? 0: $pg_reg;
                 ...
                 $data .='<td align="center"><b>'.$pg_strength.'</b></td>';
                   $data .='<td align="center"> '.$pg_abs.'<b></b></td>';
                ...
                <tr>
                    ...
                    <td align="center"><b>'.$total_strength.'</b></td>
                      <td align="center"><b>'.$total_absent.'</b></td>
...
//$sem_count = ConfigUtilities::SemCaluclation($year,$month,$batch_mapping_id);
        ...
        if (isset($_POST['internetcopybutton'])) 
        {
            ...
            if(!empty($getAbsentList))
            {
                ...
                {         
                    ...
                    $s8tuCiaMarks = MarkEntry::find()->where(['category_type_id'=>$internLa->coe_category_type_id,'subject_map_id'=>$subject_map_id,'student_map_id'=>$student_map_id])->orderBy('coe_mark_entry_id desc')->one();
            ...
            $internet_copy_query->andWhere(['a.mark_type'=>27])
            ...
            $query_man->select('H.subject_code,paper_no,  A.name, A.register_number, A.dob,  H.ESE_min,H.ESE_max, H.CIA_max,H.CIA_min, F.subject_map_id, F.ESE,F.CIA, F.result,F.withheld,F.grade_name,F.student_map_id,F.year, F.month,D.degree_code,E.programme_name,F.semester')
                ...
                ->join('JOIN', 'coe_mandatory_subcat_subjects as G', 'G.coe_mandatory_subcat_subjects_id=F.subject_map_id')
                ->join('JOIN', 'coe_mandatory_subjects H', 'H.coe_mandatory_subjects_id=G.man_subject_id');
            $query_man->Where(['F.year' => $_POST['year'], 'F.month' =>  $_POST['month'], 'A.student_status' => 'Active','G.is_additional'=>'NO','F.mark_type'=>$mark_type])
                ->andWhere(['<>', 'status_category_type_id', $det_disc_type]);
    ...
    public function actionHallticketexportdata()
    {
        ...
        else
        {
            ...
            $query = new Query();
            $query->select('L.batch_name,D.register_number,D.name,D.dob,B.degree_code,C.programme_name,G.semester,F.subject_code,F.subject_name,H.exam_date,K.category_type,H.exam_type,I.hall_name,J.row,J.row_column,J.seat_no')
                ->from('coe_bat_deg_reg A')
                ...
                ->where(['J.year' => $year,'J.month' => $month,'H.exam_year'=> $year,'H.exam_month'=>$month,'H.exam_type'=>$exam_type,'L.coe_batch_id'=>$batch_id,'batch_name'=>$batch_name_id]);
                /*if(isset($batch_id) && !empty($batch_id))
                {
            ...
            $query_1 = new Query();
            $query_1->select('L.batch_name,D.register_number,D.name,D.dob,B.degree_code,C.programme_name,G.semester,F.subject_code,F.subject_name,H.exam_date,K.category_type,H.exam_type,I.hall_name,J.row,J.row_column,J.seat_no')
                ->from('coe_bat_deg_reg A')
                ->join('JOIN', 'coe_degree B', 'A.coe_degree_id=B.coe_degree_id')
                ->join('JOIN', 'coe_programme C', 'A.coe_programme_id=C.coe_programme_id')
                ->join('JOIN', 'coe_batch L', 'A.coe_batch_id=L.coe_batch_id')
        ...
        $final = array_diff($a, $b);
          ...
          $reg_num_in = '';
           ...
           $pg_maximum_marks = 2250;
            //$pg_maximum_marks = 6000;
            $ug_maximum_credits = 140;
           $pg_maximum_credits = 90;
            //$pg_maximum_credits = 234;
...
//print_r($temp_part1);exit;
    ...
    public function actionUniversityreportdata()
    {
        ...
        $batch = Yii::$app->request->post('batch');
        $bat_map_id = Yii::$app->request->post('bat_map_id');
        $mark_year =Yii::$app->request->post('mark_year') ;
       ...
       $deg_info = Degree::findOne($get_batc_map->coe_degree_id);
        ...
        $det_disc_type = Yii::$app->db->createCommand("select coe_category_type_id from coe_category_type where category_type like '%Discontinued%'")->queryScalar();
        $passed_student = Yii::$app->db->createCommand("select * from coe_student as A,coe_student_mapping as B,coe_subjects_mapping as C,coe_mark_entry_master as D where A.coe_student_id=B.student_rel_id and B.course_batch_mapping_id=C.batch_mapping_id and B.coe_student_mapping_id=D.student_map_id and C.coe_subjects_mapping_id=D.subject_map_id and B.course_batch_mapping_id='" . $bat_map_id . "' and C.batch_mapping_id='" . $bat_map_id . "' and status_category_type_id NOT IN('".$det_cat_type."','".$det_disc_type."') and year_of_passing!='' and D.year='" . $mark_year . "' and D.month='" . $exam_month . "' and D.term='" . $exam_term . "' order by A.register_number")->queryAll();
      ...
      //print_r( $passed_student);exit;
       ...
       /* $get_stu_query = "SELECT F.student_map_id,A.register_number,A.dob,A.name,A.gender,D.degree_code,D.degree_name,E.programme_name,H.subject_code,C.regulation_year,H.subject_name,G.semester,H.credit_points,H.CIA_max,H.ESE_max,F.grade_point,F.grade_name,F.year,F.month,B.course_batch_mapping_id,F.year_of_passing,paper_no,F.result,max(F.year_of_passing) as last_appearance,round (sum(H.credit_points*F.grade_point)/sum(H.credit_points),5) as total FROM coe_student as A JOIN coe_student_mapping as B ON B.student_rel_id=A.coe_student_id JOIN coe_bat_deg_reg as C ON C.coe_bat_deg_reg_id=B.course_batch_mapping_id JOIN coe_degree as D ON D.coe_degree_id=C.coe_degree_id JOIN coe_programme as E ON E.coe_programme_id=C.coe_programme_id JOIN coe_mark_entry_master as F ON F.student_map_id=B.coe_student_mapping_id JOIN coe_subjects_mapping as G ON G.coe_subjects_mapping_id=F.subject_map_id JOIN coe_subjects as H ON H.coe_subjects_id=G.subject_id JOIN coe_batch as I ON I.coe_batch_id=C.coe_batch_id where G.batch_mapping_id='".$bat_map_id."' AND B.coe_student_mapping_id NOT IN(select student_map_id from coe_mark_entry_master where year_of_passing='' and subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where student_map_id=F.student_map_id and result like '%pass%') and subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where student_map_id=F.student_map_id and result like '%COMPLETED%')) and status_category_type_id NOT IN('".$det_cat_type."','".$det_disc_type."') AND F.grade_name not IN ('U','wh','AB','ab','WH','ra','wd','WD') AND A.register_number IN (".$trim_reg.") and part_no=1 group by A.register_number order by A.register_number, G.semester, paper_no";
        $final_student = Yii::$app->db->createCommand($get_stu_query)->queryAll();*/
       ...
       // print_r($final_student);exit;
        ...
        if (count($final_student) > 0) 
        {
            ...
            $table = '<table border=1 id="checkAllFeet" class="table table-responsive table-striped" align="center" >
               ...
               $table .='<table  border="1"  class="table table-bordered table-responsive dum_edit_table table-hover" >';
        $table .='<tr><td colspan="12">SRI KRISHNA ARTS AND SCIENCE COLLEGE, (AUTONOMOUS), COIMBATORE - 641 008.</td></tr>';
        $table .='<tr><td colspan="12">MONTH AND YEAR OF EXAMINATIONS : '.$month_name->description.' '.$mark_year.' </td></tr>';
        foreach ($final_student as $key => $name)  
...
//print_r($temp_part1);exit;
                ...
                if (isset($_POST['add' . $k]) && $_POST['add' . $k]=='on') 
                {
                  ...
                  $arts_college_grade = round(($out_of_maximum/$final_sub_total)*10,1);
                    ...
                    if (empty($check_exist)) 
                    {
                        ...
                        $model_save->course_type_id=$prgm_type_val;
    ...
    public function actionInternetCopyAdditionalCredits()
    {
        ...
        if (isset($_POST['internetcopybutton'])) 
        {
            ...
            array_multisort(array_column($internet_copy, 'register_number'),  SORT_ASC, $internet_copy);
             ...
             $internet_copy_query_2 = new Query();
             $internet_copy_query_2->select('c.register_number,c.name,c.dob,subject_code,subject_name,ese_max,ese_min,cia_max,cia_min,a.CIA,a.ESE,a.result,a.total,a.grade_name,a.subject_map_id,a.student_map_id,a.year,a.month,degree_code,programme_name,a.total')
                ...
                ->join('JOIN', 'coe_degree h' ,'h.coe_degree_id=g.coe_degree_id')
                ->join('JOIN','coe_programme i','i.coe_programme_id=g.coe_programme_id')
                ->Where(['a.year' => $_POST['year'], 'a.month' => $_POST['month'],'d.course_type_id'=>122])
                ->andWhere(['<>','status_category_type_id', $det_disc_type])  ->orderBy('c.register_number');  
             
             $internet_copy_2 =$internet_copy_query_2->createCommand()->queryAll();
             //print_r($internet_copy_2);exit;

             
             if(!empty($internet_copy_2))
             {

                $internet_copy = array_merge($internet_copy_2);
             }


             array_multisort(array_column($internet_copy_2, 'register_number'), SORT_ASC, $internet_copy_2);
    ...
    public function actionMyclassroom2()
    {
        $model = new MarkEntry();
        Yii::$app->ShowFlashMessages->setMsg('Welcome', 'Welcome to My Class Room ' . ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_REPORT));
        return $this->render('myclassroom2', [
            'model' => $model,
        ]);
    }
    public function actionMyclassroomdata2()
    {
        $year = Yii::$app->request->post('year');
        $month = Yii::$app->request->post('month');
   ...
   /*public function actionMyclassroom()
    {
       ...
       $batch_map_id = Yii::$app->request->post('bat_map_val');
        ...
        /*if($batch_map_id!='')
        {
            $query->select('F.student_map_id,A.name, A.register_number, G.semester, A.dob,B.course_batch_mapping_id,F.year,F.month ,K.description as month_name , F.term, C.regulation_year, D.degree_code, D.degree_name, E.programme_name, part_no, mark_type, result_published_date,G.semester')
            ->from('coe_student as A')
            ->join('JOIN', 'coe_student_mapping as B', 'B.student_rel_id=A.coe_student_id ')
            ->join('JOIN', 'coe_bat_deg_reg as C', 'C.coe_bat_deg_reg_id=B.course_batch_mapping_id')
            ->join('JOIN', 'coe_degree as D', 'D.coe_degree_id=C.coe_degree_id')
            ...
            ->join('JOIN', 'coe_subjects_mapping as G', 'G.coe_subjects_mapping_id=F.subject_map_id')
            ->join('JOIN', 'coe_subjects H', 'H.coe_subjects_id=G.subject_id');
            $query->Where(['I.coe_batch_id'=>$batch_id,'C.coe_batch_id'=>$batch_id,'F.year' => $year, 'F.month' => $month, 'A.student_status' => 'Active','D.degree_type'=>$degree,'G.semester'=>$sem_calc])
            ->andWhere(['<>', 'status_category_type_id', $det_disc_type]);
            $query->groupBy('F.student_map_id')
            ->orderBy('A.register_number,G.semester');
        }*/
...
$semester_array = ['1'=>'I','2'=>'II','3'=>'III','4'=>'IV','5'=>'V','6'=>'VI','7'=>'VII','8'=>'VIII','9'=>'IX','10'=>'X','11'=>'XI','12'=>'XII','13'=>'XIII','14'=>'XIV'];
            ...
            foreach ($final_student as $final_student1) 
            {       
               //$cgpa_calculation = ConfigUtilities::getCgpaCaluclation($final_student1['year'],$final_student1['month'],$final_student1['course_batch_mapping_id'],$final_student1['student_map_id'],$sem_calc);
                $date_of_result = isset($final_student1['result_published_date']) && !empty($final_student1['result_published_date']) && $final_student1['result_published_date']!='0000-00-00'?date('d-M-Y',strtotime($final_student1['result_published_date'])):date('d-m-Y');
                $table .= '
                    <tr>
                        <td align="center"> ' . $sn . ' </td>
...
$semester_array = ['1'=>'I','2'=>'II','3'=>'III','4'=>'IV','5'=>'V','6'=>'VI','7'=>'VII','8'=>'VIII','9'=>'IX','10'=>'X','11'=>'XI','12'=>'XII','13'=>'XIII','14'=>'XIV'];
            ...
            {       
               $cgpa_calculation = ConfigUtilities::getCgpaCaluclation($final_student1['year'],$final_student1['month'],$final_student1['course_batch_mapping_id'],$final_student1['student_map_id'],$final_student1['semester']);
                ...
                $getRegInfo = MarkEntryMaster::find()->where(['student_map_id'=>$final_student1['student_map_id'],'year'=>$final_student1['year'],'month'=>$final_student1['month'],'mark_type'=>27])->one();
                $semester_number = ConfigUtilities::semCaluclation($year, $final_student1['month'], $final_student1['course_batch_mapping_id']);
                $cgpa_calc = ConfigUtilities::getgpaCaluclationObe1($year,$final_student1['month'],$final_student1['course_batch_mapping_id'],$final_student1['student_map_id'],$final_student1['term']);
                 $max_parts = SubInfo::find()->where(['sub_batch_id'=>$final_student1['course_batch_mapping_id']])->orderBy('part_no desc')->limit(1)->one();
              // print_r($cgpa_calc);exit;
    ...
    public function actionSubAdd()
    {
        ...
        if (isset($_POST['internetcopybutton'])) 
        {
            ...
            $internet_copy_query->select('c.register_number,subject_code,subject_name,ese_maximum,ese_minimum,cia_maximum,cia_minimum,a.CIA,a.ESE,a.result,a.total,a.grade_name,a.grade_point,a.student_map_id,a.exam_year as year,a.exam_month as month,degree_code,programme_name')
                ->from('coe_additional_credits a')
                ->join('JOIN', 'coe_student_mapping b', 'a.student_map_id=b.coe_student_mapping_id')
                ->join('JOIN', 'coe_student c', 'b.student_rel_id=c.coe_student_id')
                ->join('JOIN', 'coe_bat_deg_reg g','g.coe_bat_deg_reg_id=b.course_batch_mapping_id')
        ...
        // print_r($internet_copy_query);exit;            
            ...
            array_multisort(array_column($internet_copy, 'register_number'),  SORT_ASC, $internet_copy);
             ...
             $internet_copy_query_2 = new Query();
             $internet_copy_query_2->select('c.register_number,subject_code,subject_name,ese_max,ese_min,cia_max,cia_min,a.CIA,a.ESE,a.result,a.total,a.grade_name,a.subject_map_id,a.student_map_id,a.year,a.month,degree_code,programme_name')
                ->from('coe_value_mark_entry a')
                ->join('JOIN','coe_student_mapping b','a.student_map_id=b.coe_student_mapping_id')
                ->join('JOIN','coe_student c', 'b.student_rel_id=c.coe_student_id')
                ->join('JOIN','sub d','a.subject_map_id=d.coe_sub_mapping_id')
                ...
                ->join('JOIN', 'coe_batch k','k.coe_batch_id=g.coe_batch_id')
                ->join('JOIN','coe_programme i','i.coe_programme_id=g.coe_programme_id')
                ->Where(['a.year' => $_POST['year'], 'a.month' => $_POST['month'],'b.course_batch_mapping_id'=>$_POST['bat_map_val']])
                ->andWhere(['<>','status_category_type_id', $det_disc_type])  ->orderBy('c.register_number');  
             //$internet_copy_query_2->where($whereCondition);
             //$internet_copy_query_2
             $internet_copy_2 =$internet_copy_query_2->createCommand()->queryAll();
             
             if(!empty($internet_copy_2))
             {

                $internet_copy = array_merge($internet_copy,$internet_copy_2);
             }
    ...
    public function actionSubAddPdf()
    {
        ...
        $pdf = new Pdf([
            'mode' => Pdf::MODE_CORE,
            'filename' => ' Additional Credits Copy.pdf',
            'format' => Pdf::FORMAT_A4,
            'orientation' => Pdf::ORIENT_LANDSCAPE,
            'content' => $content,
            'cssFile' => '@vendor/kartik-v/yii2-mpdf/assets/kv-mpdf-bootstrap.min.css',
   ...
   public function actionSubAdditional()
    {
        ...
        // print_r($internet_copy_query);exit;            
            ...
            array_multisort(array_column($internet_copy, 'register_number'),  SORT_ASC, $internet_copy);
             ...
             $internet_copy_query_2 = new Query();
             $internet_copy_query_2->select('c.register_number,subject_code,subject_name,ese_max,ese_min,cia_max,cia_min,a.CIA,a.ESE,d.semester,a.result,a.total,a.grade_name,a.subject_map_id,a.student_map_id,a.year,a.month,degree_code,programme_name')
                ->from('coe_value_mark_entry a')
                ->join('JOIN','coe_student_mapping b','a.student_map_id=b.coe_student_mapping_id')
                ->join('JOIN','coe_student c', 'b.student_rel_id=c.coe_student_id')
                ->join('JOIN','sub d','a.subject_map_id=d.coe_sub_mapping_id')
                ...
                ->join('JOIN', 'coe_batch k','k.coe_batch_id=g.coe_batch_id')
                ->join('JOIN','coe_programme i','i.coe_programme_id=g.coe_programme_id')
                ->Where(['a.year' => $_POST['year'], 'a.month' => $_POST['month'],'b.course_batch_mapping_id'=>$_POST['bat_map_val'],'d.course_type_id'=>122])
                ->andWhere(['<>','status_category_type_id', $det_disc_type])  ->orderBy('c.register_number');  
             //$internet_copy_query_2->where($whereCondition);
             //$internet_copy_query_2
             $internet_copy_2 =$internet_copy_query_2->createCommand()->queryAll();
   ...
   public function actionSubAdditionalPdf()
    ...
    public function actionAdd()
    {
        ...
        if (isset($_POST['internetcopybutton'])) 
        {
            ...
            $internet_copy_query->select('c.register_number,subject_code,subject_name,ese_maximum,ese_minimum,cia_maximum,cia_minimum,a.CIA,a.ESE,a.result,a.total,a.grade_name,a.grade_point,a.student_map_id,a.exam_year as year,a.out_of_maximum as secured,a.exam_month as month,degree_code,programme_name,k.batch_name')
                ->from('coe_additional_credits a')
                ->join('JOIN', 'coe_student_mapping b', 'a.student_map_id=b.coe_student_mapping_id')
                ->join('JOIN', 'coe_student c', 'b.student_rel_id=c.coe_student_id')
                ->join('JOIN', 'coe_bat_deg_reg g','g.coe_bat_deg_reg_id=b.course_batch_mapping_id')
        ...
        // print_r($internet_copy_query);exit;            
            ...
            array_multisort(array_column($internet_copy, 'register_number'),  SORT_ASC, $internet_copy);
             ...
             $internet_copy_query_2 = new Query();
             $internet_copy_query_2->select('c.register_number,subject_code,subject_name,ese_max,ese_min,cia_max,cia_min,a.CIA,a.ESE,a.result,a.total,a.grade_name,a.grade_point,a.subject_map_id,a.student_map_id,a.year,a.month,degree_code,programme_name ,a.ESE as secured,k.batch_name')
                ->from('coe_value_mark_entry a')
                ->join('JOIN','coe_student_mapping b','a.student_map_id=b.coe_student_mapping_id')
                ->join('JOIN','coe_student c', 'b.student_rel_id=c.coe_student_id')
                ->join('JOIN','sub d','a.subject_map_id=d.coe_sub_mapping_id')
   ...
   public function actionAddCount()
    {
        ...
        if (isset($_POST['internetcopybutton'])) 
        {
            ...
            $internet_copy_query = new Query();
             $whereCondition = [                        
                        'a.exam_year' => $_POST['year'], 'a.exam_month' => $_POST['month'],'a.result'=>'pass'
                    ];

            $internet_copy_query->select('c.register_number,subject_code ,subject_name,a.result,count(distinct student_map_id) as count,a.exam_year as year,a.exam_month as month,degree_code,programme_name,k.batch_name')
                ->from('coe_additional_credits a')
                ->join('JOIN', 'coe_student_mapping b', 'a.student_map_id=b.coe_student_mapping_id')
                ->join('JOIN', 'coe_student c', 'b.student_rel_id=c.coe_student_id')
                ->join('JOIN', 'coe_bat_deg_reg g','g.coe_bat_deg_reg_id=b.course_batch_mapping_id')
        ...
        // print_r($internet_copy_query);exit;            
            ...
            array_multisort(array_column($internet_copy, 'register_number'),  SORT_ASC, $internet_copy);
             ...
             $internet_copy_query_2 = new Query();
             $internet_copy_query_2->select('c.register_number,subject_code,subject_name,a.result,count(distinct student_map_id) as count,a.subject_map_id,a.student_map_id,a.year,a.month,
                 degree_code,programme_name,k.batch_name')
                ->from('coe_value_mark_entry a')
                ->join('JOIN','coe_student_mapping b','a.student_map_id=b.coe_student_mapping_id')
                ->join('JOIN','coe_student c', 'b.student_rel_id=c.coe_student_id')
                ->join('JOIN','sub d','a.subject_map_id=d.coe_sub_mapping_id')
                ...
                ->join('JOIN', 'coe_degree h' ,'h.coe_degree_id=g.coe_degree_id')
                 ->join('JOIN', 'coe_batch k','k.coe_batch_id=g.coe_batch_id')
                ->join('JOIN','coe_programme i','i.coe_programme_id=g.coe_programme_id')
                ->Where(['a.year' => $_POST['year'], 'a.month' => $_POST['month'],'a.result'=>'pass','d.course_type_id'=>122])
                ->andWhere(['<>','status_category_type_id', $det_disc_type])  ->orderBy('c.register_number');  
             //$internet_copy_query_2->where($whereCondition);
             //$internet_copy_query_2
             $internet_copy_2 =$internet_copy_query_2->createCommand()->queryAll();
    ...
    public function actionStudentarrearcount()
    {
        $model = new MarkEntry();
        if(isset($_SESSION['programmewisearrearnominal'])){ unset($_SESSION['programmewisearrearnominal']);}
        if (Yii::$app->request->post()) 
        {
            ...
            $select_query = "SELECT distinct (H.subject_code) as subject_code,G.semester,A.register_number,concat(D.degree_code,'-',E.programme_code) as degree_code,count(DISTINCT F.subject_map_id) as count,H.subject_name,I.description as subject_type,J.description as course_type,K.description as paper_type ,E.programme_name,D.degree_name,bat.batch_name  FROM  coe_student as A JOIN coe_student_mapping as B ON B.student_rel_id=A.coe_student_id  JOIN coe_bat_deg_reg as C ON C.coe_bat_deg_reg_id=B.course_batch_mapping_id JOIN coe_degree as D ON D.coe_degree_id=C.coe_degree_id JOIN coe_programme as E ON E.coe_programme_id=C.coe_programme_id JOIN coe_batch as bat ON bat.coe_batch_id=C.coe_batch_id  JOIN coe_mark_entry_master as F ON F.student_map_id=B.coe_student_mapping_id JOIN coe_subjects_mapping as G ON G.coe_subjects_mapping_id=F.subject_map_id JOIN coe_subjects H ON H.coe_subjects_id=G.subject_id JOIN coe_category_type as I ON I.coe_category_type_id=G.subject_type_id JOIN coe_category_type as J ON J.coe_category_type_id=G.course_type_id JOIN coe_category_type as K ON K.coe_category_type_id=G.paper_type_id WHERE  A.student_status='Active' and F.year_of_passing='' and F.student_map_id NOT IN (SELECT student_map_id FROM coe_mark_entry_master WHERE subject_map_id=F.subject_map_id and result like '%pass%' ) AND F.year<='".$_POST['mark_year']."' and C.coe_batch_id='".$batch_val."' and bat.coe_batch_id='".$batch_val."' ".$addIntheQueryDet." ".$addIntheQuery." group by B.course_batch_mapping_id,F.student_map_id order by batch_name,degree_code,G.semester";
            
            $programmewisearrearnominal = Yii::$app->db->createCommand($select_query)->queryAll();

            if (!empty($programmewisearrearnominal)) {
                return $this->render('studentarrearcount', [
                    'model' => $model,
                    'programmewisearrearnominal' => $programmewisearrearnominal,
                ]);
            } else {
                Yii::$app->ShowFlashMessages->setMsg('Error', "No data Found Kindly re-check your Submission");
                return $this->redirect(['mark-entry/studentarrearcount']);
            }
        } else {
            Yii::$app->ShowFlashMessages->setMsg('Welcome', 'Welcome to ' . ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_PROGRAMME) . ' Wise Arrear ' . ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_REPORT));
            return $this->render('studentarrearcount', [
     ...
     public function actionStudentarrearcountPdf()
    {
        require(Yii::getAlias('@webroot/includes/use_institute_info.php'));
        ...
        $pdf = new Pdf([
            ...
            'cssInline' => ' @media all{
                ...
                ',
            'options' => ['title' => "STUDENT WISE ARREAR COUNT"],
            'methods' => [
                'SetHeader' => ["OFFICE OF THE CONTROLLER OF EXAMINATIONS ".$org_name],
                'SetFooter' => ["FULL ARREAR LIST" . ' PRINTED ON : {DATE d-m-Y H:i:s:A}  PAGE :{PAGENO}'],
            ]
    ...
    public function actionStudentarrearcountExcel()
    {
     ...
     public function actionCountadd()
    {
        ...
        if (isset($_POST['internetcopybutton'])) 
        {
            ...
            $internet_copy_query->select('c.register_number,c.name,c.dob,subject_code,subject_name,ese_maximum,ese_minimum,cia_maximum,cia_minimum,a.CIA,a.ESE,a.result,a.total,a.grade_name,a.grade_point,count(distinct student_map_id) as count,a.exam_year as year,a.semester,a.exam_month as month,degree_code,programme_name')
                ->from('coe_additional_credits a')
                ->join('JOIN', 'coe_student_mapping b', 'a.student_map_id=b.coe_student_mapping_id')
                ->join('JOIN', 'coe_student c', 'b.student_rel_id=c.coe_student_id')
                ->join('JOIN', 'coe_bat_deg_reg g','g.coe_bat_deg_reg_id=b.course_batch_mapping_id')
        ...
        // print_r($internet_copy_query);exit;            
            $internet_copy_query->andWhere(['<>', 'status_category_type_id', $det_disc_type])
                ->orderBy('subject_code' )->groupBy('subject_code' );
            ...
            array_multisort(array_column($internet_copy, 'register_number'),  SORT_ASC, $internet_copy);
             ...
             $internet_copy_query_2 = new Query();
             $internet_copy_query_2->select('c.register_number,subject_code,subject_name,ese_max,ese_min,cia_max,cia_min,a.CIA,a.ESE,d.semester,a.result,a.total,a.grade_name,a.subject_map_id,count(distinct student_map_id) as count,a.year,a.month,degree_code,programme_name')
                ->from('coe_value_mark_entry a')
                ->join('JOIN','coe_student_mapping b','a.student_map_id=b.coe_student_mapping_id')
                ->join('JOIN','coe_student c', 'b.student_rel_id=c.coe_student_id')
                ->join('JOIN','sub d','a.subject_map_id=d.coe_sub_mapping_id')
                ...
                ->join('JOIN','coe_programme i','i.coe_programme_id=g.coe_programme_id')
                ->Where(['a.year' => $_POST['year'], 'a.month' => $_POST['month'],'b.course_batch_mapping_id'=>$_POST['bat_map_val'],'d.course_type_id'=>122])
                ->andWhere(['<>','status_category_type_id', $det_disc_type])  ->orderBy('subject_code')->groupBy('subject_code' );  
             //$internet_copy_query_2->where($whereCondition);
             //$internet_copy_query_2
             $internet_copy_2 =$internet_copy_query_2->createCommand()->queryAll();
            ...
            Yii::$app->ShowFlashMessages->setMsg('Welcome', 'Welcome to Subject wise Count');
            return $this->render('Countadd', [
                'model' => $model, 'galley' => $galley,
            ]);
        }
      ...
      public function actioncountaddPdf()
    {
        require(Yii::getAlias('@webroot/includes/use_institute_info.php'));
        
        $content = $_SESSION['internet_copy'];
        
        //unset($_SESSION['student_application_date']);
        $pdf = new Pdf([
            'mode' => Pdf::MODE_CORE,
            'filename' => "Subject wise arrear count.pdf",
            'format' => Pdf::FORMAT_A4,
            'orientation' => Pdf::ORIENT_PORTRAIT,
            'content' => $content,
            'cssFile' => '@vendor/kartik-v/yii2-mpdf/assets/kv-mpdf-bootstrap.min.css',
    ...
    public function actioncountaddExcel()
    {
       
        $content = $_SESSION['internet_copy'];
        
        $fileName = "Subject wise arrear count-" . date('Y-m-d-H-i-s') . '.xls';
        $options = ['mimeType' => 'application/vnd.ms-excel'];
        return Yii::$app->excel->exportExcel($content, $fileName, $options);
    }
 ...
 public function actionAdcNptlCoursera()
    {
        $model = new MarkEntry();
        $markentrymaster = new MarkEntryMaster();
        $add_credits = new AdditionalCredits();
        ...
        if (isset($_POST['internetcopybutton'])) 
        {
            ...
            $internet_copy_query = new Query();
            $internet_copy_query->select('c.register_number,c.name,c.dob,subject_code,subject_name,ese_maximum,ese_minimum,cia_maximum,cia_minimum,a.CIA,a.ESE,a.result,a.total,a.grade_name,a.grade_point,a.student_map_id,    a.course_type_id,a.exam_year as year,a.semester,a.exam_month as month,degree_code,programme_name,m.description as course_type')
                ->from('coe_additional_credits a')
                ->join('JOIN', 'coe_student_mapping b', 'a.student_map_id=b.coe_student_mapping_id')
                ->join('JOIN', 'coe_student c', 'b.student_rel_id=c.coe_student_id')
                ->join('JOIN', 'coe_bat_deg_reg g','g.coe_bat_deg_reg_id=b.course_batch_mapping_id')
                ...
                ->join('JOIN', 'coe_batch k','k.coe_batch_id=g.coe_batch_id')
                ->join('JOIN', 'coe_programme i','i.coe_programme_id=g.coe_programme_id')
                ->join('JOIN', 'coe_category_type m','m.coe_category_type_id=a.course_type_id') 
                ->where(['a.exam_year' => $_POST['year'], 'a.exam_month' => $_POST['month'],'b.course_batch_mapping_id' => $_POST['bat_map_val'],'a.course_type_id'=>$_POST['prgm_type_val']])
                 ->andWhere(['<>','status_category_type_id', $det_disc_type])->orderBy('c.register_number');
        ...
        //print_r($internet_copy_query);exit;            
            ...
            array_multisort(array_column($internet_copy, 'register_number'),  SORT_ASC, $internet_copy);
             ...
             $internet_copy_query_2 = new Query();
             $internet_copy_query_2->select('c.register_number,subject_code,subject_name,ese_max,ese_min,cia_max,cia_min,a.CIA,a.ESE,d.semester,a.result,a.total,a.grade_name,a.subject_map_id,a.student_map_id,d.course_type_id,a.year,a.month,degree_code,programme_name,m.description as course_type')
                ->from('coe_value_mark_entry a')
                ->join('JOIN','coe_student_mapping b','a.student_map_id=b.coe_student_mapping_id')
                ->join('JOIN','coe_student c', 'b.student_rel_id=c.coe_student_id')
                ->join('JOIN','sub d','a.subject_map_id=d.coe_sub_mapping_id')
                ...
                ->join('JOIN', 'coe_batch k','k.coe_batch_id=g.coe_batch_id')
                ->join('JOIN','coe_programme i','i.coe_programme_id=g.coe_programme_id')
                ->join('JOIN', 'coe_category_type m', 'm.coe_category_type_id=d.course_type_id')
                ->Where(['a.year' => $_POST['year'], 'a.month' => $_POST['month'],'b.course_batch_mapping_id'=>$_POST['bat_map_val'],
                    'd.course_type_id'=>$_POST['prgm_type_val']])
                ->andWhere(['<>','status_category_type_id', $det_disc_type])->orderBy('c.register_number');  
             //$internet_copy_query_2->where($whereCondition);
             //$internet_copy_query_2
                //print_r($internet_copy_query_2);exit;
             $internet_copy_2 =$internet_copy_query_2->createCommand()->queryAll();
            ...
            if (count($internet_copy) > 0) {
                return $this->render('adc-nptl-coursera', [
                    'model' => $model, 'galley' => $galley, 
                     'add_credits'=> $add_credits,
                     'internet_copy' => $internet_copy,
                ]);
            } else {
                Yii::$app->ShowFlashMessages->setMsg('Error', "No data Available");
                return $this->render('adc-nptl-coursera', [
   ...
   public function actionExcelAdcNptlCoursera()
    {
        $updated_at = date("Y-m-d H:i:s");
        $updated_by = Yii::$app->user->getId();        
        $content = $_SESSION['internetcopy_additional_print'];
   ...
   public function actionAdcNptlCourseraPdf()
    {
        require(Yii::getAlias('@webroot/includes/use_institute_info.php'));
        $content = $_SESSION['internetcopy_additional_print'];
        //unset($_SESSION['student_application_date']);
        $pdf = new Pdf([
            'mode' => Pdf::MODE_CORE,
            'filename' => 'Adc-Nptl-Coursera Info.pdf',
            'format' => Pdf::FORMAT_A4,
            'orientation' => Pdf::ORIENT_PORTRAIT,
            'content' => $content,
            'cssFile' => '@vendor/kartik-v/yii2-mpdf/assets/kv-mpdf-bootstrap.min.css',
            'cssInline' => ' @media all{
                ...
                ',
            'options' => ['title' => 'Adc-Nptl-Coursera Info'],
            'methods' => [
                //'SetHeader' => ["OFFICE OF THE CONTROLLER OF EXAMINATIONS ".$org_name],
                //'SetFooter' => ['Tranparancy Data' . ' PRINTED ON : {DATE d-m-Y H:i:s:A}  PAGE :{PAGENO}'],
            ]
   ...
   public function actionValuatorMarkentry()
    {
        ...
        { 
            ...
            $val_faculty_all_id = Yii::$app->request->post('v_val_faculty_all_id');
            $dummynumbers = Yii::$app->request->post('valdummynum');

            $dummymark = Yii::$app->request->post('valdummymark');

           
            
            $val_fac_allcoate = Yii::$app->db->createCommand("SELECT total_answer_scripts,val_faculty_all_id,subject_pack_i,B.subject_mapping_id FROM coe_valuation_faculty_allocate as A join coe_answerpack_regno as B on B.answer_packet_number=A.subject_pack_i  WHERE  B.exam_month='" . $month . "' AND B.exam_year='" . $year . "' AND A.val_faculty_all_id='" . $val_faculty_all_id . "'")->queryAll();
            foreach($val_fac_allcoate as $value)
            {
             //print_r($val_fac_allcoate); exit;

             $check_verify_details = Yii::$app->db->createCommand("SELECT count(dummy_number) FROM coe_valuator_markentry WHERE val_faculty_all_id='" . $value['val_faculty_all_id'] . "' and answer_packet_number='".$value['subject_pack_i']."'")->queryScalar();

            if($value['total_answer_scripts']==($check_verify_details))
            {
                 Yii::$app->ShowFlashMessages->setMsg('Error','Packet Already done! Please Check');
                  return $this->redirect(['dummy-numbers/valuator-markentry']); 
            }
            else
            {
                $success=0;
                
                for ($i=0; $i <count($dummynumbers) ; $i++) 
                {  
                    //echo "SELECT * FROM coe_valuator_markentry WHERE dummy_number='".$dummynumbers[$i]."'"; 
                    $check_verify_details = Yii::$app->db->createCommand("SELECT count(dummy_number) FROM coe_valuator_markentry as A  WHERE dummy_number='".$dummynumbers[$i]."' and answer_packet_number='".$value['subject_pack_i']."'")->queryScalar(); 
                     //print_r($check_verify_details);exit;         

                    
                    if($check_verify_details==0)
                    {
                        //echo "string";  exit;
                        $user_id=Yii::$app->user->getId();

                        $insert = Yii::$app->db->createCommand('INSERT into coe_valuator_markentry(val_faculty_all_id, dummy_number,answer_packet_number,mark_100, created_at, created_by,year,month) values("'.$val_faculty_all_id.'","'.$dummynumbers[$i].'","'.$value['subject_pack_i'].'","'.$dummymark[$i].'","'.date('Y-m-d H:i:s').'","'.$user_id.'","'.$year.'","'.$month.'") ')->execute();
                ...
                //echo 'checking pls wait'.$success; exit;
                if($success>0)
                {
                    Yii::$app->ShowFlashMessages->setMsg('Success','Packet Saved Successfully! Please Check Report');
                    
                    $check_verify = Yii::$app->db->createCommand("SELECT * FROM coe_valuator_markentry WHERE val_faculty_all_id='" . $val_faculty_all_id . "' ORDER BY dummy_number")->queryAll(); 
                    //print_r($check_verify); exit;
                    return $this->render('valuator-markentry', [
                        'model' => $model,
                ...
                else
                {
                    ...
                    return $this->redirect(['mark-entry/valuator-markentry']);
                }
        ...
        {
            Yii::$app->ShowFlashMessages->setMsg('Welcome','Welcome to Valuator Mark Entry');
            return $this->render('valuator-markentry', [
                        'model' => $model,
                        'factallModel' =>$factallModel,
                        'check_verify'=>'',
     ...
     public function actionVerifydetailsPdf2()
    {
     ...
     public function actionValuatorMarkentryReport()
    {
        $model = new DummyNumbers();
        $factallModel = new ValuationFacultyAllocate();
        
        Yii::$app->ShowFlashMessages->setMsg('Welcome','Welcome to Valuator Mark Entry Report');
        return $this->render('valuator-markentryreport', [
                        'model' => $model,
                        'factallModel' =>$factallModel,
                        'verify_stu_data'=>'',
                        'val_faculty_all_id'=>'',
    ...
    public function actionValuatorMarkentryUpdate()
    {
        $model = new DummyNumbers();
        $factallModel = new ValuationFacultyAllocate();
        
        Yii::$app->ShowFlashMessages->setMsg('Welcome','Welcome to Valuator Mark Entry Update');
        return $this->render('valuator-markentry-update', [
                        'model' => $model,
                        'factallModel' =>$factallModel,
                        'verify_stu_data'=>'',
                        'val_faculty_all_id'=>'',
