 ...
 *
 * @property integer $coe_add_absent_entry_id
 ...
 */
class AbsentAdd extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            'coe_add_absent_entry_id' => 'Coe '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_ABSENT).' ID',
    ...
    public function getAbTypes()
    {
        ...
        $ab_types = Categorytype::find()->where(['category_id'=>$ab_type->coe_category_id])->andWhere(['NOT LIKE','description','Hall Wise Entry'])->andWhere(['NOT LIKE','description','Bar Code'])->orderBy(['category_type'=>SORT_ASC])->all();
