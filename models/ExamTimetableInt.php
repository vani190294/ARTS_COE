...
/**
 * This is the model class for table "coe_exam_timetable_int".
 *
 ...
 */
class ExamTimetableInt extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return 'coe_exam_timetable_int';
    }

    /**
     * @inheritdoc
     */
    public $coe_batch_id,$degree_type,$batch_mapping_id,$semester,$subject_code,$subject_name;
    public function rules()
    {
        return [
            [['subject_mapping_id', 'exam_month', 'exam_type', 'exam_term', 'exam_date', 'exam_session','time_slot','internal_number'], 'required'],
            ...
            [['semester','internal_number'], 'integer'],
    ...
    public function getExamTermRel()
    {
     ...
     public function getexamIntNumber()
    {
       $array= array('1'=>'CIA 1','2'=>'CIA 2','3'=>'Retest CIA 1','4'=>'Retest CIA 2','5'=>'MODEL');  
        return $array[$this->internal_number];
    }
    ...
    public function getExamtimeslot()
    {        
        $config_list = Categorytype::find()->where(['category_id' => 33])->all();
        $vals = ArrayHelper::map($config_list,'coe_category_type_id','category_type');
        return $vals;
    }
}
