...
/**
 * This is the model class for table "coe_mark_entry_master".
 *
 ...
 */
class MarkEntryMaster extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['student_map_id', 'subject_map_id', 'CIA', 'ESE', 'total', 'result', 'grade_point', 'created_by', 'created_at', 'updated_by', 'updated_at'], 'required'],
