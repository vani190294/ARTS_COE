...
class SubjectsMappingSearch extends SubjectsMapping
{
     ...
     * @inheritdoc
     */
    public $batch_name,$degree_code,$programme_code,$coe_batch_id,$subject_code,$subject_name,$ESE_min,$ESE_max,$CIA_max,$CIA_min;
    public function rules()
    {
        return [
            [['coe_subjects_mapping_id', 'batch_mapping_id', 'subject_id', 'ESE_max','ESE_min','CIA_max','CIA_min'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'batch_name', $this->batch_name])
            ...
            ->andFilterWhere(['=', 'CIA_max', $this->CIA_max])
             ->andFilterWhere(['=', 'CIA_min', $this->CIA_min])             
