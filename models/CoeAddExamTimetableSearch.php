...
/**
 * CoeAddExamTimetableSearch represents the model behind the search form about `app\models\CoeAddExamTimetable`.
 */
class CoeAddExamTimetableSearch extends CoeAddExamTimetable
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['coe_add_exam_timetable_id', 'subject_mapping_id', 'created_by', 'updated_by'], 'integer'],
            [['exam_year','semester','exam_type', 'exam_term', 'qp_code', 'exam_date', 'exam_session', 'created_at', 'updated_at','exam_month','programme_code','degree_code','batch_name','subject_code','cover_number'], 'safe'],
        ];
    }
    ...
    {
        $query = CoeAddExamTimetable::find()->orderBy('coe_add_exam_timetable_id DESC');
        ...
        $query->andFilterWhere([
            'coe_add_exam_timetable_id' => $this->coe_add_exam_timetable_id,
        ...
        $query->andFilterWhere(['like', 'exam_type.category_type', $this->exam_type])
            ...
            ->andFilterWhere(['like', 'cover_number', $this->cover_number])
