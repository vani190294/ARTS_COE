...
/**
 * ExamTimetableIntSearch represents the model behind the search form about `app\models\ExamTimetableInt`.
 */
class ExamTimetableIntSearch extends ExamTimetableInt
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['exam_year','semester','exam_type', 'exam_term', 'qp_code', 'exam_date', 'exam_session', 'created_at', 'updated_at','exam_month','programme_code','degree_code','batch_name','subject_code','internal_number'], 'safe'],
        ];
    }
    ...
    {
        $query = ExamTimetableInt::find()->orderBy('coe_exam_timetable_id DESC');
