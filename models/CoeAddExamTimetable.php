...
/**
 * This is the model class for table "coe_add_exam_timetable".
 *
 * @property integer $coe_add_exam_timetable_id
 ...
 * @property string $cover_number
 * @property integer $created_by
 * @property string $created_at
 * @property integer $updated_by
 * @property string $updated_at
 */
class CoeAddExamTimetable extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['qp_code','cover_number'], 'string', 'max' => 45],
            [['semester'], 'integer'],
    ...
    {
       return [
            'coe_add_exam_timetable_id' => 'Coe '.ConfigUtilities::getConfigValue(ConfigConstants::CONFIG_EXAM).' Timetable',
    ...
    {
        return $this->hasOne(Sub::className(), ['coe_sub_mapping_id' => 'subject_mapping_id']);
    }
    ...
    {
        return $this->hasOne(CoeValueSubjects::className(), ['coe_val_sub_id' => 'val_subject_id'])->via('subjectMapping');
