...
class ExamTimetableSearch extends ExamTimetable
{
    ...
    public function rules()
    {
        return [
            ...
            [['exam_year','semester','exam_type', 'exam_term', 'qp_code','cover_number', 'exam_date', 'exam_session', 'created_at', 'updated_at','exam_month','programme_code','degree_code','batch_name','subject_code'], 'safe'],
        ];
    }
