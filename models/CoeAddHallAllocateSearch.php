...
/**
 * CoeAddHallAllocateSearch represents the model behind the search form about `app\models\CoeAddHallAllocate`.
 */
class CoeAddHallAllocateSearch extends CoeAddHallAllocate
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['coe_add_hall_allocate_id', 'hall_master_id', 'exam_timetable_id', 'year', 'row', 'row_column', 'seat_no', 'created_by', 'updated_by'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere([
            'coe_add_hall_allocate_id' => $this->coe_add_hall_allocate_id,
            'hall_master_id' => $this->hall_master_id,
            'exam_timetable_id' => $this->exam_timetable_id,
            'year' => $this->year,
            'row' => $this->row,
