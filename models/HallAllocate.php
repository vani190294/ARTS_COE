 ...
 */
class HallAllocate extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    public function rules()
    {
        return [
            ...
            [['hall_master_id','exam_timetable_id','year', 'row', 'row_column', 'seat_no','exam_type', 'created_by', 'updated_by'], 'integer'],
