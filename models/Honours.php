...
/**
 * This is the model class for table "cur_honours".
 *
 ...
 */
class Honours extends \yii\db\ActiveRecord
{
    const TYPE_UG= 'UG';
    const TYPE_PG= 'PG';
    const TYPE_MBA= 'MBA';
    ...
    {
        return [
            [['coe_batch_id', 'batch_map_id', 'degree_type','coe_batch_id', 'coe_regulation_id', 'coe_dept_id', 'honours_type', 'register_number', 'subject_code', 'semester'], 'required'],
            [['batch_map_id', 'coe_regulation_id', 'coe_dept_id', 'honours_type', 'semester', 'approve_status', 'created_by', 'updated_by'], 'integer'],
    ...
    public function getDepartmentdetails()
    {
     ...
     public function getHonourstype()
    { 
         return $this->hasOne(Categorytype::className(), ['coe_category_type_id' => 'honours_type']);
    }
    ...
    public function getHonourstypeDetails()
    {
        $deptall = Yii::$app->db->createCommand("SELECT coe_category_type_id,category_type FROM coe_category_type WHERE category_id=31 AND coe_category_type_id!=230")->queryAll();
