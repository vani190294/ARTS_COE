...
class ConfigUtilities
{
  ...
  public  function getConfigValue($name)
    ...
    {
        $batch = Batch::find()->orderBy(['batch_name'=>SORT_DESC])->all();
    ...
    public function getCgpaCaluclation($exam_year,$exam_month,$batch_mapping_id,$student_map_id,$term,$se=null)
    {
      ...
      {
         $total_credits_earn_part_1 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" and month="'.$exam_month_fin.'" and student_map_id="'.$student_map_id.'" and result like "%pass%" and  part_no=1 and term=35';
        $total_earn_reg_part_1= Yii::$app->db->createCommand($total_credits_earn_part_1)->queryScalar();
      }
        //print_r($term);exit;
    ...
    $total_credits_earn_part_3 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" and month="'.$exam_month_fin.'" and student_map_id="'.$student_map_id.'" and result like "%pass%" and  part_no=3  and term=35  and mark_type=28';
      ...
      else
      {
        ...
        $total_credits_earn_part_4 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" and month="'.$exam_month_fin.'" and student_map_id="'.$student_map_id.'" and result like "%pass%" and  part_no=4 and term=35 and mark_type=28';
        $total_earn_reg_part_4= Yii::$app->db->createCommand($total_credits_earn_part_4)->queryScalar();
       //print_r($total_credits_earn_part_4);exit;
       ...
       $get_final_cgpa = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),5) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE student_map_id="'.$student_map_id.'" and result like "%pass%"'; 
        ...
        $total_earn_reg_part_1= Yii::$app->db->createCommand($total_credits_earn_part_1)->queryScalar();
          ...
          $total_credits_earn_part_1 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" '.$trim_months.' and student_map_id="'.$student_map_id.'" and result like "%pass%" '.$sem_add .' AND subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where year="'.$exam_year.'" and student_map_id="'.$student_map_id.'" and month=30 and result like "%pass%" '.$sem_add .' ) and part_no=1 and term=35';
        $total_earn_reg_part_1= Yii::$app->db->createCommand($total_credits_earn_part_1)->queryScalar();
         }
 if($term==34)
 {
      ...
      else
      {
         ...
         $total_credits_earn_part_2 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" '.$trim_months.' and student_map_id="'.$student_map_id.'" and result like "%pass%" '.$sem_add .' AND subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where year="'.$exam_year.'" and student_map_id="'.$student_map_id.'" and month=30 and result like "%pass%" '.$sem_add .' ) and part_no=2 and term=35';
        $total_earn_reg_part_2= Yii::$app->db->createCommand($total_credits_earn_part_2)->queryScalar();
      }
      ...
      if($term==34)
      {
       ...
       else
       {
         ...
         $total_credits_earn_part_4 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" '.$trim_months.' and student_map_id="'.$student_map_id.'" and result like "%pass%" '.$sem_add .' AND subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where year="'.$exam_year.'" and student_map_id="'.$student_map_id.'" and month=30 and result like "%pass%" '.$sem_add .' ) and part_no=4 and term=35 and mark_type=28';
        $total_earn_reg_part_4= Yii::$app->db->createCommand($total_credits_earn_part_4)->queryScalar();
       ...
       $total_ad_earn_reg= Yii::$app->db->createCommand($total_add_credits_earn)->queryScalar();
        ...
        //print_r( $gpa_result_part_3 );exit;
      }
      else
      {
     ...
     public function getgpaCaluclationObe($exam_year,$exam_month,$batch_mapping_id,$student_map_id,$term,$se=null)
    {
        $get_month = is_numeric($exam_month)?$exam_month:Categorytype::find()->where(['description'=>$exam_month])->one();
       ...
       if($term==34)
        { 
        $total_credits_earn_part_1 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" and month="'.$exam_month_fin.'" and student_map_id="'.$student_map_id.'" and result like "%pass%" and B.semester="'.$sem_calc.'" and  part_no=1';
        $total_earn_reg_part_1= Yii::$app->db->createCommand($total_credits_earn_part_1)->queryScalar();
      }
      else
      {
         $total_credits_earn_part_1 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" and month="'.$exam_month_fin.'" and student_map_id="'.$student_map_id.'" and result like "%pass%" and  part_no=1  and  B.semester="'.$sem_calc.'" and term=35';
        $total_earn_reg_part_1= Yii::$app->db->createCommand($total_credits_earn_part_1)->queryScalar();
      }
        //print_r($term);exit;
        ...
        if($term==34)
        {
         ...
         $total_credits_earn_part_2 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" and month="'.$exam_month_fin.'" and student_map_id="'.$student_map_id.'" and result like "%pass%" and   B.semester="'.$sem_calc.'" and part_no=2';
        $total_earn_reg_part_2= Yii::$app->db->createCommand($total_credits_earn_part_2)->queryScalar();
      }
      else
      {

       $total_credits_earn_part_2 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" and month="'.$exam_month_fin.'" and student_map_id="'.$student_map_id.'" and result like "%pass%" and  part_no=2 and B.semester="'.$sem_calc.'" and  term=35';
        $total_earn_reg_part_2= Yii::$app->db->createCommand($total_credits_earn_part_2)->queryScalar();
      }

     if($term==34)
     {
        $total_credits_earn_part_3 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" and month="'.$exam_month_fin.'" and student_map_id="'.$student_map_id.'" and result like "%pass%" and  B.semester="'.$sem_calc.'" and part_no=3';
        $total_earn_reg_part_3= Yii::$app->db->createCommand($total_credits_earn_part_3)->queryScalar();
      }
      else
      {
   $total_credits_earn_part_3 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year=2020 and month=29 and student_map_id="'.$student_map_id.'" and result like "%pass%" and  part_no=3  and term=35  and  B.semester="'.$sem_calc.'" and mark_type=28';
        $total_earn_reg_part_3= Yii::$app->db->createCommand($total_credits_earn_part_3)->queryScalar();
      }

        $total_credits_earn_part_4 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" and month="'.$exam_month_fin.'" and student_map_id="'.$student_map_id.'" and result like "%pass%" and  B.semester="'.$sem_calc.'" and  part_no=4';
        $total_earn_reg_part_4= Yii::$app->db->createCommand($total_credits_earn_part_4)->queryScalar();
       ...
       $get_final_cgpa = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),5) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE student_map_id="'.$student_map_id.'" and B.semester="'.$sem_calc.'" and  result like "%pass%"'; 
        $final_cgpa_result = Yii::$app->db->createCommand($get_final_cgpa)->queryScalar();
        $final_cgpa_result = round($final_cgpa_result,2);

        $total_credits_cons = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE student_map_id="'.$student_map_id.'" and   B.semester="'.$sem_calc.'" and result like "%pass%" ';
        $consolidate_tot = Yii::$app->db->createCommand($total_credits_cons)->queryScalar();
 ...
 if($term==34)
 {
      ...
      $get_gpa_part_3 = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),2) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" and month="'.$exam_month_fin.'" and student_map_id="'.$student_map_id.'" and result like "%pass%" and  part_no=3 and B.semester="'.$sem_calc.'" and term=35';
      $gpa_result_part_3 = Yii::$app->db->createCommand($get_gpa_part_3)->queryScalar();
     ...
     /**  $get_gpa_part_3 = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),2) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" and month="'.$exam_month_fin.'" and student_map_id="'.$student_map_id.'" and result like "%pass%" and  part_no=3 '; 
      ...
      //  print_r($part_3_cgpa);exit;
        ...
        if($sem_calc%2==0)
        {
         ...
         $total_credits_ob = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE   student_map_id="'.$student_map_id.'" and result like "%pass%" and  B.semester="'.$sem_calc.'" and part_no=1';
        $total_earn_reg_part_ob= Yii::$app->db->createCommand($total_credits_ob)->queryScalar();


        $part_1_ob = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),2) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE  student_map_id="'.$student_map_id.'" and result like "%pass%"  AND  B.semester="'.$sem_calc.'" and  part_no=1  ';
          
          $part_1_cgpa_ob = Yii::$app->db->createCommand($part_1_ob )->queryScalar();


           $part_2_ob = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),2) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE  student_map_id="'.$student_map_id.'" and  B.semester="'.$sem_calc.'" and result like "%pass%"  AND   part_no=2  ';
          
          $part_2_cgpa_ob = Yii::$app->db->createCommand($part_2_ob )->queryScalar();


          


           $part_3_ob = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),2) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE  student_map_id="'.$student_map_id.'" and result like "%pass%"  AND  B.semester="'.$sem_calc.'" and   part_no=3  ';
          
          $part_3_cgpa_ob = Yii::$app->db->createCommand($part_3_ob )->queryScalar();

          //



           $part_4_ob = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),2) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE  student_map_id="'.$student_map_id.'" and result like "%pass%"  AND  B.semester="'.$sem_calc.'" and  part_no=4  ';
          
          $part_4_cgpa_ob = Yii::$app->db->createCommand($part_4_ob )->queryScalar();

          //print_r($part_1_cgpa_ob);exit;
         ...
         $total_credits_ob_2 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE   student_map_id="'.$student_map_id.'" and result like "%pass%" and  B.semester="'.$sem_calc.'" and part_no=2';
        $total_earn_reg_part_ob_2= Yii::$app->db->createCommand($total_credits_ob_2)->queryScalar();



        $total_credits_ob_3 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE   student_map_id="'.$student_map_id.'" and result like "%pass%" and  B.semester="'.$sem_calc.'" and part_no=3';
        $total_earn_reg_part_ob_3= Yii::$app->db->createCommand($total_credits_ob_3)->queryScalar();

          $total_credits_ob_4 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE   student_map_id="'.$student_map_id.'" and result like "%pass%" and   B.semester="'.$sem_calc.'" and            part_no=4';
        $total_earn_reg_part_ob_4= Yii::$app->db->createCommand($total_credits_ob_4)->queryScalar();

         //$register_number = StuInfo::find()->where(['stu_map_id'=>$student_map_id]);

  $register_number = Yii::$app->db->createCommand(" select reg_num from stu_info where stu_map_id='".$student_map_id."' ")->queryOne();

  //$register_number='18BEN002';
        ...
        $cumulative_total_addition_cred = empty($cumulative_total_addition_cred)?"0":$cumulative_total_addition_cred;
        $total_registered = empty($total_reg)?"-":$total_reg;
        $credits_earned_part4 = empty($total_earn_reg_part_ob_4)?"--":$total_earn_reg_part_ob_4;
        $cgpa_result_sen_part4 = empty($part_4_cgpa_ob)?"--":round($part_4_cgpa_ob,1);
        $gpa_result_send_part4 = empty($gpa_result_part_4)?"--":round($gpa_result_part_4,1);
        $grade_point_part4= ConfigUtilities::getPartGradePonts($cgpa_result_sen_part4, $register_number);

        $credits_earned_part3 = empty($total_earn_reg_part_ob_3)?"--":$total_earn_reg_part_ob_3;
        $cgpa_result_sen_part3 = empty($part_3_cgpa_ob)?"--":round($part_3_cgpa_ob,1);
        $gpa_result_send_part3 = empty($gpa_result_part_3)?"--":round($gpa_result_part_3,1);
        $grade_point_part3= ConfigUtilities::getPartGradePonts($cgpa_result_sen_part3, $register_number);

        $credits_earned_part2 = empty($total_earn_reg_part_ob_2)?"--":$total_earn_reg_part_ob_2;
        $cgpa_result_sen_part2 = empty($part_2_cgpa_ob)?"--":round($part_2_cgpa_ob,1);
        $gpa_result_send_part2 = empty($gpa_result_part_2)?"--":round($gpa_result_part_2,1);
        $grade_point_part2= ConfigUtilities::getPartGradePonts($cgpa_result_sen_part2, $register_number);
        //print_r( $grade_point_part2);exit;

        $credits_earned_part1 = empty($total_earn_reg_part_ob)?"--":$total_earn_reg_part_ob;
        $cgpa_result_sen_part1 = empty($part_1_cgpa_ob)?"--":round($part_1_cgpa_ob,1);
        $gpa_result_send_part1 = empty($gpa_result_part_1)?"--":round($gpa_result_part_1,1);
        $grade_point_part1= ConfigUtilities::getPartGradePonts($cgpa_result_sen_part1, $register_number);

        //print_r($grade_point_part1);exit;
        ...
        return $arra = ['part_1_gpa'=>$gpa_result_send_part1,'part_2_gpa'=>$gpa_result_send_part2,'part_3_gpa'=>$gpa_result_send_part3,'part_4_gpa'=>$gpa_result_send_part4,'part_1_earned'=>$credits_earned_part1,'part_2_earned'=>$credits_earned_part2,'part_3_earned'=>$credits_earned_part3,'part_4_earned'=>$credits_earned_part4,'part_1_cgpa'=>$cgpa_result_sen_part1,'part_2_cgpa'=>$cgpa_result_sen_part2,'part_3_cgpa'=>$cgpa_result_sen_part3,'part_4_cgpa'=>$cgpa_result_sen_part4,'final_cgpa'=>$final_cgpa_result,'consolidate_cre' =>$consolidate_total_cred,'registered'=>$total_registered,'part_1_grade'=>$grade_point_part1['grade_name'],'part_2_grade'=>$grade_point_part2['grade_name'],'part_3_grade'=>$grade_point_part3['grade_name'],'part_4_grade'=>$grade_point_part4['grade_name']];

    }

    public function getgpaCaluclationObe1($exam_year,$exam_month,$batch_mapping_id,$student_map_id,$term)
    {
        $get_month = is_numeric($exam_month)?$exam_month:Categorytype::find()->where(['description'=>$exam_month])->one();
   ...
   $total_credits_earn_part_3 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year=2020 and month=29 and student_map_id="'.$student_map_id.'" and result like "%pass%" and  part_no=3  and term=35   and mark_type=28';
       ...
       $get_final_cgpa = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),5) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE student_map_id="'.$student_map_id.'"  and  result like "%pass%"'; 
          ...
          
        {
          if($term==34)
          {
             $total_credits_earn_part_1 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" '.$trim_months.' and student_map_id="'.$student_map_id.'" and result like "%pass%" '.$sem_add .' AND subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where year="'.$exam_year.'" and student_map_id="'.$student_map_id.'" and month=30 and result like "%pass%" ) and part_no=1';
        $total_earn_reg_part_1= Yii::$app->db->createCommand($total_credits_earn_part_1)->queryScalar();
          }
          else
          {
          ...
          $total_credits_earn_part_1 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" '.$trim_months.' and student_map_id="'.$student_map_id.'" and result like "%pass%" '.$sem_add .' AND subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where year="'.$exam_year.'" and student_map_id="'.$student_map_id.'" and month=30 and result like "%pass%"  ) and part_no=1 and term=35';
        $total_earn_reg_part_1= Yii::$app->db->createCommand($total_credits_earn_part_1)->queryScalar();
         }
 if($term==34)
 {
        ...
        $total_credits_earn_part_2 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" '.$trim_months.' and student_map_id="'.$student_map_id.'" and result like "%pass%" '.$sem_add .' AND subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where year="'.$exam_year.'" and student_map_id="'.$student_map_id.'" and month=30 and result like "%pass%"  ) and part_no=2 ';
        $total_earn_reg_part_2= Yii::$app->db->createCommand($total_credits_earn_part_2)->queryScalar();
      }
      else
      {
         ...
         $total_credits_earn_part_2 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" '.$trim_months.' and student_map_id="'.$student_map_id.'" and result like "%pass%" '.$sem_add .' AND subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where year="'.$exam_year.'" and student_map_id="'.$student_map_id.'" and month=30 and result like "%pass%"  ) and part_no=2 and term=35';
        $total_earn_reg_part_2= Yii::$app->db->createCommand($total_credits_earn_part_2)->queryScalar();
      }
        ...
        $total_credits_earn_part_3 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" '.$trim_months.' and student_map_id="'.$student_map_id.'" and result like "%pass%" '.$sem_add .' AND subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where year="'.$exam_year.'" and student_map_id="'.$student_map_id.'" and month=30 and result like "%pass%"  ) and part_no=3 ';
        $total_earn_reg_part_3= Yii::$app->db->createCommand($total_credits_earn_part_3)->queryScalar();
      }
      else{
        
         $total_credits_earn_part_3 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" '.$trim_months.' and student_map_id="'.$student_map_id.'" and result like "%pass%" '.$sem_add .' AND subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where year="'.$exam_year.'" and student_map_id="'.$student_map_id.'" and month=30 and result like "%pass%"  ) and part_no=3  and term=35';
      
        $total_earn_reg_part_3= Yii::$app->db->createCommand($total_credits_earn_part_3)->queryScalar();
      }

        $total_credits_earn_part_4 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" '.$trim_months.' and student_map_id="'.$student_map_id.'" and result like "%pass%" '.$sem_add .' AND subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where year="'.$exam_year.'" and student_map_id="'.$student_map_id.'" and month=30 and result like "%pass%"  ) and part_no=4';
        $total_earn_reg_part_4= Yii::$app->db->createCommand($total_credits_earn_part_4)->queryScalar();
       ...
       $total_ad_earn_reg= Yii::$app->db->createCommand($total_add_credits_earn)->queryScalar();
        ...
        $get_gpa_part_2 = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),2) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" and month="'.$exam_month_fin.'"  and result like "%pass%" and  B.semester="'.$sem_calc.'" and  part_no=2'; 
        $gpa_result_part_2 = Yii::$app->db->createCommand($get_gpa_part_2)->queryScalar();
        if($term==34)
        {
     ...
     /**  $get_gpa_part_3 = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),2) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year="'.$exam_year.'" and month="'.$exam_month_fin.'" and student_map_id="'.$student_map_id.'" and result like "%pass%" and  part_no=3 '; 
      ...
      //  print_r($part_3_cgpa);exit;
        ...
        if($sem_calc%2==0)
        {
          $part_1 = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),2) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE year<="'.$exam_year.'" '.$trim_months.' and student_map_id="'.$student_map_id.'" and result like "%pass%"  AND subject_map_id NOT IN(select subject_map_id FROM coe_mark_entry_master where year="'.$exam_year.'" and student_map_id="'.$student_map_id.'" and month=30 and result like "%pass%"  ) and part_no=1  ';
         ...
         $total_credits_ob = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE   student_map_id="'.$student_map_id.'" and result like "%pass%"  and part_no=1';
        $total_earn_reg_part_ob= Yii::$app->db->createCommand($total_credits_ob)->queryScalar();


        $part_1_ob = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),2) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE  student_map_id="'.$student_map_id.'" and result like "%pass%"   and  part_no=1  ';
          
          $part_1_cgpa_ob = Yii::$app->db->createCommand($part_1_ob )->queryScalar();


           $part_2_ob = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),2) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE  student_map_id="'.$student_map_id.'"  and result like "%pass%"  AND   part_no=2  ';
          ...
          $part_2_cgpa_ob = Yii::$app->db->createCommand($part_2_ob )->queryScalar();
           ...
           $part_3_ob = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),2) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE  student_map_id="'.$student_map_id.'" and result like "%pass%"   and   part_no=3  ';
          ...
          //
           ...
           $part_4_ob = 'SELECT round (sum(A.grade_point*D.credit_points)/sum(D.credit_points),2) as cgpa FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE  student_map_id="'.$student_map_id.'" and result like "%pass%"  and  part_no=4  ';
         ...
         $total_credits_ob_2 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE   student_map_id="'.$student_map_id.'" and result like "%pass%" and part_no=2';
          $total_earn_reg_part_ob_2= Yii::$app->db->createCommand($total_credits_ob_2)->queryScalar();



        $total_credits_ob_3 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE   student_map_id="'.$student_map_id.'" and result like "%pass%"  and part_no=3';
        $total_earn_reg_part_ob_3= Yii::$app->db->createCommand($total_credits_ob_3)->queryScalar();

          $total_credits_ob_4 = 'SELECT sum(D.credit_points) as total_credits FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id WHERE   student_map_id="'.$student_map_id.'" and result like "%pass%"  and  part_no=4';
        $total_earn_reg_part_ob_4= Yii::$app->db->createCommand($total_credits_ob_4)->queryScalar();
  ...
  //$register_number='18BEN002';
    ...
    {        
       ...
       // $getYearOfPassing = Yii::$app->db->createCommand('select * from coe_mark_entry_master as B where result not like  "%pass%" and result not like  "%COMPLETED%" and  result not like  "%EXEMPLARY%"  and   result not like  "%VERY GOOD%"  and result not like "%GOOD%"  and result not like "%FAIR%" and student_map_id="'.$stuInfo['stu_map_id'].'" limit 3')->queryAll();
    ...
    {       
        $query = "SELECT coe_programme_id,programme_code FROM coe_programme order by coe_programme_id";
        $degreeInfo = Yii::$app->db->createCommand($query)->queryAll();        
     ...
     public function getAttempts($stu_map_id,$exam_year,$exam_month)
     {
      ...
      public function getPartDetails($register_number,$part_no)
      {
       ...
       // print_r($part_marks );exit;
        ...
        $part_5 = 'SELECT grade_name FROM coe_mark_entry_master as A JOIN coe_subjects_mapping as B ON B.coe_subjects_mapping_id=A.subject_map_id JOIN coe_student_mapping as C ON C.coe_student_mapping_id=A.student_map_id JOIN coe_subjects as D ON D.coe_subjects_id=B.subject_id  WHERE student_map_id="'.$getStu['stu_map_id'].'" and B.semester=6 and part_no=5';
        $part_5_details = Yii::$app->db->createCommand($part_5)->queryOne();

        //print_r($part_5_details);exit;
      ...
      $part_cgpa = (!empty($sum['cgpa']) || $sum['cgpa']!=0) ? round($sum['cgpa'],1):'--';
         ...
         $part_cgpa = (strlen( $part_cgpa)==1  || strlen( $part_cgpa)==2)  &&  $part_cgpa!='--' ?$part_cgpa.".0": $part_cgpa;   

         //$part_cgpa = empty($sum['cgpa'])?"--":round($sum['cgpa'],1);

        //print_r($part_cgpa);exit;
